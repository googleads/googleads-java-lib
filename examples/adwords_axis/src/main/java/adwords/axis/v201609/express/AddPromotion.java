...
package adwords.axis.v201609.express;
...
import com.google.api.ads.adwords.axis.v201609.express.ExpandedCreative;
import com.google.api.ads.adwords.axis.v201609.express.ProductService;
import com.google.api.ads.adwords.axis.v201609.express.Promotion;
import com.google.api.ads.adwords.axis.v201609.express.PromotionOperation;
import com.google.api.ads.adwords.axis.v201609.express.PromotionServiceInterface;
import com.google.api.ads.adwords.axis.v201609.express.PromotionStatus;
...
public class AddPromotion {
  ...
  public static List<Promotion> runExample(
    ...
    expandedCreative.setHeadline1("Standard Mars Trip");
    expandedCreative.setHeadline2("Fly coach to Mars");
    expandedCreative.setDescription("Free in-flight pretzels");

    marsTourPromotion.setExpandedCreative(expandedCreative);
