...
import com.google.api.ads.adwords.axis.v201406.cm.ConstantOperandConstantType;
import com.google.api.ads.adwords.axis.v201406.cm.CustomerFeed;
import com.google.api.ads.adwords.axis.v201406.cm.CustomerFeedOperation;
import com.google.api.ads.adwords.axis.v201406.cm.CustomerFeedReturnValue;
import com.google.api.ads.adwords.axis.v201406.cm.CustomerFeedServiceInterface;
import com.google.api.ads.adwords.axis.v201406.cm.Feed;
import com.google.api.ads.adwords.axis.v201406.cm.FeedOperation;
import com.google.api.ads.adwords.axis.v201406.cm.FeedOrigin;
...
import com.google.api.ads.adwords.axis.v201406.cm.Function;
import com.google.api.ads.adwords.axis.v201406.cm.FunctionArgumentOperand;
import com.google.api.ads.adwords.axis.v201406.cm.FunctionOperator;
import com.google.api.ads.adwords.axis.v201406.cm.OAuthInfo;
import com.google.api.ads.adwords.axis.v201406.cm.Operator;
import com.google.api.ads.adwords.axis.v201406.cm.PlacesLocationFeedData;
...
public class AddGoogleMyBusinessLocationExtensions {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // To obtain an access token for your GMB account, run the GetRefreshToken example.
    // Make sure you are logged in as the same user as gmbEmailAddress above when you follow
    // the link provided by the example, then capture the generated Credential's access token.
  ...
  private static void runExample(AdWordsServices adWordsServices, AdWordsSession session,
      String gmbEmailAddress, String gmbAccessToken) throws ApiException, RemoteException,
