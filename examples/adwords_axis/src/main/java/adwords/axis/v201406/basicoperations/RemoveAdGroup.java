...
public class RemoveAdGroup {
  ...
  public static void runExample(
    ...
    // When removing an ad group, rename it to avoid name collisions with new ad groups.
    adGroup.setName("Removed on " + new SimpleDateFormat("yyMMDD HH:mm:ss.S").format(new Date()));
