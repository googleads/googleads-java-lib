...
import com.google.api.ads.dfa.axis.v1_20.ContentCategoryRecordSet;
import com.google.api.ads.dfa.axis.v1_20.ContentCategoryRemote;
import com.google.api.ads.dfa.axis.v1_20.ContentCategorySearchCriteria;
...
public class GetContentCategories {
  ...
  public static void runExample(
    ...
    if (contentCategoryRecordSet.getRecords() != null) {
      for (ContentCategory result : contentCategoryRecordSet.getRecords()) {
        System.out.println("Content category with name \"" + result.getName()
            + "\" and ID \"" + result.getId() + "\" was found.");
      }
    } else {
      System.out.print("No content categories found for your criteria.");
    }
  }
