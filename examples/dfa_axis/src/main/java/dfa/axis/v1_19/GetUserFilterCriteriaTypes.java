...
import com.google.api.ads.dfa.axis.v1_19.UserFilterCriteriaType;
 ...
 */
public class GetUserFilterCriteriaTypes {
  ...
  public static void runExample(DfaServices dfaServices, DfaSession session) throws Exception {
    ...
    UserFilterCriteriaType[] types = userService.getAvailableUserFilterCriteriaTypes();

    // Display user filter criteria types.
    for (UserFilterCriteriaType type : types) {
      System.out.printf("User filter criteria type with name \"%s\" and ID \"%s\" was found.",
