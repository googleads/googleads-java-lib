...
package admanager.axis.v201905.premiumrateservice;
...
import com.google.api.ads.admanager.axis.v201905.PremiumAdjustmentType;
import com.google.api.ads.admanager.axis.v201905.PremiumRate;
import com.google.api.ads.admanager.axis.v201905.PremiumRatePage;
import com.google.api.ads.admanager.axis.v201905.PremiumRateServiceInterface;
import com.google.api.ads.admanager.axis.v201905.PremiumRateValue;
...
/**
 * This example updates a premium rate to add a flat fee to an existing feature premium. To
 * determine which premium rates exist, run GetAllPremiumRates.java.
 *
...
public class UpdatePremiumRates {
  ...
  private static class UpdatePremiumRatesParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.PREMIUM_RATE_ID,
        required = true,
  ...
  public static void runExample(
      AdManagerServices adManagerServices, AdManagerSession session, long premiumRateId)
      throws RemoteException {
    // Get the PremiumRateService.
    PremiumRateServiceInterface premiumRateService =
        adManagerServices.get(session, PremiumRateServiceInterface.class);
    ...
    List<PremiumRateValue> existingPremiumRateValues =
        ((premiumRate.getPremiumRateValues() != null)
    ...
    premiumRate.setPremiumRateValues(existingPremiumRateValues.toArray(new PremiumRateValue[] {}));
    ...
    for (PremiumRate updatedPremiumRate : premiumRates) {
      System.out.printf(
          "Premium rate with ID %d associated with rate card id %d was updated.%n",
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(adManagerServices, session, params.premiumRateId);
