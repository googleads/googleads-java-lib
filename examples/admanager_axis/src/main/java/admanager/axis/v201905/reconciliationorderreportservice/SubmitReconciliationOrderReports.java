...
package admanager.axis.v201905.reconciliationorderreportservice;
...
import com.google.api.ads.admanager.axis.v201905.ReconciliationOrderReport;
import com.google.api.ads.admanager.axis.v201905.ReconciliationOrderReportPage;
import com.google.api.ads.admanager.axis.v201905.ReconciliationOrderReportServiceInterface;
...
/**
 * This example submits a reconciliation order report. To get all reconciliation order reports for a
 * reconciliation report, run GetReconciliationOrderReportsForReconciliationReport.java.
 *
...
public class SubmitReconciliationOrderReports {
  ...
  private static class SubmitReconciliationOrderReportsParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.RECONCILIATION_ORDER_REPORT_ID,
        required = true,
  ...
  public static void runExample(
    ...
    com.google.api.ads.admanager.axis.v201905.SubmitReconciliationOrderReports action =
        new com.google.api.ads.admanager.axis.v201905.SubmitReconciliationOrderReports();
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(adManagerServices, session, params.reconciliationOrderReportId);
