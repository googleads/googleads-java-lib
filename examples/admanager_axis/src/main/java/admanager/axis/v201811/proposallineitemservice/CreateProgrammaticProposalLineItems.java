...
/**
 * This example creates a new programmatic proposal line item that uses its product's targeting.
 * Your network must have sales management enabled to run this example.
 *
...
public class CreateProgrammaticProposalLineItems {
  ...
  private static class CreateProgrammaticProposalLineItemsParams extends CodeSampleParams {
    ...
    @Parameter(
        ...
        required = true,
        description =
            "The ID of the Marketplace rate card that the proposal line items should"
                + " be priced with.")
