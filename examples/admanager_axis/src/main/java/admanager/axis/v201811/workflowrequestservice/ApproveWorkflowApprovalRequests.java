...
package admanager.axis.v201811.workflowrequestservice;
...
import com.google.api.ads.admanager.axis.v201811.UpdateResult;
import com.google.api.ads.admanager.axis.v201811.WorkflowApprovalRequestStatus;
import com.google.api.ads.admanager.axis.v201811.WorkflowEntityType;
import com.google.api.ads.admanager.axis.v201811.WorkflowRequest;
import com.google.api.ads.admanager.axis.v201811.WorkflowRequestPage;
import com.google.api.ads.admanager.axis.v201811.WorkflowRequestServiceInterface;
import com.google.api.ads.admanager.axis.v201811.WorkflowRequestType;
...
/**
 * This example approves all workflow approval requests belonging to a specific proposal. To
 * determine which proposals exist, run GetAllProposals.java.
 *
...
public class ApproveWorkflowApprovalRequests {
   ...
   * @param proposalId the ID of the proposal to approve workflow approval requests for.
  ...
  public static void runExample(
    ...
    StatementBuilder statementBuilder =
        new StatementBuilder()
            ...
            .withBindVariableValue(
                "approvalStatus", WorkflowApprovalRequestStatus.PENDING_APPROVAL.toString())
            .withBindVariableValue(
                "type", WorkflowRequestType.WORKFLOW_APPROVAL_REQUEST.toString());
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (WorkflowRequest workflowRequest : page.getResults()) {
          System.out.printf(
              "%d) Workflow approval request with ID %d will be approved.%n",
    ...
    System.out.printf(
        "Number of workflow approval requests to be approved: %d%n", totalResultSetSize);
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.admanager.axis.v201811.ApproveWorkflowApprovalRequests action =
          new com.google.api.ads.admanager.axis.v201811.ApproveWorkflowApprovalRequests();
      ...
      if (result != null && result.getNumChanges() > 0) {
        System.out.printf(
            "Number of workflow approval requests approved: %d%n", result.getNumChanges());
      } else {
