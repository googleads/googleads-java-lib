...
import com.google.api.ads.admanager.axis.v201811.ProductTemplatePage;
...
/**
 * This example updates a product template's targeting to include a new GeoTarget. To determine
 * which product templates exist, run GetAllProductTemplates.java.
 *
...
public class UpdateProductTemplates {
  ...
  public static void runExample(
    ...
    for (ProductTemplate updatedProductTemplate : productTemplates) {
      System.out.printf(
          "Product template with ID %d and name '%s' was updated.%n",
          updatedProductTemplate.getId(), updatedProductTemplate.getName());
    }
  }
