...
import com.google.api.ads.admanager.axis.v201811.WorkflowEvaluationStatus;
...
/**
 * This example triggers all workflow external condition requests belonging to a specific proposal.
 * Workflow external condition requests must be triggered or skipped for a workflow to finish. To
  ...
  public static void runExample(
    ...
    StatementBuilder statementBuilder =
        new StatementBuilder()
            ...
            .withBindVariableValue("conditionStatus", WorkflowEvaluationStatus.PENDING.toString())
            .withBindVariableValue(
                "type", WorkflowRequestType.WORKFLOW_EXTERNAL_CONDITION_REQUEST.toString());
    ...
    System.out.printf(
        "Number of workflow external condition requests to be triggered: %d%n", totalResultSetSize);
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.admanager.axis.v201811.TriggerWorkflowExternalConditionRequests action =
          new com.google.api.ads.admanager.axis.v201811.TriggerWorkflowExternalConditionRequests();
      ...
      if (result != null && result.getNumChanges() > 0) {
        System.out.printf(
            "Number of workflow external condition requests triggered: %d%n",
