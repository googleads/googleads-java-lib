 ...
 *
 * <p>To create product package items, run CreateProductPackageItems.java.
 *
 * <p>Credentials and properties in {@code fromFile()} are pulled from the "ads.properties" file.
 * See README for more info.
 */
public class GetAllProductPackageItems {
        ...
        for (ProductPackageItem productPackageItem : page.getResults()) {
          System.out.printf(
              "%d) Product package item with ID %d and product ID %d "
                  + "belonging to product package ID %d was found.%n",
              i++,
