...
package admanager.axis.v201811.reconciliationlineitemreportservice;
...
import com.google.api.ads.admanager.axis.v201811.BillFrom;
import com.google.api.ads.admanager.axis.v201811.ReconciliationLineItemReport;
import com.google.api.ads.admanager.axis.v201811.ReconciliationLineItemReportPage;
import com.google.api.ads.admanager.axis.v201811.ReconciliationLineItemReportServiceInterface;
 ...
 *
 * <p>To get reconciliation line item reports for a reconciliation report, run
...
public class UpdateReconciliationLineItemReports {
  ...
  private static class UpdateReconciliationLineItemReportsParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.RECONCILIATION_LINE_ITEM_REPORT_ID,
        required = true,
  ...
  public static void runExample(
      ...
      long reconciliationLineItemReportId)
    ...
    ReconciliationLineItemReportServiceInterface reconciliationLineItemReportService =
        adManagerServices.get(session, ReconciliationLineItemReportServiceInterface.class);
    ...
    // Set and use a manual volume for billing. This example splits the difference between
    // Ad Manager and the third party volume.
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(adManagerServices, session, params.reconciliationLineItemReportId);
