...
package admanager.axis.v201811.exchangerateservice;
...
import com.google.api.ads.admanager.axis.v201811.ExchangeRate;
import com.google.api.ads.admanager.axis.v201811.ExchangeRatePage;
import com.google.api.ads.admanager.axis.v201811.ExchangeRateRefreshRate;
import com.google.api.ads.admanager.axis.v201811.ExchangeRateServiceInterface;
...
/**
 * This example updates an exchange rate's refresh rate. To determine which exchange rates exist,
...
public class UpdateExchangeRates {
  ...
  private static class UpdateExchangeRatesParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.EXCHANGE_RATE_ID,
        required = true,
  ...
  public static void runExample(
    ...
    ExchangeRate[] exchangeRates =
        exchangeRateService.updateExchangeRates(new ExchangeRate[] {exchangeRate});

    for (ExchangeRate updatedExchangeRate : exchangeRates) {
      System.out.printf(
          "Exchange rate with ID %d, currency code '%s',"
              + " direction '%s', and exchange rate %.2f was updated.%n",
          updatedExchangeRate.getId(),
          updatedExchangeRate.getCurrencyCode(),
