 ...
 *
 * <p>To determine which product package items exist, run GetAllProductPackageItems.java.
 *
...
public class CreateProductPackageItems {
  ...
  public static void runExample(
    ...
    for (ProductPackageItem createdProductPackageItem : productPackageItems) {
      System.out.printf(
          "A product package item with ID %d created from "
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(adManagerServices, session, params.productPackageId, params.productId);
