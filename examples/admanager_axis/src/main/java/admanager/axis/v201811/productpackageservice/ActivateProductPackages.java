...
package admanager.axis.v201811.productpackageservice;
...
import com.google.api.ads.admanager.axis.v201811.ProductPackage;
import com.google.api.ads.admanager.axis.v201811.ProductPackagePage;
import com.google.api.ads.admanager.axis.v201811.ProductPackageServiceInterface;
...
/**
 * This example activates a product package. To determine which product packages exist, run
 * GetAllProductPackages.java.
 *
...
public class ActivateProductPackages {
  ...
  private static class ActivateProductPackagesParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.PRODUCT_PACKAGE_ID,
        required = true,
  ...
  public static void runExample(
      AdManagerServices adManagerServices, AdManagerSession session, long productPackageId)
    ...
    ProductPackage productPackage = Iterables.getOnlyElement(Arrays.asList(page.getResults()));

    System.out.printf("Product package with ID %d will be activated.%n", productPackage.getId());

    // Remove limit and offset from statement.
    statementBuilder.removeLimitAndOffset();

    // Create action to activate product packages.
    com.google.api.ads.admanager.axis.v201811.ActivateProductPackages action =
        new com.google.api.ads.admanager.axis.v201811.ActivateProductPackages();

    // Perform action.
    UpdateResult result =
        productPackageService.performProductPackageAction(action, statementBuilder.toStatement());
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(adManagerServices, session, params.productPackageId);
