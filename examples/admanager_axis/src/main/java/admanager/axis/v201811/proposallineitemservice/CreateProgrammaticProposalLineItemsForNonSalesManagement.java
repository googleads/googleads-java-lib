...
package admanager.axis.v201811.proposallineitemservice;
...
import com.google.api.ads.admanager.axis.v201811.AdExchangeEnvironment;
...
import com.google.api.ads.admanager.axis.v201811.DeliveryRateType;
import com.google.api.ads.admanager.axis.v201811.DeviceCapability;
import com.google.api.ads.admanager.axis.v201811.DeviceCapabilityTargeting;
...
import com.google.api.ads.admanager.axis.v201811.ProposalLineItem;
import com.google.api.ads.admanager.axis.v201811.ProposalLineItemMarketplaceInfo;
import com.google.api.ads.admanager.axis.v201811.ProposalLineItemServiceInterface;
import com.google.api.ads.admanager.axis.v201811.RateType;
...
public class CreateProgrammaticProposalLineItemsForNonSalesManagement {
  ...
  public static void runExample(
    ...
    proposalLineItem.setName(
        "Programmatic proposal line item #" + new Random().nextInt(Integer.MAX_VALUE));
    ...
    for (ProposalLineItem createdProposalLineItem : proposalLineItems) {
      System.out.printf(
          "A programmatic proposal line item with ID %d and name '%s' was created.%n",
