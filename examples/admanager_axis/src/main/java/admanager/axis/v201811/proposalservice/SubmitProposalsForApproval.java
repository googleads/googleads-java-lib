...
package admanager.axis.v201811.proposalservice;
...
import com.google.api.ads.admanager.axis.v201811.Proposal;
import com.google.api.ads.admanager.axis.v201811.ProposalPage;
import com.google.api.ads.admanager.axis.v201811.ProposalServiceInterface;
...
/**
 * This example submits a proposal for approval. To determine which proposals exist, run
...
public class SubmitProposalsForApproval {
  ...
  private static class SubmitProposalsForApprovalParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.PROPOSAL_ID,
        required = true,
        description = "The ID of the proposal to submit.")
  ...
  public static void runExample(
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (Proposal proposal : page.getResults()) {
          System.out.printf(
              "%d) Proposal with ID %d and name '%s' will be approved.%n",
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.admanager.axis.v201811.SubmitProposalsForApproval action =
          new com.google.api.ads.admanager.axis.v201811.SubmitProposalsForApproval();
      ...
      if (result != null && result.getNumChanges() > 0) {
        System.out.printf(
            "Number of proposals submitted for approval: %d%n", result.getNumChanges());
      } else {
  ...
  public static void main(String[] args) {
    ...
    SubmitProposalsForApprovalParams params = new SubmitProposalsForApprovalParams();
