...
/**
 * This example activates a product template. To determine which product templates exist, run
 * GetAllProductTemplates.java.
 *
...
public class ActivateProductTemplates {
  ...
  public static void runExample(
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (ProductTemplate productTemplate : page.getResults()) {
          System.out.printf(
              "%d) Product template with ID %d will be activated.%n", i++, productTemplate.getId());
        }
      }
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.admanager.axis.v201811.ActivateProductTemplates action =
          new com.google.api.ads.admanager.axis.v201811.ActivateProductTemplates();
