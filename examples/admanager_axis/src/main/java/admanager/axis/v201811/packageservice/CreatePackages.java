 ...
 *
 * <p>To determine which packages exist, run GetAllPackages.java.
 *
...
public class CreatePackages {
  ...
  private static class CreatePackagesParams extends CodeSampleParams {
    ...
    @Parameter(
        ...
        required = true,
        description =
            "The ID of the rate card the proposal line items belonging to the product"
  ...
  public static void runExample(
    ...
    for (Package createdPackage : packages) {
      System.out.printf(
          "A package with ID %d and name '%s' was created.%n",
