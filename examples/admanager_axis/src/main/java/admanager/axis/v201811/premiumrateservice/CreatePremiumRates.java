...
import com.google.api.ads.admanager.axis.v201811.AdUnitPremiumFeature;
...
import com.google.api.ads.admanager.axis.v201811.PricingMethod;
...
public class CreatePremiumRates {
  ...
  public static void runExample(
      AdManagerServices adManagerServices, AdManagerSession session, long rateCardId)
    ...
    for (PremiumRate createdPremiumRate : createdPremiumRates) {
      System.out.printf(
          "A premium rate for '%s' was added to the rate card with ID of %d.%n",
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(adManagerServices, session, params.rateCardId);
