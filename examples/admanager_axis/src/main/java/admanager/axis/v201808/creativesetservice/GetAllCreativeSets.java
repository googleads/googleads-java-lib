...
package admanager.axis.v201808.creativesetservice;
...
import com.google.api.ads.admanager.axis.v201808.CreativeSet;
import com.google.api.ads.admanager.axis.v201808.CreativeSetPage;
import com.google.api.ads.admanager.axis.v201808.CreativeSetServiceInterface;
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (CreativeSet creativeSet : page.getResults()) {
          System.out.printf(
              "%d) Creative set with ID %d and name '%s' was found.%n", i++,
