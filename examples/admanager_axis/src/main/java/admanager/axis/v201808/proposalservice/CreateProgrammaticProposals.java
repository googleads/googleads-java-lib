...
package admanager.axis.v201808.proposalservice;
...
import com.google.api.ads.admanager.axis.v201808.Proposal;
import com.google.api.ads.admanager.axis.v201808.ProposalCompanyAssociation;
import com.google.api.ads.admanager.axis.v201808.ProposalCompanyAssociationType;
import com.google.api.ads.admanager.axis.v201808.ProposalMarketplaceInfo;
import com.google.api.ads.admanager.axis.v201808.ProposalServiceInterface;
import com.google.api.ads.admanager.axis.v201808.SalespersonSplit;
...
public class CreateProgrammaticProposals {
  ...
  private static class CreateProgrammaticProposalsParams extends CodeSampleParams {
    ...
    @Parameter(names = ArgumentNames.BUYER_ID, required = true,
        description = "The ID of the buyer. This can be obtained through the Programmatic_Buyer"
            + " PQL table.")
