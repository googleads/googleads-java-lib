...
package admanager.axis.v201808.teamservice;
...
import com.google.api.ads.admanager.axis.v201808.Team;
import com.google.api.ads.admanager.axis.v201808.TeamPage;
import com.google.api.ads.admanager.axis.v201808.TeamServiceInterface;
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (Team team : page.getResults()) {
          System.out.printf("%d) Team with ID %d and name '%s' was found.%n", i++,
