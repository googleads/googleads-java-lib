...
import com.google.api.ads.admanager.axis.v201911.CustomTargetingKeyType;
import com.google.api.ads.admanager.axis.v201911.CustomTargetingServiceInterface;
import com.google.api.ads.admanager.axis.v201911.CustomTargetingValue;
import com.google.api.ads.admanager.axis.v201911.CustomTargetingValueMatchType;
...
/**
 * This example creates new custom targeting keys and values. To determine which custom targeting
 * keys and values exist, run GetAllCustomTargetingKeysAndValue.java. To target these custom
...
public class CreateCustomTargetingKeysAndValues {
  ...
  public static void runExample(AdManagerServices adManagerServices, AdManagerSession session)
    ...
    for (CustomTargetingKey createdCustomTargetingKey : customTargetingKeys) {
      System.out.printf(
          "A custom targeting key with ID %d, name '%s', and display name " + "'%s' was created.%n",
          createdCustomTargetingKey.getId(),
          createdCustomTargetingKey.getName(),
          createdCustomTargetingKey.getDisplayName());
    }
    ...
    for (CustomTargetingValue createdCustomTargetingValue : customTargetingValues) {
      System.out.printf(
          ...
          createdCustomTargetingValue.getName(),
          createdCustomTargetingValue.getDisplayName());
    }
  }
