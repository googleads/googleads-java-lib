...
import com.google.api.ads.admanager.axis.v201911.LabelType;
...
/**
 * This example creates new labels. To determine which labels exist, run GetAllLabels.java.
 *
...
public class CreateLabels {
  ...
  public static void runExample(AdManagerServices adManagerServices, AdManagerSession session)
    ...
    for (Label createdLabel : labels) {
      System.out.printf(
          "A label with ID %d and name '%s' was created.%n",
