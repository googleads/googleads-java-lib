...
package admanager.axis.v201902.ratecardservice;
...
import com.google.api.ads.admanager.axis.v201902.RateCard;
import com.google.api.ads.admanager.axis.v201902.RateCardServiceInterface;
...
/**
 * This example creates a new rate card. To determine which rate cards exist, run
...
public class CreateRateCards {
  ...
  private static class CreateRateCardsParams extends CodeSampleParams {
    ...
    @Parameter(
        ...
        description =
            "The IDs of the teams this rate"
  ...
  public static void runExample(
    ...
    for (RateCard createdRateCard : rateCards) {
      System.out.printf(
          "A rate card with ID %d, name '%s', and currency code " + "'%s' was created.%n",
          createdRateCard.getId(), createdRateCard.getName(), createdRateCard.getCurrencyCode());
    }
  }
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(adManagerServices, session, params.currencyCode, Longs.toArray(params.teamIds));
