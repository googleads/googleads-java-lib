...
/**
 * This example creates a product base rate. To determine which base rates exist, run
...
public class CreateProductBaseRates {
  ...
  public static void runExample(
    ...
    for (BaseRate createdBaseRate : baseRates) {
      System.out.printf(
          "A product base rate with ID %d and rate %.4f %s was created.%n",
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(adManagerServices, session, params.rateCardId, params.productId);
