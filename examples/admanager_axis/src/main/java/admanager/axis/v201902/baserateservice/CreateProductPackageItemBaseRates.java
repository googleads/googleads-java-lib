...
import com.google.api.ads.admanager.axis.v201902.ProductPackageItemBaseRate;
...
/**
 * This example creates a product package item base rate. To determine which base rates exist, run
...
public class CreateProductPackageItemBaseRates {
  ...
  public static void runExample(
    ...
    BaseRate[] baseRates =
        baseRateService.createBaseRates(new BaseRate[] {productPackageItemBaseRate});

    for (BaseRate createdBaseRate : baseRates) {
      System.out.printf(
          "A product package item base rate with ID %d and rate %.4f %s was" + " created.%n",
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(adManagerServices, session, params.rateCardId, params.productPackageItemId);
