...
package admanager.axis.v201902.baserateservice;
...
import com.google.api.ads.admanager.axis.v201902.BaseRate;
import com.google.api.ads.admanager.axis.v201902.BaseRatePage;
import com.google.api.ads.admanager.axis.v201902.BaseRateServiceInterface;
import com.google.api.ads.admanager.axis.v201902.Money;
import com.google.api.ads.admanager.axis.v201902.ProductBaseRate;
import com.google.api.ads.admanager.axis.v201902.ProductTemplateBaseRate;
...
/**
 * This example updates a base rate's value. To determine which base rates exist, run
...
public class UpdateBaseRates {
  ...
  private static class UpdateBaseRatesParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.BASE_RATE_ID,
        required = true,
  ...
  public static void runExample(
      AdManagerServices adManagerServices, AdManagerSession session, long baseRateId)
    ...
    // Get the base rate.
    BaseRatePage page = baseRateService.getBaseRatesByStatement(statementBuilder.toStatement());
    ...
    for (BaseRate updatedBaseRate : baseRates) {
      System.out.printf(
          "Base rate with ID %d and type '%s'," + " belonging to rate card ID %d was updated.%n",
          updatedBaseRate.getId(),
          updatedBaseRate.getClass().getSimpleName(),
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(adManagerServices, session, params.baseRateId);
