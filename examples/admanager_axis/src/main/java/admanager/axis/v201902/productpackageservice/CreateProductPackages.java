 ...
 *
 * <p>To determine which product packages exist, run GetAllProductPackages.java.
 *
...
public class CreateProductPackages {
  ...
  public static void runExample(
    ...
    productPackage.setName("Product package #" + new Random().nextInt(Integer.MAX_VALUE));
    ...
    for (ProductPackage createdProductPackage : productPackages) {
      System.out.printf(
          "A product package with ID %d and name '%s' was created.%n",
