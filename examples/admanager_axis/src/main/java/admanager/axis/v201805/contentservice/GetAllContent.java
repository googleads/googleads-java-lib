...
package admanager.axis.v201805.contentservice;
...
import com.google.api.ads.admanager.axis.v201805.Content;
import com.google.api.ads.admanager.axis.v201805.ContentPage;
import com.google.api.ads.admanager.axis.v201805.ContentServiceInterface;
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (Content content : page.getResults()) {
          System.out.printf(
              "%d) Content with ID %d and name '%s' was found.%n", i++,
