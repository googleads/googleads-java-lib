...
/**
 * This example creates a new user with a trafficker role. To determine which users exist, run
 * GetAllUsers.java. To determine which roles exist, run GetAllRoles.java.
 *
...
public class CreateUsers {
  ...
  private static class CreateUsersParams extends CodeSampleParams {
    ...
    @Parameter(names = ArgumentNames.NAME, required = true, description = "The name of the user.")
    private String name;
  }
  ...
  public static void runExample(
    ...
    for (User createdUser : users) {
      System.out.printf(
          "A user with ID %d and name '%s' was created.%n",
