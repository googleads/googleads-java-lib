...
/**
 * This example creates a new order. To determine which orders exist, run GetAllOrders.java.
 *
...
public class CreateOrders {
  ...
  private static class CreateOrdersParams extends CodeSampleParams {
    ...
    @Parameter(
        names = ArgumentNames.TRAFFICKER_ID,
        required = true,
  ...
  public static void runExample(
    ...
    for (Order createdOrder : orders) {
      System.out.printf(
          "An order with ID %d and name '%s' was created.%n",
