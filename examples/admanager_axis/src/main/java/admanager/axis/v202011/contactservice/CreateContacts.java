...
/**
 * This example creates new contacts. To determine which contacts exist, run GetAllContacts.java.
 *
...
public class CreateContacts {
  ...
  public static void runExample(
    ...
    for (Contact createdContact : contacts) {
      System.out.printf(
          "A contact with ID %d and name '%s' was created.%n",
