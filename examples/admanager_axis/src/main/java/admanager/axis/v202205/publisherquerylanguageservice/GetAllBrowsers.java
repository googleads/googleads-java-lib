...
package admanager.axis.v202205.publisherquerylanguageservice;

import static com.google.api.ads.common.lib.utils.Builder.DEFAULT_CONFIGURATION_FILENAME;

import com.google.api.ads.admanager.axis.factory.AdManagerServices;
import com.google.api.ads.admanager.axis.utils.v202205.Pql;
...
import com.google.api.ads.admanager.axis.v202205.PublisherQueryLanguageServiceInterface;
...
/**
 * This example gets all browsers available to target from the Browser table. Other tables include
 * 'Bandwidth_Group', 'Browser_Language', 'Device_Capability', 'Operating_System', etc...
 *
 * <p>A full list of available criteria tables can be found at
...
public class GetAllBrowsers {
  ...
  public static void runExample(AdManagerServices adManagerServices, AdManagerSession session)
    ...
    do {
      ...
      System.out.printf(
          "%d) %d criteria beginning at offset %d were found.%n",
          i++,
