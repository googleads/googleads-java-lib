...
package admanager.axis.v202205.activityservice;
...
import com.google.api.ads.admanager.axis.v202205.Activity;
import com.google.api.ads.admanager.axis.v202205.ActivityPage;
import com.google.api.ads.admanager.axis.v202205.ActivityServiceInterface;
...
/**
 * This example updates activity expected URLs. To determine which activities exist, run
...
public class UpdateActivities {
  ...
  private static class UpdateActivitiesParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.ACTIVITY_ID,
        required = true,
  ...
  public static void runExample(
      AdManagerServices adManagerServices, AdManagerSession session, long activityId)
  ...
  public static void main(String[] args) {
    ...
    if (!params.parseArguments(args)) {
      ...
      params.activityId = Long.valueOf("INSERT_ACTIVITY_ID_HERE");
    }

    try {
      runExample(adManagerServices, session, params.activityId);
