...
/**
 * This example updates a label's description. To determine which labels exist, run
 * GetAllLabels.java.
 *
...
public class UpdateLabels {
  ...
  public static void runExample(
    ...
    for (Label updatedLabel : labels) {
      System.out.printf(
          "Label with ID %d and name '%s' was updated.%n",
          updatedLabel.getId(), updatedLabel.getName());
    }
  }
