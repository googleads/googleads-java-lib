...
import com.google.api.ads.admanager.axis.v202205.LineItemCreativeAssociationPage;
...
/**
 * This example updates a LICA's destination URL. To determine which LICAs exist, run
 * GetAllLineItemCreativeAssociations.java.
 *
...
public class UpdateLicas {
  ...
  private static class UpdateLicasParams extends CodeSampleParams {
    ...
    @Parameter(
        ...
        required = true,
        description =
            "The master or creative set ID of the LICA. For creative sets, set the"
                + " master creative ID.")
  ...
  public static void runExample(
    ...
    for (LineItemCreativeAssociation updatedLica : licas) {
      System.out.printf(
          "LICA with line item ID %d and creative ID %d was updated.%n",
