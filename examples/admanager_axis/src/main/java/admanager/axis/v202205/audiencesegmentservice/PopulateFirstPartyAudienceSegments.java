...
import com.google.api.ads.admanager.axis.v202205.AudienceSegmentPage;
import com.google.api.ads.admanager.axis.v202205.AudienceSegmentServiceInterface;
import com.google.api.ads.admanager.axis.v202205.PopulateAudienceSegments;
...
/**
 * This example populates a specific rule base first party audience segment. To determine which
 * audience segments exist, run GetAllAudienceSegments.java.
 *
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (AudienceSegment audienceSegment : page.getResults()) {
          System.out.printf(
              "%d) Audience segment with ID %d and name '%s' will be populated.%n",
              i++, audienceSegment.getId(), audienceSegment.getName());
        }
      }
