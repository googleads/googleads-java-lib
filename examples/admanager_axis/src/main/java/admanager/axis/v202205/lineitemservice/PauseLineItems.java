...
/**
 * This example pauses a line item. Line items must be paused before they can be updated. To
 * determine which line items exist, run GetAllLineItems.java.
 *
...
public class PauseLineItems {
  ...
  private static class PauseLineItemsParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.LINE_ITEM_ID,
        required = true,
        description = "The ID of the line item to pause.")
  ...
  public static void runExample(
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.admanager.axis.v202205.PauseLineItems action =
          new com.google.api.ads.admanager.axis.v202205.PauseLineItems();
  ...
  public static void main(String[] args) {
    ...
    PauseLineItemsParams params = new PauseLineItemsParams();
