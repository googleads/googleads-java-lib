...
package admanager.axis.v202205.contactservice;
...
import com.google.api.ads.admanager.axis.v202205.Contact;
import com.google.api.ads.admanager.axis.v202205.ContactPage;
import com.google.api.ads.admanager.axis.v202205.ContactServiceInterface;
...
/**
 * This example updates contact addresses. To determine which contacts exist, run
 * GetAllContacts.java.
 *
...
public class UpdateContacts {
  ...
  private static class UpdateContactsParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.CONTACT_ID,
        required = true,
  ...
  public static void runExample(
      AdManagerServices adManagerServices, AdManagerSession session, long contactId)
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(adManagerServices, session, params.contactId);
