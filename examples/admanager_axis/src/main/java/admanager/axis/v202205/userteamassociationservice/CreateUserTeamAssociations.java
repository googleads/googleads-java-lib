...
/**
 * This example creates a new user team association to add a user to that team. To determine which
 * user team associations exist, run GetAllUserTeamAssociations.java. To determine which users
 * exist, run GetAllUsers.java. To determine which teams exist, run GetAllTeams.java.
 *
...
public class CreateUserTeamAssociations {
  ...
  private static class CreateUserTeamAssociationsParams extends CodeSampleParams {
    ...
    @Parameter(
        ...
        required = true,
        description =
            "The team ID of the user team association (i.e. what team the user will"
                + " be added to).")
    private Long teamId;
  }
