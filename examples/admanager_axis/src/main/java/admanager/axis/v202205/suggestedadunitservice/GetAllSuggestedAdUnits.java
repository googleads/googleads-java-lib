 ...
 * ApproveSuggestedAdUnits.java. This feature is only available to Ad Manager premium solution
 * networks.
 *
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (SuggestedAdUnit suggestedAdUnit : page.getResults()) {
          System.out.printf(
              "%d) Suggested ad unit with ID '%s', path '%s', "
                  + "and number of requests %d was found.%n",
              i++,
              suggestedAdUnit.getId(),
              Joiner.on('/').join(suggestedAdUnit.getPath()),
