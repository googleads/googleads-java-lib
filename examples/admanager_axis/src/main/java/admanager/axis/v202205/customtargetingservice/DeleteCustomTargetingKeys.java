...
package admanager.axis.v202205.customtargetingservice;
...
import com.google.api.ads.admanager.axis.v202205.CustomTargetingKey;
import com.google.api.ads.admanager.axis.v202205.CustomTargetingKeyPage;
import com.google.api.ads.admanager.axis.v202205.CustomTargetingServiceInterface;
import com.google.api.ads.admanager.axis.v202205.UpdateResult;
...
/**
 * This example deletes a custom targeting key. To determine which custom targeting keys and values
 * exist, run GetAllCustomTargetingKeysAndValue.java.
 *
...
public class DeleteCustomTargetingKeys {
  ...
  private static class DeleteCustomTargetingKeysParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.TARGETING_KEY_ID,
        required = true,
        description = "The ID of the custom targeting key.")
  ...
  public static void runExample(
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (CustomTargetingKey customTargetingKey : page.getResults()) {
          System.out.printf(
              "%d) Custom targeting key with ID %d" + " will be deleted.%n",
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.admanager.axis.v202205.DeleteCustomTargetingKeys action =
          new com.google.api.ads.admanager.axis.v202205.DeleteCustomTargetingKeys();
  ...
  public static void main(String[] args) {
    ...
    DeleteCustomTargetingKeysParams params = new DeleteCustomTargetingKeysParams();
