...
/**
 * This example deletes a custom targeting value. To determine which custom targeting keys and
 * values exist, run GetAllCustomTargetingKeysAndValue.java.
 *
...
public class DeleteCustomTargetingValues {
  ...
  public static void runExample(
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.admanager.axis.v202205.DeleteCustomTargetingValues action =
          new com.google.api.ads.admanager.axis.v202205.DeleteCustomTargetingValues();
