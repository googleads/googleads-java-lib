...
package admanager.axis.v202205.customfieldservice;

import static com.google.api.ads.common.lib.utils.Builder.DEFAULT_CONFIGURATION_FILENAME;

import com.beust.jcommander.Parameter;
import com.google.api.ads.admanager.axis.factory.AdManagerServices;
import com.google.api.ads.admanager.axis.utils.v202205.StatementBuilder;
import com.google.api.ads.admanager.axis.v202205.ApiError;
import com.google.api.ads.admanager.axis.v202205.ApiException;
import com.google.api.ads.admanager.axis.v202205.BaseCustomFieldValue;
import com.google.api.ads.admanager.axis.v202205.CustomFieldServiceInterface;
import com.google.api.ads.admanager.axis.v202205.CustomFieldValue;
import com.google.api.ads.admanager.axis.v202205.DropDownCustomFieldValue;
import com.google.api.ads.admanager.axis.v202205.LineItem;
import com.google.api.ads.admanager.axis.v202205.LineItemPage;
import com.google.api.ads.admanager.axis.v202205.LineItemServiceInterface;
import com.google.api.ads.admanager.axis.v202205.NumberValue;
...
/**
 * This example sets custom field values on a line item. To determine which custom fields exist, run
 * GetAllCustomFields.java. To determine which line items exist, run GetAllLineItems.java.
 *
...
public class SetLineItemCustomFieldValue {
  ...
  public static void runExample(
    ...
    for (LineItem updatedLineItem : lineItems) {
      ...
      List<String> customFieldValueStrings =
          Lists.transform(
              ...
              new Function<BaseCustomFieldValue, String>() {
                ...
                public String apply(BaseCustomFieldValue baseCustomFieldValue) {
                  if (baseCustomFieldValue instanceof CustomFieldValue
                      && ((CustomFieldValue) baseCustomFieldValue).getValue()
                          instanceof NumberValue) {
                    return String.format(
                        "{ID: %d, value: %.0f}",
                        baseCustomFieldValue.getCustomFieldId(),
                        Double.parseDouble(
                            ((NumberValue) ((CustomFieldValue) baseCustomFieldValue).getValue())
                                .getValue()));
                  } else if (baseCustomFieldValue instanceof DropDownCustomFieldValue) {
                    return String.format(
                        "{ID: %d, customFieldOptionId: %d}",
                        baseCustomFieldValue.getCustomFieldId(),
      ...
      System.out.printf(
          "A line item with ID %d was updated with custom field values '%s'%n",
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(
          adManagerServices,
          session,
          params.numberCustomFieldId,
          params.customFieldOptionId,
          params.lineItemId);
