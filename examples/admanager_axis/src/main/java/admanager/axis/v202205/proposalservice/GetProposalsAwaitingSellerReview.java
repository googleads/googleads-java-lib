...
import com.google.api.ads.admanager.axis.v202205.NegotiationStatus;
 ...
 */
public class GetProposalsAwaitingSellerReview {
  ...
  public static void runExample(AdManagerServices adManagerServices, AdManagerSession session)
    ...
    StatementBuilder statementBuilder =
        new StatementBuilder()
            ...
            .withBindVariableValue("status", NegotiationStatus.AWAITING_SELLER_REVIEW.toString());
