...
import com.google.api.ads.admanager.axis.v202205.CreativeWrapperOrdering;
...
/**
 * This example updates a creative wrapper to the 'OUTER' wrapping order. To determine which
 * creative wrappers exist, run GetAllCreativeWrappers.java.
 *
...
public class UpdateCreativeWrappers {
  ...
  private static class UpdateCreativeWrappersParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.CREATIVE_WRAPPER_ID,
        required = true,
  ...
  public static void runExample(
      AdManagerServices adManagerServices, AdManagerSession session, long creativeWrapperId)
