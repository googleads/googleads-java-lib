...
import com.google.api.ads.admanager.axis.v202205.CustomCreative;
import com.google.api.ads.admanager.axis.v202205.CustomCreativeAsset;
...
/**
 * This example creates a custom creative for a given advertiser. This feature is only available to
 * Ad Manager premium solution networks. To determine which creatives already exist, run
...
public class CreateCustomCreatives {
  ...
  private static class CreateCustomCreativesParams extends CodeSampleParams {
    @Parameter(
  ...
  public static void runExample(
    ...
    customCreative.setHtmlSnippet(
        "<a href='%%CLICK_URL_UNESC%%%%DEST_URL%%'>"
            + "<img src='%%FILE:"
            + customCreativeAsset.getMacroName()
            + "%%'/>"
