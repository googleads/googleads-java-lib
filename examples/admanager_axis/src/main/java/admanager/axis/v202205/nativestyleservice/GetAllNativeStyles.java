...
package admanager.axis.v202205.nativestyleservice;
...
import com.google.api.ads.admanager.axis.v202205.NativeStyle;
import com.google.api.ads.admanager.axis.v202205.NativeStylePage;
import com.google.api.ads.admanager.axis.v202205.NativeStyleServiceInterface;
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (NativeStyle nativeStyle : page.getResults()) {
          System.out.printf(
              "%d) Native style with ID %d and name '%s' was found.%n",
              i++, nativeStyle.getId(), nativeStyle.getName());
        }
      }
