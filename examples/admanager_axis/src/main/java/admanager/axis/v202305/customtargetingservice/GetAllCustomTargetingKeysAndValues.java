...
import com.google.api.ads.admanager.axis.v202305.CustomTargetingValuePage;
...
/**
 * This example gets all custom targeting keys and values. To create custom targeting keys and
 * values, run CreateCustomTargetingKeysAndValues.java.
 *
...
public class GetAllCustomTargetingKeysAndValues {
      ...
      do {
        ...
        if (page.getResults() != null) {
          ...
          for (CustomTargetingValue customTargetingValue : page.getResults()) {
            System.out.printf(
                "%d) Custom targeting value with ID %d, belonging to key "
  ...
  private static List<Long> getAllCustomTargetingKeyIds(
