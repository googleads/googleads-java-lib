...
public class GetUserByEmailAddress {
  ...
  public static void runExample(
      AdManagerServices adManagerServices, AdManagerSession session, String emailAddress)
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (User user : page.getResults()) {
          System.out.printf(
              "%d) User with ID %d and name '%s' was found.%n", i++, user.getId(), user.getName());
        }
      }
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(adManagerServices, session, params.emailAddress);
