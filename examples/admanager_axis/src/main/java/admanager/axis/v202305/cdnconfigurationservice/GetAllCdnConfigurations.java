...
import com.google.api.ads.admanager.axis.v202305.CdnConfigurationPage;
  ...
  public static void runExample(AdManagerServices adManagerServices, AdManagerSession session)
    ...
    do {
      CdnConfigurationPage page =
          cdnConfigurationService.getCdnConfigurationsByStatement(statementBuilder.toStatement());
      ...
      if (page.getResults() != null) {
        ...
        for (CdnConfiguration cdnConfiguration : page.getResults()) {
          System.out.printf(
              ...
              i++, cdnConfiguration.getId(), cdnConfiguration.getName());
        }
      }
