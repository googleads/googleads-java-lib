...
import com.google.api.ads.admanager.axis.v202305.DeliveryForecast;
import com.google.api.ads.admanager.axis.v202305.DeliveryForecastOptions;
import com.google.api.ads.admanager.axis.v202305.ForecastServiceInterface;
import com.google.api.ads.admanager.axis.v202305.LineItemDeliveryForecast;
...
/**
 * This example gets a delivery forecast for existing line items. To determine which line items
...
public class GetDeliveryForecastForLineItems {
  ...
  private static class GetDeliveryForecastForLineItemsParams extends CodeSampleParams {
    @Parameter(
        ...
        required = true,
        description =
            "The IDs of the line items to get a forecast for. You may pass multiple" + " values.")
