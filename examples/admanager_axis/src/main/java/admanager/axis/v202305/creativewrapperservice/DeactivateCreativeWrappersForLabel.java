...
package admanager.axis.v202305.creativewrapperservice;
...
import com.google.api.ads.admanager.axis.v202305.CreativeWrapper;
import com.google.api.ads.admanager.axis.v202305.CreativeWrapperPage;
import com.google.api.ads.admanager.axis.v202305.CreativeWrapperServiceInterface;
import com.google.api.ads.admanager.axis.v202305.CreativeWrapperStatus;
import com.google.api.ads.admanager.axis.v202305.DeactivateCreativeWrappers;
...
/**
 * This example deactivates all creative wrappers belonging to a label. To determine which labels
...
public class DeactivateCreativeWrappersForLabel {
  ...
  public static void runExample(
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (CreativeWrapper creativeWrapper : page.getResults()) {
          System.out.printf(
              "%d) Creative wrapper with ID %d applying to label ID" + " %d will be deactivated.%n",
    ...
    if (totalResultSetSize > 0) {
      ...
      // Perform action.
      UpdateResult result =
          creativeWrapperService.performCreativeWrapperAction(
