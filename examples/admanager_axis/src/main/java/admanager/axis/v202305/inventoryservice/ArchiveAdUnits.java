...
/**
 * This example archives ad units underneath a parent ad unit, as well as the parent ad unit. To
 * create ad units, run CreateAdUnits.java. To determine which ad units exist, run
 * GetAllAdUnits.java.
 *
...
public class ArchiveAdUnits {
  ...
  public static void runExample(
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (AdUnit adUnit : page.getResults()) {
          System.out.printf(
              "%d) Ad unit with ID '%s' and name '%s' will be archived.%n",
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.admanager.axis.v202305.ArchiveAdUnits action =
          new com.google.api.ads.admanager.axis.v202305.ArchiveAdUnits();
