...
package admanager.axis.v202305.activitygroupservice;

import static com.google.api.ads.common.lib.utils.Builder.DEFAULT_CONFIGURATION_FILENAME;

import com.beust.jcommander.Parameter;
import com.google.api.ads.admanager.axis.factory.AdManagerServices;
import com.google.api.ads.admanager.axis.v202305.ActivityGroup;
import com.google.api.ads.admanager.axis.v202305.ActivityGroupServiceInterface;
...
/**
 * This example creates new activity groups. To determine which activity groups exist, run
 * GetAllActivityGroups.java.
 *
...
public class CreateActivityGroups {
  ...
  public static void runExample(
      AdManagerServices adManagerServices, AdManagerSession session, long advertiserCompanyId)
    ...
    for (ActivityGroup createdActivityGroup : activityGroups) {
      System.out.printf(
          "An activity group with ID %d and name '%s' was created.%n",
