...
package admanager.axis.v202305.suggestedadunitservice;
...
import com.google.api.ads.admanager.axis.v202305.SuggestedAdUnit;
import com.google.api.ads.admanager.axis.v202305.SuggestedAdUnitPage;
import com.google.api.ads.admanager.axis.v202305.SuggestedAdUnitServiceInterface;
import com.google.api.ads.admanager.axis.v202305.SuggestedAdUnitUpdateResult;
...
/**
 * This example approves highly requested suggested ad units. To determine which suggested ad units
 * exist, run GetAllSuggestedAdUnits.java. This feature is only available to Ad Manager premium
 * solution networks.
 *
...
public class ApproveSuggestedAdUnits {
  ...
  private static class ApproveSuggestedAdUnitsParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.NUM_REQUESTS,
        required = true,
        description =
            "The number of requests for suggested ad units greater than which to" + " approve.")
  ...
  public static void runExample(
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (SuggestedAdUnit suggestedAdUnit : page.getResults()) {
          System.out.printf(
              "%d) Suggested ad unit with ID '%s' will be approved.%n",
              i++, suggestedAdUnit.getId());
        }
      }
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.admanager.axis.v202305.ApproveSuggestedAdUnits action =
          new com.google.api.ads.admanager.axis.v202305.ApproveSuggestedAdUnits();
