...
import com.google.api.ads.admanager.axis.v202305.ProposalLineItemPage;
...
/**
 * This example archives a proposal line item. To determine which proposal line items exist, run
 * GetAllProposalLineItems.java.
 *
...
public class ArchiveProposalLineItems {
  ...
  public static void runExample(
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (ProposalLineItem proposalLineItem : page.getResults()) {
          System.out.printf(
              "%d) Proposal line item with ID %d will be archived.%n",
              i++, proposalLineItem.getId());
        }
      }
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.admanager.axis.v202305.ArchiveProposalLineItems action =
          new com.google.api.ads.admanager.axis.v202305.ArchiveProposalLineItems();
