...
package admanager.axis.v202305.inventoryservice;
...
import com.google.api.ads.admanager.axis.v202305.AdUnit;
import com.google.api.ads.admanager.axis.v202305.AdUnitPage;
import com.google.api.ads.admanager.axis.v202305.AdUnitSize;
...
import com.google.api.ads.admanager.axis.v202305.InventoryServiceInterface;
...
public class UpdateAdUnits {
  ...
  private static class UpdateAdUnitsParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.AD_UNIT_ID,
        required = true,
  ...
  public static void runExample(
      AdManagerServices adManagerServices, AdManagerSession session, String adUnitId)
    ...
    for (AdUnit updatedAdUnit : adUnits) {
      ...
      for (AdUnitSize updatedAdUnitSize : updatedAdUnit.getAdUnitSizes()) {
        adUnitSizeStrings.add(
            String.format(
                "%dx%d",
                updatedAdUnitSize.getSize().getWidth(), updatedAdUnitSize.getSize().getHeight()));
      }
      System.out.printf(
          "Ad unit with ID '%s', name '%s', and sizes [%s] was updated.%n",
  ...
  public static void main(String[] args) {
    ...
    try {
      runExample(adManagerServices, session, params.adUnitId);
