...
/**
 * This example creates new creative sets. To determine which creative sets exist, run
 * GetAllCreativeSets.java.
 *
...
public class CreateCreativeSets {
  ...
  private static class CreateCreativeSetsParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.MASTER_CREATIVE_ID,
        required = true,
  ...
  public static void runExample(
    ...
    System.out.printf(
        "A creative set with ID %d, master creative ID %d, "
            + "and companion creative IDs [%s] was created.%n",
