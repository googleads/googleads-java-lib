...
package admanager.axis.v202305.creativesetservice;
...
import com.google.api.ads.admanager.axis.v202305.CreativeSet;
import com.google.api.ads.admanager.axis.v202305.CreativeSetPage;
import com.google.api.ads.admanager.axis.v202305.CreativeSetServiceInterface;
...
/**
 * This example adds a companion creative to a creative set. To determine which creative sets exist,
 * run GetAllCreativeSets.java.
 *
...
public class UpdateCreativeSets {
  ...
  private static class UpdateCreativeSetsParams extends CodeSampleParams {
    @Parameter(
        names = ArgumentNames.CREATIVE_SET_ID,
        required = true,
        description = "The ID of the creative set to update.")
    private Long creativeSetId;

    @Parameter(
        names = ArgumentNames.COMPANION_CREATIVE_ID,
        required = true,
  ...
  public static void runExample(
    ...
    System.out.printf(
        "A creative set with ID %d, master creative ID %d, "
            + "and companion creative IDs [%s] was updated.",
        updatedCreativeSet.getId(),
