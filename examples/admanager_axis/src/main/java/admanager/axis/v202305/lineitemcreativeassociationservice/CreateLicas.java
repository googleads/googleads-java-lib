...
package admanager.axis.v202305.lineitemcreativeassociationservice;
...
import com.google.api.ads.admanager.axis.v202305.LineItemCreativeAssociation;
import com.google.api.ads.admanager.axis.v202305.LineItemCreativeAssociationServiceInterface;
...
/**
 * This example creates a new line item creative association (LICA). For small business networks,
 * creative IDs must represent new or copied creatives since creatives cannot be used for more than
 * one line item. For premium solution networks, any creative can be used. To copy creatives, run
 * CopyImageCreatives.java. To determine which LICAs exist, run GetAllLicas.java.
 *
...
public class CreateLicas {
  ...
  private static class CreateLicasParams extends CodeSampleParams {
    ...
    @Parameter(
        ...
        required = true,
        description =
            "The master creative or creatvie set ID of the LICA. For creative sets,"
  ...
  public static void runExample(
    ...
    LineItemCreativeAssociation[] licas =
        licaService.createLineItemCreativeAssociations(new LineItemCreativeAssociation[] {lica});

    for (LineItemCreativeAssociation createdLica : licas) {
      System.out.printf(
          "A LICA with line item ID %d and creative ID %d was created.%n",
