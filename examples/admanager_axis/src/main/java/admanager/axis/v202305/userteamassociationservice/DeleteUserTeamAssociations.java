...
package admanager.axis.v202305.userteamassociationservice;
...
import com.google.api.ads.admanager.axis.v202305.UserTeamAssociation;
import com.google.api.ads.admanager.axis.v202305.UserTeamAssociationPage;
import com.google.api.ads.admanager.axis.v202305.UserTeamAssociationServiceInterface;
...
/**
 * This example deletes all user team associations for a given user (i.e. removes the user from all
 * teams). To determine which user team associations exist, run GetAllUserTeamAssociations.java. To
...
public class DeleteUserTeamAssociations {
  ...
  public static void runExample(
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (UserTeamAssociation userTeamAssociation : page.getResults()) {
          System.out.printf(
              "%d) User team association with user ID %d and " + "team ID %d will be deleted.%n",
              i++, userTeamAssociation.getUserId(), userTeamAssociation.getTeamId());
        }
      }
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.admanager.axis.v202305.DeleteUserTeamAssociations action =
          new com.google.api.ads.admanager.axis.v202305.DeleteUserTeamAssociations();

      // Perform action.
      UpdateResult result =
          userTeamAssociationService.performUserTeamAssociationAction(
