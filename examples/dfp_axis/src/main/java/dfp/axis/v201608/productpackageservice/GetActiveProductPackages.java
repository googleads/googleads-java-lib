...
package dfp.axis.v201608.productpackageservice;

import com.google.api.ads.common.lib.auth.OfflineCredentials;
import com.google.api.ads.common.lib.auth.OfflineCredentials.Api;
import com.google.api.ads.dfp.axis.factory.DfpServices;
import com.google.api.ads.dfp.axis.utils.v201608.StatementBuilder;
import com.google.api.ads.dfp.axis.v201608.ProductPackage;
import com.google.api.ads.dfp.axis.v201608.ProductPackagePage;
import com.google.api.ads.dfp.axis.v201608.ProductPackageServiceInterface;
import com.google.api.ads.dfp.axis.v201608.ProductPackageStatus;
...
public class GetActiveProductPackages {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session)
    ...
    // Create a statement to select all active product packages.
    StatementBuilder statementBuilder = new StatementBuilder()
        .where("status = :status")
        .orderBy("id ASC")
        .limit(StatementBuilder.SUGGESTED_PAGE_LIMIT)
        .withBindVariableValue(
            "status", ProductPackageStatus.ACTIVE.getValue());
