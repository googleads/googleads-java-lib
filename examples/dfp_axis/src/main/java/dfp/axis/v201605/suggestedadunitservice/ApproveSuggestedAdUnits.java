...
import com.google.api.ads.dfp.axis.v201605.SuggestedAdUnitUpdateResult;
...
public class ApproveSuggestedAdUnits {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long numRequests)
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201605.ApproveSuggestedAdUnits action =
          new com.google.api.ads.dfp.axis.v201605.ApproveSuggestedAdUnits();
