...
package dfp.axis.v201605.contentmetadatakeyhierarchyservice;

import com.google.api.ads.common.lib.auth.OfflineCredentials;
import com.google.api.ads.common.lib.auth.OfflineCredentials.Api;
import com.google.api.ads.dfp.axis.factory.DfpServices;
import com.google.api.ads.dfp.axis.utils.v201605.StatementBuilder;
import com.google.api.ads.dfp.axis.v201605.ContentMetadataKeyHierarchy;
import com.google.api.ads.dfp.axis.v201605.ContentMetadataKeyHierarchyPage;
import com.google.api.ads.dfp.axis.v201605.ContentMetadataKeyHierarchyServiceInterface;
...
public class GetAllContentMetadataKeyHierarchies {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session) throws Exception {
    ...
    // Retreive a small amount of content metadata key hierarchies at a time, paging through
    // until all content metadata key hierarchies have been retrieved.
    int totalResultSetSize = 0;
    do {
      ContentMetadataKeyHierarchyPage page =
          contentMetadataKeyHierarchyService.getContentMetadataKeyHierarchiesByStatement(statementBuilder.toStatement());
      ...
      if (page.getResults() != null) {
        ...
        for (ContentMetadataKeyHierarchy contentMetadataKeyHierarchy : page.getResults()) {
          System.out.printf(
              "%d) Content metadata key hierarchy with ID \"%d\" and name \"%s\" was found.%n",
              i++,
