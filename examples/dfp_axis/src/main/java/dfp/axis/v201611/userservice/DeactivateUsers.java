...
package dfp.axis.v201611.userservice;
...
import com.google.api.ads.dfp.axis.v201611.User;
import com.google.api.ads.dfp.axis.v201611.UserPage;
import com.google.api.ads.dfp.axis.v201611.UserServiceInterface;
...
public class DeactivateUsers {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long userId)
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201611.DeactivateUsers action =
          new com.google.api.ads.dfp.axis.v201611.DeactivateUsers();
