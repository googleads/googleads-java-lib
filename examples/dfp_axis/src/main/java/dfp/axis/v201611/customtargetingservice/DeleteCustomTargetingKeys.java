...
import com.google.api.ads.dfp.axis.v201611.CustomTargetingKeyPage;
...
public class DeleteCustomTargetingKeys {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session,
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201611.DeleteCustomTargetingKeys action =
          new com.google.api.ads.dfp.axis.v201611.DeleteCustomTargetingKeys();
