...
import com.google.api.ads.dfp.axis.v201705.ProposalLineItemPage;
...
public class ArchiveProposalLineItems {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session,
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201705.ArchiveProposalLineItems action =
          new com.google.api.ads.dfp.axis.v201705.ArchiveProposalLineItems();
