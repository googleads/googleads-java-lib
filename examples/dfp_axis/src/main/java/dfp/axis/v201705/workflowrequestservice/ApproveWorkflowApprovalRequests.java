...
import com.google.api.ads.dfp.axis.v201705.WorkflowApprovalRequestStatus;
...
public class ApproveWorkflowApprovalRequests {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long proposalId)
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201705.ApproveWorkflowApprovalRequests action =
          new com.google.api.ads.dfp.axis.v201705.ApproveWorkflowApprovalRequests();
