...
import com.google.api.ads.dfp.axis.v201705.WorkflowEntityType;
import com.google.api.ads.dfp.axis.v201705.WorkflowEvaluationStatus;
import com.google.api.ads.dfp.axis.v201705.WorkflowRequest;
import com.google.api.ads.dfp.axis.v201705.WorkflowRequestPage;
...
public class TriggerWorkflowExternalConditionRequests {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long proposalId)
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201705.TriggerWorkflowExternalConditionRequests action =
          new com.google.api.ads.dfp.axis.v201705.TriggerWorkflowExternalConditionRequests();
