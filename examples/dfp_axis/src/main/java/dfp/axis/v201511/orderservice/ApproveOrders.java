...
package dfp.axis.v201511.orderservice;
...
import com.google.api.ads.dfp.axis.v201511.OrderPage;
import com.google.api.ads.dfp.axis.v201511.OrderServiceInterface;
...
public class ApproveOrders {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long orderId)
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201511.ApproveOrders action =
          new com.google.api.ads.dfp.axis.v201511.ApproveOrders();
