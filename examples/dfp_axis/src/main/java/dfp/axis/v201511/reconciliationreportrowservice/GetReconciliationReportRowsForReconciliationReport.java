...
package dfp.axis.v201511.reconciliationreportrowservice;

import com.google.api.ads.common.lib.auth.OfflineCredentials;
import com.google.api.ads.common.lib.auth.OfflineCredentials.Api;
import com.google.api.ads.dfp.axis.factory.DfpServices;
import com.google.api.ads.dfp.axis.utils.v201511.StatementBuilder;
import com.google.api.ads.dfp.axis.v201511.ReconciliationReportRow;
import com.google.api.ads.dfp.axis.v201511.ReconciliationReportRowPage;
import com.google.api.ads.dfp.axis.v201511.ReconciliationReportRowServiceInterface;
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (ReconciliationReportRow reconciliationReportRow : page.getResults()) {
          System.out.printf(
              "%d) Reconciliation report row with ID %d was found, with reconciliation "
              + "source '%s' and reconciled volume %d.%n",
              i++,
