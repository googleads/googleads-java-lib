...
package dfp.axis.v201702.placementservice;
...
import com.google.api.ads.dfp.axis.v201702.PlacementPage;
import com.google.api.ads.dfp.axis.v201702.PlacementServiceInterface;
...
public class DeactivatePlacements {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long placementId)
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201702.DeactivatePlacements action =
          new com.google.api.ads.dfp.axis.v201702.DeactivatePlacements();
