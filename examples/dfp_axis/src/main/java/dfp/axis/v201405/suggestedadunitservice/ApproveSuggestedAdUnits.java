...
import com.google.api.ads.dfp.axis.v201405.SuggestedAdUnitUpdateResult;
...
public class ApproveSuggestedAdUnits {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long numRequests)
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201405.ApproveSuggestedAdUnit action =
          new com.google.api.ads.dfp.axis.v201405.ApproveSuggestedAdUnit();
