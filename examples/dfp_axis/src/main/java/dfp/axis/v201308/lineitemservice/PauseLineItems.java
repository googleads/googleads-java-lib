...
import com.google.api.ads.dfp.axis.v201308.LineItemPage;
...
public class PauseLineItems {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long lineItemId)
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201308.PauseLineItems action =
          new com.google.api.ads.dfp.axis.v201308.PauseLineItems();
