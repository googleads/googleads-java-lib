...
import com.google.api.ads.dfp.axis.v201508.UserPage;
...
public class DeactivateUsers {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long userId)
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201508.DeactivateUsers action =
          new com.google.api.ads.dfp.axis.v201508.DeactivateUsers();
