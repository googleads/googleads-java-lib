...
import com.google.api.ads.dfp.axis.v201508.ProposalPage;
...
public class SubmitProposalsForApproval {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long proposalId)
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201508.SubmitProposalsForApproval action =
          new com.google.api.ads.dfp.axis.v201508.SubmitProposalsForApproval();
