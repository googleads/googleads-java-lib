...
import com.google.api.ads.dfp.axis.v201408.ProductTemplatePage;
...
/**
 * This example archives a product template. To determine which product templates exist,
 ...
 */
public class ArchiveProductTemplates {

  // Set the ID of the product template to archive.
  private static final String PRODUCT_TEMPLATE_ID = "INSERT_PRODUCT_TEMPLATE_ID";
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long productTemplateId)
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (ProductTemplate productTemplate : page.getResults()) {
          System.out.printf(
              "%d) Product template with ID \"%d\" will be archived.%n", i++,
    ...
    System.out.printf("Number of product templates to be archived: %d%n", totalResultSetSize);
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201408.ArchiveProductTemplates action =
          new com.google.api.ads.dfp.axis.v201408.ArchiveProductTemplates();
      ...
      if (result != null && result.getNumChanges() > 0) {
        System.out.printf("Number of product templates archived: %d%n", result.getNumChanges());
      } else {
        System.out.println("No product templates were archived.");
      }
    }
  }
