...
package dfp.axis.v201408.userservice;
...
import com.google.api.ads.dfp.axis.v201408.User;
import com.google.api.ads.dfp.axis.v201408.UserPage;
import com.google.api.ads.dfp.axis.v201408.UserServiceInterface;
...
public class DeactivateUsers {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long userId)
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201408.DeactivateUsers action =
          new com.google.api.ads.dfp.axis.v201408.DeactivateUsers();
