...
package dfp.axis.v201408.placementservice;
...
public class DeactivatePlacements {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long placementId)
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201408.DeactivatePlacements action =
          new com.google.api.ads.dfp.axis.v201408.DeactivatePlacements();
