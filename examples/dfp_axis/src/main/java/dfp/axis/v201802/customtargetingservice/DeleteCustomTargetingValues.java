...
public class DeleteCustomTargetingValues {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session,
      long customTargetingValueId) throws RemoteException {
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201802.DeleteCustomTargetingValues action =
          new com.google.api.ads.dfp.axis.v201802.DeleteCustomTargetingValues();
