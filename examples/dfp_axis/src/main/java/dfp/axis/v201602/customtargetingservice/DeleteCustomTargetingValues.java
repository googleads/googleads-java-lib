...
package dfp.axis.v201602.customtargetingservice;
...
public class DeleteCustomTargetingValues {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session,
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201602.DeleteCustomTargetingValues action =
          new com.google.api.ads.dfp.axis.v201602.DeleteCustomTargetingValues();
