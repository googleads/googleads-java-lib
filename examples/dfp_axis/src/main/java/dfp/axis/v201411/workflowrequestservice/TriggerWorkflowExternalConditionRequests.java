...
public class TriggerWorkflowExternalConditionRequests {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long proposalId)
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201411.TriggerWorkflowExternalConditionRequests action =
          new com.google.api.ads.dfp.axis.v201411.TriggerWorkflowExternalConditionRequests();
