...
4.  Run an example.
    ...
    *   **If using Maven with Eclipse**
        ...
        `src/main/java/adwords/axis/v201605/basicoperations/GetCampaigns.java`)
        and run the example.
    ...
    *   **If using Maven from the command line**
        ...
        ```
        $ mvn -X exec:java -Dexec.mainClass="adwords.axis.v201605.basicoperations.GetCampaigns"
        ```

    *   **If using jars**

        Navigate in your project to any example (e.g.,
        `src/adwords/axis/v201605/basicoperations/GetCampaigns.java`)
        and run the example.
...
import com.google.api.ads.adwords.axis.v201605.*;
