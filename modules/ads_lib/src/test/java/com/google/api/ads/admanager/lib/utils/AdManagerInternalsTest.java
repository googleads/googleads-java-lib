...
/** Tests for {@link AdManagerInternals}. */
@RunWith(JUnit4.class)
public class AdManagerInternalsTest {

  /** Test method for {@link AdManagerInternals#getInstance()}. */
  @Test
  public void testGetInstance() {
    Internals internals = AdManagerInternals.getInstance();
    String userAgent = internals.getUserAgentCombiner().getUserAgent("test");

    assertTrue(userAgent.contains("DfpApi"));
