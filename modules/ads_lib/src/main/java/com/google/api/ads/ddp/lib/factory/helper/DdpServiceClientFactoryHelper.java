...
package com.google.api.ads.ddp.lib.factory.helper;
...
/**
 * Factory helper for Ddp.
 */
public class DdpServiceClientFactoryHelper extends
    BaseAdsServiceClientFactoryHelper<DdpServiceClient,
                                      DdpSession,
  ...
  @Inject
  public DdpServiceClientFactoryHelper(
      AdsServiceClientFactoryInterface<DdpServiceClient,
                                       DdpSession,
                                       DdpServiceDescriptor> adsServiceClientFactory,
      AdsServiceDescriptorFactoryInterface<DdpServiceDescriptor> adsServiceDescriptorFactory,
