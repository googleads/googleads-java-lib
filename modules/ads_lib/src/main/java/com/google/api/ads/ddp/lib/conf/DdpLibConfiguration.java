 ...
 */
public class DdpLibConfiguration extends AdsLibConfiguration {

  private static final String KEY_PREFIX = "api.ddp";
   ...
   */
  @Inject
  public DdpLibConfiguration(@Named("lib") Configuration config) {
    super(config);
  }
