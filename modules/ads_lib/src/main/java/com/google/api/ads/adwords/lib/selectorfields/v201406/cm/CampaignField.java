...
public enum CampaignField implements EntityField {
  ...
  /**
   * Indicates if a campaign is a search network with display select enabled campaign.
   * This setting is an intermediate setting that will be used to facilitate the migration of legacy bundled campaigns to search network with display select enabled campaigns.
   * This is also applicable only to search enabled campaigns (search or search+display).
   */
  @Filterable
  DisplaySelect(true),
