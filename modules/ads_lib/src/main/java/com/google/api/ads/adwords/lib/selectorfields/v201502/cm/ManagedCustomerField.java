...
public enum ManagedCustomerField implements EntityField {
   ...
   * To change the list of labels applied to this customer, see {@link com.google.ads.api.services.mcm.customer.ManagedCustomerService#mutateLabels ManagedCustomerService.mutateLabels}.
   */
  @Filterable
  AccountLabels(true),
