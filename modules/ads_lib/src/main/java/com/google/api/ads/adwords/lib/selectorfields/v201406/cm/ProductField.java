...
/**
 * A {@code Enum} to facilitate the selection of fields for {@code Product}.
 */
public enum ProductField implements EntityField {
  ...
  private ProductField(boolean isFilterable) {
