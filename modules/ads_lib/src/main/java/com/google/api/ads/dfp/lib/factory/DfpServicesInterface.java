...
public interface DfpServicesInterface extends AdsServicesInterface<DfpSession> {
 ...
 // to DfpSession. This is convenient for library users because they do not have
 // to specify the generic type argument when creating a reference. It also improves readability
 // of user code, since declaring a reference of type DfpServicesInterface is clearer
 // than declaring a reference of type AdsServicesInterface<DfpSession>.
}
