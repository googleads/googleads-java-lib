...
package com.google.api.ads.ddp.lib.conf;
...
/**
 * Configuration information for DDP library.
 */
public class DdpApiConfiguration extends AdsApiConfiguration {

  public static final String NAMESPACE_PREFIX_KEY = "api.ddp.namespace.prefix";
   ...
   */
  @Inject
  public DdpApiConfiguration(@Named("api") Configuration config) {
    super(config);
  }
  ...
  public String getServiceUrlGroup(String version, String service) {
    String[] groups = config.getStringArray("api.ddp.version." + version + ".groups");
    for (String group : groups) {
      String[] services =
          config.getStringArray("api.ddp.version." + version + "." + group + ".services");
...
//    String subProductName = config.getString("api.ddp.version." + version + "."
