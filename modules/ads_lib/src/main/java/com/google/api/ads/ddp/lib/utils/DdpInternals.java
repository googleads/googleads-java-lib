...
package com.google.api.ads.ddp.lib.utils;
 ...
 */
public class DdpInternals {

  private static final Internals INSTANCE = Guice.createInjector(
      new DdpModule()).getInstance(Internals.class);

  /**
   * Returns an {@link Internals} configured for DDP.
   */
