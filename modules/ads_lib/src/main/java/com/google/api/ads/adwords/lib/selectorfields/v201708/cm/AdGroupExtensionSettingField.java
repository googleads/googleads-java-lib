...
/**
 * A {@code Enum} to facilitate the selection of fields for {@code AdGroupExtensionSetting}.
 */
public enum AdGroupExtensionSettingField implements EntityField {
  ...
  private AdGroupExtensionSettingField(boolean isFilterable) {
