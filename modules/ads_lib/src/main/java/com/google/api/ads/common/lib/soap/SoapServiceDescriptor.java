...
public interface SoapServiceDescriptor {
   ...
   */
  public abstract Class<?> getInterfaceClass() throws ServiceException;
   ...
   */
  public abstract String getEndpointAddress(String endpointServer) throws MalformedURLException;
}
