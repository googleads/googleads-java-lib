...
public abstract class SaveResult  implements java.io.Serializable {
    private long id;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.doubleclick.net/dfa-api/v1.20", "SaveResult"));
