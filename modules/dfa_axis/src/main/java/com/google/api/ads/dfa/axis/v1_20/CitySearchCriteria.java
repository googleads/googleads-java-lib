...
public class CitySearchCriteria  implements java.io.Serializable {
    ...
    /**
     * Gets the ids value for this CitySearchCriteria.
     * 
     * @return ids
     */
    public long[] getIds() {
    ...
    /**
     * Sets the ids value for this CitySearchCriteria.
     * 
     * @param ids
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.doubleclick.net/dfa-api/v1.20", "CitySearchCriteria"));
