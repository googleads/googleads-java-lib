...
public class CreativeSaveResult  extends com.google.api.ads.dfa.axis.v1_19.SaveResult  implements java.io.Serializable {
    private long adId;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.doubleclick.net/dfa-api/v1.19", "CreativeSaveResult"));
