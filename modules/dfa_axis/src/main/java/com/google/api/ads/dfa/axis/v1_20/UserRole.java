...
public class UserRole  extends com.google.api.ads.dfa.axis.v1_20.UserRoleBase  implements java.io.Serializable {
    private long parentUserRoleId;

    private com.google.api.ads.dfa.axis.v1_20.Permission[] permissions;
    ...
    public UserRole(
           ...
           com.google.api.ads.dfa.axis.v1_20.Permission[] permissions,
     ...
     * @return permissions
     */
    public com.google.api.ads.dfa.axis.v1_20.Permission[] getPermissions() {
        return permissions;
    }
     ...
     * @param permissions
     */
    public void setPermissions(com.google.api.ads.dfa.axis.v1_20.Permission[] permissions) {
        this.permissions = permissions;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.doubleclick.net/dfa-api/v1.20", "UserRole"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.doubleclick.net/dfa-api/v1.20", "Permission"));
