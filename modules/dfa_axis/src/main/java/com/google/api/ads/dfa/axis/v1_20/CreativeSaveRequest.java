...
public class CreativeSaveRequest  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfa.axis.v1_20.FlashFile flashFile;

    private com.google.api.ads.dfa.axis.v1_20.ImageFile imageFile;
    ...
    public CreativeSaveRequest(
           ...
           com.google.api.ads.dfa.axis.v1_20.FlashFile flashFile,
           com.google.api.ads.dfa.axis.v1_20.ImageFile imageFile) {
     ...
     * @return flashFile
     */
    public com.google.api.ads.dfa.axis.v1_20.FlashFile getFlashFile() {
        return flashFile;
    }
     ...
     * @param flashFile
     */
    public void setFlashFile(com.google.api.ads.dfa.axis.v1_20.FlashFile flashFile) {
        this.flashFile = flashFile;
    }
     ...
     * @return imageFile
     */
    public com.google.api.ads.dfa.axis.v1_20.ImageFile getImageFile() {
        return imageFile;
    }
     ...
     * @param imageFile
     */
    public void setImageFile(com.google.api.ads.dfa.axis.v1_20.ImageFile imageFile) {
        this.imageFile = imageFile;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.doubleclick.net/dfa-api/v1.20", "CreativeSaveRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.doubleclick.net/dfa-api/v1.20", "FlashFile"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("imageFile");
        elemField.setXmlName(new javax.xml.namespace.QName("", "imageFile"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.doubleclick.net/dfa-api/v1.20", "ImageFile"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
