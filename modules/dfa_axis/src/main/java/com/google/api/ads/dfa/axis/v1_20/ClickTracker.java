...
public class ClickTracker  extends com.google.api.ads.dfa.axis.v1_20.AdBase  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.doubleclick.net/dfa-api/v1.20", "ClickTracker"));
