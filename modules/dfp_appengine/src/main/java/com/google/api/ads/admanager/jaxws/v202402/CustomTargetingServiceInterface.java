...
public interface CustomTargetingServiceInterface {
     ...
     * @param keys
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v202402.CustomTargetingKey>
     ...
     * @param values
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v202402.CustomTargetingValue>
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202402")
