 ...
 * 
 */
@WebServiceClient(name = "WorkflowActionService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201306", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201306/WorkflowActionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WORKFLOWACTIONSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201306", "WorkflowActionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201306/WorkflowActionService?wsdl");
    ...
    public WorkflowActionServiceInterface getWorkflowActionServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201306", "WorkflowActionServiceInterfacePort"), WorkflowActionServiceInterface.class);
    }
    ...
    public WorkflowActionServiceInterface getWorkflowActionServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201306", "WorkflowActionServiceInterfacePort"), WorkflowActionServiceInterface.class, features);
    }
