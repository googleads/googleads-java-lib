...
public enum DimensionAttribute {
     ...
     *                 <p>Corresponds to "Line item labels" in the Ad Manager UI.</p>
     *               
     * 
     */
    LINE_ITEM_LABELS,
     ...
     *                 </tr>
     *                 </table>
     *                 <p>Corresponds to "Delivery Indicator" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Delivery pacing" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Frequency cap" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Line item reconciliation status" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 {@link Dimension#LINE_ITEM_NAME} and {@link Dimension#MONTH_YEAR}.
     *                 <p>Corresponds to "Line item last reconciliation time" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "External advertiser ID" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 Can be used for filtering.
     *                 <p>Corresponds to "Advertiser type" in the Ad Manager UI.</p>
     *               
     * 
     */
    ADVERTISER_TYPE,
     ...
     *                 Can be used for filtering.
     *                 <p>Corresponds to "Advertiser credit status" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Advertiser primary contact" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "External order ID" in the Ad Manager UI.</p>
     *               
     * 
     */
    ORDER_EXTERNAL_ID,
     ...
     *                 Can be used for filtering.
     *                 <p>Corresponds to "Programmatic order" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Agency" in the Ad Manager UI.</p>
     *               
     * 
     */
    ORDER_AGENCY,
     ...
     *                 <p>Corresponds to "Order labels" in the Ad Manager UI.</p>
     *               
     * 
     */
    ORDER_LABELS,
     ...
     *                 <p>Corresponds to "Trafficker" in the Ad Manager UI.</p>
     *               
     * 
     */
    ORDER_TRAFFICKER,
     ...
     *                 <p>Corresponds to "Secondary traffickers" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Secondary salespeople" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 {@link Dimension#ORDER_NAME}.
     *                 <p>Corresponds to "Order lifetime impressions" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 {@link Dimension#ORDER_NAME}.
     *                 <p>Corresponds to "Order lifetime clicks" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Booked CPM" in the Ad Manager UI.</p>
     *               
     * 
     */
    ORDER_BOOKED_CPM,
     ...
     *                 <p>Corresponds to "Booked CPC" in the Ad Manager UI.</p>
     *               
     * 
     */
    ORDER_BOOKED_CPC,
     ...
     *                 Can be used for filtering.
     *                 <p>Corresponds to "Line item start date" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 Can be used for filtering.
     *                 <p>Corresponds to "Line item end date" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 Can be used for filtering.
     *                 <p>Corresponds to "External Line Item ID" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 Can be used for filtering.
     *                 <p>Corresponds to "Cost type" in the Ad Manager UI.</p>
     *               
     * 
     */
    LINE_ITEM_COST_TYPE,
     ...
     *                 <p>Corresponds to "Rate" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Currency code" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 for {@link Dimension#LINE_ITEM_NAME}.
     *                 <p>Corresponds to "Goal quantity" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Sponsorship goal (%)" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Line item lifetime impressions" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 {@link Dimension#LINE_ITEM_NAME}.
     *                 <p>Corresponds to "Line item lifetime clicks" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 Can be used for filtering.
     *                 <p>Corresponds to "Line item priority" in the Ad Manager UI.</p>
     *               
     * 
     */
    LINE_ITEM_PRIORITY,
     ...
     *                 <p>Corresponds to "Master or Companion" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Discount" in the Ad Manager UI.</p>
     *               
     * 
     */
    LINE_ITEM_DISCOUNT,
     ...
     *                 <p>Corresponds to "Booked revenue (exclude CPD)" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Advertiser labels" in the Ad Manager UI.</p>
     *               
     * 
     */
    ADVERTISER_LABELS,
     ...
     *                 <p>Corresponds to "Click-through URL" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Creative SSL scan result" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Creative SSL compliance override" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Creative start date" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 {@link Dimension#LINE_ITEM_NAME} and a {@link Dimension#CREATIVE_NAME}.
     *                 Includes the date without the time.
     *                 <p>Corresponds to "Creative end date" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Proposal start time" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Proposal end time" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 for filtering.
     *                 <p>Corresponds to "Creation time" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Sold time" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 filtering.
     *                 <p>Corresponds to "Sold" in the Ad Manager UI.</p>
     *               
     * 
     */
    PROPOSAL_IS_SOLD,
     ...
     *                 <p>Corresponds to "Proposal archival status" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Currency" in the Ad Manager UI.</p>
     *               
     * 
     */
    PROPOSAL_CURRENCY,
     ...
     *                 <p>Corresponds to "Exchange rate" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Agency commission rate" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "VAT rate" in the Ad Manager UI.</p>
     *               
     * 
     */
    PROPOSAL_VAT_RATE,
     ...
     *                 <p>Corresponds to "Proposal discount" in the Ad Manager UI.</p>
     *               
     * 
     */
    PROPOSAL_DISCOUNT,
     ...
     *                 <p>Corresponds to "Advertiser ID" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Agency IDs" in the Ad Manager UI.</p>
     *               
     * 
     */
    PROPOSAL_AGENCY_IDS,
     ...
     *                 <p>Corresponds to "PO number" in the Ad Manager UI.</p>
     *               
     * 
     */
    PROPOSAL_PO_NUMBER,
     ...
     *                 <p>Corresponds to "Creator" in the Ad Manager UI.</p>
     *               
     * 
     */
    PROPOSAL_CREATOR,
     ...
     *                 <p>Corresponds to "Sales planners" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Pricing model" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Proposal billing source" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Proposal caps and rollovers" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Proposal billing schedule" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 {@link Dimension#PROPOSAL_NAME}.
     *                 <p>Corresponds to "Teams" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Approval stage" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Inventory release time" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Budget (local)" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Remaining budget (local)" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Proposal flat fee" in the Ad Manager UI.</p>
     *               
     * 
     */
    PROPOSAL_FLAT_FEE,
     ...
     *                 Can be used for filtering.
     *                 <p>Corresponds to "Proposal line item rate type" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 filtering.
     *                 <p>Corresponds to "Reservation status" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Can correspond to any of the following in the Ad Manager UI: Rate (local), Rate (net) (local).</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Proposal line item caps and rollovers" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 {@link Dimension#PROPOSAL_LINE_ITEM_NAME}.
     *                 <p>Corresponds to "Proposal line item billing schedule" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Goal (%)" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Cost adjustment" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 Dimension#PROPOSAL_LINE_ITEM_NAME}.
     *                 <p>Corresponds to "Proposal line item comments" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Proposal line item reconciliation status" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 {@link Dimension#PROPOSAL_LINE_ITEM_NAME} and {@link Dimension#MONTH_YEAR}.
     *                 <p>Corresponds to "Proposal line item last reconciliation time" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Proposal line item flat fee" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Product template name" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Product rate type" in the Ad Manager UI.</p>
     *               
     * 
     */
    PRODUCT_RATE_TYPE,
     ...
     *                 <p>Corresponds to "Product status" in the Ad Manager UI.</p>
     *               
     * 
     */
    PRODUCT_STATUS,
     ...
     *                 <p>Corresponds to "Product product type" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Product notes" in the Ad Manager UI.</p>
     *               
     * 
     */
    PRODUCT_NOTES,
     ...
     *                 <p>Corresponds to "Salespeople proposal contribution" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Package comments" in the Ad Manager UI.</p>
     *               
     * 
     */
    PACKAGE_COMMENTS,
     ...
     *                 <p>Corresponds to "Package start time" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Package end time" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Content source name" in the Ad Manager UI.</p>
     *               
     * 
     */
    CONTENT_CMS_NAME,
     ...
     *                 {@link Content#cmsContent} for {@link Dimension#CONTENT_NAME}.
     *                 <p>Corresponds to "ID of the video in the content source" in the Ad Manager UI.</p>
     *               
     * 
     */
     ...
     *                 <p>Corresponds to "Ad unit code" in the Ad Manager UI.</p>
     *               
     * 
     */
    AD_UNIT_CODE;
