 ...
 *           
 * 
 * <p>Java class for ExchangeRatePage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ExchangeRatePage">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v201711}ExchangeRate" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "ExchangeRatePage", propOrder = {
    "results",
    "startIndex",
    "totalResultSetSize"
})
public class ExchangeRatePage {
    ...
    protected List<ExchangeRate> results;
     ...
     * 
     */
    public List<ExchangeRate> getResults() {
        if (results == null) {
            results = new ArrayList<ExchangeRate>();
        }
        return this.results;
    }
