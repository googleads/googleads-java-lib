...
public interface PremiumRateServiceInterface {
     ...
     * @param premiumRates
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v201805.PremiumRate>
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805")
    @RequestWrapper(localName = "createPremiumRates", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", className = "com.google.api.ads.admanager.jaxws.v201805.PremiumRateServiceInterfacecreatePremiumRates")
    @ResponseWrapper(localName = "createPremiumRatesResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", className = "com.google.api.ads.admanager.jaxws.v201805.PremiumRateServiceInterfacecreatePremiumRatesResponse")
     ...
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v201805.PremiumRatePage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805")
    @RequestWrapper(localName = "getPremiumRatesByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", className = "com.google.api.ads.admanager.jaxws.v201805.PremiumRateServiceInterfacegetPremiumRatesByStatement")
    @ResponseWrapper(localName = "getPremiumRatesByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", className = "com.google.api.ads.admanager.jaxws.v201805.PremiumRateServiceInterfacegetPremiumRatesByStatementResponse")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805")
    @RequestWrapper(localName = "updatePremiumRates", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", className = "com.google.api.ads.admanager.jaxws.v201805.PremiumRateServiceInterfaceupdatePremiumRates")
    @ResponseWrapper(localName = "updatePremiumRatesResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", className = "com.google.api.ads.admanager.jaxws.v201805.PremiumRateServiceInterfaceupdatePremiumRatesResponse")
