 ...
 *           
 * 
 * <p>Java class for ProposalLineItemPage complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202602}ProposalLineItem" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ProposalLineItemPage", propOrder = {
    "results",
    "startIndex",
    "totalResultSetSize"
})
public class ProposalLineItemPage {

    protected List<ProposalLineItem> results;
     ...
     * 
     */
    public List<ProposalLineItem> getResults() {
        if (results == null) {
            results = new ArrayList<ProposalLineItem>();
        }
        return this.results;
    }
