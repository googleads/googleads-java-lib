 ...
 * 
 */
@WebServiceClient(name = "CreativeTemplateService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202211", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202211/CreativeTemplateService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CREATIVETEMPLATESERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202211", "CreativeTemplateService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202211/CreativeTemplateService?wsdl");
    ...
    public CreativeTemplateServiceInterface getCreativeTemplateServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202211", "CreativeTemplateServiceInterfacePort"), CreativeTemplateServiceInterface.class);
    }
    ...
    public CreativeTemplateServiceInterface getCreativeTemplateServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202211", "CreativeTemplateServiceInterfacePort"), CreativeTemplateServiceInterface.class, features);
    }
