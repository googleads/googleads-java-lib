    ...
    extends Service
{
    ...
    private final static QName COMPANYSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201408", "CompanyService");
    ...
    public CompanyServiceInterface getCompanyServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201408", "CompanyServiceInterfacePort"), CompanyServiceInterface.class);
    }
    ...
    public CompanyServiceInterface getCompanyServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201408", "CompanyServiceInterfacePort"), CompanyServiceInterface.class, features);
    }
