...
public interface DaiAuthenticationKeyServiceInterface {
     ...
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v202311.DaiAuthenticationKey>
    ...
    public List<DaiAuthenticationKey> createDaiAuthenticationKeys(
        @WebParam(name = "daiAuthenticationKeys", targetNamespace = "https://www.google.com/apis/ads/publisher/v202311")
     ...
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202311.DaiAuthenticationKeyPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202311")
    ...
    public UpdateResult performDaiAuthenticationKeyAction(
        @WebParam(name = "daiAuthenticationKeyAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v202311")
