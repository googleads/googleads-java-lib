 ...
 *           
 * 
 * <p>Java class for CreativeTemplatePage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}CreativeTemplate" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CreativeTemplatePage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class CreativeTemplatePage {
    ...
    protected List<CreativeTemplate> results;
     ...
     * 
     */
    public List<CreativeTemplate> getResults() {
        if (results == null) {
            results = new ArrayList<CreativeTemplate>();
        }
        return this.results;
    }
