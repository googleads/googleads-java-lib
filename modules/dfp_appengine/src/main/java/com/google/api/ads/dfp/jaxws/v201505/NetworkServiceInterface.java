...
public interface NetworkServiceInterface {
     ...
     * 
     * @return
     *     returns java.util.List<com.google.api.ads.dfp.jaxws.v201505.Network>
     ...
     * 
     * @return
     *     returns com.google.api.ads.dfp.jaxws.v201505.Network
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201505")
    ...
    public Network updateNetwork(
        @WebParam(name = "network", targetNamespace = "https://www.google.com/apis/ads/publisher/v201505")
        Network network)
        throws ApiException_Exception
    ;
