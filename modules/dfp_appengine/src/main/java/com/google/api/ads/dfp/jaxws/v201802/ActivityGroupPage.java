 ...
 *           
 * 
 * <p>Java class for ActivityGroupPage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ActivityGroupPage">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v201802}ActivityGroup" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ActivityGroupPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class ActivityGroupPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<ActivityGroup> results;
     ...
     * 
     */
    public List<ActivityGroup> getResults() {
        if (results == null) {
            results = new ArrayList<ActivityGroup>();
        }
        return this.results;
    }
