 ...
 * 
 */
@WebService(name = "ReconciliationReportRowServiceInterface", targetNamespace = "https://www.google.com/apis/ads/publisher/v201605")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ReconciliationReportRowServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.dfp.jaxws.v201605.ReconciliationReportRowPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201605")
    @RequestWrapper(localName = "getReconciliationReportRowsByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v201605", className = "com.google.api.ads.dfp.jaxws.v201605.ReconciliationReportRowServiceInterfacegetReconciliationReportRowsByStatement")
    @ResponseWrapper(localName = "getReconciliationReportRowsByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201605", className = "com.google.api.ads.dfp.jaxws.v201605.ReconciliationReportRowServiceInterfacegetReconciliationReportRowsByStatementResponse")
     ...
     * @return
     *     returns java.util.List<com.google.api.ads.dfp.jaxws.v201605.ReconciliationReportRow>
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201605")
    @RequestWrapper(localName = "updateReconciliationReportRows", targetNamespace = "https://www.google.com/apis/ads/publisher/v201605", className = "com.google.api.ads.dfp.jaxws.v201605.ReconciliationReportRowServiceInterfaceupdateReconciliationReportRows")
    @ResponseWrapper(localName = "updateReconciliationReportRowsResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201605", className = "com.google.api.ads.dfp.jaxws.v201605.ReconciliationReportRowServiceInterfaceupdateReconciliationReportRowsResponse")
    public List<ReconciliationReportRow> updateReconciliationReportRows(
        @WebParam(name = "reconciliationReportRows", targetNamespace = "https://www.google.com/apis/ads/publisher/v201605")
