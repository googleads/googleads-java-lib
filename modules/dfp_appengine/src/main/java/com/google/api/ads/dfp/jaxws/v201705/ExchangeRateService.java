 ...
 * 
 */
@WebServiceClient(name = "ExchangeRateService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201705", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201705/ExchangeRateService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXCHANGERATESERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201705", "ExchangeRateService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201705/ExchangeRateService?wsdl");
    ...
    public ExchangeRateServiceInterface getExchangeRateServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201705", "ExchangeRateServiceInterfacePort"), ExchangeRateServiceInterface.class);
    }
    ...
    public ExchangeRateServiceInterface getExchangeRateServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201705", "ExchangeRateServiceInterfacePort"), ExchangeRateServiceInterface.class, features);
    }
