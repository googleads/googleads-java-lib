 ...
 * 
 */
@WebServiceClient(name = "NativeStyleService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202008", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202008/NativeStyleService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NATIVESTYLESERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202008", "NativeStyleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202008/NativeStyleService?wsdl");
    ...
    public NativeStyleServiceInterface getNativeStyleServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202008", "NativeStyleServiceInterfacePort"), NativeStyleServiceInterface.class);
    }
    ...
    public NativeStyleServiceInterface getNativeStyleServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202008", "NativeStyleServiceInterfacePort"), NativeStyleServiceInterface.class, features);
    }
