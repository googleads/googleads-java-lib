 ...
 * 
 */
@WebServiceClient(name = "CreativeSetService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201508", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201508/CreativeSetService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CREATIVESETSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201508", "CreativeSetService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201508/CreativeSetService?wsdl");
    ...
    public CreativeSetServiceInterface getCreativeSetServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201508", "CreativeSetServiceInterfacePort"), CreativeSetServiceInterface.class);
    }
    ...
    public CreativeSetServiceInterface getCreativeSetServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201508", "CreativeSetServiceInterfacePort"), CreativeSetServiceInterface.class, features);
    }
