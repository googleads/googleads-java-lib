 ...
 *           
 * 
 * <p>Java class for SharedAdUnitPage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SharedAdUnitPage">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v201502}SharedAdUnit" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SharedAdUnitPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class SharedAdUnitPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<SharedAdUnit> results;
     ...
     * 
     */
    public List<SharedAdUnit> getResults() {
        if (results == null) {
            results = new ArrayList<SharedAdUnit>();
        }
        return this.results;
    }
