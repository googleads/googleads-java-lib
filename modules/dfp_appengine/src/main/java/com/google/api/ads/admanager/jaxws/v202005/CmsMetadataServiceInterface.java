 ...
 * 
 */
@WebService(name = "CmsMetadataServiceInterface", targetNamespace = "https://www.google.com/apis/ads/publisher/v202005")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CmsMetadataServiceInterface {
     ...
     * @param statement
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202005.CmsMetadataKeyPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202005")
    @RequestWrapper(localName = "getCmsMetadataKeysByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v202005", className = "com.google.api.ads.admanager.jaxws.v202005.CmsMetadataServiceInterfacegetCmsMetadataKeysByStatement")
    @ResponseWrapper(localName = "getCmsMetadataKeysByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v202005", className = "com.google.api.ads.admanager.jaxws.v202005.CmsMetadataServiceInterfacegetCmsMetadataKeysByStatementResponse")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202005")
    @RequestWrapper(localName = "performCmsMetadataValueAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v202005", className = "com.google.api.ads.admanager.jaxws.v202005.CmsMetadataServiceInterfaceperformCmsMetadataValueAction")
    @ResponseWrapper(localName = "performCmsMetadataValueActionResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v202005", className = "com.google.api.ads.admanager.jaxws.v202005.CmsMetadataServiceInterfaceperformCmsMetadataValueActionResponse")
    public UpdateResult performCmsMetadataValueAction(
        @WebParam(name = "valueAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v202005")
