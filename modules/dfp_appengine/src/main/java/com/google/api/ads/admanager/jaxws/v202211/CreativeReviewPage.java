...
/**
 * <p>Java class for CreativeReviewPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202211}CreativeReview" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CreativeReviewPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class CreativeReviewPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<CreativeReview> results;
     ...
     * 
     */
    public List<CreativeReview> getResults() {
        if (results == null) {
            results = new ArrayList<CreativeReview>();
        }
        return this.results;
    }
