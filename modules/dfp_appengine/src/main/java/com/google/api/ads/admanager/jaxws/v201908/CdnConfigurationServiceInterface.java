 ...
 * 
 */
@WebService(name = "CdnConfigurationServiceInterface", targetNamespace = "https://www.google.com/apis/ads/publisher/v201908")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CdnConfigurationServiceInterface {
     ...
     * @param statement
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v201908.CdnConfigurationPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201908")
    @RequestWrapper(localName = "getCdnConfigurationsByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v201908", className = "com.google.api.ads.admanager.jaxws.v201908.CdnConfigurationServiceInterfacegetCdnConfigurationsByStatement")
    @ResponseWrapper(localName = "getCdnConfigurationsByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201908", className = "com.google.api.ads.admanager.jaxws.v201908.CdnConfigurationServiceInterfacegetCdnConfigurationsByStatementResponse")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201908")
    @RequestWrapper(localName = "performCdnConfigurationAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v201908", className = "com.google.api.ads.admanager.jaxws.v201908.CdnConfigurationServiceInterfaceperformCdnConfigurationAction")
    @ResponseWrapper(localName = "performCdnConfigurationActionResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201908", className = "com.google.api.ads.admanager.jaxws.v201908.CdnConfigurationServiceInterfaceperformCdnConfigurationActionResponse")
    public UpdateResult performCdnConfigurationAction(
        @WebParam(name = "cdnConfigurationAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v201908")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201908")
    @RequestWrapper(localName = "updateCdnConfigurations", targetNamespace = "https://www.google.com/apis/ads/publisher/v201908", className = "com.google.api.ads.admanager.jaxws.v201908.CdnConfigurationServiceInterfaceupdateCdnConfigurations")
    @ResponseWrapper(localName = "updateCdnConfigurationsResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201908", className = "com.google.api.ads.admanager.jaxws.v201908.CdnConfigurationServiceInterfaceupdateCdnConfigurationsResponse")
