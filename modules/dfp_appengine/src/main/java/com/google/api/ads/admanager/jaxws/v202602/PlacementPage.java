 ...
 *           
 * 
 * <p>Java class for PlacementPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202602}Placement" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "PlacementPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class PlacementPage {
    ...
    protected List<Placement> results;
    ...
    public List<Placement> getResults() {
        if (results == null) {
            results = new ArrayList<Placement>();
        }
        return this.results;
    }
