 ...
 * 
 */
@WebServiceClient(name = "CustomFieldService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202302", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202302/CustomFieldService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMFIELDSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202302", "CustomFieldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202302/CustomFieldService?wsdl");
    ...
    public CustomFieldServiceInterface getCustomFieldServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202302", "CustomFieldServiceInterfacePort"), CustomFieldServiceInterface.class);
    }
    ...
    public CustomFieldServiceInterface getCustomFieldServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202302", "CustomFieldServiceInterfacePort"), CustomFieldServiceInterface.class, features);
    }
