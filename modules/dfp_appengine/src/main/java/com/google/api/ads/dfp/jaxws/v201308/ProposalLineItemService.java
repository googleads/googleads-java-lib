 ...
 * 
 */
@WebServiceClient(name = "ProposalLineItemService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201308", wsdlLocation = "https://www.google.com/apis/ads/publisher/v201308/ProposalLineItemService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PROPOSALLINEITEMSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201308", "ProposalLineItemService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://www.google.com/apis/ads/publisher/v201308/ProposalLineItemService?wsdl");
    ...
    public ProposalLineItemServiceInterface getProposalLineItemServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201308", "ProposalLineItemServiceInterfacePort"), ProposalLineItemServiceInterface.class);
    }
    ...
    public ProposalLineItemServiceInterface getProposalLineItemServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201308", "ProposalLineItemServiceInterfacePort"), ProposalLineItemServiceInterface.class, features);
    }
