 ...
 *           
 * 
 * <p>Java class for YieldGroupPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202602}YieldGroup" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "YieldGroupPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class YieldGroupPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<YieldGroup> results;
     ...
     * 
     */
    public List<YieldGroup> getResults() {
        if (results == null) {
            results = new ArrayList<YieldGroup>();
        }
        return this.results;
    }
