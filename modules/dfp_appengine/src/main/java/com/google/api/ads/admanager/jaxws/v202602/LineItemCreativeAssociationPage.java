 ...
 *           
 * 
 * <p>Java class for LineItemCreativeAssociationPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202602}LineItemCreativeAssociation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "LineItemCreativeAssociationPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class LineItemCreativeAssociationPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<LineItemCreativeAssociation> results;
     ...
     * 
     */
    public List<LineItemCreativeAssociation> getResults() {
        if (results == null) {
            results = new ArrayList<LineItemCreativeAssociation>();
        }
        return this.results;
    }
