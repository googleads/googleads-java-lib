 ...
 * 
 */
@WebService(name = "ContentServiceInterface", targetNamespace = "https://www.google.com/apis/ads/publisher/v202302")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ContentServiceInterface {
     ...
     * @param statement
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202302.ContentPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202302")
    @RequestWrapper(localName = "getContentByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v202302", className = "com.google.api.ads.admanager.jaxws.v202302.ContentServiceInterfacegetContentByStatement")
    @ResponseWrapper(localName = "getContentByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v202302", className = "com.google.api.ads.admanager.jaxws.v202302.ContentServiceInterfacegetContentByStatementResponse")
