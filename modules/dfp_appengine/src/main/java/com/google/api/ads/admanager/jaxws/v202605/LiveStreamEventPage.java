 ...
 *           
 * 
 * <p>Java class for LiveStreamEventPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}LiveStreamEvent" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "LiveStreamEventPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class LiveStreamEventPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<LiveStreamEvent> results;
     ...
     * 
     */
    public List<LiveStreamEvent> getResults() {
        if (results == null) {
            results = new ArrayList<LiveStreamEvent>();
        }
        return this.results;
    }
