 ...
 *           
 * 
 * <p>Java class for AdUnitPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202602}AdUnit" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AdUnitPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class AdUnitPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<AdUnit> results;
     ...
     * 
     */
    public List<AdUnit> getResults() {
        if (results == null) {
            results = new ArrayList<AdUnit>();
        }
        return this.results;
    }
