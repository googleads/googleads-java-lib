...
public interface PackageServiceInterface {
     ...
     * @param packages
     * @return
     *     returns java.util.List<com.google.api.ads.dfp.jaxws.v201805.Package>
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805")
    @RequestWrapper(localName = "createPackages", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", className = "com.google.api.ads.dfp.jaxws.v201805.PackageServiceInterfacecreatePackages")
    @ResponseWrapper(localName = "createPackagesResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", className = "com.google.api.ads.dfp.jaxws.v201805.PackageServiceInterfacecreatePackagesResponse")
    public List<Package> createPackages(
        @WebParam(name = "packages", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805")
     ...
     * @return
     *     returns com.google.api.ads.dfp.jaxws.v201805.PackagePage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805")
    @RequestWrapper(localName = "performPackageAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", className = "com.google.api.ads.dfp.jaxws.v201805.PackageServiceInterfaceperformPackageAction")
    @ResponseWrapper(localName = "performPackageActionResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", className = "com.google.api.ads.dfp.jaxws.v201805.PackageServiceInterfaceperformPackageActionResponse")
    public UpdateResult performPackageAction(
        @WebParam(name = "packageAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805")
    @RequestWrapper(localName = "updatePackages", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", className = "com.google.api.ads.dfp.jaxws.v201805.PackageServiceInterfaceupdatePackages")
    @ResponseWrapper(localName = "updatePackagesResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", className = "com.google.api.ads.dfp.jaxws.v201805.PackageServiceInterfaceupdatePackagesResponse")
