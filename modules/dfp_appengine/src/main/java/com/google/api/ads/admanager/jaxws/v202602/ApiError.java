 ...
 *         &lt;element name="fieldPathElements" type="{https://www.google.com/apis/ads/publisher/v202602}FieldPathElement" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlSeeAlso({
    ...
    PublisherProvidedSignalsTargetingError.class,
