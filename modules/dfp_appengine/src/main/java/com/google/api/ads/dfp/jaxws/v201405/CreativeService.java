    ...
    extends Service
{
    ...
    private final static QName CREATIVESERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201405", "CreativeService");
    ...
    public CreativeServiceInterface getCreativeServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201405", "CreativeServiceInterfacePort"), CreativeServiceInterface.class);
    }
    ...
    public CreativeServiceInterface getCreativeServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201405", "CreativeServiceInterfacePort"), CreativeServiceInterface.class, features);
    }
