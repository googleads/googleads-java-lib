...
public interface LiveStreamEventServiceInterface {
     ...
     * @return
     *     returns java.util.List<com.google.api.ads.dfp.jaxws.v201511.LiveStreamEvent>
    ...
    public List<LiveStreamEvent> createLiveStreamEvents(
        @WebParam(name = "liveStreamEvents", targetNamespace = "https://www.google.com/apis/ads/publisher/v201511")
     ...
     * @return
     *     returns com.google.api.ads.dfp.jaxws.v201511.LiveStreamEventPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201511")
    ...
    public UpdateResult performLiveStreamEventAction(
        @WebParam(name = "liveStreamEventAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v201511")
