 ...
 * 
 */
@WebServiceClient(name = "ReconciliationReportService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201502", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201502/ReconciliationReportService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RECONCILIATIONREPORTSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201502", "ReconciliationReportService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201502/ReconciliationReportService?wsdl");
    ...
    public ReconciliationReportServiceInterface getReconciliationReportServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201502", "ReconciliationReportServiceInterfacePort"), ReconciliationReportServiceInterface.class);
    }
    ...
    public ReconciliationReportServiceInterface getReconciliationReportServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201502", "ReconciliationReportServiceInterfacePort"), ReconciliationReportServiceInterface.class, features);
    }
