 ...
 *           
 * 
 * <p>Java class for AdExclusionRulePage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v201802}AdExclusionRule" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AdExclusionRulePage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class AdExclusionRulePage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<AdExclusionRule> results;
     ...
     * 
     */
    public List<AdExclusionRule> getResults() {
        if (results == null) {
            results = new ArrayList<AdExclusionRule>();
        }
        return this.results;
    }
