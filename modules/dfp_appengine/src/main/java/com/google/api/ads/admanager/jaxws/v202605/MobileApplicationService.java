 ...
 * 
 */
@WebServiceClient(name = "MobileApplicationService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202605", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202605/MobileApplicationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MOBILEAPPLICATIONSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202605", "MobileApplicationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202605/MobileApplicationService?wsdl");
    ...
    public MobileApplicationServiceInterface getMobileApplicationServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202605", "MobileApplicationServiceInterfacePort"), MobileApplicationServiceInterface.class);
    }
    ...
    public MobileApplicationServiceInterface getMobileApplicationServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202605", "MobileApplicationServiceInterfacePort"), MobileApplicationServiceInterface.class, features);
    }
