 ...
 * 
 */
@WebService(name = "SiteServiceInterface", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface SiteServiceInterface {
     ...
     * @param sites
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v202202.Site>
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202")
    @RequestWrapper(localName = "createSites", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202", className = "com.google.api.ads.admanager.jaxws.v202202.SiteServiceInterfacecreateSites")
    @ResponseWrapper(localName = "createSitesResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202", className = "com.google.api.ads.admanager.jaxws.v202202.SiteServiceInterfacecreateSitesResponse")
    public List<Site> createSites(
        @WebParam(name = "sites", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202")
        List<Site> sites)
        throws ApiException_Exception
    ;
     ...
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202202.SitePage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202")
    @RequestWrapper(localName = "getSitesByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202", className = "com.google.api.ads.admanager.jaxws.v202202.SiteServiceInterfacegetSitesByStatement")
    @ResponseWrapper(localName = "getSitesByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202", className = "com.google.api.ads.admanager.jaxws.v202202.SiteServiceInterfacegetSitesByStatementResponse")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202")
    @RequestWrapper(localName = "updateSites", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202", className = "com.google.api.ads.admanager.jaxws.v202202.SiteServiceInterfaceupdateSites")
    @ResponseWrapper(localName = "updateSitesResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202", className = "com.google.api.ads.admanager.jaxws.v202202.SiteServiceInterfaceupdateSitesResponse")
