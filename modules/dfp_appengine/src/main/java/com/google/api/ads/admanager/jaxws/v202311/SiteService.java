    ...
    extends Service
{
    ...
    private final static QName SITESERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202311", "SiteService");
    ...
    public SiteServiceInterface getSiteServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202311", "SiteServiceInterfacePort"), SiteServiceInterface.class);
    }
    ...
    public SiteServiceInterface getSiteServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202311", "SiteServiceInterfacePort"), SiteServiceInterface.class, features);
    }
