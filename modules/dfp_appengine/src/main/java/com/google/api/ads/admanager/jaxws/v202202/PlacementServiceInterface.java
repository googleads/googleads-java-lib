...
public interface PlacementServiceInterface {
     ...
     * @param placements
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v202202.Placement>
    ...
    public List<Placement> createPlacements(
        @WebParam(name = "placements", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202")
     ...
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202202.PlacementPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202")
    ...
    public UpdateResult performPlacementAction(
        @WebParam(name = "placementAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v202202")
