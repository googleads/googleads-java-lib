 ...
 *           
 * 
 * <p>Java class for LineItemPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}LineItem" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "LineItemPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class LineItemPage {
    ...
    protected List<LineItem> results;
    ...
    public List<LineItem> getResults() {
        if (results == null) {
            results = new ArrayList<LineItem>();
        }
        return this.results;
    }
