    ...
    extends Service
{
    ...
    private final static QName CONTENTSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201208", "ContentService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://www.google.com/apis/ads/publisher/v201208/ContentService?wsdl");
    ...
    public ContentServiceInterface getContentServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201208", "ContentServiceInterfacePort"), ContentServiceInterface.class);
    }
    ...
    public ContentServiceInterface getContentServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201208", "ContentServiceInterfacePort"), ContentServiceInterface.class, features);
    }
