 ...
 *           
 * 
 * <p>Java class for ProductPackagePage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProductPackagePage">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v201802}ProductPackage" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ProductPackagePage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class ProductPackagePage {
    ...
    protected List<ProductPackage> results;
     ...
     * 
     */
    public List<ProductPackage> getResults() {
        if (results == null) {
            results = new ArrayList<ProductPackage>();
        }
        return this.results;
    }
