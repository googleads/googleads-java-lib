 ...
 * 
 */
@WebService(name = "CreativeTemplateServiceInterface", targetNamespace = "https://www.google.com/apis/ads/publisher/v202011")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CreativeTemplateServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202011.CreativeTemplatePage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202011")
    @RequestWrapper(localName = "getCreativeTemplatesByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v202011", className = "com.google.api.ads.admanager.jaxws.v202011.CreativeTemplateServiceInterfacegetCreativeTemplatesByStatement")
    @ResponseWrapper(localName = "getCreativeTemplatesByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v202011", className = "com.google.api.ads.admanager.jaxws.v202011.CreativeTemplateServiceInterfacegetCreativeTemplatesByStatementResponse")
