 ...
 *           
 * 
 * <p>Java class for ReconciliationReportRowPage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ReconciliationReportRowPage">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v201711}ReconciliationReportRow" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ReconciliationReportRowPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class ReconciliationReportRowPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<ReconciliationReportRow> results;
     ...
     * 
     */
    public List<ReconciliationReportRow> getResults() {
        if (results == null) {
            results = new ArrayList<ReconciliationReportRow>();
        }
        return this.results;
    }
