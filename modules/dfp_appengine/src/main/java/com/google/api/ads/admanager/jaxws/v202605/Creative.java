 ...
 *         &lt;element name="size" type="{https://www.google.com/apis/ads/publisher/v202605}Size" minOccurs="0"/&gt;
 *         &lt;element name="previewUrl" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="policyLabels" type="{https://www.google.com/apis/ads/publisher/v202605}CreativePolicyViolation" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="thirdPartyDataDeclaration" type="{https://www.google.com/apis/ads/publisher/v202605}ThirdPartyDataDeclaration" minOccurs="0"/&gt;
 *         &lt;element name="thirdPartyDataDeclarationStatus" type="{https://www.google.com/apis/ads/publisher/v202605}ThirdPartyDataDeclarationStatus" minOccurs="0"/&gt;
 *         &lt;element name="adBadgingEnabled" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="selfDeclaredEuropeanUnionPoliticalContent" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public abstract class Creative {
    ...
    @XmlSchemaType(name = "string")
    protected ThirdPartyDataDeclarationStatus thirdPartyDataDeclarationStatus;
    protected Boolean adBadgingEnabled;
    protected Boolean selfDeclaredEuropeanUnionPoliticalContent;
    ...
    /**
     * Gets the value of the thirdPartyDataDeclarationStatus property.
     * 
     * @return
     *     possible object is
     *     {@link ThirdPartyDataDeclarationStatus }
     *     
     */
    public ThirdPartyDataDeclarationStatus getThirdPartyDataDeclarationStatus() {
        return thirdPartyDataDeclarationStatus;
    }

    /**
     * Sets the value of the thirdPartyDataDeclarationStatus property.
     * 
     * @param value
     *     allowed object is
     *     {@link ThirdPartyDataDeclarationStatus }
     *     
     */
    public void setThirdPartyDataDeclarationStatus(ThirdPartyDataDeclarationStatus value) {
        this.thirdPartyDataDeclarationStatus = value;
    }

    /**
     * Gets the value of the adBadgingEnabled property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isAdBadgingEnabled() {
        return adBadgingEnabled;
    }

    /**
     * Sets the value of the adBadgingEnabled property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setAdBadgingEnabled(Boolean value) {
        this.adBadgingEnabled = value;
    }

    /**
     * Gets the value of the selfDeclaredEuropeanUnionPoliticalContent property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isSelfDeclaredEuropeanUnionPoliticalContent() {
        return selfDeclaredEuropeanUnionPoliticalContent;
    }

    /**
     * Sets the value of the selfDeclaredEuropeanUnionPoliticalContent property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setSelfDeclaredEuropeanUnionPoliticalContent(Boolean value) {
        this.selfDeclaredEuropeanUnionPoliticalContent = value;
    }
