 ...
 *           
 * 
 * <p>Java class for CustomTargetingKeyPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202602}CustomTargetingKey" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CustomTargetingKeyPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class CustomTargetingKeyPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<CustomTargetingKey> results;
     ...
     * 
     */
    public List<CustomTargetingKey> getResults() {
        if (results == null) {
            results = new ArrayList<CustomTargetingKey>();
        }
        return this.results;
    }
