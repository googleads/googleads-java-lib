 ...
 * 
 */
@WebServiceClient(name = "AdjustmentService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202002", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202002/AdjustmentService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADJUSTMENTSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202002", "AdjustmentService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202002/AdjustmentService?wsdl");
    ...
    public AdjustmentServiceInterface getAdjustmentServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202002", "AdjustmentServiceInterfacePort"), AdjustmentServiceInterface.class);
    }
    ...
    public AdjustmentServiceInterface getAdjustmentServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202002", "AdjustmentServiceInterfacePort"), AdjustmentServiceInterface.class, features);
    }
