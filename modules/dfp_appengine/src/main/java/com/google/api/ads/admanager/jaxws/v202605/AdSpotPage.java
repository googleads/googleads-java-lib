 ...
 *           
 * 
 * <p>Java class for AdSpotPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}AdSpot" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AdSpotPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class AdSpotPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<AdSpot> results;
     ...
     * 
     */
    public List<AdSpot> getResults() {
        if (results == null) {
            results = new ArrayList<AdSpot>();
        }
        return this.results;
    }
