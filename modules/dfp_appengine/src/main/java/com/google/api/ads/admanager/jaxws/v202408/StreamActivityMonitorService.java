 ...
 * 
 */
@WebServiceClient(name = "StreamActivityMonitorService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202408", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202408/StreamActivityMonitorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STREAMACTIVITYMONITORSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202408", "StreamActivityMonitorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202408/StreamActivityMonitorService?wsdl");
    ...
    public StreamActivityMonitorServiceInterface getStreamActivityMonitorServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202408", "StreamActivityMonitorServiceInterfacePort"), StreamActivityMonitorServiceInterface.class);
    }
    ...
    public StreamActivityMonitorServiceInterface getStreamActivityMonitorServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202408", "StreamActivityMonitorServiceInterfacePort"), StreamActivityMonitorServiceInterface.class, features);
    }
