...
public enum UserConsentEligibility {
     ...
     *                 field). their consent designations (in other words, for requests that have *either* NPA=1 or no
     *                 NPA.
     *               
     * 
     */
     ...
     *                 eligible to serve on any consented request (ie. on requests that *do not* have NPA=1).
     *                 
     ...
     *                 this line item.
     *                 
     *                 If a non-consented request (a request that *does* have NPA=1) is received, this line item will
