 ...
 *           
 * 
 * <p>Java class for CreativeSetPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}CreativeSet" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CreativeSetPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class CreativeSetPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<CreativeSet> results;
     ...
     * 
     */
    public List<CreativeSet> getResults() {
        if (results == null) {
            results = new ArrayList<CreativeSet>();
        }
        return this.results;
    }
