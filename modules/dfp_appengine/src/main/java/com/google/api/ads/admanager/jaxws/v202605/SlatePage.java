 ...
 *           
 * 
 * <p>Java class for SlatePage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}Slate" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "SlatePage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class SlatePage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<Slate> results;
     ...
     * 
     */
    public List<Slate> getResults() {
        if (results == null) {
            results = new ArrayList<Slate>();
        }
        return this.results;
    }
