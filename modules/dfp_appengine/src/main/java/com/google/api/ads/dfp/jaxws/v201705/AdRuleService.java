 ...
 * 
 */
@WebServiceClient(name = "AdRuleService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201705", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201705/AdRuleService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADRULESERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201705", "AdRuleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201705/AdRuleService?wsdl");
    ...
    public AdRuleServiceInterface getAdRuleServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201705", "AdRuleServiceInterfacePort"), AdRuleServiceInterface.class);
    }
    ...
    public AdRuleServiceInterface getAdRuleServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201705", "AdRuleServiceInterfacePort"), AdRuleServiceInterface.class, features);
    }
