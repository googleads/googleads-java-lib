...
public interface LineItemServiceInterface {
     ...
     * @param lineItems
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v202402.LineItem>
     ...
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202402.LineItemPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202402")
    ...
    public UpdateResult performLineItemAction(
        @WebParam(name = "lineItemAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v202402")
