 ...
 * 
 */
@WebServiceClient(name = "RateCardCustomizationService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201311", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201311/RateCardCustomizationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RATECARDCUSTOMIZATIONSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201311", "RateCardCustomizationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201311/RateCardCustomizationService?wsdl");
    ...
    public RateCardCustomizationServiceInterface getRateCardCustomizationServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201311", "RateCardCustomizationServiceInterfacePort"), RateCardCustomizationServiceInterface.class);
    }
    ...
    public RateCardCustomizationServiceInterface getRateCardCustomizationServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201311", "RateCardCustomizationServiceInterfacePort"), RateCardCustomizationServiceInterface.class, features);
    }
