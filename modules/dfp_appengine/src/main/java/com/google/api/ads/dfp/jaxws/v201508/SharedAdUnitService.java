 ...
 * 
 */
@WebServiceClient(name = "SharedAdUnitService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201508", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201508/SharedAdUnitService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SHAREDADUNITSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201508", "SharedAdUnitService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201508/SharedAdUnitService?wsdl");
    ...
    public SharedAdUnitServiceInterface getSharedAdUnitServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201508", "SharedAdUnitServiceInterfacePort"), SharedAdUnitServiceInterface.class);
    }
    ...
    public SharedAdUnitServiceInterface getSharedAdUnitServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201508", "SharedAdUnitServiceInterfacePort"), SharedAdUnitServiceInterface.class, features);
    }
