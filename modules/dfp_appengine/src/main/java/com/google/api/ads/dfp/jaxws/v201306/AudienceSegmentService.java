    ...
    extends Service
{
    ...
    private final static QName AUDIENCESEGMENTSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201306", "AudienceSegmentService");
    ...
    public AudienceSegmentServiceInterface getAudienceSegmentServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201306", "AudienceSegmentServiceInterfacePort"), AudienceSegmentServiceInterface.class);
    }
    ...
    public AudienceSegmentServiceInterface getAudienceSegmentServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201306", "AudienceSegmentServiceInterfacePort"), AudienceSegmentServiceInterface.class, features);
    }
