 ...
 * 
 */
@WebServiceClient(name = "ProductPackageService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201805/ProductPackageService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTPACKAGESERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201805", "ProductPackageService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201805/ProductPackageService?wsdl");
    ...
    public ProductPackageServiceInterface getProductPackageServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201805", "ProductPackageServiceInterfacePort"), ProductPackageServiceInterface.class);
    }
    ...
    public ProductPackageServiceInterface getProductPackageServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201805", "ProductPackageServiceInterfacePort"), ProductPackageServiceInterface.class, features);
    }
