 ...
 * 
 */
@WebServiceClient(name = "ReconciliationReportRowService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201608", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201608/ReconciliationReportRowService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RECONCILIATIONREPORTROWSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201608", "ReconciliationReportRowService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201608/ReconciliationReportRowService?wsdl");
    ...
    public ReconciliationReportRowServiceInterface getReconciliationReportRowServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201608", "ReconciliationReportRowServiceInterfacePort"), ReconciliationReportRowServiceInterface.class);
    }
    ...
    public ReconciliationReportRowServiceInterface getReconciliationReportRowServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201608", "ReconciliationReportRowServiceInterfacePort"), ReconciliationReportRowServiceInterface.class, features);
    }
