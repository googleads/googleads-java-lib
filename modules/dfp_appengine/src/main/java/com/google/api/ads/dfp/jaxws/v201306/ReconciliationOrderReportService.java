 ...
 * 
 */
@WebServiceClient(name = "ReconciliationOrderReportService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201306", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201306/ReconciliationOrderReportService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RECONCILIATIONORDERREPORTSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201306", "ReconciliationOrderReportService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201306/ReconciliationOrderReportService?wsdl");
    ...
    public ReconciliationOrderReportServiceInterface getReconciliationOrderReportServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201306", "ReconciliationOrderReportServiceInterfacePort"), ReconciliationOrderReportServiceInterface.class);
    }
    ...
    public ReconciliationOrderReportServiceInterface getReconciliationOrderReportServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201306", "ReconciliationOrderReportServiceInterfacePort"), ReconciliationOrderReportServiceInterface.class, features);
    }
