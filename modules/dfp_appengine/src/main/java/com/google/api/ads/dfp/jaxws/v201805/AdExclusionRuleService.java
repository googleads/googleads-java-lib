 ...
 * 
 */
@WebServiceClient(name = "AdExclusionRuleService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201805/AdExclusionRuleService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADEXCLUSIONRULESERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201805", "AdExclusionRuleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201805/AdExclusionRuleService?wsdl");
    ...
    public AdExclusionRuleServiceInterface getAdExclusionRuleServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201805", "AdExclusionRuleServiceInterfacePort"), AdExclusionRuleServiceInterface.class);
    }
    ...
    public AdExclusionRuleServiceInterface getAdExclusionRuleServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201805", "AdExclusionRuleServiceInterfacePort"), AdExclusionRuleServiceInterface.class, features);
    }
