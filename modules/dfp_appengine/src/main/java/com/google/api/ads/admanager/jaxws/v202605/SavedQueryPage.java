 ...
 *           
 * 
 * <p>Java class for SavedQueryPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}SavedQuery" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "SavedQueryPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class SavedQueryPage {
    ...
    protected List<SavedQuery> results;
     ...
     * 
     */
    public List<SavedQuery> getResults() {
        if (results == null) {
            results = new ArrayList<SavedQuery>();
        }
        return this.results;
    }
