 ...
 * 
 */
@WebServiceClient(name = "LineItemTemplateService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202102", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202102/LineItemTemplateService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LINEITEMTEMPLATESERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202102", "LineItemTemplateService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202102/LineItemTemplateService?wsdl");
    ...
    public LineItemTemplateServiceInterface getLineItemTemplateServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202102", "LineItemTemplateServiceInterfacePort"), LineItemTemplateServiceInterface.class);
    }
    ...
    public LineItemTemplateServiceInterface getLineItemTemplateServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202102", "LineItemTemplateServiceInterfacePort"), LineItemTemplateServiceInterface.class, features);
    }
