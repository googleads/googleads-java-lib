 ...
 *           
 * 
 * <p>Java class for ProductTemplatePage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProductTemplatePage">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v201802}ProductTemplate" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ProductTemplatePage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class ProductTemplatePage {
    ...
    protected List<ProductTemplate> results;
     ...
     * 
     */
    public List<ProductTemplate> getResults() {
        if (results == null) {
            results = new ArrayList<ProductTemplate>();
        }
        return this.results;
    }
