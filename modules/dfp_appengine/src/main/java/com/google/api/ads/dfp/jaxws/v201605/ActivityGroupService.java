 ...
 * 
 */
@WebServiceClient(name = "ActivityGroupService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201605", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201605/ActivityGroupService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACTIVITYGROUPSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201605", "ActivityGroupService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201605/ActivityGroupService?wsdl");
    ...
    public ActivityGroupServiceInterface getActivityGroupServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201605", "ActivityGroupServiceInterfacePort"), ActivityGroupServiceInterface.class);
    }
    ...
    public ActivityGroupServiceInterface getActivityGroupServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201605", "ActivityGroupServiceInterfacePort"), ActivityGroupServiceInterface.class, features);
    }
