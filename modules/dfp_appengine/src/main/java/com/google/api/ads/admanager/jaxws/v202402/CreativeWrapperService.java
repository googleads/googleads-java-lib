 ...
 * 
 */
@WebServiceClient(name = "CreativeWrapperService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202402", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202402/CreativeWrapperService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CREATIVEWRAPPERSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202402", "CreativeWrapperService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202402/CreativeWrapperService?wsdl");
    ...
    public CreativeWrapperServiceInterface getCreativeWrapperServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202402", "CreativeWrapperServiceInterfacePort"), CreativeWrapperServiceInterface.class);
    }
    ...
    public CreativeWrapperServiceInterface getCreativeWrapperServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202402", "CreativeWrapperServiceInterfacePort"), CreativeWrapperServiceInterface.class, features);
    }
