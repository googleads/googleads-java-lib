...
public interface AdjustmentServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v201902.TrafficForecastAdjustmentPage
     ...
     * @param adjustments
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v201902.TrafficForecastAdjustment>
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201902")
    ...
    public List<TrafficForecastAdjustment> updateTrafficAdjustments(
        @WebParam(name = "adjustments", targetNamespace = "https://www.google.com/apis/ads/publisher/v201902")
