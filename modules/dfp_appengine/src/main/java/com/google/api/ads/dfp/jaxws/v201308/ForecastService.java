    ...
    extends Service
{
    ...
    private final static QName FORECASTSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201308", "ForecastService");
    ...
    public ForecastServiceInterface getForecastServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201308", "ForecastServiceInterfacePort"), ForecastServiceInterface.class);
    }
    ...
    public ForecastServiceInterface getForecastServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201308", "ForecastServiceInterfacePort"), ForecastServiceInterface.class, features);
    }
