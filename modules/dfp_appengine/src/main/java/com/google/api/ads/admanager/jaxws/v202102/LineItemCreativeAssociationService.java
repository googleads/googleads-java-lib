 ...
 * 
 */
@WebServiceClient(name = "LineItemCreativeAssociationService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202102", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202102/LineItemCreativeAssociationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LINEITEMCREATIVEASSOCIATIONSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202102", "LineItemCreativeAssociationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202102/LineItemCreativeAssociationService?wsdl");
    ...
    public LineItemCreativeAssociationServiceInterface getLineItemCreativeAssociationServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202102", "LineItemCreativeAssociationServiceInterfacePort"), LineItemCreativeAssociationServiceInterface.class);
    }
    ...
    public LineItemCreativeAssociationServiceInterface getLineItemCreativeAssociationServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202102", "LineItemCreativeAssociationServiceInterfacePort"), LineItemCreativeAssociationServiceInterface.class, features);
    }
