 ...
 *     &lt;enumeration value="DIFFERENT_BACKFILL_WEB_PROPERTY_CODE"/>
...
public enum LineItemErrorReason {
    ...
    /**
     * 
     *                 All line items in a programmatic order must have the same web property code.
     *               
     * 
     */
    DIFFERENT_BACKFILL_WEB_PROPERTY_CODE,
