 ...
 * 
 */
@WebService(name = "CreativeReviewServiceInterface", targetNamespace = "https://www.google.com/apis/ads/publisher/v202302")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CreativeReviewServiceInterface {
     ...
     * @param statement
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202302.CreativeReviewPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202302")
    @RequestWrapper(localName = "getCreativeReviewsByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v202302", className = "com.google.api.ads.admanager.jaxws.v202302.CreativeReviewServiceInterfacegetCreativeReviewsByStatement")
    @ResponseWrapper(localName = "getCreativeReviewsByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v202302", className = "com.google.api.ads.admanager.jaxws.v202302.CreativeReviewServiceInterfacegetCreativeReviewsByStatementResponse")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202302")
    @RequestWrapper(localName = "performCreativeReviewAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v202302", className = "com.google.api.ads.admanager.jaxws.v202302.CreativeReviewServiceInterfaceperformCreativeReviewAction")
    @ResponseWrapper(localName = "performCreativeReviewActionResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v202302", className = "com.google.api.ads.admanager.jaxws.v202302.CreativeReviewServiceInterfaceperformCreativeReviewActionResponse")
    public UpdateResult performCreativeReviewAction(
        @WebParam(name = "creativeReviewAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v202302")
