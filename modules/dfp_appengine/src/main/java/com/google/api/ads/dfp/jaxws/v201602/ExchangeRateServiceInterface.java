...
public interface ExchangeRateServiceInterface {
     ...
     * @param exchangeRates
     * @return
     *     returns java.util.List<com.google.api.ads.dfp.jaxws.v201602.ExchangeRate>
    ...
    public List<ExchangeRate> createExchangeRates(
        @WebParam(name = "exchangeRates", targetNamespace = "https://www.google.com/apis/ads/publisher/v201602")
     ...
     * @return
     *     returns com.google.api.ads.dfp.jaxws.v201602.ExchangeRatePage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201602")
    ...
    public UpdateResult performExchangeRateAction(
        @WebParam(name = "exchangeRateAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v201602")
