 ...
 * 
 */
@WebServiceClient(name = "ReconciliationLineItemReportService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201702", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201702/ReconciliationLineItemReportService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RECONCILIATIONLINEITEMREPORTSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201702", "ReconciliationLineItemReportService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201702/ReconciliationLineItemReportService?wsdl");
    ...
    public ReconciliationLineItemReportServiceInterface getReconciliationLineItemReportServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201702", "ReconciliationLineItemReportServiceInterfacePort"), ReconciliationLineItemReportServiceInterface.class);
    }
    ...
    public ReconciliationLineItemReportServiceInterface getReconciliationLineItemReportServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201702", "ReconciliationLineItemReportServiceInterfacePort"), ReconciliationLineItemReportServiceInterface.class, features);
    }
