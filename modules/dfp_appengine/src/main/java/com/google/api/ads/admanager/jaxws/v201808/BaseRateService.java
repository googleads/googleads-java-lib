 ...
 * 
 */
@WebServiceClient(name = "BaseRateService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201808", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201808/BaseRateService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BASERATESERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201808", "BaseRateService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201808/BaseRateService?wsdl");
    ...
    public BaseRateServiceInterface getBaseRateServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201808", "BaseRateServiceInterfacePort"), BaseRateServiceInterface.class);
    }
    ...
    public BaseRateServiceInterface getBaseRateServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201808", "BaseRateServiceInterfacePort"), BaseRateServiceInterface.class, features);
    }
