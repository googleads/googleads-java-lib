 ...
 * 
 */
@WebService(name = "MobileApplicationServiceInterface", targetNamespace = "https://www.google.com/apis/ads/publisher/v201911")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface MobileApplicationServiceInterface {
     ...
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v201911.MobileApplication>
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201911")
    @RequestWrapper(localName = "createMobileApplications", targetNamespace = "https://www.google.com/apis/ads/publisher/v201911", className = "com.google.api.ads.admanager.jaxws.v201911.MobileApplicationServiceInterfacecreateMobileApplications")
    @ResponseWrapper(localName = "createMobileApplicationsResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201911", className = "com.google.api.ads.admanager.jaxws.v201911.MobileApplicationServiceInterfacecreateMobileApplicationsResponse")
    public List<MobileApplication> createMobileApplications(
        @WebParam(name = "mobileApplications", targetNamespace = "https://www.google.com/apis/ads/publisher/v201911")
     ...
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v201911.MobileApplicationPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201911")
    @RequestWrapper(localName = "getMobileApplicationsByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v201911", className = "com.google.api.ads.admanager.jaxws.v201911.MobileApplicationServiceInterfacegetMobileApplicationsByStatement")
    @ResponseWrapper(localName = "getMobileApplicationsByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201911", className = "com.google.api.ads.admanager.jaxws.v201911.MobileApplicationServiceInterfacegetMobileApplicationsByStatementResponse")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201911")
    @RequestWrapper(localName = "updateMobileApplications", targetNamespace = "https://www.google.com/apis/ads/publisher/v201911", className = "com.google.api.ads.admanager.jaxws.v201911.MobileApplicationServiceInterfaceupdateMobileApplications")
    @ResponseWrapper(localName = "updateMobileApplicationsResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201911", className = "com.google.api.ads.admanager.jaxws.v201911.MobileApplicationServiceInterfaceupdateMobileApplicationsResponse")
