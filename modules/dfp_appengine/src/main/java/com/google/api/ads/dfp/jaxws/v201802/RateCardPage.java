 ...
 *           
 * 
 * <p>Java class for RateCardPage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RateCardPage">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v201802}RateCard" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "RateCardPage", propOrder = {
    "results",
    "startIndex",
    "totalResultSetSize"
})
public class RateCardPage {
    ...
    protected List<RateCard> results;
     ...
     * 
     */
    public List<RateCard> getResults() {
        if (results == null) {
            results = new ArrayList<RateCard>();
        }
        return this.results;
    }
