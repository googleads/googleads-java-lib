 ...
 *           
 * 
 * <p>Java class for MobileApplicationPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202602}MobileApplication" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "MobileApplicationPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class MobileApplicationPage {
    ...
    protected List<MobileApplication> results;
     ...
     * 
     */
    public List<MobileApplication> getResults() {
        if (results == null) {
            results = new ArrayList<MobileApplication>();
        }
        return this.results;
    }
