 ...
 * 
 */
@WebServiceClient(name = "RateCardService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201805/RateCardService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RATECARDSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201805", "RateCardService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201805/RateCardService?wsdl");
    ...
    public RateCardServiceInterface getRateCardServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201805", "RateCardServiceInterfacePort"), RateCardServiceInterface.class);
    }
    ...
    public RateCardServiceInterface getRateCardServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201805", "RateCardServiceInterfacePort"), RateCardServiceInterface.class, features);
    }
