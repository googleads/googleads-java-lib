 ...
 *           
 * 
 * <p>Java class for YieldPartner complex type.
 * 
 ...
 *         &lt;element name="settings" type="{https://www.google.com/apis/ads/publisher/v202602}YieldPartnerSettings" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "YieldPartner", propOrder = {
    "companyId",
    "settings"
})
public class YieldPartner {
     ...
     * {@link YieldPartnerSettings }
     * 
     * 
     */
    public List<YieldPartnerSettings> getSettings() {
        if (settings == null) {
            settings = new ArrayList<YieldPartnerSettings>();
        }
