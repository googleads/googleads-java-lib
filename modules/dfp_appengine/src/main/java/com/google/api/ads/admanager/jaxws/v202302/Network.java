 ...
 *         &lt;element name="childPublishers" type="{https://www.google.com/apis/ads/publisher/v202302}ChildPublisher" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Network {
    ...
    /**
     * Gets the value of the childPublishers property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the childPublishers property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getChildPublishers().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<ChildPublisher> getChildPublishers() {
        if (childPublishers == null) {
            childPublishers = new ArrayList<ChildPublisher>();
        }
