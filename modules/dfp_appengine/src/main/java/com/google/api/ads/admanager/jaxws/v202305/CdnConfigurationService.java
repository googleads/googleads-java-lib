 ...
 * 
 */
@WebServiceClient(name = "CdnConfigurationService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202305", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202305/CdnConfigurationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CDNCONFIGURATIONSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202305", "CdnConfigurationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202305/CdnConfigurationService?wsdl");
    ...
    public CdnConfigurationServiceInterface getCdnConfigurationServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202305", "CdnConfigurationServiceInterfacePort"), CdnConfigurationServiceInterface.class);
    }
    ...
    public CdnConfigurationServiceInterface getCdnConfigurationServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202305", "CdnConfigurationServiceInterfacePort"), CdnConfigurationServiceInterface.class, features);
    }
