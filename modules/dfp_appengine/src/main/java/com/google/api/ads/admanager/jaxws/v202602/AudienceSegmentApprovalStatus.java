...
/**
 * <p>Java class for AudienceSegmentApprovalStatus.
 * 
 ...
 * 
 */
@XmlType(name = "AudienceSegmentApprovalStatus")
@XmlEnum
public enum AudienceSegmentApprovalStatus {
    ...
    public static AudienceSegmentApprovalStatus fromValue(String v) {
        return valueOf(v);
    }
