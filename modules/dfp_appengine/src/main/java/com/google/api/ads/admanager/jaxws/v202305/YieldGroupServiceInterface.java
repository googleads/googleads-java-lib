...
public interface YieldGroupServiceInterface {
     ...
     * @param yieldGroups
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v202305.YieldGroup>
    ...
    public List<YieldGroup> createYieldGroups(
        @WebParam(name = "yieldGroups", targetNamespace = "https://www.google.com/apis/ads/publisher/v202305")
     ...
     * @param statement
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202305.YieldGroupPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202305")
     ...
     * 
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v202305.YieldPartner>
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202305")
