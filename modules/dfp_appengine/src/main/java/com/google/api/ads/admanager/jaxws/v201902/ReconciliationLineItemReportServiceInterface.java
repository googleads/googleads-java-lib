 ...
 * 
 */
@WebService(name = "ReconciliationLineItemReportServiceInterface", targetNamespace = "https://www.google.com/apis/ads/publisher/v201902")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ReconciliationLineItemReportServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v201902.ReconciliationLineItemReportPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201902")
    @RequestWrapper(localName = "getReconciliationLineItemReportsByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v201902", className = "com.google.api.ads.admanager.jaxws.v201902.ReconciliationLineItemReportServiceInterfacegetReconciliationLineItemReportsByStatement")
    @ResponseWrapper(localName = "getReconciliationLineItemReportsByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201902", className = "com.google.api.ads.admanager.jaxws.v201902.ReconciliationLineItemReportServiceInterfacegetReconciliationLineItemReportsByStatementResponse")
     ...
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v201902.ReconciliationLineItemReport>
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201902")
    @RequestWrapper(localName = "updateReconciliationLineItemReports", targetNamespace = "https://www.google.com/apis/ads/publisher/v201902", className = "com.google.api.ads.admanager.jaxws.v201902.ReconciliationLineItemReportServiceInterfaceupdateReconciliationLineItemReports")
    @ResponseWrapper(localName = "updateReconciliationLineItemReportsResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201902", className = "com.google.api.ads.admanager.jaxws.v201902.ReconciliationLineItemReportServiceInterfaceupdateReconciliationLineItemReportsResponse")
    public List<ReconciliationLineItemReport> updateReconciliationLineItemReports(
        @WebParam(name = "reconciliationLineItemReports", targetNamespace = "https://www.google.com/apis/ads/publisher/v201902")
