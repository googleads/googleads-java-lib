 ...
 *           
 * 
 * <p>Java class for DaiEncodingProfilePage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202602}DaiEncodingProfile" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "DaiEncodingProfilePage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class DaiEncodingProfilePage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<DaiEncodingProfile> results;
     ...
     * 
     */
    public List<DaiEncodingProfile> getResults() {
        if (results == null) {
            results = new ArrayList<DaiEncodingProfile>();
        }
        return this.results;
    }
