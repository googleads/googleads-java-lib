 ...
 *           
 * 
 * <p>Java class for ReconciliationReportPage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ReconciliationReportPage">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v201711}ReconciliationReport" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ReconciliationReportPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class ReconciliationReportPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<ReconciliationReport> results;
     ...
     * 
     */
    public List<ReconciliationReport> getResults() {
        if (results == null) {
            results = new ArrayList<ReconciliationReport>();
        }
        return this.results;
    }
