 ...
 *           
 * 
 * <p>Java class for AdRulePage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202602}AdRule" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AdRulePage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class AdRulePage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<AdRule> results;
     ...
     * 
     */
    public List<AdRule> getResults() {
        if (results == null) {
            results = new ArrayList<AdRule>();
        }
        return this.results;
    }
