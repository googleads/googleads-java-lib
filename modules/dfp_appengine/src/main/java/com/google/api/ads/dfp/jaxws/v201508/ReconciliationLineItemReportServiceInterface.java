 ...
 * 
 */
@WebService(name = "ReconciliationLineItemReportServiceInterface", targetNamespace = "https://www.google.com/apis/ads/publisher/v201508")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ReconciliationLineItemReportServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.dfp.jaxws.v201508.ReconciliationLineItemReportPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201508")
    @RequestWrapper(localName = "getReconciliationLineItemReportsByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v201508", className = "com.google.api.ads.dfp.jaxws.v201508.ReconciliationLineItemReportServiceInterfacegetReconciliationLineItemReportsByStatement")
    @ResponseWrapper(localName = "getReconciliationLineItemReportsByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201508", className = "com.google.api.ads.dfp.jaxws.v201508.ReconciliationLineItemReportServiceInterfacegetReconciliationLineItemReportsByStatementResponse")
     ...
     * @return
     *     returns java.util.List<com.google.api.ads.dfp.jaxws.v201508.ReconciliationLineItemReport>
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201508")
    @RequestWrapper(localName = "updateReconciliationLineItemReports", targetNamespace = "https://www.google.com/apis/ads/publisher/v201508", className = "com.google.api.ads.dfp.jaxws.v201508.ReconciliationLineItemReportServiceInterfaceupdateReconciliationLineItemReports")
    @ResponseWrapper(localName = "updateReconciliationLineItemReportsResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201508", className = "com.google.api.ads.dfp.jaxws.v201508.ReconciliationLineItemReportServiceInterfaceupdateReconciliationLineItemReportsResponse")
    public List<ReconciliationLineItemReport> updateReconciliationLineItemReports(
        @WebParam(name = "reconciliationLineItemReports", targetNamespace = "https://www.google.com/apis/ads/publisher/v201508")
