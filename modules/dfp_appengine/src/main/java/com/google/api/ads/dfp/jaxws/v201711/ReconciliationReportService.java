    ...
    extends Service
{
    ...
    private final static QName RECONCILIATIONREPORTSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201711", "ReconciliationReportService");
    ...
    public ReconciliationReportServiceInterface getReconciliationReportServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201711", "ReconciliationReportServiceInterfacePort"), ReconciliationReportServiceInterface.class);
    }
    ...
    public ReconciliationReportServiceInterface getReconciliationReportServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201711", "ReconciliationReportServiceInterfacePort"), ReconciliationReportServiceInterface.class, features);
    }
