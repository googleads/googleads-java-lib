 ...
 * 
 */
@WebServiceClient(name = "UserTeamAssociationService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202211", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202211/UserTeamAssociationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERTEAMASSOCIATIONSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202211", "UserTeamAssociationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202211/UserTeamAssociationService?wsdl");
    ...
    public UserTeamAssociationServiceInterface getUserTeamAssociationServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202211", "UserTeamAssociationServiceInterfacePort"), UserTeamAssociationServiceInterface.class);
    }
    ...
    public UserTeamAssociationServiceInterface getUserTeamAssociationServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202211", "UserTeamAssociationServiceInterfacePort"), UserTeamAssociationServiceInterface.class, features);
    }
