 ...
 * 
 */
@WebServiceClient(name = "ContentMetadataKeyHierarchyService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201602", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201602/ContentMetadataKeyHierarchyService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONTENTMETADATAKEYHIERARCHYSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201602", "ContentMetadataKeyHierarchyService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201602/ContentMetadataKeyHierarchyService?wsdl");
    ...
    public ContentMetadataKeyHierarchyServiceInterface getContentMetadataKeyHierarchyServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201602", "ContentMetadataKeyHierarchyServiceInterfacePort"), ContentMetadataKeyHierarchyServiceInterface.class);
    }
    ...
    public ContentMetadataKeyHierarchyServiceInterface getContentMetadataKeyHierarchyServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201602", "ContentMetadataKeyHierarchyServiceInterfacePort"), ContentMetadataKeyHierarchyServiceInterface.class, features);
    }
