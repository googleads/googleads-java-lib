 ...
 * 
 */
@WebServiceClient(name = "PublisherQueryLanguageService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202008", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202008/PublisherQueryLanguageService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PUBLISHERQUERYLANGUAGESERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202008", "PublisherQueryLanguageService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202008/PublisherQueryLanguageService?wsdl");
    ...
    public PublisherQueryLanguageServiceInterface getPublisherQueryLanguageServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202008", "PublisherQueryLanguageServiceInterfacePort"), PublisherQueryLanguageServiceInterface.class);
    }
    ...
    public PublisherQueryLanguageServiceInterface getPublisherQueryLanguageServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202008", "PublisherQueryLanguageServiceInterfacePort"), PublisherQueryLanguageServiceInterface.class, features);
    }
