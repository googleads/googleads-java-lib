...
public interface MobileApplicationServiceInterface {
     ...
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v202305.MobileApplication>
    ...
    public List<MobileApplication> createMobileApplications(
        @WebParam(name = "mobileApplications", targetNamespace = "https://www.google.com/apis/ads/publisher/v202305")
     ...
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202305.MobileApplicationPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202305")
    ...
    public UpdateResult performMobileApplicationAction(
        @WebParam(name = "mobileApplicationAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v202305")
