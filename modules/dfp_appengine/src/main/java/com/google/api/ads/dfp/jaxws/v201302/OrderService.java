    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201302", "OrderService");
    ...
    public OrderServiceInterface getOrderServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201302", "OrderServiceInterfacePort"), OrderServiceInterface.class);
    }
    ...
    public OrderServiceInterface getOrderServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201302", "OrderServiceInterfacePort"), OrderServiceInterface.class, features);
    }
