...
/**
 * <p>Java class for CompetitiveConstraintScope.
 * 
 ...
 * 
 */
@XmlType(name = "CompetitiveConstraintScope")
@XmlEnum
public enum CompetitiveConstraintScope {
    ...
    public static CompetitiveConstraintScope fromValue(String v) {
        return valueOf(v);
    }
