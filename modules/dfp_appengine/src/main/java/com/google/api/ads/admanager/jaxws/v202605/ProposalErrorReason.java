 ...
 *     &lt;enumeration value="UPDATE_SUPPLY_PATH_NOT_ALLOWED"/&gt;
 *     &lt;enumeration value="BUYER_DISABLED_FOR_AGENCY_DIRECT"/&gt;
...
public enum ProposalErrorReason {
    ...
    /**
     * 
     *                 The supply path type cannot be updated after creation.
     *               
     * 
     */
    UPDATE_SUPPLY_PATH_NOT_ALLOWED,

    /**
     * 
     *                 The buyer is not enabled for agency direct supply path.
     *               
     * 
     */
    BUYER_DISABLED_FOR_AGENCY_DIRECT,
