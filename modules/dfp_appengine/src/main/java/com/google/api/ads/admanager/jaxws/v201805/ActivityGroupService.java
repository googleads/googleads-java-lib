 ...
 * 
 */
@WebServiceClient(name = "ActivityGroupService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201805", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201805/ActivityGroupService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACTIVITYGROUPSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201805", "ActivityGroupService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201805/ActivityGroupService?wsdl");
    ...
    public ActivityGroupServiceInterface getActivityGroupServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201805", "ActivityGroupServiceInterfacePort"), ActivityGroupServiceInterface.class);
    }
    ...
    public ActivityGroupServiceInterface getActivityGroupServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201805", "ActivityGroupServiceInterfacePort"), ActivityGroupServiceInterface.class, features);
    }
