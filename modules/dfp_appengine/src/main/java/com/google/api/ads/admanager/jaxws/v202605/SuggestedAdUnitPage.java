 ...
 *           
 * 
 * <p>Java class for SuggestedAdUnitPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}SuggestedAdUnit" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "SuggestedAdUnitPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class SuggestedAdUnitPage {
    ...
    protected List<SuggestedAdUnit> results;
     ...
     * 
     */
    public List<SuggestedAdUnit> getResults() {
        if (results == null) {
            results = new ArrayList<SuggestedAdUnit>();
        }
        return this.results;
    }
