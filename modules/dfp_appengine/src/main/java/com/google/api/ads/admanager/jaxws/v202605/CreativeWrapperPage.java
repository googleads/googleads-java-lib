 ...
 *           
 * 
 * <p>Java class for CreativeWrapperPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}CreativeWrapper" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CreativeWrapperPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class CreativeWrapperPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<CreativeWrapper> results;
     ...
     * 
     */
    public List<CreativeWrapper> getResults() {
        if (results == null) {
            results = new ArrayList<CreativeWrapper>();
        }
        return this.results;
    }
