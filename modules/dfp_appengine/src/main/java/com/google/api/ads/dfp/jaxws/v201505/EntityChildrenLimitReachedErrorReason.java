 ...
 *     &lt;enumeration value="CUSTOM_TARGETING_VALUES_FOR_FREEFORM_KEY_LIMIT_REACHED"/>
...
public enum EntityChildrenLimitReachedErrorReason {
    ...
    /**
     * 
     *                 The number of custom targeting values for a free-form custom targeting key exceeds the
     *                 max number allowed per free-form custom targeting key in the network.
     *               
     * 
     */
    CUSTOM_TARGETING_VALUES_FOR_FREEFORM_KEY_LIMIT_REACHED,
