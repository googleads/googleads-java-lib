 ...
 * 
 */
@WebServiceClient(name = "UserTeamAssociationService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201208", wsdlLocation = "https://www.google.com/apis/ads/publisher/v201208/UserTeamAssociationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERTEAMASSOCIATIONSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201208", "UserTeamAssociationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://www.google.com/apis/ads/publisher/v201208/UserTeamAssociationService?wsdl");
    ...
    public UserTeamAssociationServiceInterface getUserTeamAssociationServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201208", "UserTeamAssociationServiceInterfacePort"), UserTeamAssociationServiceInterface.class);
    }
    ...
    public UserTeamAssociationServiceInterface getUserTeamAssociationServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201208", "UserTeamAssociationServiceInterfacePort"), UserTeamAssociationServiceInterface.class, features);
    }
