 ...
 * 
 */
@WebServiceClient(name = "CreativeReviewService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202311", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202311/CreativeReviewService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CREATIVEREVIEWSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202311", "CreativeReviewService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202311/CreativeReviewService?wsdl");
    ...
    public CreativeReviewServiceInterface getCreativeReviewServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202311", "CreativeReviewServiceInterfacePort"), CreativeReviewServiceInterface.class);
    }
    ...
    public CreativeReviewServiceInterface getCreativeReviewServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202311", "CreativeReviewServiceInterfacePort"), CreativeReviewServiceInterface.class, features);
    }
