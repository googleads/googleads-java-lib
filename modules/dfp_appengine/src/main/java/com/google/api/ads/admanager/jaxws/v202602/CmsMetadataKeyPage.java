 ...
 *           
 * 
 * <p>Java class for CmsMetadataKeyPage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CmsMetadataKeyPage"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202602}CmsMetadataKey" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CmsMetadataKeyPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class CmsMetadataKeyPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<CmsMetadataKey> results;
     ...
     * 
     */
    public List<CmsMetadataKey> getResults() {
        if (results == null) {
            results = new ArrayList<CmsMetadataKey>();
        }
        return this.results;
    }
