 ...
 *           
 * 
 * <p>Java class for CustomFieldPage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CustomFieldPage"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}CustomField" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CustomFieldPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class CustomFieldPage {
    ...
    public List<CustomField> getResults() {
        if (results == null) {
            results = new ArrayList<CustomField>();
        }
        return this.results;
    }
