...
public interface ContentBundleServiceInterface {
     ...
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v201905.ContentBundle>
    ...
    public List<ContentBundle> createContentBundles(
        @WebParam(name = "contentBundles", targetNamespace = "https://www.google.com/apis/ads/publisher/v201905")
     ...
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v201905.ContentBundlePage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201905")
    ...
    public UpdateResult performContentBundleAction(
        @WebParam(name = "contentBundleAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v201905")
