...
public interface NativeStyleServiceInterface {
     ...
     * @param nativeStyles
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v202308.NativeStyle>
    ...
    public List<NativeStyle> createNativeStyles(
        @WebParam(name = "nativeStyles", targetNamespace = "https://www.google.com/apis/ads/publisher/v202308")
     ...
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202308.NativeStylePage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202308")
    ...
    public UpdateResult performNativeStyleAction(
        @WebParam(name = "nativeStyleAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v202308")
