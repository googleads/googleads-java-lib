 ...
 *           
 * 
 * <p>Java class for CustomTargetingValuePage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}CustomTargetingValue" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CustomTargetingValuePage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class CustomTargetingValuePage {
    ...
    protected List<CustomTargetingValue> results;
     ...
     * 
     */
    public List<CustomTargetingValue> getResults() {
        if (results == null) {
            results = new ArrayList<CustomTargetingValue>();
        }
        return this.results;
    }
