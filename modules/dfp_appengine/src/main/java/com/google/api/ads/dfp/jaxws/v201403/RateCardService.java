    ...
    extends Service
{
    ...
    private final static QName RATECARDSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201403", "RateCardService");
    ...
    public RateCardServiceInterface getRateCardServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201403", "RateCardServiceInterfacePort"), RateCardServiceInterface.class);
    }
    ...
    public RateCardServiceInterface getRateCardServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201403", "RateCardServiceInterfacePort"), RateCardServiceInterface.class, features);
    }
