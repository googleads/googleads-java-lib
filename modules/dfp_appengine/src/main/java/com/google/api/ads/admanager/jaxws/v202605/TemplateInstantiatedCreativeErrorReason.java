 ...
 *     &lt;enumeration value="INVALID_LIST_VARIABLE_VALUE"/&gt;
...
public enum TemplateInstantiatedCreativeErrorReason {
    ...
    /**
     * 
     *                 The value of a list variable is not in the list of choices, and custom values are not
     *                 allowed.
     *               
     * 
     */
    INVALID_LIST_VARIABLE_VALUE,
