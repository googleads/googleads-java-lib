 ...
 *           
 * 
 * <p>Java class for TargetingPresetPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202602}TargetingPreset" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "TargetingPresetPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class TargetingPresetPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<TargetingPreset> results;
     ...
     * 
     */
    public List<TargetingPreset> getResults() {
        if (results == null) {
            results = new ArrayList<TargetingPreset>();
        }
        return this.results;
    }
