 ...
 * 
 */
@WebServiceClient(name = "ProductPackageService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201505", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201505/ProductPackageService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTPACKAGESERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201505", "ProductPackageService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201505/ProductPackageService?wsdl");
    ...
    public ProductPackageServiceInterface getProductPackageServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201505", "ProductPackageServiceInterfacePort"), ProductPackageServiceInterface.class);
    }
    ...
    public ProductPackageServiceInterface getProductPackageServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201505", "ProductPackageServiceInterfacePort"), ProductPackageServiceInterface.class, features);
    }
