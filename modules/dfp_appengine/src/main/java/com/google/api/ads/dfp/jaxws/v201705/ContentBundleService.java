 ...
 * 
 */
@WebServiceClient(name = "ContentBundleService", targetNamespace = "https://www.google.com/apis/ads/publisher/v201705", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v201705/ContentBundleService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONTENTBUNDLESERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v201705", "ContentBundleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v201705/ContentBundleService?wsdl");
    ...
    public ContentBundleServiceInterface getContentBundleServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201705", "ContentBundleServiceInterfacePort"), ContentBundleServiceInterface.class);
    }
    ...
    public ContentBundleServiceInterface getContentBundleServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v201705", "ContentBundleServiceInterfacePort"), ContentBundleServiceInterface.class, features);
    }
