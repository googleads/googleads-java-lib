 ...
 * 
 */
@WebServiceClient(name = "LiveStreamEventService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202308", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202308/LiveStreamEventService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LIVESTREAMEVENTSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202308", "LiveStreamEventService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202308/LiveStreamEventService?wsdl");
    ...
    public LiveStreamEventServiceInterface getLiveStreamEventServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202308", "LiveStreamEventServiceInterfacePort"), LiveStreamEventServiceInterface.class);
    }
    ...
    public LiveStreamEventServiceInterface getLiveStreamEventServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202308", "LiveStreamEventServiceInterfacePort"), LiveStreamEventServiceInterface.class, features);
    }
