 ...
 *           
 * 
 * <p>Java class for CreativePage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}Creative" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CreativePage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class CreativePage {
    ...
    protected List<Creative> results;
     ...
     * 
     */
    public List<Creative> getResults() {
        if (results == null) {
            results = new ArrayList<Creative>();
        }
        return this.results;
    }
