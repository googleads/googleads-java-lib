 ...
 * 
 */
@WebServiceClient(name = "LineItemService", targetNamespace = "https://www.google.com/apis/ads/publisher/v202002", wsdlLocation = "https://ads.google.com/apis/ads/publisher/v202002/LineItemService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LINEITEMSERVICE_QNAME = new QName("https://www.google.com/apis/ads/publisher/v202002", "LineItemService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ads.google.com/apis/ads/publisher/v202002/LineItemService?wsdl");
    ...
    public LineItemServiceInterface getLineItemServiceInterfacePort() {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202002", "LineItemServiceInterfacePort"), LineItemServiceInterface.class);
    }
    ...
    public LineItemServiceInterface getLineItemServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.google.com/apis/ads/publisher/v202002", "LineItemServiceInterfacePort"), LineItemServiceInterface.class, features);
    }
