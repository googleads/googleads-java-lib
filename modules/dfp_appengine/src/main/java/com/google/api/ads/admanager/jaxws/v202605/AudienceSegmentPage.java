 ...
 *           
 * 
 * <p>Java class for AudienceSegmentPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}AudienceSegment" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AudienceSegmentPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class AudienceSegmentPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<AudienceSegment> results;
     ...
     * 
     */
    public List<AudienceSegment> getResults() {
        if (results == null) {
            results = new ArrayList<AudienceSegment>();
        }
        return this.results;
    }
