 ...
 *         &lt;element name="status" type="{https://www.google.com/apis/ads/publisher/v202605}ContentBundleStatus" minOccurs="0"/&gt;
...
@XmlType(name = "ContentBundle", propOrder = {
    "id",
    "name",
    "status",
...
public class ContentBundle {
     ...
     * @return
     *     possible object is
     *     {@link ContentBundleStatus }
     *     
     */
    public ContentBundleStatus getStatus() {
        return status;
    }
     ...
     *     
     */
    public void setStatus(ContentBundleStatus value) {
        this.status = value;
    }
