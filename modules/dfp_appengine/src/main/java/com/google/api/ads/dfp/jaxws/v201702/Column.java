...
public enum Column {
    ...
    /**
     * 
     *                 The number of impressions delivered by the ad server on shared inventory unit in a partner's
     *                 network.
     *                 <p>
     *                 This field is deprecated in favor of partner management metrics e.g.,
     *                 {@link #PARTNER_MANAGEMENT_HOST_IMPRESSIONS}.
     *               
     * 
     */
    ...
    /**
     * 
     *                 The number of clicks delivered by the ad server on shared inventory unit in a partner's
     *                 network.
     *                 <p>
     *                 This field is deprecated in favor of partner management metrics e.g.,
     *                 {@link #PARTNER_MANAGEMENT_HOST_CLICKS}.
     *               
     * 
     */
    ...
    /**
     * 
     *                 The CTR for an ad delivered by the ad server on shared inventory unit in a partner's network.
     *                 <p>
     *                 This field is deprecated in favor of partner management metrics e.g.,
     *                 {@link #PARTNER_MANAGEMENT_HOST_CTR}.
     *               
     * 
     */
    ...
    /**
     * 
     *                 The number of partner network impressions a dynamic allocation ad delivered when no {@link
     *                 LineItem} reservation could be found by the ad server for shared inventory-level dynamic
     *                 allocation. For premium networks, this includes line item-level dynamic allocation as well.
     *                 <p>
     *                 This field is deprecated in favor of partner management metrics e.g.,
     *                 {@link #PARTNER_MANAGEMENT_HOST_IMPRESSIONS}.
     *               
    ...
    /**
     * 
     *                 Ad impressions (legacy) on mapped Ad Exchange properties. In the case of text ads, you may have
     *                 one matched request which yields more than one ad impression, since multiple text ads can serve
     *                 in place of one display ad.
     *               
     * 
     */
    ...
    /**
     * 
     *                 The viewable rate of Active View impressions generated by Ad Exchange properties linked to DFP.
     *                 
     *                 <p><b>This experimental column only works with Ad Exchange web properties linked with an active
     *                 status.</b>
     *               
     ...
     *                 including inventory-level dynamic allocation on shared inventory units.
     *                 <p>
     *                 This field is deprecated in favor of partner management metrics e.g.,
     *                 {@link #PARTNER_MANAGEMENT_UNFILLED_IMPRESSIONS}.
     *               
     * 
     */
