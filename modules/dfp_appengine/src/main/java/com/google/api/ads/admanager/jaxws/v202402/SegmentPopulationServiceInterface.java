...
public interface SegmentPopulationServiceInterface {
     ...
     * @return
     *     returns java.util.List<com.google.api.ads.admanager.jaxws.v202402.SegmentPopulationResults>
    ...
    public List<SegmentPopulationResults> getSegmentPopulationResultsByIds(
        @WebParam(name = "batchUploadIds", targetNamespace = "https://www.google.com/apis/ads/publisher/v202402")
     ...
     * @param updateRequest
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202402.SegmentPopulationResponse
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202402")
    ...
    public SegmentPopulationResponse updateSegmentMemberships(
        @WebParam(name = "updateRequest", targetNamespace = "https://www.google.com/apis/ads/publisher/v202402")
