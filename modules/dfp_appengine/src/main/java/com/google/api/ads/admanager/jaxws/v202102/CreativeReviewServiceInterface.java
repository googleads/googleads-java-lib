 ...
 * 
 */
@WebService(name = "CreativeReviewServiceInterface", targetNamespace = "https://www.google.com/apis/ads/publisher/v202102")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CreativeReviewServiceInterface {
     ...
     * @param statement
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202102.CreativeReviewPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202102")
    @RequestWrapper(localName = "getCreativeReviewsByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v202102", className = "com.google.api.ads.admanager.jaxws.v202102.CreativeReviewServiceInterfacegetCreativeReviewsByStatement")
    @ResponseWrapper(localName = "getCreativeReviewsByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v202102", className = "com.google.api.ads.admanager.jaxws.v202102.CreativeReviewServiceInterfacegetCreativeReviewsByStatementResponse")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202102")
    @RequestWrapper(localName = "performCreativeReviewAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v202102", className = "com.google.api.ads.admanager.jaxws.v202102.CreativeReviewServiceInterfaceperformCreativeReviewAction")
    @ResponseWrapper(localName = "performCreativeReviewActionResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v202102", className = "com.google.api.ads.admanager.jaxws.v202102.CreativeReviewServiceInterfaceperformCreativeReviewActionResponse")
    public UpdateResult performCreativeReviewAction(
        @WebParam(name = "creativeReviewAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v202102")
