...
/**
 * 
 *             An error that occurs for an internal Ad Manager process that happens in the background. For
 *             example, {@link Proposal} workflows can have background tasks that may have offline errors.
 *           
 * 
 * <p>Java class for OfflineError complex type.
 * 
 ...
 *         &lt;element name="errorTime" type="{https://www.google.com/apis/ads/publisher/v201808}DateTime" minOccurs="0"/>
...
@XmlType(name = "OfflineError", propOrder = {
    "fieldPath",
    "trigger",
    "errorTime",
    "reason"
...
public class OfflineError {
     ...
     *     
     */
    public void setErrorTime(DateTime value) {
