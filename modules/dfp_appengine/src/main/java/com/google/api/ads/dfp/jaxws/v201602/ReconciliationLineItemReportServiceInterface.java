 ...
 * 
 */
@WebService(name = "ReconciliationLineItemReportServiceInterface", targetNamespace = "https://www.google.com/apis/ads/publisher/v201602")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ReconciliationLineItemReportServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.dfp.jaxws.v201602.ReconciliationLineItemReportPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201602")
    @RequestWrapper(localName = "getReconciliationLineItemReportsByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v201602", className = "com.google.api.ads.dfp.jaxws.v201602.ReconciliationLineItemReportServiceInterfacegetReconciliationLineItemReportsByStatement")
    @ResponseWrapper(localName = "getReconciliationLineItemReportsByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201602", className = "com.google.api.ads.dfp.jaxws.v201602.ReconciliationLineItemReportServiceInterfacegetReconciliationLineItemReportsByStatementResponse")
     ...
     * @return
     *     returns java.util.List<com.google.api.ads.dfp.jaxws.v201602.ReconciliationLineItemReport>
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v201602")
    @RequestWrapper(localName = "updateReconciliationLineItemReports", targetNamespace = "https://www.google.com/apis/ads/publisher/v201602", className = "com.google.api.ads.dfp.jaxws.v201602.ReconciliationLineItemReportServiceInterfaceupdateReconciliationLineItemReports")
    @ResponseWrapper(localName = "updateReconciliationLineItemReportsResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v201602", className = "com.google.api.ads.dfp.jaxws.v201602.ReconciliationLineItemReportServiceInterfaceupdateReconciliationLineItemReportsResponse")
    public List<ReconciliationLineItemReport> updateReconciliationLineItemReports(
        @WebParam(name = "reconciliationLineItemReports", targetNamespace = "https://www.google.com/apis/ads/publisher/v201602")
