 ...
 *           
 * 
 * <p>Java class for BreakTemplatePage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}BreakTemplate" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "BreakTemplatePage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class BreakTemplatePage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<BreakTemplate> results;
     ...
     * 
     */
    public List<BreakTemplate> getResults() {
        if (results == null) {
            results = new ArrayList<BreakTemplate>();
        }
        return this.results;
    }
