 ...
 *           
 * 
 * <p>Java class for CdnConfigurationPage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202605}CdnConfiguration" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CdnConfigurationPage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class CdnConfigurationPage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<CdnConfiguration> results;
     ...
     * 
     */
    public List<CdnConfiguration> getResults() {
        if (results == null) {
            results = new ArrayList<CdnConfiguration>();
        }
        return this.results;
    }
