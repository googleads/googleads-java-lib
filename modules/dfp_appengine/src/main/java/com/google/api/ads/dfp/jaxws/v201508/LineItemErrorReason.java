 ...
 *     &lt;enumeration value="SYSTEM_DEFINED_TEMPLATE_REQUIRED"/>
...
public enum LineItemErrorReason {
    ...
    /**
     * 
     *                 For AdX backfill line items, native placeholders can only contain system-defined
     *                 native creative templates.
     *               
     * 
     */
    SYSTEM_DEFINED_TEMPLATE_REQUIRED,
