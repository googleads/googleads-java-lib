 ...
 * 
 */
@WebService(name = "CreativeReviewServiceInterface", targetNamespace = "https://www.google.com/apis/ads/publisher/v202008")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CreativeReviewServiceInterface {
     ...
     * @param statement
     * @return
     *     returns com.google.api.ads.admanager.jaxws.v202008.CreativeReviewPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202008")
    @RequestWrapper(localName = "getCreativeReviewsByStatement", targetNamespace = "https://www.google.com/apis/ads/publisher/v202008", className = "com.google.api.ads.admanager.jaxws.v202008.CreativeReviewServiceInterfacegetCreativeReviewsByStatement")
    @ResponseWrapper(localName = "getCreativeReviewsByStatementResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v202008", className = "com.google.api.ads.admanager.jaxws.v202008.CreativeReviewServiceInterfacegetCreativeReviewsByStatementResponse")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://www.google.com/apis/ads/publisher/v202008")
    @RequestWrapper(localName = "performCreativeReviewAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v202008", className = "com.google.api.ads.admanager.jaxws.v202008.CreativeReviewServiceInterfaceperformCreativeReviewAction")
    @ResponseWrapper(localName = "performCreativeReviewActionResponse", targetNamespace = "https://www.google.com/apis/ads/publisher/v202008", className = "com.google.api.ads.admanager.jaxws.v202008.CreativeReviewServiceInterfaceperformCreativeReviewActionResponse")
    public UpdateResult performCreativeReviewAction(
        @WebParam(name = "creativeReviewAction", targetNamespace = "https://www.google.com/apis/ads/publisher/v202008")
