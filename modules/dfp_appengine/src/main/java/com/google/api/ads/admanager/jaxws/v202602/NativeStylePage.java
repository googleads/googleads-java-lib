 ...
 *           
 * 
 * <p>Java class for NativeStylePage complex type.
 * 
 ...
 *         &lt;element name="results" type="{https://www.google.com/apis/ads/publisher/v202602}NativeStyle" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "NativeStylePage", propOrder = {
    "totalResultSetSize",
    "startIndex",
    "results"
})
public class NativeStylePage {

    protected Integer totalResultSetSize;
    protected Integer startIndex;
    protected List<NativeStyle> results;
     ...
     * 
     */
    public List<NativeStyle> getResults() {
        if (results == null) {
            results = new ArrayList<NativeStyle>();
        }
        return this.results;
    }
