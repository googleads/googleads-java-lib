...
public class DateTimesTest {
  ...
  private com.google.api.ads.admanager.jaxws.v202508.DateTime apiDateTime1;
  private com.google.api.ads.admanager.jaxws.v202508.DateTime apiDateTime2;
  private com.google.api.ads.admanager.jaxws.v202508.DateTime apiDateTime3;
  ...
  public void setUp() throws Exception {
    apiDateTime1 = new com.google.api.ads.admanager.jaxws.v202508.DateTime();
    Date apiDate1 = new Date();
    ...
    apiDateTime2 = new com.google.api.ads.admanager.jaxws.v202508.DateTime();
    Date apiDate2 = new Date();
    ...
    apiDateTime3 = new com.google.api.ads.admanager.jaxws.v202508.DateTime();
    Date apiDate3 = new Date();
  ...
  private static void assertEquals(
      com.google.api.ads.admanager.jaxws.v202508.DateTime expected,
      com.google.api.ads.admanager.jaxws.v202508.DateTime actual) {
    boolean equals =
        expected == actual
            || new EqualsBuilder()
  ...
  private static String toString(com.google.api.ads.admanager.jaxws.v202508.DateTime apiDateTime) {
    return apiDateTime == null
        ? "null"
        : "Year ("
            + apiDateTime.getDate().getYear()
            + " ) "
            + "Month ("
            + apiDateTime.getDate().getMonth()
            + ") "
            + "Day ("
            + apiDateTime.getDate().getDay()
            + ") "
            + "Hour ("
            + apiDateTime.getHour()
            + ") "
            + "Minute ("
            + apiDateTime.getMinute()
            + ") "
            + "Second ("
            + apiDateTime.getSecond()
            + ") "
            + "TimeZoneId ("
            + apiDateTime.getTimeZoneId()
            + ") ";
  }
}
