 ...
 * 
 */
@WebServiceClient(name = "AdGroupAdService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201809/AdGroupAdService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPADSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201809", "AdGroupAdService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201809/AdGroupAdService?wsdl");
    ...
    public AdGroupAdServiceInterface getAdGroupAdServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201809", "AdGroupAdServiceInterfacePort"), AdGroupAdServiceInterface.class);
    }
    ...
    public AdGroupAdServiceInterface getAdGroupAdServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201809", "AdGroupAdServiceInterfacePort"), AdGroupAdServiceInterface.class, features);
    }
