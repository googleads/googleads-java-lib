 ...
 *         &lt;sequence>
 *           &lt;element name="operations" type="{https://adwords.google.com/api/adwords/cm/v201710}OfflineCallConversionFeedOperation" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/sequence>
 *       &lt;/restriction>
 *     &lt;/complexContent>
 *   &lt;/complexType>
...
public class OfflineCallConversionFeedServiceInterfacemutate {

    protected List<OfflineCallConversionFeedOperation> operations;
     ...
     * {@link OfflineCallConversionFeedOperation }
     * 
     * 
     */
    public List<OfflineCallConversionFeedOperation> getOperations() {
        if (operations == null) {
            operations = new ArrayList<OfflineCallConversionFeedOperation>();
        }
