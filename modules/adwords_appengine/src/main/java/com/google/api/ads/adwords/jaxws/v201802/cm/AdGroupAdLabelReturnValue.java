 ...
 *       &lt;sequence>
 *         &lt;element name="value" type="{https://adwords.google.com/api/adwords/cm/v201802}AdGroupAdLabel" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends ListReturnValue
{
    ...
    protected List<AdGroupAdLabel> value;
     ...
     * 
     */
    public List<AdGroupAdLabel> getValue() {
        if (value == null) {
            value = new ArrayList<AdGroupAdLabel>();
        }
        return this.value;
    }
