 ...
 * 
 */
@WebService(name = "TargetingIdeaServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/o/v201402")
@XmlSeeAlso({
...
public interface TargetingIdeaServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201402.o.TargetingIdeaPage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/o/v201402")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/o/v201402", className = "com.google.api.ads.adwords.jaxws.v201402.o.TargetingIdeaServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/o/v201402", className = "com.google.api.ads.adwords.jaxws.v201402.o.TargetingIdeaServiceInterfacegetResponse")
    public TargetingIdeaPage get(
        @WebParam(name = "selector", targetNamespace = "https://adwords.google.com/api/adwords/o/v201402")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/o/v201402")
    @RequestWrapper(localName = "getBulkKeywordIdeas", targetNamespace = "https://adwords.google.com/api/adwords/o/v201402", className = "com.google.api.ads.adwords.jaxws.v201402.o.TargetingIdeaServiceInterfacegetBulkKeywordIdeas")
    @ResponseWrapper(localName = "getBulkKeywordIdeasResponse", targetNamespace = "https://adwords.google.com/api/adwords/o/v201402", className = "com.google.api.ads.adwords.jaxws.v201402.o.TargetingIdeaServiceInterfacegetBulkKeywordIdeasResponse")
