 ...
 * 
 */
@WebService(name = "CampaignGroupServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CampaignGroupServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201809.cm.CampaignGroupPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.cm.CampaignGroupServiceInterfaceget")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201809.cm.CampaignGroupReturnValue
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.cm.CampaignGroupServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.cm.CampaignGroupServiceInterfacemutateResponse")
