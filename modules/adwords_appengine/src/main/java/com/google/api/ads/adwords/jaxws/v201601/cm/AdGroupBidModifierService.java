 ...
 * 
 */
@WebServiceClient(name = "AdGroupBidModifierService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201601", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201601/AdGroupBidModifierService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPBIDMODIFIERSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201601", "AdGroupBidModifierService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201601/AdGroupBidModifierService?wsdl");
    ...
    public AdGroupBidModifierServiceInterface getAdGroupBidModifierServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201601", "AdGroupBidModifierServiceInterfacePort"), AdGroupBidModifierServiceInterface.class);
    }
    ...
    public AdGroupBidModifierServiceInterface getAdGroupBidModifierServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201601", "AdGroupBidModifierServiceInterfacePort"), AdGroupBidModifierServiceInterface.class, features);
    }
