 ...
 *         &lt;element name="entries" type="{https://adwords.google.com/api/adwords/o/v201402}TargetingIdea" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TargetingIdeaPage {
    ...
    protected List<TargetingIdea> entries;
     ...
     * 
     */
    public List<TargetingIdea> getEntries() {
        if (entries == null) {
            entries = new ArrayList<TargetingIdea>();
        }
        return this.entries;
    }
