 ...
 * 
 */
@WebService(name = "AdGroupAdServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201306")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface AdGroupAdServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201306.cm.AdGroupAdPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201306")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201306", className = "com.google.api.ads.adwords.jaxws.v201306.cm.AdGroupAdServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201306", className = "com.google.api.ads.adwords.jaxws.v201306.cm.AdGroupAdServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201306.cm.AdGroupAdReturnValue
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201306")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201306", className = "com.google.api.ads.adwords.jaxws.v201306.cm.AdGroupAdServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201306", className = "com.google.api.ads.adwords.jaxws.v201306.cm.AdGroupAdServiceInterfacemutateResponse")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201306")
    @RequestWrapper(localName = "query", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201306", className = "com.google.api.ads.adwords.jaxws.v201306.cm.AdGroupAdServiceInterfacequery")
    @ResponseWrapper(localName = "queryResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201306", className = "com.google.api.ads.adwords.jaxws.v201306.cm.AdGroupAdServiceInterfacequeryResponse")
