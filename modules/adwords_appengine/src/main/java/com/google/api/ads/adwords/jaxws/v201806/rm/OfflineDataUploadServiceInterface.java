 ...
 * 
 */
@WebService(name = "OfflineDataUploadServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201806")
@XmlSeeAlso({
...
public interface OfflineDataUploadServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201806.rm.OfflineDataUploadPage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201806")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201806", className = "com.google.api.ads.adwords.jaxws.v201806.rm.OfflineDataUploadServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201806", className = "com.google.api.ads.adwords.jaxws.v201806.rm.OfflineDataUploadServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201806.rm.OfflineDataUploadReturnValue
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201806")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201806", className = "com.google.api.ads.adwords.jaxws.v201806.rm.OfflineDataUploadServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201806", className = "com.google.api.ads.adwords.jaxws.v201806.rm.OfflineDataUploadServiceInterfacemutateResponse")
