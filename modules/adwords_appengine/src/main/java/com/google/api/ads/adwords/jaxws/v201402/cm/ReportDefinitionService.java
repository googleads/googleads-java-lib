 ...
 * 
 */
@WebServiceClient(name = "ReportDefinitionService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201402", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201402/ReportDefinitionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTDEFINITIONSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201402", "ReportDefinitionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201402/ReportDefinitionService?wsdl");
    ...
    public ReportDefinitionServiceInterface getReportDefinitionServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201402", "ReportDefinitionServiceInterfacePort"), ReportDefinitionServiceInterface.class);
    }
    ...
    public ReportDefinitionServiceInterface getReportDefinitionServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201402", "ReportDefinitionServiceInterfacePort"), ReportDefinitionServiceInterface.class, features);
    }
