 ...
 * 
 */
@WebServiceClient(name = "CampaignSharedSetService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201306", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201306/CampaignSharedSetService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNSHAREDSETSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201306", "CampaignSharedSetService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201306/CampaignSharedSetService?wsdl");
    ...
    public CampaignSharedSetServiceInterface getCampaignSharedSetServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201306", "CampaignSharedSetServiceInterfacePort"), CampaignSharedSetServiceInterface.class);
    }
    ...
    public CampaignSharedSetServiceInterface getCampaignSharedSetServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201306", "CampaignSharedSetServiceInterfacePort"), CampaignSharedSetServiceInterface.class, features);
    }
