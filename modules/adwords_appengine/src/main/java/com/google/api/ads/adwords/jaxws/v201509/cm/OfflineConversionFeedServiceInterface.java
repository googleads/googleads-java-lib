 ...
 * 
 */
@WebService(name = "OfflineConversionFeedServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface OfflineConversionFeedServiceInterface {
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201509.cm.OfflineConversionFeedReturnValue
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509", className = "com.google.api.ads.adwords.jaxws.v201509.cm.OfflineConversionFeedServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509", className = "com.google.api.ads.adwords.jaxws.v201509.cm.OfflineConversionFeedServiceInterfacemutateResponse")
