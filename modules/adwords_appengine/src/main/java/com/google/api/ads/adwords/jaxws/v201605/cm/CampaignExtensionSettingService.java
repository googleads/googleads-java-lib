 ...
 * 
 */
@WebServiceClient(name = "CampaignExtensionSettingService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201605", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201605/CampaignExtensionSettingService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNEXTENSIONSETTINGSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201605", "CampaignExtensionSettingService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201605/CampaignExtensionSettingService?wsdl");
    ...
    public CampaignExtensionSettingServiceInterface getCampaignExtensionSettingServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201605", "CampaignExtensionSettingServiceInterfacePort"), CampaignExtensionSettingServiceInterface.class);
    }
    ...
    public CampaignExtensionSettingServiceInterface getCampaignExtensionSettingServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201605", "CampaignExtensionSettingServiceInterfacePort"), CampaignExtensionSettingServiceInterface.class, features);
    }
