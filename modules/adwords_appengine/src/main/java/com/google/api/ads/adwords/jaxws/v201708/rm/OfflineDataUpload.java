 ...
 *       &lt;sequence>
 *         &lt;element name="uploadId" type="{http://www.w3.org/2001/XMLSchema}long" minOccurs="0"/>
 *         &lt;element name="externalUploadId" type="{http://www.w3.org/2001/XMLSchema}long" minOccurs="0"/>
 *         &lt;element name="uploadType" type="{https://adwords.google.com/api/adwords/rm/v201708}OfflineDataUploadType" minOccurs="0"/>
 *         &lt;element name="uploadStatus" type="{https://adwords.google.com/api/adwords/rm/v201708}OfflineDataUploadStatus" minOccurs="0"/>
 *         &lt;element name="uploadMetadata" type="{https://adwords.google.com/api/adwords/rm/v201708}UploadMetadata" minOccurs="0"/>
 *         &lt;element name="offlineDataList" type="{https://adwords.google.com/api/adwords/rm/v201708}OfflineData" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="partialDataErrors" type="{https://adwords.google.com/api/adwords/cm/v201708}ApiError" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="failureReason" type="{https://adwords.google.com/api/adwords/rm/v201708}OfflineDataUploadFailureReason" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OfflineDataUpload {
    ...
    protected List<ApiError> partialDataErrors;
    @XmlSchemaType(name = "string")
    ...
    /**
     * Gets the value of the partialDataErrors property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the partialDataErrors property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPartialDataErrors().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ApiError> getPartialDataErrors() {
        if (partialDataErrors == null) {
            partialDataErrors = new ArrayList<ApiError>();
        }
