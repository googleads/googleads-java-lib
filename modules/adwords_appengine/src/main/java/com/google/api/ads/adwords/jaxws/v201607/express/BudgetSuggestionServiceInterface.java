 ...
 * 
 */
@WebService(name = "BudgetSuggestionServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607")
@XmlSeeAlso({
...
public interface BudgetSuggestionServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201607.express.BudgetSuggestion
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607", className = "com.google.api.ads.adwords.jaxws.v201607.express.BudgetSuggestionServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607", className = "com.google.api.ads.adwords.jaxws.v201607.express.BudgetSuggestionServiceInterfacegetResponse")
