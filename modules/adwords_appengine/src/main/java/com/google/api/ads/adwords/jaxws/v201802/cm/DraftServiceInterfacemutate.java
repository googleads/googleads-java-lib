 ...
 *         &lt;sequence>
 *           &lt;element name="operations" type="{https://adwords.google.com/api/adwords/cm/v201802}DraftOperation" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/sequence>
 *       &lt;/restriction>
 *     &lt;/complexContent>
 *   &lt;/complexType>
...
public class DraftServiceInterfacemutate {

    protected List<DraftOperation> operations;
     ...
     * 
     */
    public List<DraftOperation> getOperations() {
        if (operations == null) {
            operations = new ArrayList<DraftOperation>();
        }
