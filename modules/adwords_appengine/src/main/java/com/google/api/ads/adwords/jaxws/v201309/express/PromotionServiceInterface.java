 ...
 * 
 */
@WebService(name = "PromotionServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/express/v201309")
@XmlSeeAlso({
...
public interface PromotionServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201309.express.PromotionPage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201309")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/express/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.express.PromotionServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.express.PromotionServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns java.util.List<com.google.api.ads.adwords.jaxws.v201309.express.Promotion>
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201309")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/express/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.express.PromotionServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.express.PromotionServiceInterfacemutateResponse")
