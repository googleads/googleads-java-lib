 ...
 * 
 */
@WebServiceClient(name = "AdGroupBidModifierService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201710", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201710/AdGroupBidModifierService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPBIDMODIFIERSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201710", "AdGroupBidModifierService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201710/AdGroupBidModifierService?wsdl");
    ...
    public AdGroupBidModifierServiceInterface getAdGroupBidModifierServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201710", "AdGroupBidModifierServiceInterfacePort"), AdGroupBidModifierServiceInterface.class);
    }
    ...
    public AdGroupBidModifierServiceInterface getAdGroupBidModifierServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201710", "AdGroupBidModifierServiceInterfacePort"), AdGroupBidModifierServiceInterface.class, features);
    }
