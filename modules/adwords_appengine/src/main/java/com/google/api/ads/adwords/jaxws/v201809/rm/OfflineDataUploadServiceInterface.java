 ...
 * 
 */
@WebService(name = "OfflineDataUploadServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201809")
@XmlSeeAlso({
...
public interface OfflineDataUploadServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201809.rm.OfflineDataUploadPage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201809")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.rm.OfflineDataUploadServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.rm.OfflineDataUploadServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201809.rm.OfflineDataUploadReturnValue
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201809")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.rm.OfflineDataUploadServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.rm.OfflineDataUploadServiceInterfacemutateResponse")
