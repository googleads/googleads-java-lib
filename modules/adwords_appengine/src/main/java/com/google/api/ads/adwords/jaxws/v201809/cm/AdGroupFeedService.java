 ...
 * 
 */
@WebServiceClient(name = "AdGroupFeedService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201809/AdGroupFeedService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPFEEDSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201809", "AdGroupFeedService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201809/AdGroupFeedService?wsdl");
    ...
    public AdGroupFeedServiceInterface getAdGroupFeedServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201809", "AdGroupFeedServiceInterfacePort"), AdGroupFeedServiceInterface.class);
    }
    ...
    public AdGroupFeedServiceInterface getAdGroupFeedServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201809", "AdGroupFeedServiceInterfacePort"), AdGroupFeedServiceInterface.class, features);
    }
