 ...
 *       &lt;sequence>
 *         &lt;element name="value" type="{https://adwords.google.com/api/adwords/cm/v201802}AdGroupCriterionLabel" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends ListReturnValue
{
    ...
    protected List<AdGroupCriterionLabel> value;
     ...
     * 
     */
    public List<AdGroupCriterionLabel> getValue() {
        if (value == null) {
            value = new ArrayList<AdGroupCriterionLabel>();
        }
        return this.value;
    }
