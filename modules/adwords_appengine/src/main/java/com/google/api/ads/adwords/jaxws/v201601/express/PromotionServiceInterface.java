 ...
 * 
 */
@WebService(name = "PromotionServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/express/v201601")
@XmlSeeAlso({
...
public interface PromotionServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201601.express.PromotionPage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201601")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/express/v201601", className = "com.google.api.ads.adwords.jaxws.v201601.express.PromotionServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201601", className = "com.google.api.ads.adwords.jaxws.v201601.express.PromotionServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns java.util.List<com.google.api.ads.adwords.jaxws.v201601.express.Promotion>
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201601")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/express/v201601", className = "com.google.api.ads.adwords.jaxws.v201601.express.PromotionServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201601", className = "com.google.api.ads.adwords.jaxws.v201601.express.PromotionServiceInterfacemutateResponse")
