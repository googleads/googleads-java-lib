 ...
 *         &lt;sequence>
 *           &lt;element name="operations" type="{https://adwords.google.com/api/adwords/cm/v201802}CampaignOperation" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/sequence>
 *       &lt;/restriction>
 *     &lt;/complexContent>
 *   &lt;/complexType>
...
public class CampaignServiceInterfacemutate {

    protected List<CampaignOperation> operations;
     ...
     * 
     */
    public List<CampaignOperation> getOperations() {
        if (operations == null) {
            operations = new ArrayList<CampaignOperation>();
        }
