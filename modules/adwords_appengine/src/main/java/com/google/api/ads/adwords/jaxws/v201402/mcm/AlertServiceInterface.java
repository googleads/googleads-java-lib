 ...
 * 
 */
@WebService(name = "AlertServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/mcm/v201402")
@XmlSeeAlso({
...
public interface AlertServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201402.mcm.AlertPage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/mcm/v201402")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/mcm/v201402", className = "com.google.api.ads.adwords.jaxws.v201402.mcm.AlertServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/mcm/v201402", className = "com.google.api.ads.adwords.jaxws.v201402.mcm.AlertServiceInterfacegetResponse")
