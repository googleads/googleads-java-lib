 ...
 *         &lt;element name="type" type="{https://adwords.google.com/api/adwords/cm/v201806}Criterion.Type" minOccurs="0"/>
...
@XmlSeeAlso({
    ...
    Language.class,
    CriterionCustomAffinity.class,
    LocationGroups.class,
    CriterionCustomIntent.class,
