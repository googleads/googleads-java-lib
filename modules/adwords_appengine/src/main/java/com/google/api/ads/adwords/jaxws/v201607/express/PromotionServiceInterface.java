 ...
 * 
 */
@WebService(name = "PromotionServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607")
@XmlSeeAlso({
...
public interface PromotionServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201607.express.PromotionPage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607", className = "com.google.api.ads.adwords.jaxws.v201607.express.PromotionServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607", className = "com.google.api.ads.adwords.jaxws.v201607.express.PromotionServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns java.util.List<com.google.api.ads.adwords.jaxws.v201607.express.Promotion>
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607", className = "com.google.api.ads.adwords.jaxws.v201607.express.PromotionServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607", className = "com.google.api.ads.adwords.jaxws.v201607.express.PromotionServiceInterfacemutateResponse")
