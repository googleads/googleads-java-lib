 ...
 * 
 */
@WebService(name = "CustomerSyncServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/ch/v201506")
@XmlSeeAlso({
...
public interface CustomerSyncServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201506.ch.CustomerChangeData
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/ch/v201506")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/ch/v201506", className = "com.google.api.ads.adwords.jaxws.v201506.ch.CustomerSyncServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/ch/v201506", className = "com.google.api.ads.adwords.jaxws.v201506.ch.CustomerSyncServiceInterfacegetResponse")
    public CustomerChangeData get(
        @WebParam(name = "selector", targetNamespace = "https://adwords.google.com/api/adwords/ch/v201506")
