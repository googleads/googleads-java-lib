 ...
 * 
 */
@WebServiceClient(name = "ReportDefinitionService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201306", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201306/ReportDefinitionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTDEFINITIONSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201306", "ReportDefinitionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201306/ReportDefinitionService?wsdl");
    ...
    public ReportDefinitionServiceInterface getReportDefinitionServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201306", "ReportDefinitionServiceInterfacePort"), ReportDefinitionServiceInterface.class);
    }
    ...
    public ReportDefinitionServiceInterface getReportDefinitionServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201306", "ReportDefinitionServiceInterfacePort"), ReportDefinitionServiceInterface.class, features);
    }
