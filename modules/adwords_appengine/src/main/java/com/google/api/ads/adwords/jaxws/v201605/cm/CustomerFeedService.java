 ...
 * 
 */
@WebServiceClient(name = "CustomerFeedService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201605", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201605/CustomerFeedService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERFEEDSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201605", "CustomerFeedService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201605/CustomerFeedService?wsdl");
    ...
    public CustomerFeedServiceInterface getCustomerFeedServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201605", "CustomerFeedServiceInterfacePort"), CustomerFeedServiceInterface.class);
    }
    ...
    public CustomerFeedServiceInterface getCustomerFeedServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201605", "CustomerFeedServiceInterfacePort"), CustomerFeedServiceInterface.class, features);
    }
