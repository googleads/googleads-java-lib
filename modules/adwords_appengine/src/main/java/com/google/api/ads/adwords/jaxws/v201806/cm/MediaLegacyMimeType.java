...
/**
 * <p>Java class for Media.LegacyMimeType.
 * 
 ...
 * 
 */
@XmlType(name = "Media.LegacyMimeType")
@XmlEnum
public enum MediaLegacyMimeType {
    ...
    public static MediaLegacyMimeType fromValue(String v) {
        for (MediaLegacyMimeType c: MediaLegacyMimeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
