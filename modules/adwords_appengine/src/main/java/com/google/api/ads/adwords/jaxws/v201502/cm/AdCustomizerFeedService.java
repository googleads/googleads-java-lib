 ...
 * 
 */
@WebServiceClient(name = "AdCustomizerFeedService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201502", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201502/AdCustomizerFeedService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADCUSTOMIZERFEEDSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201502", "AdCustomizerFeedService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201502/AdCustomizerFeedService?wsdl");
    ...
    public AdCustomizerFeedServiceInterface getAdCustomizerFeedServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201502", "AdCustomizerFeedServiceInterfacePort"), AdCustomizerFeedServiceInterface.class);
    }
    ...
    public AdCustomizerFeedServiceInterface getAdCustomizerFeedServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201502", "AdCustomizerFeedServiceInterfacePort"), AdCustomizerFeedServiceInterface.class, features);
    }
