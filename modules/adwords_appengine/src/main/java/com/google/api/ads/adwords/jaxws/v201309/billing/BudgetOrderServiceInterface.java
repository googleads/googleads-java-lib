 ...
 * 
 */
@WebService(name = "BudgetOrderServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201309")
@XmlSeeAlso({
...
public interface BudgetOrderServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201309.billing.BudgetOrderPage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201309")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.billing.Get")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.billing.GetResponse")
    public BudgetOrderPage get(
        @WebParam(name = "serviceSelector", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201309")
     ...
     * 
     * @return
     *     returns java.util.List<com.google.api.ads.adwords.jaxws.v201309.billing.BillingAccount>
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201309")
    @RequestWrapper(localName = "getBillingAccounts", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.billing.GetBillingAccounts")
    @ResponseWrapper(localName = "getBillingAccountsResponse", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.billing.GetBillingAccountsResponse")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201309.billing.BudgetOrderReturnValue
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201309")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.billing.Mutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.billing.MutateResponse")
    public BudgetOrderReturnValue mutate(
        @WebParam(name = "operations", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201309")
