...
/**
 * 
 *             Class that holds user list member identifiers. Following types of member identifier are
 *             supported:
 *             
 *             <ul>
 ...
 *             </ul>
 *             
 *             One list could only be uploaded with one type of data. Once it's uploaded, the user list will not
 *             accept other type of data. Multiple member identifiers of the same type for the same member could
 ...
 *         &lt;element name="addressInfo" type="{https://adwords.google.com/api/adwords/rm/v201708}AddressInfo" minOccurs="0"/>
