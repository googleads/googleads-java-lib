 ...
 * 
 */
@WebServiceClient(name = "ConversionTrackerService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201806", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201806/ConversionTrackerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONVERSIONTRACKERSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201806", "ConversionTrackerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201806/ConversionTrackerService?wsdl");
    ...
    public ConversionTrackerServiceInterface getConversionTrackerServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201806", "ConversionTrackerServiceInterfacePort"), ConversionTrackerServiceInterface.class);
    }
    ...
    public ConversionTrackerServiceInterface getConversionTrackerServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201806", "ConversionTrackerServiceInterfacePort"), ConversionTrackerServiceInterface.class, features);
    }
