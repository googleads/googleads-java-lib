    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/mcm/v201806", "CustomerService");
    ...
    public CustomerServiceInterface getCustomerServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/mcm/v201806", "CustomerServiceInterfacePort"), CustomerServiceInterface.class);
    }
    ...
    public CustomerServiceInterface getCustomerServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/mcm/v201806", "CustomerServiceInterfacePort"), CustomerServiceInterface.class, features);
    }
