 ...
 *         &lt;sequence>
 *           &lt;element name="operations" type="{https://adwords.google.com/api/adwords/rm/v201809}CustomAffinityOperation" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/sequence>
 *       &lt;/restriction>
 *     &lt;/complexContent>
 *   &lt;/complexType>
...
public class CustomAffinityServiceInterfacemutate {

    protected List<CustomAffinityOperation> operations;
     ...
     * {@link CustomAffinityOperation }
     * 
     * 
     */
    public List<CustomAffinityOperation> getOperations() {
        if (operations == null) {
            operations = new ArrayList<CustomAffinityOperation>();
        }
