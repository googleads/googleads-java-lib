 ...
 *         &lt;element name="feedChangeStatus" type="{https://adwords.google.com/api/adwords/ch/v201309}ChangeStatus" minOccurs="0"/>
 *         &lt;element name="changedFeedItems" type="{http://www.w3.org/2001/XMLSchema}long" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="deletedFeedItems" type="{http://www.w3.org/2001/XMLSchema}long" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class FeedChangeData {
    ...
    @XmlElement(type = Long.class)
    protected List<Long> deletedFeedItems;
    ...
    /**
     * Gets the value of the deletedFeedItems property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the deletedFeedItems property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDeletedFeedItems().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Long> getDeletedFeedItems() {
        if (deletedFeedItems == null) {
            deletedFeedItems = new ArrayList<Long>();
        }
        return this.deletedFeedItems;
    }
