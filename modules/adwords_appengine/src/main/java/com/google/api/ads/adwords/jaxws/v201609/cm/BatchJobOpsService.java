 ...
 * 
 */
@WebServiceClient(name = "BatchJobOpsService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201609", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201609/BatchJobOpsService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BATCHJOBOPSSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201609", "BatchJobOpsService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201609/BatchJobOpsService?wsdl");
    ...
    public BatchJobOpsServiceInterface getBatchJobOpsServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201609", "BatchJobOpsServiceInterfacePort"), BatchJobOpsServiceInterface.class);
    }
    ...
    public BatchJobOpsServiceInterface getBatchJobOpsServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201609", "BatchJobOpsServiceInterfacePort"), BatchJobOpsServiceInterface.class, features);
    }
