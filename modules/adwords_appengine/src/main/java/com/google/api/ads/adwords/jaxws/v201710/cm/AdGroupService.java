 ...
 * 
 */
@WebServiceClient(name = "AdGroupService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201710", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201710/AdGroupService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201710", "AdGroupService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201710/AdGroupService?wsdl");
    ...
    public AdGroupServiceInterface getAdGroupServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201710", "AdGroupServiceInterfacePort"), AdGroupServiceInterface.class);
    }
    ...
    public AdGroupServiceInterface getAdGroupServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201710", "AdGroupServiceInterfacePort"), AdGroupServiceInterface.class, features);
    }
