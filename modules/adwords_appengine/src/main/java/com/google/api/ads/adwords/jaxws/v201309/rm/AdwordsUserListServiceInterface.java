...
public interface AdwordsUserListServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201309.rm.UserListPage
     * @throws ApiException
     */
    @WebMethod
    ...
    public UserListPage get(
        @WebParam(name = "serviceSelector", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201309")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201309.rm.UserListReturnValue
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201309")
    ...
    public UserListReturnValue mutate(
        @WebParam(name = "operations", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201309")
