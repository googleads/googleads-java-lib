 ...
 * 
 */
@WebServiceClient(name = "CampaignExtensionSettingService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201603", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201603/CampaignExtensionSettingService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNEXTENSIONSETTINGSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201603", "CampaignExtensionSettingService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201603/CampaignExtensionSettingService?wsdl");
    ...
    public CampaignExtensionSettingServiceInterface getCampaignExtensionSettingServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201603", "CampaignExtensionSettingServiceInterfacePort"), CampaignExtensionSettingServiceInterface.class);
    }
    ...
    public CampaignExtensionSettingServiceInterface getCampaignExtensionSettingServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201603", "CampaignExtensionSettingServiceInterfacePort"), CampaignExtensionSettingServiceInterface.class, features);
    }
