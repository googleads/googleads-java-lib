 ...
 *         &lt;sequence>
 *           &lt;element name="operations" type="{https://adwords.google.com/api/adwords/cm/v201605}CustomerExtensionSettingOperation" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/sequence>
 *       &lt;/restriction>
 *     &lt;/complexContent>
 *   &lt;/complexType>
...
public class CustomerExtensionSettingServiceInterfacemutate {

    protected List<CustomerExtensionSettingOperation> operations;
     ...
     * {@link CustomerExtensionSettingOperation }
     * 
     * 
     */
    public List<CustomerExtensionSettingOperation> getOperations() {
        if (operations == null) {
            operations = new ArrayList<CustomerExtensionSettingOperation>();
        }
