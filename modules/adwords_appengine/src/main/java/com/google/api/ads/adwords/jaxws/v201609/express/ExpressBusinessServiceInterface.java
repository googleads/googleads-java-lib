 ...
 * 
 */
@WebService(name = "ExpressBusinessServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/express/v201609")
@XmlSeeAlso({
...
public interface ExpressBusinessServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201609.express.ExpressBusinessPage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201609")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/express/v201609", className = "com.google.api.ads.adwords.jaxws.v201609.express.ExpressBusinessServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201609", className = "com.google.api.ads.adwords.jaxws.v201609.express.ExpressBusinessServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns java.util.List<com.google.api.ads.adwords.jaxws.v201609.express.ExpressBusiness>
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201609")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/express/v201609", className = "com.google.api.ads.adwords.jaxws.v201609.express.ExpressBusinessServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201609", className = "com.google.api.ads.adwords.jaxws.v201609.express.ExpressBusinessServiceInterfacemutateResponse")
