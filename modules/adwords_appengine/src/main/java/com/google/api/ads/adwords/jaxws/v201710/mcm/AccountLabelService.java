 ...
 * 
 */
@WebServiceClient(name = "AccountLabelService", targetNamespace = "https://adwords.google.com/api/adwords/mcm/v201710", wsdlLocation = "https://adwords.google.com/api/adwords/mcm/v201710/AccountLabelService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTLABELSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/mcm/v201710", "AccountLabelService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/mcm/v201710/AccountLabelService?wsdl");
    ...
    public AccountLabelServiceInterface getAccountLabelServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/mcm/v201710", "AccountLabelServiceInterfacePort"), AccountLabelServiceInterface.class);
    }
    ...
    public AccountLabelServiceInterface getAccountLabelServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/mcm/v201710", "AccountLabelServiceInterfacePort"), AccountLabelServiceInterface.class, features);
    }
