 ...
 * 
 */
@WebServiceClient(name = "CampaignAdExtensionService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201402", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201402/CampaignAdExtensionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNADEXTENSIONSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201402", "CampaignAdExtensionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201402/CampaignAdExtensionService?wsdl");
    ...
    public CampaignAdExtensionServiceInterface getCampaignAdExtensionServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201402", "CampaignAdExtensionServiceInterfacePort"), CampaignAdExtensionServiceInterface.class);
    }
    ...
    public CampaignAdExtensionServiceInterface getCampaignAdExtensionServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201402", "CampaignAdExtensionServiceInterfacePort"), CampaignAdExtensionServiceInterface.class, features);
    }
