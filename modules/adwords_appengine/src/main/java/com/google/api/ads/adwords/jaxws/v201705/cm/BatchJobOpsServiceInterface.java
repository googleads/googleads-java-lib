 ...
 * 
 */
@WebService(name = "BatchJobOpsServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201705")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface BatchJobOpsServiceInterface {
     ...
     * @param operations
     * @return
     *     returns java.util.List<com.google.api.ads.adwords.jaxws.v201705.cm.MutateResult>
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201705")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201705", className = "com.google.api.ads.adwords.jaxws.v201705.cm.BatchJobOpsServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201705", className = "com.google.api.ads.adwords.jaxws.v201705.cm.BatchJobOpsServiceInterfacemutateResponse")
