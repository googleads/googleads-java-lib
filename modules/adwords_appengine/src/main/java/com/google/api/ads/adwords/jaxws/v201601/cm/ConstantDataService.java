 ...
 * 
 */
@WebServiceClient(name = "ConstantDataService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201601", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201601/ConstantDataService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONSTANTDATASERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201601", "ConstantDataService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201601/ConstantDataService?wsdl");
    ...
    public ConstantDataServiceInterface getConstantDataServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201601", "ConstantDataServiceInterfacePort"), ConstantDataServiceInterface.class);
    }
    ...
    public ConstantDataServiceInterface getConstantDataServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201601", "ConstantDataServiceInterfacePort"), ConstantDataServiceInterface.class, features);
    }
