 ...
 * 
 */
@WebServiceClient(name = "AdParamService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201806", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201806/AdParamService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADPARAMSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201806", "AdParamService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201806/AdParamService?wsdl");
    ...
    public AdParamServiceInterface getAdParamServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201806", "AdParamServiceInterfacePort"), AdParamServiceInterface.class);
    }
    ...
    public AdParamServiceInterface getAdParamServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201806", "AdParamServiceInterfacePort"), AdParamServiceInterface.class, features);
    }
