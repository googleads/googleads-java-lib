 ...
 * 
 */
@WebService(name = "OfflineCallConversionFeedServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201609")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface OfflineCallConversionFeedServiceInterface {
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201609.cm.OfflineCallConversionFeedReturnValue
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201609")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201609", className = "com.google.api.ads.adwords.jaxws.v201609.cm.OfflineCallConversionFeedServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201609", className = "com.google.api.ads.adwords.jaxws.v201609.cm.OfflineCallConversionFeedServiceInterfacemutateResponse")
