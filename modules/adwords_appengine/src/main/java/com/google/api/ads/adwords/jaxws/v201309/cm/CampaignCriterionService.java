 ...
 * 
 */
@WebServiceClient(name = "CampaignCriterionService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201309/CampaignCriterionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNCRITERIONSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201309", "CampaignCriterionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201309/CampaignCriterionService?wsdl");
    ...
    public CampaignCriterionServiceInterface getCampaignCriterionServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201309", "CampaignCriterionServiceInterfacePort"), CampaignCriterionServiceInterface.class);
    }
    ...
    public CampaignCriterionServiceInterface getCampaignCriterionServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201309", "CampaignCriterionServiceInterfacePort"), CampaignCriterionServiceInterface.class, features);
    }
