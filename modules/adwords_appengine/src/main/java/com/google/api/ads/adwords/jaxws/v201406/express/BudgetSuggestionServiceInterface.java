 ...
 * 
 */
@WebService(name = "BudgetSuggestionServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/express/v201406")
@XmlSeeAlso({
...
public interface BudgetSuggestionServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201406.express.BudgetSuggestion
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201406")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/express/v201406", className = "com.google.api.ads.adwords.jaxws.v201406.express.BudgetSuggestionServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201406", className = "com.google.api.ads.adwords.jaxws.v201406.express.BudgetSuggestionServiceInterfacegetResponse")
