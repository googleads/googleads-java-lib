 ...
 * 
 */
@WebServiceClient(name = "AdGroupService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201708", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201708/AdGroupService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201708", "AdGroupService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201708/AdGroupService?wsdl");
    ...
    public AdGroupServiceInterface getAdGroupServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201708", "AdGroupServiceInterfacePort"), AdGroupServiceInterface.class);
    }
    ...
    public AdGroupServiceInterface getAdGroupServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201708", "AdGroupServiceInterfacePort"), AdGroupServiceInterface.class, features);
    }
