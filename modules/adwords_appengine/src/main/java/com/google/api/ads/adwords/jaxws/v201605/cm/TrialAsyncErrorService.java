 ...
 * 
 */
@WebServiceClient(name = "TrialAsyncErrorService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201605", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201605/TrialAsyncErrorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TRIALASYNCERRORSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201605", "TrialAsyncErrorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201605/TrialAsyncErrorService?wsdl");
    ...
    public TrialAsyncErrorServiceInterface getTrialAsyncErrorServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201605", "TrialAsyncErrorServiceInterfacePort"), TrialAsyncErrorServiceInterface.class);
    }
    ...
    public TrialAsyncErrorServiceInterface getTrialAsyncErrorServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201605", "TrialAsyncErrorServiceInterfacePort"), TrialAsyncErrorServiceInterface.class, features);
    }
