 ...
 * 
 */
@WebService(name = "ConversionTrackerServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201806")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ConversionTrackerServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201806.cm.ConversionTrackerPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201806")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201806", className = "com.google.api.ads.adwords.jaxws.v201806.cm.ConversionTrackerServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201806", className = "com.google.api.ads.adwords.jaxws.v201806.cm.ConversionTrackerServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201806.cm.ConversionTrackerReturnValue
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201806")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201806", className = "com.google.api.ads.adwords.jaxws.v201806.cm.ConversionTrackerServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201806", className = "com.google.api.ads.adwords.jaxws.v201806.cm.ConversionTrackerServiceInterfacemutateResponse")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201806")
    @RequestWrapper(localName = "query", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201806", className = "com.google.api.ads.adwords.jaxws.v201806.cm.ConversionTrackerServiceInterfacequery")
    @ResponseWrapper(localName = "queryResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201806", className = "com.google.api.ads.adwords.jaxws.v201806.cm.ConversionTrackerServiceInterfacequeryResponse")
