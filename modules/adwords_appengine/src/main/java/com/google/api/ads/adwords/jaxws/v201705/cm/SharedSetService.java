 ...
 * 
 */
@WebServiceClient(name = "SharedSetService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201705", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201705/SharedSetService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SHAREDSETSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201705", "SharedSetService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201705/SharedSetService?wsdl");
    ...
    public SharedSetServiceInterface getSharedSetServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201705", "SharedSetServiceInterfacePort"), SharedSetServiceInterface.class);
    }
    ...
    public SharedSetServiceInterface getSharedSetServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201705", "SharedSetServiceInterfacePort"), SharedSetServiceInterface.class, features);
    }
