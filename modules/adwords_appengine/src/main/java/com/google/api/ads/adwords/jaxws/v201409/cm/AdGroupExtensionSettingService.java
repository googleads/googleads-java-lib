 ...
 * 
 */
@WebServiceClient(name = "AdGroupExtensionSettingService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201409", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201409/AdGroupExtensionSettingService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPEXTENSIONSETTINGSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201409", "AdGroupExtensionSettingService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201409/AdGroupExtensionSettingService?wsdl");
    ...
    public AdGroupExtensionSettingServiceInterface getAdGroupExtensionSettingServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201409", "AdGroupExtensionSettingServiceInterfacePort"), AdGroupExtensionSettingServiceInterface.class);
    }
    ...
    public AdGroupExtensionSettingServiceInterface getAdGroupExtensionSettingServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201409", "AdGroupExtensionSettingServiceInterfacePort"), AdGroupExtensionSettingServiceInterface.class, features);
    }
