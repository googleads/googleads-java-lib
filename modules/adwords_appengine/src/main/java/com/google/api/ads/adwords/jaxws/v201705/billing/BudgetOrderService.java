    ...
    extends Service
{
    ...
    private final static QName BUDGETORDERSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/billing/v201705", "BudgetOrderService");
    ...
    public BudgetOrderServiceInterface getBudgetOrderServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/billing/v201705", "BudgetOrderServiceInterfacePort"), BudgetOrderServiceInterface.class);
    }
    ...
    public BudgetOrderServiceInterface getBudgetOrderServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/billing/v201705", "BudgetOrderServiceInterfacePort"), BudgetOrderServiceInterface.class, features);
    }
