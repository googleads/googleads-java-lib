 ...
 * 
 */
@WebServiceClient(name = "BudgetSuggestionService", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607", wsdlLocation = "https://adwords.google.com/api/adwords/express/v201607/BudgetSuggestionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BUDGETSUGGESTIONSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/express/v201607", "BudgetSuggestionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/express/v201607/BudgetSuggestionService?wsdl");
    ...
    public BudgetSuggestionServiceInterface getBudgetSuggestionServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/express/v201607", "BudgetSuggestionServiceInterfacePort"), BudgetSuggestionServiceInterface.class);
    }
    ...
    public BudgetSuggestionServiceInterface getBudgetSuggestionServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/express/v201607", "BudgetSuggestionServiceInterfacePort"), BudgetSuggestionServiceInterface.class, features);
    }
