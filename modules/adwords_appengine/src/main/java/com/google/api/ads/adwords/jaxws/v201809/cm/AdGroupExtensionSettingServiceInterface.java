 ...
 * 
 */
@WebService(name = "AdGroupExtensionSettingServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface AdGroupExtensionSettingServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201809.cm.AdGroupExtensionSettingPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.cm.AdGroupExtensionSettingServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.cm.AdGroupExtensionSettingServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201809.cm.AdGroupExtensionSettingReturnValue
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.cm.AdGroupExtensionSettingServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.cm.AdGroupExtensionSettingServiceInterfacemutateResponse")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809")
    @RequestWrapper(localName = "query", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.cm.AdGroupExtensionSettingServiceInterfacequery")
    @ResponseWrapper(localName = "queryResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.cm.AdGroupExtensionSettingServiceInterfacequeryResponse")
