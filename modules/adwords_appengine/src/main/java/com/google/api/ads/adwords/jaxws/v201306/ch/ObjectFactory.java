 ...
 * generated in the com.google.api.ads.adwords.jaxws.v201306.ch package. 
...
public class ObjectFactory {
    ...
    private final static QName _ApiExceptionFault_QNAME = new QName("https://adwords.google.com/api/adwords/ch/v201306", "ApiExceptionFault");
    private final static QName _ResponseHeader_QNAME = new QName("https://adwords.google.com/api/adwords/ch/v201306", "ResponseHeader");
    private final static QName _RequestHeader_QNAME = new QName("https://adwords.google.com/api/adwords/ch/v201306", "RequestHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.google.api.ads.adwords.jaxws.v201306.ch
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://adwords.google.com/api/adwords/ch/v201306", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://adwords.google.com/api/adwords/ch/v201306", name = "ResponseHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://adwords.google.com/api/adwords/ch/v201306", name = "RequestHeader")
