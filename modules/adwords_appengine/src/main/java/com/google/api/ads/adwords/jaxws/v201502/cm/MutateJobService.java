 ...
 * 
 */
@WebServiceClient(name = "MutateJobService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201502", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201502/MutateJobService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MUTATEJOBSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201502", "MutateJobService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201502/MutateJobService?wsdl");
    ...
    public MutateJobServiceInterface getMutateJobServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201502", "MutateJobServiceInterfacePort"), MutateJobServiceInterface.class);
    }
    ...
    public MutateJobServiceInterface getMutateJobServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201502", "MutateJobServiceInterfacePort"), MutateJobServiceInterface.class, features);
    }
