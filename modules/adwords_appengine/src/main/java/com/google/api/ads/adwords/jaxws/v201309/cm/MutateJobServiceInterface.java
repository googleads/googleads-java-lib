 ...
 * 
 */
@WebService(name = "MutateJobServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface MutateJobServiceInterface {
     ...
     * @param selector
     * @return
     *     returns java.util.List<com.google.api.ads.adwords.jaxws.v201309.cm.Job>
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.cm.MutateJobServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.cm.MutateJobServiceInterfacegetResponse")
    public List<Job> get(
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201309.cm.JobResult
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309")
    @RequestWrapper(localName = "getResult", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.cm.MutateJobServiceInterfacegetResult")
    @ResponseWrapper(localName = "getResultResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.cm.MutateJobServiceInterfacegetResultResponse")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201309.cm.SimpleMutateJob
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.cm.MutateJobServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.cm.MutateJobServiceInterfacemutateResponse")
    public SimpleMutateJob mutate(
        ...
        @WebParam(name = "policy", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309")
