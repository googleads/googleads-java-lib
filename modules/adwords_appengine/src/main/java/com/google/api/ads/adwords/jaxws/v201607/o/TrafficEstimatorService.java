 ...
 * 
 */
@WebServiceClient(name = "TrafficEstimatorService", targetNamespace = "https://adwords.google.com/api/adwords/o/v201607", wsdlLocation = "https://adwords.google.com/api/adwords/o/v201607/TrafficEstimatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TRAFFICESTIMATORSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/o/v201607", "TrafficEstimatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/o/v201607/TrafficEstimatorService?wsdl");
    ...
    public TrafficEstimatorServiceInterface getTrafficEstimatorServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/o/v201607", "TrafficEstimatorServiceInterfacePort"), TrafficEstimatorServiceInterface.class);
    }
    ...
    public TrafficEstimatorServiceInterface getTrafficEstimatorServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/o/v201607", "TrafficEstimatorServiceInterfacePort"), TrafficEstimatorServiceInterface.class, features);
    }
