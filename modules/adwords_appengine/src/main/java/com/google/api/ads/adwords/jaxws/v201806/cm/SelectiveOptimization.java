...
/**
 * 
 *             Selected set of conversion types or a selective optimization set id for optimizing campaigns. For
 *             e.g. For universal app campaigns, these are the set of in-app actions to optimize the campaign
 *             towards.
 *           
 * 
 ...
 *         &lt;element name="conversionTypeIdsOps" type="{https://adwords.google.com/api/adwords/cm/v201806}ListOperations" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
