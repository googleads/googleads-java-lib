...
/**
 * 
 *             Error indicating that an entity will be disapproved unless changes are made to it before it is
 *             saved. This error occurs when the entity will have a policy summary that includes a PROHIBITED
 *             policy topic entry.
 *           
 * 
