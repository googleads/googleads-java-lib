 ...
 * 
 */
@WebService(name = "CustomerSyncServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/ch/v201609")
@XmlSeeAlso({
...
public interface CustomerSyncServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201609.ch.CustomerChangeData
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/ch/v201609")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/ch/v201609", className = "com.google.api.ads.adwords.jaxws.v201609.ch.CustomerSyncServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/ch/v201609", className = "com.google.api.ads.adwords.jaxws.v201609.ch.CustomerSyncServiceInterfacegetResponse")
    public CustomerChangeData get(
        @WebParam(name = "selector", targetNamespace = "https://adwords.google.com/api/adwords/ch/v201609")
