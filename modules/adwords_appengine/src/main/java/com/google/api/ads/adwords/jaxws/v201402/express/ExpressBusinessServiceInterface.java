 ...
 * 
 */
@WebService(name = "ExpressBusinessServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/express/v201402")
@XmlSeeAlso({
...
public interface ExpressBusinessServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201402.express.ExpressBusinessPage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201402")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/express/v201402", className = "com.google.api.ads.adwords.jaxws.v201402.express.ExpressBusinessServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201402", className = "com.google.api.ads.adwords.jaxws.v201402.express.ExpressBusinessServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns java.util.List<com.google.api.ads.adwords.jaxws.v201402.express.ExpressBusiness>
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201402")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/express/v201402", className = "com.google.api.ads.adwords.jaxws.v201402.express.ExpressBusinessServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201402", className = "com.google.api.ads.adwords.jaxws.v201402.express.ExpressBusinessServiceInterfacemutateResponse")
