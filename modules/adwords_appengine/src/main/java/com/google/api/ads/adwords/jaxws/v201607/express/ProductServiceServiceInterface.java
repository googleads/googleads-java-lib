 ...
 * 
 */
@WebService(name = "ProductServiceServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607")
@XmlSeeAlso({
...
public interface ProductServiceServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201607.express.ProductServicePage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607", className = "com.google.api.ads.adwords.jaxws.v201607.express.ProductServiceServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201607", className = "com.google.api.ads.adwords.jaxws.v201607.express.ProductServiceServiceInterfacegetResponse")
