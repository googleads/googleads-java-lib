 ...
 * 
 */
@WebServiceClient(name = "AdParamService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201710", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201710/AdParamService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADPARAMSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201710", "AdParamService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201710/AdParamService?wsdl");
    ...
    public AdParamServiceInterface getAdParamServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201710", "AdParamServiceInterfacePort"), AdParamServiceInterface.class);
    }
    ...
    public AdParamServiceInterface getAdParamServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201710", "AdParamServiceInterfacePort"), AdParamServiceInterface.class, features);
    }
