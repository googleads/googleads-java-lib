 ...
 * 
 */
@WebServiceClient(name = "ExpressBusinessService", targetNamespace = "https://adwords.google.com/api/adwords/express/v201605", wsdlLocation = "https://adwords.google.com/api/adwords/express/v201605/ExpressBusinessService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXPRESSBUSINESSSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/express/v201605", "ExpressBusinessService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/express/v201605/ExpressBusinessService?wsdl");
    ...
    public ExpressBusinessServiceInterface getExpressBusinessServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/express/v201605", "ExpressBusinessServiceInterfacePort"), ExpressBusinessServiceInterface.class);
    }
    ...
    public ExpressBusinessServiceInterface getExpressBusinessServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/express/v201605", "ExpressBusinessServiceInterfacePort"), ExpressBusinessServiceInterface.class, features);
    }
