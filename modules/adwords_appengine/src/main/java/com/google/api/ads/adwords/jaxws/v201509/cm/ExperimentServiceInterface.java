 ...
 * 
 */
@WebService(name = "ExperimentServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ExperimentServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201509.cm.ExperimentPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509", className = "com.google.api.ads.adwords.jaxws.v201509.cm.ExperimentServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509", className = "com.google.api.ads.adwords.jaxws.v201509.cm.ExperimentServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201509.cm.ExperimentReturnValue
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509", className = "com.google.api.ads.adwords.jaxws.v201509.cm.ExperimentServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509", className = "com.google.api.ads.adwords.jaxws.v201509.cm.ExperimentServiceInterfacemutateResponse")
