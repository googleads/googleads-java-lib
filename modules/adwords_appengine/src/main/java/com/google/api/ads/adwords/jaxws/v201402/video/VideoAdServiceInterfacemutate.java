 ...
 *         &lt;sequence>
 *           &lt;element name="operations" type="{https://adwords.google.com/api/adwords/video/v201402}VideoAdOperation" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/sequence>
 *       &lt;/restriction>
 *     &lt;/complexContent>
 *   &lt;/complexType>
...
public class VideoAdServiceInterfacemutate {

    protected List<VideoAdOperation> operations;
     ...
     * {@link VideoAdOperation }
     * 
     * 
     */
    public List<VideoAdOperation> getOperations() {
        if (operations == null) {
            operations = new ArrayList<VideoAdOperation>();
        }
