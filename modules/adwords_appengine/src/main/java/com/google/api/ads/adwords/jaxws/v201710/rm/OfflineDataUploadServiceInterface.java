 ...
 * 
 */
@WebService(name = "OfflineDataUploadServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201710")
@XmlSeeAlso({
...
public interface OfflineDataUploadServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201710.rm.OfflineDataUploadPage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201710")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201710", className = "com.google.api.ads.adwords.jaxws.v201710.rm.OfflineDataUploadServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201710", className = "com.google.api.ads.adwords.jaxws.v201710.rm.OfflineDataUploadServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201710.rm.OfflineDataUploadReturnValue
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201710")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201710", className = "com.google.api.ads.adwords.jaxws.v201710.rm.OfflineDataUploadServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201710", className = "com.google.api.ads.adwords.jaxws.v201710.rm.OfflineDataUploadServiceInterfacemutateResponse")
