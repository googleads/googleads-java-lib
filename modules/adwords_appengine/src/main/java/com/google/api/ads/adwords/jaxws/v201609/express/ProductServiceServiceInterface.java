 ...
 * 
 */
@WebService(name = "ProductServiceServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/express/v201609")
@XmlSeeAlso({
...
public interface ProductServiceServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201609.express.ProductServicePage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201609")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/express/v201609", className = "com.google.api.ads.adwords.jaxws.v201609.express.ProductServiceServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201609", className = "com.google.api.ads.adwords.jaxws.v201609.express.ProductServiceServiceInterfacegetResponse")
