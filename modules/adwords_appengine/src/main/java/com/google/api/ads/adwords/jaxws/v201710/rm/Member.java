 ...
 *             accept any other ID types. Multiple member identifiers of the same type for
 *             the same member can be provided at the same time. At least one identifier is
 ...
 *         &lt;element name="addressInfo" type="{https://adwords.google.com/api/adwords/rm/v201710}AddressInfo" minOccurs="0"/>
