 ...
 * 
 */
@WebServiceClient(name = "ProductServiceService", targetNamespace = "https://adwords.google.com/api/adwords/express/v201603", wsdlLocation = "https://adwords.google.com/api/adwords/express/v201603/ProductServiceService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICESERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/express/v201603", "ProductServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/express/v201603/ProductServiceService?wsdl");
    ...
    public ProductServiceServiceInterface getProductServiceServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/express/v201603", "ProductServiceServiceInterfacePort"), ProductServiceServiceInterface.class);
    }
    ...
    public ProductServiceServiceInterface getProductServiceServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/express/v201603", "ProductServiceServiceInterfacePort"), ProductServiceServiceInterface.class, features);
    }
