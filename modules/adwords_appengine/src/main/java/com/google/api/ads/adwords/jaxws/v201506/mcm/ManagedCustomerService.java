 ...
 * 
 */
@WebServiceClient(name = "ManagedCustomerService", targetNamespace = "https://adwords.google.com/api/adwords/mcm/v201506", wsdlLocation = "https://adwords.google.com/api/adwords/mcm/v201506/ManagedCustomerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MANAGEDCUSTOMERSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/mcm/v201506", "ManagedCustomerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/mcm/v201506/ManagedCustomerService?wsdl");
    ...
    public ManagedCustomerServiceInterface getManagedCustomerServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/mcm/v201506", "ManagedCustomerServiceInterfacePort"), ManagedCustomerServiceInterface.class);
    }
    ...
    public ManagedCustomerServiceInterface getManagedCustomerServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/mcm/v201506", "ManagedCustomerServiceInterfacePort"), ManagedCustomerServiceInterface.class, features);
    }
