 ...
 * 
 */
@WebServiceClient(name = "AdwordsUserListService", targetNamespace = "https://adwords.google.com/api/adwords/rm/v201705", wsdlLocation = "https://adwords.google.com/api/adwords/rm/v201705/AdwordsUserListService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADWORDSUSERLISTSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/rm/v201705", "AdwordsUserListService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/rm/v201705/AdwordsUserListService?wsdl");
    ...
    public AdwordsUserListServiceInterface getAdwordsUserListServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/rm/v201705", "AdwordsUserListServiceInterfacePort"), AdwordsUserListServiceInterface.class);
    }
    ...
    public AdwordsUserListServiceInterface getAdwordsUserListServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/rm/v201705", "AdwordsUserListServiceInterfacePort"), AdwordsUserListServiceInterface.class, features);
    }
