 ...
 * 
 */
@WebService(name = "BudgetSuggestionServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/express/v201601")
@XmlSeeAlso({
...
public interface BudgetSuggestionServiceInterface {
     ...
     * @param selector
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201601.express.BudgetSuggestion
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/express/v201601")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/express/v201601", className = "com.google.api.ads.adwords.jaxws.v201601.express.BudgetSuggestionServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/express/v201601", className = "com.google.api.ads.adwords.jaxws.v201601.express.BudgetSuggestionServiceInterfacegetResponse")
