 ...
 * 
 */
@WebServiceClient(name = "BudgetOrderService", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201603", wsdlLocation = "https://adwords.google.com/api/adwords/billing/v201603/BudgetOrderService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BUDGETORDERSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/billing/v201603", "BudgetOrderService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/billing/v201603/BudgetOrderService?wsdl");
    ...
    public BudgetOrderServiceInterface getBudgetOrderServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/billing/v201603", "BudgetOrderServiceInterfacePort"), BudgetOrderServiceInterface.class);
    }
    ...
    public BudgetOrderServiceInterface getBudgetOrderServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/billing/v201603", "BudgetOrderServiceInterfacePort"), BudgetOrderServiceInterface.class, features);
    }
