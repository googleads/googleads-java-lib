 ...
 * 
 */
@WebServiceClient(name = "ConstantDataService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201502", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201502/ConstantDataService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONSTANTDATASERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201502", "ConstantDataService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201502/ConstantDataService?wsdl");
    ...
    public ConstantDataServiceInterface getConstantDataServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201502", "ConstantDataServiceInterfacePort"), ConstantDataServiceInterface.class);
    }
    ...
    public ConstantDataServiceInterface getConstantDataServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201502", "ConstantDataServiceInterfacePort"), ConstantDataServiceInterface.class, features);
    }
