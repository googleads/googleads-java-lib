 ...
 *         &lt;sequence>
 *           &lt;element name="operations" type="{https://adwords.google.com/api/adwords/video/v201406}VideoCampaignOperation" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/sequence>
 *       &lt;/restriction>
 *     &lt;/complexContent>
 *   &lt;/complexType>
...
public class VideoCampaignServiceInterfacemutate {

    protected List<VideoCampaignOperation> operations;
     ...
     * {@link VideoCampaignOperation }
     * 
     * 
     */
    public List<VideoCampaignOperation> getOperations() {
        if (operations == null) {
            operations = new ArrayList<VideoCampaignOperation>();
        }
