 ...
 * 
 */
@WebServiceClient(name = "AdGroupExtensionSettingService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201809", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201809/AdGroupExtensionSettingService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPEXTENSIONSETTINGSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201809", "AdGroupExtensionSettingService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201809/AdGroupExtensionSettingService?wsdl");
    ...
    public AdGroupExtensionSettingServiceInterface getAdGroupExtensionSettingServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201809", "AdGroupExtensionSettingServiceInterfacePort"), AdGroupExtensionSettingServiceInterface.class);
    }
    ...
    public AdGroupExtensionSettingServiceInterface getAdGroupExtensionSettingServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201809", "AdGroupExtensionSettingServiceInterfacePort"), AdGroupExtensionSettingServiceInterface.class, features);
    }
