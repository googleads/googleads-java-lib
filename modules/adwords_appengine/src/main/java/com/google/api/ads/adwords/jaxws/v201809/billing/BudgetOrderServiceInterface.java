 ...
 * 
 */
@WebService(name = "BudgetOrderServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201809")
@XmlSeeAlso({
    com.google.api.ads.adwords.jaxws.v201809.billing.ObjectFactory.class,
    com.google.api.ads.adwords.jaxws.v201809.ch.ObjectFactory.class,
    ...
    com.google.api.ads.adwords.jaxws.v201809.o.ObjectFactory.class,
...
public interface BudgetOrderServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201809.billing.BudgetOrderPage
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201809")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.billing.Get")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.billing.GetResponse")
    public BudgetOrderPage get(
        @WebParam(name = "serviceSelector", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201809")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201809.billing.BudgetOrderReturnValue
     * @throws ApiException
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201809")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.billing.Mutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201809", className = "com.google.api.ads.adwords.jaxws.v201809.billing.MutateResponse")
    public BudgetOrderReturnValue mutate(
        @WebParam(name = "operations", targetNamespace = "https://adwords.google.com/api/adwords/billing/v201809")
