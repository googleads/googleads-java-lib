 ...
 * 
 */
@WebServiceClient(name = "FeedMappingService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201603", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201603/FeedMappingService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FEEDMAPPINGSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201603", "FeedMappingService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201603/FeedMappingService?wsdl");
    ...
    public FeedMappingServiceInterface getFeedMappingServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201603", "FeedMappingServiceInterfacePort"), FeedMappingServiceInterface.class);
    }
    ...
    public FeedMappingServiceInterface getFeedMappingServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201603", "FeedMappingServiceInterfacePort"), FeedMappingServiceInterface.class, features);
    }
