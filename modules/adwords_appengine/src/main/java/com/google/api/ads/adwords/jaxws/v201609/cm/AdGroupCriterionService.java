 ...
 * 
 */
@WebServiceClient(name = "AdGroupCriterionService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201609", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201609/AdGroupCriterionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPCRITERIONSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201609", "AdGroupCriterionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201609/AdGroupCriterionService?wsdl");
    ...
    public AdGroupCriterionServiceInterface getAdGroupCriterionServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201609", "AdGroupCriterionServiceInterfacePort"), AdGroupCriterionServiceInterface.class);
    }
    ...
    public AdGroupCriterionServiceInterface getAdGroupCriterionServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201609", "AdGroupCriterionServiceInterfacePort"), AdGroupCriterionServiceInterface.class, features);
    }
