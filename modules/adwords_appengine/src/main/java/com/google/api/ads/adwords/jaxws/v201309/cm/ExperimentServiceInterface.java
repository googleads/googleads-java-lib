 ...
 * 
 */
@WebService(name = "ExperimentServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ExperimentServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201309.cm.ExperimentPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.cm.ExperimentServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.cm.ExperimentServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201309.cm.ExperimentReturnValue
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.cm.ExperimentServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201309", className = "com.google.api.ads.adwords.jaxws.v201309.cm.ExperimentServiceInterfacemutateResponse")
