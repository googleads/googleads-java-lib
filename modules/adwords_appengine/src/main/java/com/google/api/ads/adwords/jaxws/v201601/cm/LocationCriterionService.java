 ...
 * 
 */
@WebServiceClient(name = "LocationCriterionService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201601", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201601/LocationCriterionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOCATIONCRITERIONSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201601", "LocationCriterionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201601/LocationCriterionService?wsdl");
    ...
    public LocationCriterionServiceInterface getLocationCriterionServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201601", "LocationCriterionServiceInterfacePort"), LocationCriterionServiceInterface.class);
    }
    ...
    public LocationCriterionServiceInterface getLocationCriterionServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201601", "LocationCriterionServiceInterfacePort"), LocationCriterionServiceInterface.class, features);
    }
