 ...
 * 
 */
@WebServiceClient(name = "ExpressBusinessService", targetNamespace = "https://adwords.google.com/api/adwords/express/v201609", wsdlLocation = "https://adwords.google.com/api/adwords/express/v201609/ExpressBusinessService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXPRESSBUSINESSSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/express/v201609", "ExpressBusinessService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/express/v201609/ExpressBusinessService?wsdl");
    ...
    public ExpressBusinessServiceInterface getExpressBusinessServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/express/v201609", "ExpressBusinessServiceInterfacePort"), ExpressBusinessServiceInterface.class);
    }
    ...
    public ExpressBusinessServiceInterface getExpressBusinessServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/express/v201609", "ExpressBusinessServiceInterfacePort"), ExpressBusinessServiceInterface.class, features);
    }
