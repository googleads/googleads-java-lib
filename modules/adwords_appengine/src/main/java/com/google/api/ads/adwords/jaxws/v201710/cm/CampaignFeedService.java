 ...
 * 
 */
@WebServiceClient(name = "CampaignFeedService", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201710", wsdlLocation = "https://adwords.google.com/api/adwords/cm/v201710/CampaignFeedService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNFEEDSERVICE_QNAME = new QName("https://adwords.google.com/api/adwords/cm/v201710", "CampaignFeedService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://adwords.google.com/api/adwords/cm/v201710/CampaignFeedService?wsdl");
    ...
    public CampaignFeedServiceInterface getCampaignFeedServiceInterfacePort() {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201710", "CampaignFeedServiceInterfacePort"), CampaignFeedServiceInterface.class);
    }
    ...
    public CampaignFeedServiceInterface getCampaignFeedServiceInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("https://adwords.google.com/api/adwords/cm/v201710", "CampaignFeedServiceInterfacePort"), CampaignFeedServiceInterface.class, features);
    }
