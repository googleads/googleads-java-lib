 ...
 * 
 */
@WebService(name = "ConversionTrackerServiceInterface", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ConversionTrackerServiceInterface {
     ...
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201509.cm.ConversionTrackerPage
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509")
    @RequestWrapper(localName = "get", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509", className = "com.google.api.ads.adwords.jaxws.v201509.cm.ConversionTrackerServiceInterfaceget")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509", className = "com.google.api.ads.adwords.jaxws.v201509.cm.ConversionTrackerServiceInterfacegetResponse")
     ...
     * @param operations
     * @return
     *     returns com.google.api.ads.adwords.jaxws.v201509.cm.ConversionTrackerReturnValue
     * @throws ApiException_Exception
     */
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509")
    @RequestWrapper(localName = "mutate", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509", className = "com.google.api.ads.adwords.jaxws.v201509.cm.ConversionTrackerServiceInterfacemutate")
    @ResponseWrapper(localName = "mutateResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509", className = "com.google.api.ads.adwords.jaxws.v201509.cm.ConversionTrackerServiceInterfacemutateResponse")
    ...
    @WebMethod
    @WebResult(name = "rval", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509")
    @RequestWrapper(localName = "query", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509", className = "com.google.api.ads.adwords.jaxws.v201509.cm.ConversionTrackerServiceInterfacequery")
    @ResponseWrapper(localName = "queryResponse", targetNamespace = "https://adwords.google.com/api/adwords/cm/v201509", className = "com.google.api.ads.adwords.jaxws.v201509.cm.ConversionTrackerServiceInterfacequeryResponse")
