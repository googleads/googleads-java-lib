...
package com.google.api.ads.adwords.axis.utils.v201309;

import com.google.api.ads.adwords.axis.v201309.cm.CampaignStatus;
import com.google.api.ads.adwords.axis.v201309.cm.DateRange;
...
public class SelectorBuilderTest {
  ...
  public void testPredicatesInBuild() {
    ...
    Assert.assertEquals(CampaignStatus.DELETED.toString(), predicate.getValues()[1]);
