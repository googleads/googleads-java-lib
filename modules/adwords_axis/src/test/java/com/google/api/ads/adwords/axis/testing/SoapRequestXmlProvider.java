...
package com.google.api.ads.adwords.axis.testing;
...
public class SoapRequestXmlProvider {
  ...
  private static final String PRODUCT_FRAMEWORK_NAME = "AdWords-Axis";
  ...
  private static String getTemplatedXml(String soapXml, String apiVersion) {
    return SoapXmlTemplater.templateRequest(
        soapXml, apiVersion, new AdWordsAxisModule(), PRODUCT_FRAMEWORK_NAME);
  }
}
