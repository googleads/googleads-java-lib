...
public class NumberRuleItem  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201802.rm.NumberKey key;

    /* <span class="constraint Required">This field is required and
     * should not be {@code null}.</span> */
    private com.google.api.ads.adwords.axis.v201802.rm.NumberRuleItemNumberOperator op;
    ...
    public NumberRuleItem(
           com.google.api.ads.adwords.axis.v201802.rm.NumberKey key,
           com.google.api.ads.adwords.axis.v201802.rm.NumberRuleItemNumberOperator op,
     ...
     * should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201802.rm.NumberKey getKey() {
        return key;
    }
     ...
     * should not be {@code null}.</span>
     */
    public void setKey(com.google.api.ads.adwords.axis.v201802.rm.NumberKey key) {
        this.key = key;
    }
     ...
     * should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201802.rm.NumberRuleItemNumberOperator getOp() {
        return op;
    }
     ...
     * should not be {@code null}.</span>
     */
    public void setOp(com.google.api.ads.adwords.axis.v201802.rm.NumberRuleItemNumberOperator op) {
        this.op = op;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201802", "NumberRuleItem"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201802", "NumberKey"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201802", "NumberRuleItem.NumberOperator"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
