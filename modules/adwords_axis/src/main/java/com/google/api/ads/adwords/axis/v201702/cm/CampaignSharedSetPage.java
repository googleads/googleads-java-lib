 ...
 */
public class CampaignSharedSetPage  extends com.google.api.ads.adwords.axis.v201702.cm.NullStatsPage  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201702.cm.CampaignSharedSet>{
    private com.google.api.ads.adwords.axis.v201702.cm.CampaignSharedSet[] entries;
    ...
    public CampaignSharedSetPage(
           ...
           com.google.api.ads.adwords.axis.v201702.cm.CampaignSharedSet[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     * @return entries
     */
    public com.google.api.ads.adwords.axis.v201702.cm.CampaignSharedSet[] getEntries() {
        return entries;
    }
     ...
     * @param entries
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201702.cm.CampaignSharedSet[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201702.cm.CampaignSharedSet getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201702.cm.CampaignSharedSet _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201702.cm.CampaignSharedSet> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201702.cm.CampaignSharedSet>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201702.cm.CampaignSharedSet>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "CampaignSharedSetPage"));
