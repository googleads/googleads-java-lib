 ...
 */
public class AdGroupCriterionReturnValue  extends com.google.api.ads.adwords.axis.v201802.cm.ListReturnValue  implements java.io.Serializable {
    /* List of adgroup criteria. */
    private com.google.api.ads.adwords.axis.v201802.cm.AdGroupCriterion[] value;
    ...
    public AdGroupCriterionReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201802.cm.AdGroupCriterion[] value,
     ...
     */
    public com.google.api.ads.adwords.axis.v201802.cm.AdGroupCriterion[] getValue() {
        return value;
    }
     ...
     */
    public void setValue(com.google.api.ads.adwords.axis.v201802.cm.AdGroupCriterion[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201802.cm.AdGroupCriterion getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201802.cm.AdGroupCriterion _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "AdGroupCriterionReturnValue"));
