...
public class BiddingStrategyErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_DELETE_ASSOCIATED_STRATEGY = "CANNOT_DELETE_ASSOCIATED_STRATEGY";
    ...
    public static final BiddingStrategyErrorReason CANNOT_DELETE_ASSOCIATED_STRATEGY = new BiddingStrategyErrorReason(_CANNOT_DELETE_ASSOCIATED_STRATEGY);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "BiddingStrategyError.Reason"));
    }
    /**
