...
public class CampaignSharedSetStatus implements java.io.Serializable {
    ...
    public static final CampaignSharedSetStatus ENABLED = new CampaignSharedSetStatus(_ENABLED);
    public static final CampaignSharedSetStatus REMOVED = new CampaignSharedSetStatus(_REMOVED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "CampaignSharedSet.Status"));
    }
    /**
