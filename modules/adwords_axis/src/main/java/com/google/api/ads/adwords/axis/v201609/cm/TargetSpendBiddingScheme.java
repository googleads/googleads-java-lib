 ...
 * AdX.</span>
 */
public class TargetSpendBiddingScheme  extends com.google.api.ads.adwords.axis.v201609.cm.BiddingScheme  implements java.io.Serializable {
     ...
     *                     <span class="constraint InRange">This field must
     * be greater than or equal to 0.</span> */
    private com.google.api.ads.adwords.axis.v201609.cm.Money spendTarget;
    ...
    public TargetSpendBiddingScheme(
           ...
           com.google.api.ads.adwords.axis.v201609.cm.Money spendTarget) {
        super(
            biddingSchemeType);
     ...
     * be greater than or equal to 0.</span>
     */
    public com.google.api.ads.adwords.axis.v201609.cm.Money getSpendTarget() {
        return spendTarget;
    }
     ...
     * be greater than or equal to 0.</span>
     */
    public void setSpendTarget(com.google.api.ads.adwords.axis.v201609.cm.Money spendTarget) {
        this.spendTarget = spendTarget;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "TargetSpendBiddingScheme"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "spendTarget"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "Money"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
