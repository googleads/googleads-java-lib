 ...
 */
public class FeedPage  extends com.google.api.ads.adwords.axis.v201702.cm.NullStatsPage  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201702.cm.Feed>{
    /* The resulting Feeds. */
    private com.google.api.ads.adwords.axis.v201702.cm.Feed[] entries;
    ...
    public FeedPage(
           ...
           com.google.api.ads.adwords.axis.v201702.cm.Feed[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201702.cm.Feed[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201702.cm.Feed[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201702.cm.Feed getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201702.cm.Feed _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201702.cm.Feed> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201702.cm.Feed>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201702.cm.Feed>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "FeedPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "Feed"));
