...
public class ExperimentServingStatus implements java.io.Serializable {
    ...
    public static final ExperimentServingStatus DELETED = new ExperimentServingStatus(_DELETED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "ExperimentServingStatus"));
    }
    /**
