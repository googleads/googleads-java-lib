...
public class CampaignExtensionSetting  implements java.io.Serializable {
     ...
     *                 <span class="constraint Required">This field is required
     * and should not be {@code null}.</span> */
    private com.google.api.ads.adwords.axis.v201506.cm.FeedType extensionType;
     ...
     * : ADD, SET.</span> */
    private com.google.api.ads.adwords.axis.v201506.cm.ExtensionSetting extensionSetting;
    ...
    public CampaignExtensionSetting(
           ...
           com.google.api.ads.adwords.axis.v201506.cm.FeedType extensionType,
           com.google.api.ads.adwords.axis.v201506.cm.ExtensionSetting extensionSetting) {
     ...
     * and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201506.cm.FeedType getExtensionType() {
     ...
     * and should not be {@code null}.</span>
     */
    public void setExtensionType(com.google.api.ads.adwords.axis.v201506.cm.FeedType extensionType) {
        this.extensionType = extensionType;
    }
     ...
     * : ADD, SET.</span>
     */
    public com.google.api.ads.adwords.axis.v201506.cm.ExtensionSetting getExtensionSetting() {
     ...
     * : ADD, SET.</span>
     */
    public void setExtensionSetting(com.google.api.ads.adwords.axis.v201506.cm.ExtensionSetting extensionSetting) {
        this.extensionSetting = extensionSetting;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "CampaignExtensionSetting"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "extensionType"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "Feed.Type"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("extensionSetting");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "extensionSetting"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "ExtensionSetting"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
