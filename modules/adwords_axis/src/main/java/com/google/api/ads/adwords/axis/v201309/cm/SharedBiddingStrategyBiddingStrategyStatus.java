...
public class SharedBiddingStrategyBiddingStrategyStatus implements java.io.Serializable {
    ...
    public static final SharedBiddingStrategyBiddingStrategyStatus ACTIVE = new SharedBiddingStrategyBiddingStrategyStatus(_ACTIVE);
    public static final SharedBiddingStrategyBiddingStrategyStatus DELETED = new SharedBiddingStrategyBiddingStrategyStatus(_DELETED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "SharedBiddingStrategy.BiddingStrategyStatus"));
    }
    /**
