...
public class LabelPage  extends com.google.api.ads.adwords.axis.v201609.cm.NoStatsPage  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201609.cm.Label>{
    ...
    public LabelPage(
           ...
           com.google.api.ads.adwords.axis.v201609.cm.Label[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201609.cm.Label[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201609.cm.Label[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201609.cm.Label getEntries(int i) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "LabelPage"));
