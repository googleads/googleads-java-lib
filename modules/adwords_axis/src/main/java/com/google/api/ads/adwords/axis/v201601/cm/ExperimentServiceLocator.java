...
public class ExperimentServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.adwords.axis.v201601.cm.ExperimentService {
    ...
    private java.lang.String ExperimentServiceInterfacePort_address = "https://adwords.google.com/api/adwords/cm/v201601/ExperimentService";
    ...
    public com.google.api.ads.adwords.axis.v201601.cm.ExperimentServiceInterface getExperimentServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.adwords.axis.v201601.cm.ExperimentServiceInterface getExperimentServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.adwords.axis.v201601.cm.ExperimentServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201601.cm.ExperimentServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.adwords.axis.v201601.cm.ExperimentServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.adwords.axis.v201601.cm.ExperimentServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201601.cm.ExperimentServiceSoapBindingStub(new java.net.URL(ExperimentServiceInterfacePort_address), this);
                _stub.setPortName(getExperimentServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201601", "ExperimentService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201601", "ExperimentServiceInterfacePort"));
        }
