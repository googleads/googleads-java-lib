...
public class ExpressBusinessStatus implements java.io.Serializable {
    ...
    public static final ExpressBusinessStatus ACTIVE = new ExpressBusinessStatus(_ACTIVE);
    public static final ExpressBusinessStatus DELETED = new ExpressBusinessStatus(_DELETED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201402", "ExpressBusiness.Status"));
    }
    /**
