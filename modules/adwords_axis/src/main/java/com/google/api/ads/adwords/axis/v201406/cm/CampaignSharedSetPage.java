...
public class CampaignSharedSetPage  extends com.google.api.ads.adwords.axis.v201406.cm.NullStatsPage  implements java.io.Serializable {
    ...
    public CampaignSharedSetPage(
           ...
           com.google.api.ads.adwords.axis.v201406.cm.CampaignSharedSet[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     * @return entries
     */
    public com.google.api.ads.adwords.axis.v201406.cm.CampaignSharedSet[] getEntries() {
        return entries;
    }
     ...
     * @param entries
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201406.cm.CampaignSharedSet[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201406.cm.CampaignSharedSet getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201406.cm.CampaignSharedSet _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "CampaignSharedSetPage"));
