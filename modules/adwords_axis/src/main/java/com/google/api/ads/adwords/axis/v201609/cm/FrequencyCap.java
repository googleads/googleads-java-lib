...
public class FrequencyCap  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201609.cm.TimeUnit timeUnit;
    ...
    private com.google.api.ads.adwords.axis.v201609.cm.Level level;
    ...
    public FrequencyCap(
           ...
           com.google.api.ads.adwords.axis.v201609.cm.TimeUnit timeUnit,
           com.google.api.ads.adwords.axis.v201609.cm.Level level) {
     ...
     *                 Only the Day, Week and Month time units are supported.
     */
    public com.google.api.ads.adwords.axis.v201609.cm.TimeUnit getTimeUnit() {
        return timeUnit;
    }
     ...
     *                 Only the Day, Week and Month time units are supported.
     */
    public void setTimeUnit(com.google.api.ads.adwords.axis.v201609.cm.TimeUnit timeUnit) {
        this.timeUnit = timeUnit;
    }
     ...
     * Cap is applied to all the entities of this level in the campaign.
     */
    public com.google.api.ads.adwords.axis.v201609.cm.Level getLevel() {
        return level;
    }
     ...
     * Cap is applied to all the entities of this level in the campaign.
     */
    public void setLevel(com.google.api.ads.adwords.axis.v201609.cm.Level level) {
        this.level = level;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "FrequencyCap"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "timeUnit"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "TimeUnit"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("level");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "level"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "Level"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
