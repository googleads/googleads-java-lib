 ...
 */
public class ProductScope  extends com.google.api.ads.adwords.axis.v201702.cm.Criterion  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201702.cm.ProductDimension[] dimensions;
    ...
    public ProductScope(
           ...
           com.google.api.ads.adwords.axis.v201702.cm.ProductDimension[] dimensions) {
        super(
            id,
            type,
            criterionType);
     ...
     * {@link Operator}s : ADD.</span>
     */
    public com.google.api.ads.adwords.axis.v201702.cm.ProductDimension[] getDimensions() {
        return dimensions;
    }
     ...
     * {@link Operator}s : ADD.</span>
     */
    public void setDimensions(com.google.api.ads.adwords.axis.v201702.cm.ProductDimension[] dimensions) {
        this.dimensions = dimensions;
    }

    public com.google.api.ads.adwords.axis.v201702.cm.ProductDimension getDimensions(int i) {
        return this.dimensions[i];
    }

    public void setDimensions(int i, com.google.api.ads.adwords.axis.v201702.cm.ProductDimension _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "ProductScope"));
