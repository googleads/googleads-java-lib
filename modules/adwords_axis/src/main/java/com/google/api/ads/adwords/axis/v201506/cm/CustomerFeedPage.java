 ...
 */
public class CustomerFeedPage  extends com.google.api.ads.adwords.axis.v201506.cm.NullStatsPage  implements java.io.Serializable {
    /* The resulting CustomerFeeds. */
    private com.google.api.ads.adwords.axis.v201506.cm.CustomerFeed[] entries;
    ...
    public CustomerFeedPage(
           ...
           com.google.api.ads.adwords.axis.v201506.cm.CustomerFeed[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201506.cm.CustomerFeed[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201506.cm.CustomerFeed[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201506.cm.CustomerFeed getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201506.cm.CustomerFeed _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "CustomerFeedPage"));
