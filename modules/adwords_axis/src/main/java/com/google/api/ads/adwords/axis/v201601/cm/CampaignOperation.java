 ...
 *             to {@code REMOVED}.</p>
 */
public class CampaignOperation  extends com.google.api.ads.adwords.axis.v201601.cm.Operation  implements java.io.Serializable {
    /* <span class="constraint Required">This field is required and
     * should not be {@code null}.</span> */
    private com.google.api.ads.adwords.axis.v201601.cm.Campaign operand;
    ...
    public CampaignOperation(
           ...
           com.google.api.ads.adwords.axis.v201601.cm.Campaign operand) {
        super(
            operator,
            operationType);
     ...
     * should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201601.cm.Campaign getOperand() {
        return operand;
    }
     ...
     * should not be {@code null}.</span>
     */
    public void setOperand(com.google.api.ads.adwords.axis.v201601.cm.Campaign operand) {
        this.operand = operand;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201601", "CampaignOperation"));
