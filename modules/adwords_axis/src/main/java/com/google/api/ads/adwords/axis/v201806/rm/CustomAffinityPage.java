 ...
 * call.
 */
public class CustomAffinityPage  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201806.rm.CustomAffinity>{
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201806.rm.CustomAffinity> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201806.rm.CustomAffinity>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201806.rm.CustomAffinity>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201806", "CustomAffinityPage"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201806", "totalNumEntries"));
