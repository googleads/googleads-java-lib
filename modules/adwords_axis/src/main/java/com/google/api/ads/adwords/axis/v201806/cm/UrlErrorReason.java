...
public class UrlErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _FINAL_URL_SUFFIX_MALFORMED = "FINAL_URL_SUFFIX_MALFORMED";
    public static final java.lang.String _INVALID_TAG_IN_FINAL_URL_SUFFIX = "INVALID_TAG_IN_FINAL_URL_SUFFIX";
    ...
    public static final UrlErrorReason FINAL_URL_SUFFIX_MALFORMED = new UrlErrorReason(_FINAL_URL_SUFFIX_MALFORMED);
    public static final UrlErrorReason INVALID_TAG_IN_FINAL_URL_SUFFIX = new UrlErrorReason(_INVALID_TAG_IN_FINAL_URL_SUFFIX);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "UrlError.Reason"));
    }
    /**
