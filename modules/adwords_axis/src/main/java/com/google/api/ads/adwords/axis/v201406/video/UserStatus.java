...
public class UserStatus implements java.io.Serializable {
    ...
    public static final UserStatus UNKNOWN = new UserStatus(_UNKNOWN);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201406", "UserStatus"));
    }
    /**
