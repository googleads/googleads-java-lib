...
public class AdErrorReason implements java.io.Serializable {
    ...
    public static final AdErrorReason CUSTOMER_CONSENT_FOR_CALL_RECORDING_REQUIRED = new AdErrorReason(_CUSTOMER_CONSENT_FOR_CALL_RECORDING_REQUIRED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "AdError.Reason"));
    }
    /**
