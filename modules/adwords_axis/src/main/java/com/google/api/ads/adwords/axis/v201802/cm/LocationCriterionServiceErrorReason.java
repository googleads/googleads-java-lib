...
public class LocationCriterionServiceErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _LOCATION_NAME_TOO_LARGE = "LOCATION_NAME_TOO_LARGE";
    ...
    public static final LocationCriterionServiceErrorReason LOCATION_NAME_TOO_LARGE = new LocationCriterionServiceErrorReason(_LOCATION_NAME_TOO_LARGE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "LocationCriterionServiceError.Reason"));
    }
    /**
