 ...
 */
public class FeedMappingPage  extends com.google.api.ads.adwords.axis.v201607.cm.NullStatsPage  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201607.cm.FeedMapping>{
    /* The resulting FeedMappings */
    private com.google.api.ads.adwords.axis.v201607.cm.FeedMapping[] entries;
    ...
    public FeedMappingPage(
           ...
           com.google.api.ads.adwords.axis.v201607.cm.FeedMapping[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201607.cm.FeedMapping[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201607.cm.FeedMapping[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201607.cm.FeedMapping getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201607.cm.FeedMapping _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201607.cm.FeedMapping> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201607.cm.FeedMapping>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201607.cm.FeedMapping>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201607", "FeedMappingPage"));
