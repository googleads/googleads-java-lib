...
public class CampaignSharedSet  implements java.io.Serializable {
     ...
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201502.cm.CampaignSharedSetStatus status;
    ...
    public CampaignSharedSet(
           ...
           com.google.api.ads.adwords.axis.v201502.cm.SharedSetType sharedSetType,
           java.lang.String campaignName,
           com.google.api.ads.adwords.axis.v201502.cm.CampaignSharedSetStatus status) {
     ...
     * be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201502.cm.SharedSetType getSharedSetType() {
     ...
     * be ignored when sent to the API.</span>
     */
    public void setSharedSetType(com.google.api.ads.adwords.axis.v201502.cm.SharedSetType sharedSetType) {
        this.sharedSetType = sharedSetType;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201502.cm.CampaignSharedSetStatus getStatus() {
        return status;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201502.cm.CampaignSharedSetStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "CampaignSharedSet"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "sharedSetName"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "sharedSetType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "CampaignSharedSet.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
