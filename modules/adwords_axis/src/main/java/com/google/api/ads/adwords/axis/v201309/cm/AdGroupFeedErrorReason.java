...
public class AdGroupFeedErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_OPERATE_ON_DELETED_ADGROUP_FEED = "CANNOT_OPERATE_ON_DELETED_ADGROUP_FEED";
    ...
    public static final java.lang.String _FEEDS_ONLY_UNDER_ENHANCED_CAMPAIGNS = "FEEDS_ONLY_UNDER_ENHANCED_CAMPAIGNS";
    ...
    public static final AdGroupFeedErrorReason CANNOT_OPERATE_ON_DELETED_ADGROUP_FEED = new AdGroupFeedErrorReason(_CANNOT_OPERATE_ON_DELETED_ADGROUP_FEED);
    ...
    public static final AdGroupFeedErrorReason FEEDS_ONLY_UNDER_ENHANCED_CAMPAIGNS = new AdGroupFeedErrorReason(_FEEDS_ONLY_UNDER_ENHANCED_CAMPAIGNS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "AdGroupFeedError.Reason"));
    }
    /**
