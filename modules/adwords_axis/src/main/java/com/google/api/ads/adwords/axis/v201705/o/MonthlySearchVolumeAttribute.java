 ...
 * month.
 */
public class MonthlySearchVolumeAttribute  extends com.google.api.ads.adwords.axis.v201705.o.Attribute  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201705.o.MonthlySearchVolume[] value;
    ...
    public MonthlySearchVolumeAttribute(
           ...
           com.google.api.ads.adwords.axis.v201705.o.MonthlySearchVolume[] value) {
        super(
            attributeType);
        this.value = value;
    }
     ...
     * required and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201705.o.MonthlySearchVolume[] getValue() {
        return value;
    }
     ...
     * required and should not be {@code null}.</span>
     */
    public void setValue(com.google.api.ads.adwords.axis.v201705.o.MonthlySearchVolume[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201705.o.MonthlySearchVolume getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201705.o.MonthlySearchVolume _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201705", "MonthlySearchVolumeAttribute"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201705", "MonthlySearchVolume"));
