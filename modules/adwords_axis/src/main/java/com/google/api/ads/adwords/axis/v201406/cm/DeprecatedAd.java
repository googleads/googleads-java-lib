 ...
 */
public class DeprecatedAd  extends com.google.api.ads.adwords.axis.v201406.cm.Ad  implements java.io.Serializable {
    /* Name of the ad.
    ...
    private com.google.api.ads.adwords.axis.v201406.cm.DeprecatedAdType type;
    ...
    public DeprecatedAd(
           ...
           com.google.api.ads.adwords.axis.v201406.cm.DeprecatedAdType type) {
        super(
            id,
            url,
            displayUrl,
     ...
     * can be selected using the value "Type".</span>
     */
    public com.google.api.ads.adwords.axis.v201406.cm.DeprecatedAdType getType() {
        return type;
    }
     ...
     * can be selected using the value "Type".</span>
     */
    public void setType(com.google.api.ads.adwords.axis.v201406.cm.DeprecatedAdType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "DeprecatedAd"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "DeprecatedAd.Type"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
