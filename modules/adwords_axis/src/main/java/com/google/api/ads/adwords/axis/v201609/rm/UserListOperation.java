...
public class UserListOperation  extends com.google.api.ads.adwords.axis.v201609.cm.Operation  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201609.rm.UserList operand;
    ...
    public UserListOperation(
           ...
           com.google.api.ads.adwords.axis.v201609.rm.UserList operand) {
        super(
            operator,
            operationType);
     ...
     * required and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201609.rm.UserList getOperand() {
        return operand;
    }
     ...
     * required and should not be {@code null}.</span>
     */
    public void setOperand(com.google.api.ads.adwords.axis.v201609.rm.UserList operand) {
        this.operand = operand;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201609", "UserListOperation"));
