 ...
 */
public class BulkMutateJobError  extends com.google.api.ads.adwords.axis.v201601.cm.ApiError  implements java.io.Serializable {
    /* The specific reason for this job handling error. */
    private com.google.api.ads.adwords.axis.v201601.cm.BulkMutateJobErrorReason reason;
    ...
    public BulkMutateJobError(
           ...
           com.google.api.ads.adwords.axis.v201601.cm.BulkMutateJobErrorReason reason) {
        super(
            fieldPath,
            trigger,
            errorString,
     ...
     */
    public com.google.api.ads.adwords.axis.v201601.cm.BulkMutateJobErrorReason getReason() {
        return reason;
    }
     ...
     */
    public void setReason(com.google.api.ads.adwords.axis.v201601.cm.BulkMutateJobErrorReason reason) {
        this.reason = reason;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201601", "BulkMutateJobError"));
