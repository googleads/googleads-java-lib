 ...
 * the media.
 */
public class MediaPage  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201609.cm.Media>{
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201609.cm.Media[] entries;
    ...
    public MediaPage(
           com.google.api.ads.adwords.axis.v201609.cm.Media[] entries,
     ...
     */
    public com.google.api.ads.adwords.axis.v201609.cm.Media[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201609.cm.Media[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201609.cm.Media getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201609.cm.Media _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201609.cm.Media> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201609.cm.Media>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201609.cm.Media>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "MediaPage"));
