...
public class BatchJob  implements java.io.Serializable {
     ...
     * only and will be ignored when sent to the API for the following {@link
     * Operator}s: ADD.</span> */
    private com.google.api.ads.adwords.axis.v201702.cm.BatchJobStatus status;
    ...
    private com.google.api.ads.adwords.axis.v201702.cm.ProgressStats progressStats;
    ...
    private com.google.api.ads.adwords.axis.v201702.cm.TemporaryUrl uploadUrl;
     ...
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201702.cm.TemporaryUrl downloadUrl;
     ...
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201702.cm.BatchJobProcessingError[] processingErrors;
    ...
    public BatchJob(
           java.lang.Long id,
           com.google.api.ads.adwords.axis.v201702.cm.BatchJobStatus status,
           com.google.api.ads.adwords.axis.v201702.cm.ProgressStats progressStats,
           com.google.api.ads.adwords.axis.v201702.cm.TemporaryUrl uploadUrl,
           com.google.api.ads.adwords.axis.v201702.cm.TemporaryUrl downloadUrl,
           com.google.api.ads.adwords.axis.v201702.cm.BatchJobProcessingError[] processingErrors,
     ...
     * Operator}s: ADD.</span>
     */
    public com.google.api.ads.adwords.axis.v201702.cm.BatchJobStatus getStatus() {
        return status;
    }
     ...
     * Operator}s: ADD.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201702.cm.BatchJobStatus status) {
        this.status = status;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201702.cm.ProgressStats getProgressStats() {
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setProgressStats(com.google.api.ads.adwords.axis.v201702.cm.ProgressStats progressStats) {
        this.progressStats = progressStats;
    }
     ...
     * be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201702.cm.TemporaryUrl getUploadUrl() {
        return uploadUrl;
    }
     ...
     * be ignored when sent to the API.</span>
     */
    public void setUploadUrl(com.google.api.ads.adwords.axis.v201702.cm.TemporaryUrl uploadUrl) {
        this.uploadUrl = uploadUrl;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201702.cm.TemporaryUrl getDownloadUrl() {
        return downloadUrl;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setDownloadUrl(com.google.api.ads.adwords.axis.v201702.cm.TemporaryUrl downloadUrl) {
        this.downloadUrl = downloadUrl;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201702.cm.BatchJobProcessingError[] getProcessingErrors() {
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setProcessingErrors(com.google.api.ads.adwords.axis.v201702.cm.BatchJobProcessingError[] processingErrors) {
        this.processingErrors = processingErrors;
    }

    public com.google.api.ads.adwords.axis.v201702.cm.BatchJobProcessingError getProcessingErrors(int i) {
        return this.processingErrors[i];
    }

    public void setProcessingErrors(int i, com.google.api.ads.adwords.axis.v201702.cm.BatchJobProcessingError _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "BatchJob"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "BatchJobStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("progressStats");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "progressStats"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "ProgressStats"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("uploadUrl");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "uploadUrl"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "TemporaryUrl"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("downloadUrl");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "downloadUrl"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "TemporaryUrl"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "processingErrors"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "BatchJobProcessingError"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "diskUsageQuotaBalance"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
