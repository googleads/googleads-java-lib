...
public class ServingInfo  implements java.io.Serializable {
    /* The list of issues. */
    private com.google.api.ads.adwords.axis.v201402.video.ServingIssue[] issues;

    private com.google.api.ads.adwords.axis.v201402.video.ServingStatus servingStatus;

    public ServingInfo() {
    }

    public ServingInfo(
           com.google.api.ads.adwords.axis.v201402.video.ServingIssue[] issues,
           com.google.api.ads.adwords.axis.v201402.video.ServingStatus servingStatus) {
           this.issues = issues;
     ...
     */
    public com.google.api.ads.adwords.axis.v201402.video.ServingIssue[] getIssues() {
        return issues;
    }
     ...
     */
    public void setIssues(com.google.api.ads.adwords.axis.v201402.video.ServingIssue[] issues) {
        this.issues = issues;
    }

    public com.google.api.ads.adwords.axis.v201402.video.ServingIssue getIssues(int i) {
        return this.issues[i];
    }

    public void setIssues(int i, com.google.api.ads.adwords.axis.v201402.video.ServingIssue _value) {
     ...
     */
    public com.google.api.ads.adwords.axis.v201402.video.ServingStatus getServingStatus() {
        return servingStatus;
    }
     ...
     * @param servingStatus
     */
    public void setServingStatus(com.google.api.ads.adwords.axis.v201402.video.ServingStatus servingStatus) {
        this.servingStatus = servingStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "ServingInfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "ServingIssue"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "servingStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "ServingStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
