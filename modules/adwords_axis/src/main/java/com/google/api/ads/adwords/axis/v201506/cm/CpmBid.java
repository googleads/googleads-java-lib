 ...
 */
public class CpmBid  extends com.google.api.ads.adwords.axis.v201506.cm.Bids  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201506.cm.BidSource cpmBidSource;
    ...
    public CpmBid(
           ...
           com.google.api.ads.adwords.axis.v201506.cm.BidSource cpmBidSource) {
        super(
            bidsType);
        this.bid = bid;
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201506.cm.BidSource getCpmBidSource() {
        return cpmBidSource;
    }
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public void setCpmBidSource(com.google.api.ads.adwords.axis.v201506.cm.BidSource cpmBidSource) {
        this.cpmBidSource = cpmBidSource;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "CpmBid"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "cpmBidSource"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "BidSource"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
