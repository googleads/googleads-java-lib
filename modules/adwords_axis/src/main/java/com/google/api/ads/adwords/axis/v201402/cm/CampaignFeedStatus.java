...
public class CampaignFeedStatus implements java.io.Serializable {
    ...
    public static final CampaignFeedStatus ACTIVE = new CampaignFeedStatus(_ACTIVE);
    public static final CampaignFeedStatus DELETED = new CampaignFeedStatus(_DELETED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "CampaignFeed.Status"));
    }
    /**
