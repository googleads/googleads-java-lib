 ...
 * call.
 */
public class FeedItemTargetReturnValue  extends com.google.api.ads.adwords.axis.v201806.cm.ListReturnValue  implements java.io.Serializable {
    /* The resulting FeedItemTargets. */
    private com.google.api.ads.adwords.axis.v201806.cm.FeedItemTarget[] value;
    ...
    public FeedItemTargetReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201806.cm.FeedItemTarget[] value,
     ...
     */
    public com.google.api.ads.adwords.axis.v201806.cm.FeedItemTarget[] getValue() {
        return value;
    }
     ...
     */
    public void setValue(com.google.api.ads.adwords.axis.v201806.cm.FeedItemTarget[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201806.cm.FeedItemTarget getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201806.cm.FeedItemTarget _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "FeedItemTargetReturnValue"));
