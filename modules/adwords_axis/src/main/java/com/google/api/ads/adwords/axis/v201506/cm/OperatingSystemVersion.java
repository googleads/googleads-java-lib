 ...
 * AdX.</span>
 */
public class OperatingSystemVersion  extends com.google.api.ads.adwords.axis.v201506.cm.Criterion  implements java.io.Serializable {
     ...
     *                     <span class="constraint ReadOnly">This field is
     * read only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201506.cm.OperatingSystemVersionOperatorType operatorType;
    ...
    public OperatingSystemVersion(
           ...
           com.google.api.ads.adwords.axis.v201506.cm.OperatingSystemVersionOperatorType operatorType) {
        super(
            id,
            type,
            criterionType);
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201506.cm.OperatingSystemVersionOperatorType getOperatorType() {
        return operatorType;
    }
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public void setOperatorType(com.google.api.ads.adwords.axis.v201506.cm.OperatingSystemVersionOperatorType operatorType) {
        this.operatorType = operatorType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "OperatingSystemVersion"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "osMajorVersion"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "osMinorVersion"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "operatorType"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "OperatingSystemVersion.OperatorType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
