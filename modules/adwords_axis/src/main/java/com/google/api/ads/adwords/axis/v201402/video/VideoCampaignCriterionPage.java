...
public class VideoCampaignCriterionPage  extends com.google.api.ads.adwords.axis.v201402.cm.Page  implements java.io.Serializable {
    private com.google.api.ads.adwords.axis.v201402.video.VideoCampaignCriterion[] entries;
    ...
    public VideoCampaignCriterionPage(
           ...
           com.google.api.ads.adwords.axis.v201402.video.VideoCampaignCriterion[] entries,
     ...
     * @return entries
     */
    public com.google.api.ads.adwords.axis.v201402.video.VideoCampaignCriterion[] getEntries() {
        return entries;
    }
     ...
     * @param entries
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201402.video.VideoCampaignCriterion[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201402.video.VideoCampaignCriterion getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201402.video.VideoCampaignCriterion _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "VideoCampaignCriterionPage"));
