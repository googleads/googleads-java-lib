 ...
 */
public class CampaignEstimate  extends com.google.api.ads.adwords.axis.v201607.o.Estimate  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201607.o.AdGroupEstimate[] adGroupEstimates;

    /* Traffic estimates segmented by platform for this campaign. */
    private com.google.api.ads.adwords.axis.v201607.o.PlatformCampaignEstimate[] platformEstimates;
    ...
    public CampaignEstimate(
           ...
           com.google.api.ads.adwords.axis.v201607.o.AdGroupEstimate[] adGroupEstimates,
           com.google.api.ads.adwords.axis.v201607.o.PlatformCampaignEstimate[] platformEstimates) {
        super(
            estimateType);
     ...
     * were sent in the request.
     */
    public com.google.api.ads.adwords.axis.v201607.o.AdGroupEstimate[] getAdGroupEstimates() {
     ...
     * were sent in the request.
     */
    public void setAdGroupEstimates(com.google.api.ads.adwords.axis.v201607.o.AdGroupEstimate[] adGroupEstimates) {
        this.adGroupEstimates = adGroupEstimates;
    }

    public com.google.api.ads.adwords.axis.v201607.o.AdGroupEstimate getAdGroupEstimates(int i) {
        return this.adGroupEstimates[i];
    }

    public void setAdGroupEstimates(int i, com.google.api.ads.adwords.axis.v201607.o.AdGroupEstimate _value) {
     ...
     */
    public com.google.api.ads.adwords.axis.v201607.o.PlatformCampaignEstimate[] getPlatformEstimates() {
     ...
     */
    public void setPlatformEstimates(com.google.api.ads.adwords.axis.v201607.o.PlatformCampaignEstimate[] platformEstimates) {
        this.platformEstimates = platformEstimates;
    }

    public com.google.api.ads.adwords.axis.v201607.o.PlatformCampaignEstimate getPlatformEstimates(int i) {
        return this.platformEstimates[i];
    }

    public void setPlatformEstimates(int i, com.google.api.ads.adwords.axis.v201607.o.PlatformCampaignEstimate _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201607", "CampaignEstimate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201607", "adGroupEstimates"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201607", "AdGroupEstimate"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201607", "platformEstimates"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201607", "PlatformCampaignEstimate"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
