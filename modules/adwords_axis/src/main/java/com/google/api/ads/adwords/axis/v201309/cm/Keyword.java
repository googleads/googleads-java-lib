 ...
 */
public class Keyword  extends com.google.api.ads.adwords.axis.v201309.cm.Criterion  implements java.io.Serializable {
     ...
     * required and should not be {@code null} when it is contained within
     * {@link Operator}s : ADD.</span> */
    private com.google.api.ads.adwords.axis.v201309.cm.KeywordMatchType matchType;
    ...
    public Keyword(
           ...
           com.google.api.ads.adwords.axis.v201309.cm.KeywordMatchType matchType) {
        super(
            id,
            type,
            criterionType);
     ...
     * {@link Operator}s : ADD.</span>
     */
    public com.google.api.ads.adwords.axis.v201309.cm.KeywordMatchType getMatchType() {
        return matchType;
    }
     ...
     * {@link Operator}s : ADD.</span>
     */
    public void setMatchType(com.google.api.ads.adwords.axis.v201309.cm.KeywordMatchType matchType) {
        this.matchType = matchType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "Keyword"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "matchType"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "KeywordMatchType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
