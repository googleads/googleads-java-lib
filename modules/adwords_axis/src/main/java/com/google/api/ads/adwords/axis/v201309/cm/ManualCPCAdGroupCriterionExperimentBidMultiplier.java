 ...
 * AdX.</span>
 */
public class ManualCPCAdGroupCriterionExperimentBidMultiplier  extends com.google.api.ads.adwords.axis.v201309.cm.AdGroupCriterionExperimentBidMultiplier  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201309.cm.MultiplierSource multiplierSource;
    ...
    public ManualCPCAdGroupCriterionExperimentBidMultiplier(
           ...
           com.google.api.ads.adwords.axis.v201309.cm.MultiplierSource multiplierSource) {
        super(
     ...
     * it will be ignored.</span>
     */
    public com.google.api.ads.adwords.axis.v201309.cm.MultiplierSource getMultiplierSource() {
     ...
     * it will be ignored.</span>
     */
    public void setMultiplierSource(com.google.api.ads.adwords.axis.v201309.cm.MultiplierSource multiplierSource) {
        this.multiplierSource = multiplierSource;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "ManualCPCAdGroupCriterionExperimentBidMultiplier"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "multiplierSource"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "MultiplierSource"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
