 ...
 */
public class CpmBid  extends com.google.api.ads.adwords.axis.v201601.cm.Bids  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201601.cm.BidSource cpmBidSource;
    ...
    public CpmBid(
           ...
           com.google.api.ads.adwords.axis.v201601.cm.BidSource cpmBidSource) {
        super(
            bidsType);
        this.bid = bid;
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201601.cm.BidSource getCpmBidSource() {
        return cpmBidSource;
    }
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public void setCpmBidSource(com.google.api.ads.adwords.axis.v201601.cm.BidSource cpmBidSource) {
        this.cpmBidSource = cpmBidSource;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201601", "CpmBid"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201601", "cpmBidSource"));
