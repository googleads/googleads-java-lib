...
public class AdvertisingChannelSubType implements java.io.Serializable {
    ...
    public static final java.lang.String _DISPLAY_SMART_CAMPAIGN = "DISPLAY_SMART_CAMPAIGN";
    ...
    public static final AdvertisingChannelSubType DISPLAY_SMART_CAMPAIGN = new AdvertisingChannelSubType(_DISPLAY_SMART_CAMPAIGN);
    public static final AdvertisingChannelSubType SHOPPING_GOAL_OPTIMIZED_ADS = new AdvertisingChannelSubType(_SHOPPING_GOAL_OPTIMIZED_ADS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "AdvertisingChannelSubType"));
    }
    /**
