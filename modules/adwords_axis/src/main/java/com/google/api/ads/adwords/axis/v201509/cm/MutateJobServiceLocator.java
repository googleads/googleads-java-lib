...
public class MutateJobServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.adwords.axis.v201509.cm.MutateJobService {
    ...
    private java.lang.String MutateJobServiceInterfacePort_address = "https://adwords.google.com/api/adwords/cm/v201509/MutateJobService";
    ...
    public com.google.api.ads.adwords.axis.v201509.cm.MutateJobServiceInterface getMutateJobServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.adwords.axis.v201509.cm.MutateJobServiceInterface getMutateJobServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.adwords.axis.v201509.cm.MutateJobServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201509.cm.MutateJobServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.adwords.axis.v201509.cm.MutateJobServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.adwords.axis.v201509.cm.MutateJobServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201509.cm.MutateJobServiceSoapBindingStub(new java.net.URL(MutateJobServiceInterfacePort_address), this);
                _stub.setPortName(getMutateJobServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "MutateJobService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "MutateJobServiceInterfacePort"));
        }
