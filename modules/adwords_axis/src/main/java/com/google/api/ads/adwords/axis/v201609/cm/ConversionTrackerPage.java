 ...
 * call.
 */
public class ConversionTrackerPage  extends com.google.api.ads.adwords.axis.v201609.cm.NoStatsPage  implements java.io.Serializable {
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201609.cm.ConversionTracker[] entries;
    ...
    public ConversionTrackerPage(
           ...
           com.google.api.ads.adwords.axis.v201609.cm.ConversionTracker[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201609.cm.ConversionTracker[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201609.cm.ConversionTracker[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201609.cm.ConversionTracker getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201609.cm.ConversionTracker _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "ConversionTrackerPage"));
