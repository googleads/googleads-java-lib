...
public class TargetErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_CHANGE_GOOGLE_SEARCH_SETTING = "CANNOT_CHANGE_GOOGLE_SEARCH_SETTING";
    ...
    public static final TargetErrorReason CANNOT_CHANGE_GOOGLE_SEARCH_SETTING = new TargetErrorReason(_CANNOT_CHANGE_GOOGLE_SEARCH_SETTING);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201409", "TargetError.Reason"));
    }
    /**
