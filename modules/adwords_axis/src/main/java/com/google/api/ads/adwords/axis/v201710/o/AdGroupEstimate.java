 ...
 */
public class AdGroupEstimate  extends com.google.api.ads.adwords.axis.v201710.o.Estimate  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201710.o.KeywordEstimate[] keywordEstimates;
    ...
    public AdGroupEstimate(
           ...
           com.google.api.ads.adwords.axis.v201710.o.KeywordEstimate[] keywordEstimates) {
        super(
            estimateType);
     ...
     *                     were sent in the request.
     */
    public com.google.api.ads.adwords.axis.v201710.o.KeywordEstimate[] getKeywordEstimates() {
     ...
     *                     were sent in the request.
     */
    public void setKeywordEstimates(com.google.api.ads.adwords.axis.v201710.o.KeywordEstimate[] keywordEstimates) {
        this.keywordEstimates = keywordEstimates;
    }

    public com.google.api.ads.adwords.axis.v201710.o.KeywordEstimate getKeywordEstimates(int i) {
        return this.keywordEstimates[i];
    }

    public void setKeywordEstimates(int i, com.google.api.ads.adwords.axis.v201710.o.KeywordEstimate _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201710", "AdGroupEstimate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201710", "keywordEstimates"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201710", "KeywordEstimate"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
