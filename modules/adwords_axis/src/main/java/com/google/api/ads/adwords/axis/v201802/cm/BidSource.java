...
public class BidSource implements java.io.Serializable {
    ...
    public static final java.lang.String _ADGROUP_BIDDING_STRATEGY = "ADGROUP_BIDDING_STRATEGY";
    public static final java.lang.String _CAMPAIGN_BIDDING_STRATEGY = "CAMPAIGN_BIDDING_STRATEGY";
    ...
    public static final BidSource ADGROUP_BIDDING_STRATEGY = new BidSource(_ADGROUP_BIDDING_STRATEGY);
    public static final BidSource CAMPAIGN_BIDDING_STRATEGY = new BidSource(_CAMPAIGN_BIDDING_STRATEGY);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "BidSource"));
    }
    /**
