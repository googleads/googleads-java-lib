...
public class TargetingGroupAssociation  implements java.io.Serializable {
     ...
     *                 <span class="constraint Required">This field is required
     * and should not be {@code null}.</span> */
    private com.google.api.ads.adwords.axis.v201402.video.TargetingGroupAssociationStatus status;
    ...
    public TargetingGroupAssociation(
           ...
           com.google.api.ads.adwords.axis.v201402.video.TargetingGroupAssociationStatus status) {
     ...
     * and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201402.video.TargetingGroupAssociationStatus getStatus() {
        return status;
    }
     ...
     * and should not be {@code null}.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201402.video.TargetingGroupAssociationStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "TargetingGroupAssociation"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "TargetingGroupAssociation.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
