...
public class CampaignAdExtensionErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_ADD_DELETED_CAMPAIGN_ADEXTENSION = "CANNOT_ADD_DELETED_CAMPAIGN_ADEXTENSION";
    public static final java.lang.String _CANNOT_OPERATE_ON_DELETED_CAMPAIGN_ADEXTENSION = "CANNOT_OPERATE_ON_DELETED_CAMPAIGN_ADEXTENSION";
    ...
    public static final java.lang.String _MUST_USE_CONCRETE_ADEXTENSION_DURING_ADD = "MUST_USE_CONCRETE_ADEXTENSION_DURING_ADD";
    ...
    public static final CampaignAdExtensionErrorReason CANNOT_ADD_DELETED_CAMPAIGN_ADEXTENSION = new CampaignAdExtensionErrorReason(_CANNOT_ADD_DELETED_CAMPAIGN_ADEXTENSION);
    public static final CampaignAdExtensionErrorReason CANNOT_OPERATE_ON_DELETED_CAMPAIGN_ADEXTENSION = new CampaignAdExtensionErrorReason(_CANNOT_OPERATE_ON_DELETED_CAMPAIGN_ADEXTENSION);
    ...
    public static final CampaignAdExtensionErrorReason MUST_USE_CONCRETE_ADEXTENSION_DURING_ADD = new CampaignAdExtensionErrorReason(_MUST_USE_CONCRETE_ADEXTENSION_DURING_ADD);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "CampaignAdExtensionError.Reason"));
    }
    /**
