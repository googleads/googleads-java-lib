...
public class OfflineDataUploadServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.adwords.axis.v201708.rm.OfflineDataUploadService {
    ...
    private java.lang.String OfflineDataUploadServiceInterfacePort_address = "https://adwords.google.com/api/adwords/rm/v201708/OfflineDataUploadService";
    ...
    public com.google.api.ads.adwords.axis.v201708.rm.OfflineDataUploadServiceInterface getOfflineDataUploadServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.adwords.axis.v201708.rm.OfflineDataUploadServiceInterface getOfflineDataUploadServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.adwords.axis.v201708.rm.OfflineDataUploadServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201708.rm.OfflineDataUploadServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.adwords.axis.v201708.rm.OfflineDataUploadServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.adwords.axis.v201708.rm.OfflineDataUploadServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201708.rm.OfflineDataUploadServiceSoapBindingStub(new java.net.URL(OfflineDataUploadServiceInterfacePort_address), this);
                _stub.setPortName(getOfflineDataUploadServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201708", "OfflineDataUploadService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201708", "OfflineDataUploadServiceInterfacePort"));
        }
