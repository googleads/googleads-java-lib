 ...
 * call.
 */
public class AdGroupExtensionSettingReturnValue  extends com.google.api.ads.adwords.axis.v201802.cm.ListReturnValue  implements java.io.Serializable {
    /* The resulting AdGroupExtensionSettings. */
    private com.google.api.ads.adwords.axis.v201802.cm.AdGroupExtensionSetting[] value;
    ...
    public AdGroupExtensionSettingReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201802.cm.AdGroupExtensionSetting[] value,
     ...
     */
    public com.google.api.ads.adwords.axis.v201802.cm.AdGroupExtensionSetting[] getValue() {
        return value;
    }
     ...
     */
    public void setValue(com.google.api.ads.adwords.axis.v201802.cm.AdGroupExtensionSetting[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201802.cm.AdGroupExtensionSetting getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201802.cm.AdGroupExtensionSetting _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "AdGroupExtensionSettingReturnValue"));
