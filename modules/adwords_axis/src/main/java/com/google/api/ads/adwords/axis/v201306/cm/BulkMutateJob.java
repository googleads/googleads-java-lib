 ...
 */
public class BulkMutateJob  extends com.google.api.ads.adwords.axis.v201306.cm.Job  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201306.cm.BulkMutateJobPolicy policy;
    ...
    private com.google.api.ads.adwords.axis.v201306.cm.BulkMutateRequest request;
     ...
     * read only and should not be set.  If this field is sent to the API,
     * it will be ignored.</span> */
    private com.google.api.ads.adwords.axis.v201306.cm.BulkMutateJobEvent[] history;

    /* The selected result part of this job.
     *                     <span class="constraint ReadOnly">This field is
     * read only and should not be set.  If this field is sent to the API,
     * it will be ignored.</span> */
    private com.google.api.ads.adwords.axis.v201306.cm.BulkMutateResult result;
    ...
    public BulkMutateJob(
           com.google.api.ads.adwords.axis.v201306.cm.ApiErrorReason failureReason,
           com.google.api.ads.adwords.axis.v201306.cm.JobStats stats,
           com.google.api.ads.adwords.axis.v201306.cm.BillingSummary billingSummary,
           java.lang.String jobType,
           java.lang.Long id,
           com.google.api.ads.adwords.axis.v201306.cm.BulkMutateJobPolicy policy,
           com.google.api.ads.adwords.axis.v201306.cm.BulkMutateRequest request,
           com.google.api.ads.adwords.axis.v201306.cm.BasicJobStatus status,
           com.google.api.ads.adwords.axis.v201306.cm.BulkMutateJobEvent[] history,
           com.google.api.ads.adwords.axis.v201306.cm.BulkMutateResult result,
     ...
     * SET.  If this field is sent to the API, it will be ignored.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.BulkMutateJobPolicy getPolicy() {
        return policy;
    }
     ...
     * SET.  If this field is sent to the API, it will be ignored.</span>
     */
    public void setPolicy(com.google.api.ads.adwords.axis.v201306.cm.BulkMutateJobPolicy policy) {
        this.policy = policy;
    }
     ...
     * {@link Operator}s : ADD.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.BulkMutateRequest getRequest() {
        return request;
    }
     ...
     * {@link Operator}s : ADD.</span>
     */
    public void setRequest(com.google.api.ads.adwords.axis.v201306.cm.BulkMutateRequest request) {
        this.request = request;
    }
     ...
     * it will be ignored.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.BulkMutateJobEvent[] getHistory() {
        return history;
    }
     ...
     * it will be ignored.</span>
     */
    public void setHistory(com.google.api.ads.adwords.axis.v201306.cm.BulkMutateJobEvent[] history) {
        this.history = history;
    }

    public com.google.api.ads.adwords.axis.v201306.cm.BulkMutateJobEvent getHistory(int i) {
        return this.history[i];
    }

    public void setHistory(int i, com.google.api.ads.adwords.axis.v201306.cm.BulkMutateJobEvent _value) {
     ...
     * it will be ignored.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.BulkMutateResult getResult() {
        return result;
    }
     ...
     * it will be ignored.</span>
     */
    public void setResult(com.google.api.ads.adwords.axis.v201306.cm.BulkMutateResult result) {
        this.result = result;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "BulkMutateJob"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "policy"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "BulkMutateJobPolicy"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("request");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "request"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "BulkMutateRequest"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "history"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "BulkMutateJobEvent"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "result"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "numRequestParts"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "numRequestPartsReceived"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
