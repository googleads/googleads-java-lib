...
public class VideoTargetingGroupCriterionServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.adwords.axis.v201406.video.VideoTargetingGroupCriterionService {
    ...
    private java.lang.String VideoTargetingGroupCriterionServiceInterfacePort_address = "https://adwords.google.com/api/adwords/video/v201406/VideoTargetingGroupCriterionService";
    ...
    public com.google.api.ads.adwords.axis.v201406.video.VideoTargetingGroupCriterionServiceInterface getVideoTargetingGroupCriterionServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.adwords.axis.v201406.video.VideoTargetingGroupCriterionServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201406.video.VideoTargetingGroupCriterionServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.adwords.axis.v201406.video.VideoTargetingGroupCriterionServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.adwords.axis.v201406.video.VideoTargetingGroupCriterionServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201406.video.VideoTargetingGroupCriterionServiceSoapBindingStub(new java.net.URL(VideoTargetingGroupCriterionServiceInterfacePort_address), this);
                _stub.setPortName(getVideoTargetingGroupCriterionServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201406", "VideoTargetingGroupCriterionService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201406", "VideoTargetingGroupCriterionServiceInterfacePort"));
        }
