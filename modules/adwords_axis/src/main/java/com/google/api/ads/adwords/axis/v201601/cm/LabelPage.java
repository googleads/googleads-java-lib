 ...
 */
public class LabelPage  extends com.google.api.ads.adwords.axis.v201601.cm.NoStatsPage  implements java.io.Serializable {
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201601.cm.Label[] entries;
    ...
    public LabelPage(
           ...
           com.google.api.ads.adwords.axis.v201601.cm.Label[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201601.cm.Label[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201601.cm.Label[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201601.cm.Label getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201601.cm.Label _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201601", "LabelPage"));
