...
public class FeedMappingStatus implements java.io.Serializable {
    ...
    public static final FeedMappingStatus ACTIVE = new FeedMappingStatus(_ACTIVE);
    public static final FeedMappingStatus DELETED = new FeedMappingStatus(_DELETED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "FeedMapping.Status"));
    }
    /**
