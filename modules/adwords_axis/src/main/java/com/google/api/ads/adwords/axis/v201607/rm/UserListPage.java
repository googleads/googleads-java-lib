 ...
 */
public class UserListPage  extends com.google.api.ads.adwords.axis.v201607.cm.Page  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201607.rm.UserList>{
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201607.rm.UserList[] entries;
    ...
    public UserListPage(
           ...
           com.google.api.ads.adwords.axis.v201607.rm.UserList[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201607.rm.UserList[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201607.rm.UserList[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201607.rm.UserList getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201607.rm.UserList _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201607.rm.UserList> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201607.rm.UserList>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201607.rm.UserList>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201607", "UserListPage"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("entries");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201607", "entries"));
