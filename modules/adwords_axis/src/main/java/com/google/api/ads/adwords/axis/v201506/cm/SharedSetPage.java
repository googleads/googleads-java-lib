 ...
 */
public class SharedSetPage  extends com.google.api.ads.adwords.axis.v201506.cm.NullStatsPage  implements java.io.Serializable {
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201506.cm.SharedSet[] entries;
    ...
    public SharedSetPage(
           ...
           com.google.api.ads.adwords.axis.v201506.cm.SharedSet[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201506.cm.SharedSet[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201506.cm.SharedSet[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201506.cm.SharedSet getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201506.cm.SharedSet _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "SharedSetPage"));
