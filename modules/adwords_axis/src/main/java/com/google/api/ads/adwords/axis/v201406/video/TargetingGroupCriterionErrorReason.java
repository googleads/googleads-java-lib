...
public class TargetingGroupCriterionErrorReason implements java.io.Serializable {
    ...
    public static final TargetingGroupCriterionErrorReason TOO_MANY_OPERTAIONS = new TargetingGroupCriterionErrorReason(_TOO_MANY_OPERTAIONS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201406", "TargetingGroupCriterionError.Reason"));
    }
    /**
