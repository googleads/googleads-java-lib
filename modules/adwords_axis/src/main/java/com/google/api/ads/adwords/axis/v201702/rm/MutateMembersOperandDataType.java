...
public class MutateMembersOperandDataType implements java.io.Serializable {
    ...
    public static final java.lang.String _MOBILE_ID = "MOBILE_ID";
    public static final MutateMembersOperandDataType EMAIL_SHA256 = new MutateMembersOperandDataType(_EMAIL_SHA256);
    public static final MutateMembersOperandDataType MOBILE_ID = new MutateMembersOperandDataType(_MOBILE_ID);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201702", "MutateMembersOperand.DataType"));
    }
    /**
