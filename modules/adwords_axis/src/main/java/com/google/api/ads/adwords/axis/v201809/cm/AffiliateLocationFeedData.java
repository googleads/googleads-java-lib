 ...
 */
public class AffiliateLocationFeedData  extends com.google.api.ads.adwords.axis.v201809.cm.SystemFeedGenerationData  implements java.io.Serializable {
    /* The list of chains that the Affiliate Location Feed will sync
     * the locations from. */
    private com.google.api.ads.adwords.axis.v201809.cm.Chain[] chains;

    /* The relationship the chains have with the advertiser. */
    private com.google.api.ads.adwords.axis.v201809.cm.RelationshipType relationshipType;
    ...
    public AffiliateLocationFeedData(
           ...
           com.google.api.ads.adwords.axis.v201809.cm.Chain[] chains,
           com.google.api.ads.adwords.axis.v201809.cm.RelationshipType relationshipType) {
        super(
     ...
     * the locations from.
     */
    public void setChains(com.google.api.ads.adwords.axis.v201809.cm.Chain[] chains) {
        this.chains = chains;
    }

    public com.google.api.ads.adwords.axis.v201809.cm.Chain getChains(int i) {
        return this.chains[i];
    }

    public void setChains(int i, com.google.api.ads.adwords.axis.v201809.cm.Chain _value) {
     ...
     */
    public com.google.api.ads.adwords.axis.v201809.cm.RelationshipType getRelationshipType() {
     ...
     */
    public void setRelationshipType(com.google.api.ads.adwords.axis.v201809.cm.RelationshipType relationshipType) {
        this.relationshipType = relationshipType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "AffiliateLocationFeedData"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("chains");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "chains"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "Chain"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "relationshipType"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "RelationshipType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
