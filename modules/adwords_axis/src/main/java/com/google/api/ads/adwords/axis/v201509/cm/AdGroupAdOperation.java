 ...
 */
public class AdGroupAdOperation  extends com.google.api.ads.adwords.axis.v201509.cm.Operation  implements java.io.Serializable {
    /* AdGroupAd to operate on.
     *                     <span class="constraint Required">This field is
     * required and should not be {@code null}.</span> */
    private com.google.api.ads.adwords.axis.v201509.cm.AdGroupAd operand;

    /* Exemption requests for any policy violations in this Ad.  This
     * field is
     *                     only used for ADD operations */
    private com.google.api.ads.adwords.axis.v201509.cm.ExemptionRequest[] exemptionRequests;
    ...
    public AdGroupAdOperation(
           ...
           com.google.api.ads.adwords.axis.v201509.cm.AdGroupAd operand,
           com.google.api.ads.adwords.axis.v201509.cm.ExemptionRequest[] exemptionRequests) {
        super(
            operator,
            operationType);
     ...
     * required and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201509.cm.AdGroupAd getOperand() {
        return operand;
    }
     ...
     * required and should not be {@code null}.</span>
     */
    public void setOperand(com.google.api.ads.adwords.axis.v201509.cm.AdGroupAd operand) {
        this.operand = operand;
    }
     ...
     *                     only used for ADD operations
     */
    public com.google.api.ads.adwords.axis.v201509.cm.ExemptionRequest[] getExemptionRequests() {
     ...
     *                     only used for ADD operations
     */
    public void setExemptionRequests(com.google.api.ads.adwords.axis.v201509.cm.ExemptionRequest[] exemptionRequests) {
        this.exemptionRequests = exemptionRequests;
    }

    public com.google.api.ads.adwords.axis.v201509.cm.ExemptionRequest getExemptionRequests(int i) {
        return this.exemptionRequests[i];
    }

    public void setExemptionRequests(int i, com.google.api.ads.adwords.axis.v201509.cm.ExemptionRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "AdGroupAdOperation"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "exemptionRequests"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "ExemptionRequest"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
