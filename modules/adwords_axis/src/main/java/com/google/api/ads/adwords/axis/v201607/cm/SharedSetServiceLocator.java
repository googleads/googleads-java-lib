...
public class SharedSetServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.adwords.axis.v201607.cm.SharedSetService {
    ...
    private java.lang.String SharedSetServiceInterfacePort_address = "https://adwords.google.com/api/adwords/cm/v201607/SharedSetService";
    ...
    public com.google.api.ads.adwords.axis.v201607.cm.SharedSetServiceInterface getSharedSetServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.adwords.axis.v201607.cm.SharedSetServiceInterface getSharedSetServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.adwords.axis.v201607.cm.SharedSetServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201607.cm.SharedSetServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.adwords.axis.v201607.cm.SharedSetServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.adwords.axis.v201607.cm.SharedSetServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201607.cm.SharedSetServiceSoapBindingStub(new java.net.URL(SharedSetServiceInterfacePort_address), this);
                _stub.setPortName(getSharedSetServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201607", "SharedSetService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201607", "SharedSetServiceInterfacePort"));
        }
