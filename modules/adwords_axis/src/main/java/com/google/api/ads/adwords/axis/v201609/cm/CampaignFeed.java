...
public class CampaignFeed  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201609.cm.CampaignFeedStatus status;
    ...
    public CampaignFeed(
           ...
           com.google.api.ads.adwords.axis.v201609.cm.CampaignFeedStatus status,
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201609.cm.CampaignFeedStatus getStatus() {
        return status;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201609.cm.CampaignFeedStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "CampaignFeed"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "CampaignFeed.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
