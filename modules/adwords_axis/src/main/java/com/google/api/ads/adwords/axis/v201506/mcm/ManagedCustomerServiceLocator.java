...
public class ManagedCustomerServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.adwords.axis.v201506.mcm.ManagedCustomerService {
    ...
    private java.lang.String ManagedCustomerServiceInterfacePort_address = "https://adwords.google.com/api/adwords/mcm/v201506/ManagedCustomerService";
    ...
    public com.google.api.ads.adwords.axis.v201506.mcm.ManagedCustomerServiceInterface getManagedCustomerServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.adwords.axis.v201506.mcm.ManagedCustomerServiceInterface getManagedCustomerServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.adwords.axis.v201506.mcm.ManagedCustomerServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201506.mcm.ManagedCustomerServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.adwords.axis.v201506.mcm.ManagedCustomerServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.adwords.axis.v201506.mcm.ManagedCustomerServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201506.mcm.ManagedCustomerServiceSoapBindingStub(new java.net.URL(ManagedCustomerServiceInterfacePort_address), this);
                _stub.setPortName(getManagedCustomerServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/mcm/v201506", "ManagedCustomerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/mcm/v201506", "ManagedCustomerServiceInterfacePort"));
        }
