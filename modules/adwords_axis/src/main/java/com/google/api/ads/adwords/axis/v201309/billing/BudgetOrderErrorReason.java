...
public class BudgetOrderErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CUSTOMER_NOT_WHITELISTED_FOR_NEW_BILLING = "CUSTOMER_NOT_WHITELISTED_FOR_NEW_BILLING";
    ...
    public static final java.lang.String _BUDGET_ALREDY_STARTED = "BUDGET_ALREDY_STARTED";
    ...
    public static final BudgetOrderErrorReason CUSTOMER_NOT_WHITELISTED_FOR_NEW_BILLING = new BudgetOrderErrorReason(_CUSTOMER_NOT_WHITELISTED_FOR_NEW_BILLING);
    ...
    public static final BudgetOrderErrorReason BUDGET_ALREDY_STARTED = new BudgetOrderErrorReason(_BUDGET_ALREDY_STARTED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/billing/v201309", "BudgetOrderError.Reason"));
    }
    /**
