 ...
 * call.
 */
public class CampaignLabelReturnValue  extends com.google.api.ads.adwords.axis.v201802.cm.ListReturnValue  implements java.io.Serializable {
    private com.google.api.ads.adwords.axis.v201802.cm.CampaignLabel[] value;
    ...
    public CampaignLabelReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201802.cm.CampaignLabel[] value,
     ...
     * @return value
     */
    public com.google.api.ads.adwords.axis.v201802.cm.CampaignLabel[] getValue() {
        return value;
    }
     ...
     * @param value
     */
    public void setValue(com.google.api.ads.adwords.axis.v201802.cm.CampaignLabel[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201802.cm.CampaignLabel getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201802.cm.CampaignLabel _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "CampaignLabelReturnValue"));
