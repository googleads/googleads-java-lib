...
public class AdCustomizerErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _UNKNOWN_USER_LIST = "UNKNOWN_USER_LIST";
    ...
    public static final AdCustomizerErrorReason UNKNOWN_USER_LIST = new AdCustomizerErrorReason(_UNKNOWN_USER_LIST);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "AdCustomizerError.Reason"));
    }
    /**
