 ...
 * call.
 */
public class BudgetReturnValue  extends com.google.api.ads.adwords.axis.v201802.cm.ListReturnValue  implements java.io.Serializable {
    private com.google.api.ads.adwords.axis.v201802.cm.Budget[] value;
    ...
    public BudgetReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201802.cm.Budget[] value,
     ...
     * @return value
     */
    public com.google.api.ads.adwords.axis.v201802.cm.Budget[] getValue() {
        return value;
    }
     ...
     * @param value
     */
    public void setValue(com.google.api.ads.adwords.axis.v201802.cm.Budget[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201802.cm.Budget getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201802.cm.Budget _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "BudgetReturnValue"));
