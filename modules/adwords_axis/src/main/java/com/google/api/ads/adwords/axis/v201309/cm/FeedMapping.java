...
public class FeedMapping  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201309.cm.FeedMappingStatus status;
     ...
     * and should not be {@code null} when it is contained within {@link
     * Operator}s : ADD.</span> */
    private com.google.api.ads.adwords.axis.v201309.cm.AttributeFieldMapping[] attributeFieldMappings;
    ...
    public FeedMapping(
           ...
           com.google.api.ads.adwords.axis.v201309.cm.FeedMappingStatus status,
           com.google.api.ads.adwords.axis.v201309.cm.AttributeFieldMapping[] attributeFieldMappings) {
     ...
     * will be ignored.</span>
     */
    public com.google.api.ads.adwords.axis.v201309.cm.FeedMappingStatus getStatus() {
        return status;
    }
     ...
     * will be ignored.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201309.cm.FeedMappingStatus status) {
        this.status = status;
    }
     ...
     * Operator}s : ADD.</span>
     */
    public com.google.api.ads.adwords.axis.v201309.cm.AttributeFieldMapping[] getAttributeFieldMappings() {
     ...
     * Operator}s : ADD.</span>
     */
    public void setAttributeFieldMappings(com.google.api.ads.adwords.axis.v201309.cm.AttributeFieldMapping[] attributeFieldMappings) {
        this.attributeFieldMappings = attributeFieldMappings;
    }

    public com.google.api.ads.adwords.axis.v201309.cm.AttributeFieldMapping getAttributeFieldMappings(int i) {
        return this.attributeFieldMappings[i];
    }

    public void setAttributeFieldMappings(int i, com.google.api.ads.adwords.axis.v201309.cm.AttributeFieldMapping _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "FeedMapping"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "placeholderType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "FeedMapping.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("attributeFieldMappings");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "attributeFieldMappings"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "AttributeFieldMapping"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
