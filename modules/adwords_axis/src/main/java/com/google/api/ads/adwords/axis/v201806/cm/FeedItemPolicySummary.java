 ...
 *             of a FeedMapping.
 */
public class FeedItemPolicySummary  extends com.google.api.ads.adwords.axis.v201806.cm.PolicySummaryInfo  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201806.cm.FeedItemValidationStatus validationStatus;

    /* List of error codes specifying what errors were found during
     * validation. */
    private com.google.api.ads.adwords.axis.v201806.cm.FeedItemAttributeError[] validationErrors;

    /* Feed item quality evaluation approval status for a particular
     * feed mapping. */
    private com.google.api.ads.adwords.axis.v201806.cm.FeedItemQualityApprovalStatus qualityApprovalStatus;

    /* Feed item quality evaluation disapproval reasons. */
    private com.google.api.ads.adwords.axis.v201806.cm.FeedItemQualityDisapprovalReasons[] qualityDisapprovalReasons;
    ...
    public FeedItemPolicySummary(
           ...
           com.google.api.ads.adwords.axis.v201806.cm.FeedItemValidationStatus validationStatus,
           com.google.api.ads.adwords.axis.v201806.cm.FeedItemAttributeError[] validationErrors,
           com.google.api.ads.adwords.axis.v201806.cm.FeedItemQualityApprovalStatus qualityApprovalStatus,
           com.google.api.ads.adwords.axis.v201806.cm.FeedItemQualityDisapprovalReasons[] qualityDisapprovalReasons) {
        super(
            policyTopicEntries,
            reviewState,
            denormalizedStatus,
     ...
     */
    public com.google.api.ads.adwords.axis.v201806.cm.FeedItemValidationStatus getValidationStatus() {
     ...
     */
    public void setValidationStatus(com.google.api.ads.adwords.axis.v201806.cm.FeedItemValidationStatus validationStatus) {
        this.validationStatus = validationStatus;
    }
     ...
     * validation.
     */
    public com.google.api.ads.adwords.axis.v201806.cm.FeedItemAttributeError[] getValidationErrors() {
     ...
     * validation.
     */
    public void setValidationErrors(com.google.api.ads.adwords.axis.v201806.cm.FeedItemAttributeError[] validationErrors) {
        this.validationErrors = validationErrors;
    }

    public com.google.api.ads.adwords.axis.v201806.cm.FeedItemAttributeError getValidationErrors(int i) {
        return this.validationErrors[i];
    }

    public void setValidationErrors(int i, com.google.api.ads.adwords.axis.v201806.cm.FeedItemAttributeError _value) {
     ...
     * feed mapping.
     */
    public com.google.api.ads.adwords.axis.v201806.cm.FeedItemQualityApprovalStatus getQualityApprovalStatus() {
     ...
     * feed mapping.
     */
    public void setQualityApprovalStatus(com.google.api.ads.adwords.axis.v201806.cm.FeedItemQualityApprovalStatus qualityApprovalStatus) {
        this.qualityApprovalStatus = qualityApprovalStatus;
    }
     ...
     */
    public com.google.api.ads.adwords.axis.v201806.cm.FeedItemQualityDisapprovalReasons[] getQualityDisapprovalReasons() {
     ...
     */
    public void setQualityDisapprovalReasons(com.google.api.ads.adwords.axis.v201806.cm.FeedItemQualityDisapprovalReasons[] qualityDisapprovalReasons) {
        this.qualityDisapprovalReasons = qualityDisapprovalReasons;
    }

    public com.google.api.ads.adwords.axis.v201806.cm.FeedItemQualityDisapprovalReasons getQualityDisapprovalReasons(int i) {
        return this.qualityDisapprovalReasons[i];
    }

    public void setQualityDisapprovalReasons(int i, com.google.api.ads.adwords.axis.v201806.cm.FeedItemQualityDisapprovalReasons _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "FeedItemPolicySummary"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("feedMappingId");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "feedMappingId"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "validationStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "FeedItemValidationStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("validationErrors");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "validationErrors"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "FeedItemAttributeError"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "qualityApprovalStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "FeedItemQualityApprovalStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("qualityDisapprovalReasons");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "qualityDisapprovalReasons"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "FeedItemQualityDisapprovalReasons"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
