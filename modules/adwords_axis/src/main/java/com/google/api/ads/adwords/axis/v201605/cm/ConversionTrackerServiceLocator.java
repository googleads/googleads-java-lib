...
public class ConversionTrackerServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.adwords.axis.v201605.cm.ConversionTrackerService {
    ...
    private java.lang.String ConversionTrackerServiceInterfacePort_address = "https://adwords.google.com/api/adwords/cm/v201605/ConversionTrackerService";
    ...
    public com.google.api.ads.adwords.axis.v201605.cm.ConversionTrackerServiceInterface getConversionTrackerServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.adwords.axis.v201605.cm.ConversionTrackerServiceInterface getConversionTrackerServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.adwords.axis.v201605.cm.ConversionTrackerServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201605.cm.ConversionTrackerServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.adwords.axis.v201605.cm.ConversionTrackerServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.adwords.axis.v201605.cm.ConversionTrackerServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201605.cm.ConversionTrackerServiceSoapBindingStub(new java.net.URL(ConversionTrackerServiceInterfacePort_address), this);
                _stub.setPortName(getConversionTrackerServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201605", "ConversionTrackerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201605", "ConversionTrackerServiceInterfacePort"));
        }
