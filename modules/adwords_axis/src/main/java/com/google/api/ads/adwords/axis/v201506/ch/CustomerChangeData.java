...
public class CustomerChangeData  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201506.ch.CampaignChangeData[] changedCampaigns;
    ...
    private com.google.api.ads.adwords.axis.v201506.ch.FeedChangeData[] changedFeeds;
    ...
    public CustomerChangeData(
           com.google.api.ads.adwords.axis.v201506.ch.CampaignChangeData[] changedCampaigns,
           com.google.api.ads.adwords.axis.v201506.ch.FeedChangeData[] changedFeeds,
     ...
     *                 even if the campaign did not change.
     */
    public com.google.api.ads.adwords.axis.v201506.ch.CampaignChangeData[] getChangedCampaigns() {
     ...
     *                 even if the campaign did not change.
     */
    public void setChangedCampaigns(com.google.api.ads.adwords.axis.v201506.ch.CampaignChangeData[] changedCampaigns) {
        this.changedCampaigns = changedCampaigns;
    }

    public com.google.api.ads.adwords.axis.v201506.ch.CampaignChangeData getChangedCampaigns(int i) {
        return this.changedCampaigns[i];
    }

    public void setChangedCampaigns(int i, com.google.api.ads.adwords.axis.v201506.ch.CampaignChangeData _value) {
     ...
     *                 even if the feed did not change.
     */
    public com.google.api.ads.adwords.axis.v201506.ch.FeedChangeData[] getChangedFeeds() {
        return changedFeeds;
    }
     ...
     *                 even if the feed did not change.
     */
    public void setChangedFeeds(com.google.api.ads.adwords.axis.v201506.ch.FeedChangeData[] changedFeeds) {
        this.changedFeeds = changedFeeds;
    }

    public com.google.api.ads.adwords.axis.v201506.ch.FeedChangeData getChangedFeeds(int i) {
        return this.changedFeeds[i];
    }

    public void setChangedFeeds(int i, com.google.api.ads.adwords.axis.v201506.ch.FeedChangeData _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/ch/v201506", "CustomerChangeData"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("changedCampaigns");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/ch/v201506", "changedCampaigns"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/ch/v201506", "CampaignChangeData"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/ch/v201506", "FeedChangeData"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/ch/v201506", "lastChangeTimestamp"));
