...
public class AdExtensionOverride  implements java.io.Serializable {
     ...
     *                 <span class="constraint Required">This field is required
     * and should not be {@code null}.</span> */
    private com.google.api.ads.adwords.axis.v201306.cm.AdExtension adExtension;

    /* Additional extension override info to augment the ad extension
     * override.
     *                 If none is specified, default settings will be used. */
    private com.google.api.ads.adwords.axis.v201306.cm.OverrideInfo overrideInfo;
    ...
    private com.google.api.ads.adwords.axis.v201306.cm.AdExtensionOverrideStatus status;

    /* Approval status
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201306.cm.AdExtensionOverrideApprovalStatus approvalStatus;

    /* Stats for the ad extension override
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201306.cm.AdExtensionOverrideStats stats;
    ...
    public AdExtensionOverride(
           java.lang.Long adId,
           com.google.api.ads.adwords.axis.v201306.cm.AdExtension adExtension,
           com.google.api.ads.adwords.axis.v201306.cm.OverrideInfo overrideInfo,
           com.google.api.ads.adwords.axis.v201306.cm.AdExtensionOverrideStatus status,
           com.google.api.ads.adwords.axis.v201306.cm.AdExtensionOverrideApprovalStatus approvalStatus,
           com.google.api.ads.adwords.axis.v201306.cm.AdExtensionOverrideStats stats) {
           this.adId = adId;
     ...
     * and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.AdExtension getAdExtension() {
        return adExtension;
    }
     ...
     * and should not be {@code null}.</span>
     */
    public void setAdExtension(com.google.api.ads.adwords.axis.v201306.cm.AdExtension adExtension) {
        this.adExtension = adExtension;
    }
     ...
     *                 If none is specified, default settings will be used.
     */
    public com.google.api.ads.adwords.axis.v201306.cm.OverrideInfo getOverrideInfo() {
        return overrideInfo;
    }
     ...
     *                 If none is specified, default settings will be used.
     */
    public void setOverrideInfo(com.google.api.ads.adwords.axis.v201306.cm.OverrideInfo overrideInfo) {
        this.overrideInfo = overrideInfo;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.AdExtensionOverrideStatus getStatus() {
        return status;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201306.cm.AdExtensionOverrideStatus status) {
        this.status = status;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.AdExtensionOverrideApprovalStatus getApprovalStatus() {
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setApprovalStatus(com.google.api.ads.adwords.axis.v201306.cm.AdExtensionOverrideApprovalStatus approvalStatus) {
        this.approvalStatus = approvalStatus;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.AdExtensionOverrideStats getStats() {
        return stats;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setStats(com.google.api.ads.adwords.axis.v201306.cm.AdExtensionOverrideStats stats) {
        this.stats = stats;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "AdExtensionOverride"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("adId");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "adId"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "adExtension"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "AdExtension"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("overrideInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "overrideInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "OverrideInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "AdExtensionOverride.ApprovalStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "AdExtensionOverrideStats"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
