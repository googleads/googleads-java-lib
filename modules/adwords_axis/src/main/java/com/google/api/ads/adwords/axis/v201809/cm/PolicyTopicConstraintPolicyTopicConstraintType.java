...
public class PolicyTopicConstraintPolicyTopicConstraintType implements java.io.Serializable {
    ...
    public static final java.lang.String _CERTIFICATE_DOMAIN_MISMATCH = "CERTIFICATE_DOMAIN_MISMATCH";
    ...
    public static final PolicyTopicConstraintPolicyTopicConstraintType CERTIFICATE_DOMAIN_MISMATCH = new PolicyTopicConstraintPolicyTopicConstraintType(_CERTIFICATE_DOMAIN_MISMATCH);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "PolicyTopicConstraint.PolicyTopicConstraintType"));
    }
    /**
