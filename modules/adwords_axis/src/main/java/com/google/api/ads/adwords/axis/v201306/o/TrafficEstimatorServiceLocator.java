...
public class TrafficEstimatorServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.adwords.axis.v201306.o.TrafficEstimatorService {
    ...
    private java.lang.String TrafficEstimatorServiceInterfacePort_address = "https://adwords.google.com/api/adwords/o/v201306/TrafficEstimatorService";
    ...
    public com.google.api.ads.adwords.axis.v201306.o.TrafficEstimatorServiceInterface getTrafficEstimatorServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.adwords.axis.v201306.o.TrafficEstimatorServiceInterface getTrafficEstimatorServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.adwords.axis.v201306.o.TrafficEstimatorServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201306.o.TrafficEstimatorServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.adwords.axis.v201306.o.TrafficEstimatorServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.adwords.axis.v201306.o.TrafficEstimatorServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201306.o.TrafficEstimatorServiceSoapBindingStub(new java.net.URL(TrafficEstimatorServiceInterfacePort_address), this);
                _stub.setPortName(getTrafficEstimatorServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201306", "TrafficEstimatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201306", "TrafficEstimatorServiceInterfacePort"));
        }
