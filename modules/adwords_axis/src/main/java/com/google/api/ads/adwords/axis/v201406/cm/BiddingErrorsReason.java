...
public class BiddingErrorsReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_CHANGE_BIDDING_STRATEGY_IN_CAMPAIGN_WITH_EXPERIMENT = "CANNOT_CHANGE_BIDDING_STRATEGY_IN_CAMPAIGN_WITH_EXPERIMENT";
    ...
    public static final BiddingErrorsReason CANNOT_CHANGE_BIDDING_STRATEGY_IN_CAMPAIGN_WITH_EXPERIMENT = new BiddingErrorsReason(_CANNOT_CHANGE_BIDDING_STRATEGY_IN_CAMPAIGN_WITH_EXPERIMENT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "BiddingErrors.Reason"));
    }
    /**
