 ...
 */
public class SimpleMutateJob  extends com.google.api.ads.adwords.axis.v201309.cm.Job  implements java.io.Serializable {
    ...
    /* History of this job. */
    private com.google.api.ads.adwords.axis.v201309.cm.JobEvent[] history;
    ...
    public SimpleMutateJob(
           ...
           com.google.api.ads.adwords.axis.v201309.cm.JobEvent[] history) {
        super(
            failureReason,
            stats,
            billingSummary,
     ...
     */
    public com.google.api.ads.adwords.axis.v201309.cm.JobEvent[] getHistory() {
        return history;
    }
     ...
     */
    public void setHistory(com.google.api.ads.adwords.axis.v201309.cm.JobEvent[] history) {
        this.history = history;
    }

    public com.google.api.ads.adwords.axis.v201309.cm.JobEvent getHistory(int i) {
        return this.history[i];
    }

    public void setHistory(int i, com.google.api.ads.adwords.axis.v201309.cm.JobEvent _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "SimpleMutateJob"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "JobEvent"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
