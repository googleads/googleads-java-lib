...
public class CriterionType implements java.io.Serializable {
    ...
    public static final java.lang.String _PRODUCT_SALES_CHANNEL = "PRODUCT_SALES_CHANNEL";
    ...
    public static final CriterionType PRODUCT_SALES_CHANNEL = new CriterionType(_PRODUCT_SALES_CHANNEL);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "Criterion.Type"));
    }
    /**
