...
import com.google.api.ads.adwords.axis.v201603.cm.BatchJobOpsServiceSoapBindingStub;
...
class BatchJobHelperImpl implements BatchJobHelperInterface<Operation, Operand, ApiError,
  ...
  public BatchJobMutateResponse downloadBatchJobMutateResponse(String downloadUrl)
     ...
     */
    List<com.google.api.ads.adwords.axis.v201603.cm.MutateResult> cmMutateResults;
    try {
      cmMutateResults =
          deserializer.deserializeBatchJobMutateResults(
              new URL(downloadUrl),
              getServiceTypeMappings(),
              com.google.api.ads.adwords.axis.v201603.cm.MutateResult.class,
              resultQName);
    } catch (Exception e) {
    ...
    for (com.google.api.ads.adwords.axis.v201603.cm.MutateResult cmMutateResult : cmMutateResults) {
