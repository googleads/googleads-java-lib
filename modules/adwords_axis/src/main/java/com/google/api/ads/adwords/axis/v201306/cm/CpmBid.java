 ...
 */
public class CpmBid  extends com.google.api.ads.adwords.axis.v201306.cm.Bids  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201306.cm.BidSource cpmBidSource;
    ...
    public CpmBid(
           ...
           com.google.api.ads.adwords.axis.v201306.cm.BidSource cpmBidSource) {
        super(
            bidsType);
        this.bid = bid;
     ...
     * it will be ignored.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.BidSource getCpmBidSource() {
        return cpmBidSource;
    }
     ...
     * it will be ignored.</span>
     */
    public void setCpmBidSource(com.google.api.ads.adwords.axis.v201306.cm.BidSource cpmBidSource) {
        this.cpmBidSource = cpmBidSource;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "CpmBid"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "cpmBidSource"));
