...
public class TemplateElementField  implements java.io.Serializable {
     ...
     *                 <span class="constraint Required">This field is required
     * and should not be {@code null}.</span> */
    private com.google.api.ads.adwords.axis.v201710.cm.TemplateElementFieldType type;
    ...
    private com.google.api.ads.adwords.axis.v201710.cm.Media fieldMedia;
    ...
    public TemplateElementField(
           ...
           com.google.api.ads.adwords.axis.v201710.cm.TemplateElementFieldType type,
           java.lang.String fieldText,
           com.google.api.ads.adwords.axis.v201710.cm.Media fieldMedia) {
           this.name = name;
           this.type = type;
     ...
     * and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201710.cm.TemplateElementFieldType getType() {
        return type;
    }
     ...
     * and should not be {@code null}.</span>
     */
    public void setType(com.google.api.ads.adwords.axis.v201710.cm.TemplateElementFieldType type) {
        this.type = type;
    }
     ...
     *                 fields must be specified if fieldText is null.
     */
    public com.google.api.ads.adwords.axis.v201710.cm.Media getFieldMedia() {
        return fieldMedia;
    }
     ...
     *                 fields must be specified if fieldText is null.
     */
    public void setFieldMedia(com.google.api.ads.adwords.axis.v201710.cm.Media fieldMedia) {
        this.fieldMedia = fieldMedia;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "TemplateElementField"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "TemplateElementField.Type"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fieldText");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "fieldText"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "fieldMedia"));
