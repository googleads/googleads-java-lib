 ...
 */
public class CampaignAdExtensionPage  extends com.google.api.ads.adwords.axis.v201406.cm.Page  implements java.io.Serializable {
    /* The result entries in this page */
    private com.google.api.ads.adwords.axis.v201406.cm.CampaignAdExtension[] entries;
    ...
    public CampaignAdExtensionPage(
           ...
           com.google.api.ads.adwords.axis.v201406.cm.CampaignAdExtension[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201406.cm.CampaignAdExtension[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201406.cm.CampaignAdExtension[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201406.cm.CampaignAdExtension getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201406.cm.CampaignAdExtension _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "CampaignAdExtensionPage"));
