...
public class AdGroupAdPolicySummary  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201702.cm.PolicyTopicEntry[] policyTopicEntries;

    /* Progress through the review process. */
    private com.google.api.ads.adwords.axis.v201702.cm.PolicySummaryReviewState reviewState;

    /* Overall review status based on the policy topic entries. */
    private com.google.api.ads.adwords.axis.v201702.cm.PolicySummaryDenormalizedStatus denormalizedStatus;

    /* Approval status that combines review state and status. */
    private com.google.api.ads.adwords.axis.v201702.cm.PolicyApprovalStatus combinedApprovalStatus;

    public AdGroupAdPolicySummary() {
    }

    public AdGroupAdPolicySummary(
           com.google.api.ads.adwords.axis.v201702.cm.PolicyTopicEntry[] policyTopicEntries,
           com.google.api.ads.adwords.axis.v201702.cm.PolicySummaryReviewState reviewState,
           com.google.api.ads.adwords.axis.v201702.cm.PolicySummaryDenormalizedStatus denormalizedStatus,
           com.google.api.ads.adwords.axis.v201702.cm.PolicyApprovalStatus combinedApprovalStatus) {
     ...
     */
    public com.google.api.ads.adwords.axis.v201702.cm.PolicyTopicEntry[] getPolicyTopicEntries() {
     ...
     */
    public void setPolicyTopicEntries(com.google.api.ads.adwords.axis.v201702.cm.PolicyTopicEntry[] policyTopicEntries) {
        this.policyTopicEntries = policyTopicEntries;
    }

    public com.google.api.ads.adwords.axis.v201702.cm.PolicyTopicEntry getPolicyTopicEntries(int i) {
        return this.policyTopicEntries[i];
    }

    public void setPolicyTopicEntries(int i, com.google.api.ads.adwords.axis.v201702.cm.PolicyTopicEntry _value) {
     ...
     */
    public com.google.api.ads.adwords.axis.v201702.cm.PolicySummaryReviewState getReviewState() {
        return reviewState;
    }
     ...
     */
    public void setReviewState(com.google.api.ads.adwords.axis.v201702.cm.PolicySummaryReviewState reviewState) {
        this.reviewState = reviewState;
    }
     ...
     */
    public com.google.api.ads.adwords.axis.v201702.cm.PolicySummaryDenormalizedStatus getDenormalizedStatus() {
     ...
     */
    public void setDenormalizedStatus(com.google.api.ads.adwords.axis.v201702.cm.PolicySummaryDenormalizedStatus denormalizedStatus) {
        this.denormalizedStatus = denormalizedStatus;
    }
     ...
     */
    public com.google.api.ads.adwords.axis.v201702.cm.PolicyApprovalStatus getCombinedApprovalStatus() {
     ...
     */
    public void setCombinedApprovalStatus(com.google.api.ads.adwords.axis.v201702.cm.PolicyApprovalStatus combinedApprovalStatus) {
        this.combinedApprovalStatus = combinedApprovalStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "AdGroupAdPolicySummary"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("policyTopicEntries");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "policyTopicEntries"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "PolicyTopicEntry"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "reviewState"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "PolicySummaryReviewState"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("denormalizedStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "denormalizedStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "PolicySummaryDenormalizedStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("combinedApprovalStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "combinedApprovalStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "PolicyApprovalStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
