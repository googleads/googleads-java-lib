 ...
 */
public class FeedMappingPage  extends com.google.api.ads.adwords.axis.v201309.cm.NullStatsPage  implements java.io.Serializable {
    /* The resulting FeedMappings */
    private com.google.api.ads.adwords.axis.v201309.cm.FeedMapping[] entries;
    ...
    public FeedMappingPage(
           ...
           com.google.api.ads.adwords.axis.v201309.cm.FeedMapping[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201309.cm.FeedMapping[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201309.cm.FeedMapping[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201309.cm.FeedMapping getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201309.cm.FeedMapping _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "FeedMappingPage"));
