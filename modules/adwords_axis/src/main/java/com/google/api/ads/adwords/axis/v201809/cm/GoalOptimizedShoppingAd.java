 ...
 * A Smart Shopping ad targets
 *             multiple advertising channels across Search, Google Display
 * Network, and YouTube with a focus on
 *             retail. This supports ads that display product data (managed
 * using the Google Merchant Center) as
 *             specified in the parent campaign's {@linkplain ShoppingSetting
 * Shopping setting} as well as ads
 *             using advertiser provided asset data.
 *             
 *             <p class="caution"><b>Caution:</b> Smart Shopping ads
 * do not use {@link #url url}, {@link
 *             #finalUrls finalUrls}, {@link #finalMobileUrls finalMobileUrls},
 * {@link #finalAppUrls
 *             finalAppUrls}, or {@link #displayUrl displayUrl}; setting
 * these fields on a Smart Shopping ad
 *             will cause an error.
 *             <span class="constraint AdxEnabled">This is enabled for
 * AdX.</span>
 */
public class GoalOptimizedShoppingAd  extends com.google.api.ads.adwords.axis.v201809.cm.Ad  implements java.io.Serializable {
    public GoalOptimizedShoppingAd() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GoalOptimizedShoppingAd)) return false;
        GoalOptimizedShoppingAd other = (GoalOptimizedShoppingAd) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GoalOptimizedShoppingAd.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "GoalOptimizedShoppingAd"));
    }
