 ...
 */
public class BiddingStrategyPage  extends com.google.api.ads.adwords.axis.v201509.cm.Page  implements java.io.Serializable {
    private com.google.api.ads.adwords.axis.v201509.cm.SharedBiddingStrategy[] entries;
    ...
    public BiddingStrategyPage(
           ...
           com.google.api.ads.adwords.axis.v201509.cm.SharedBiddingStrategy[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     * @return entries
     */
    public com.google.api.ads.adwords.axis.v201509.cm.SharedBiddingStrategy[] getEntries() {
        return entries;
    }
     ...
     * @param entries
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201509.cm.SharedBiddingStrategy[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201509.cm.SharedBiddingStrategy getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201509.cm.SharedBiddingStrategy _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "BiddingStrategyPage"));
