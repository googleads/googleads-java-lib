...
public class CustomerSyncServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.adwords.axis.v201309.ch.CustomerSyncService {
    ...
    private java.lang.String CustomerSyncServiceInterfacePort_address = "https://adwords.google.com/api/adwords/ch/v201309/CustomerSyncService";
    ...
    public com.google.api.ads.adwords.axis.v201309.ch.CustomerSyncServiceInterface getCustomerSyncServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.adwords.axis.v201309.ch.CustomerSyncServiceInterface getCustomerSyncServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.adwords.axis.v201309.ch.CustomerSyncServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201309.ch.CustomerSyncServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.adwords.axis.v201309.ch.CustomerSyncServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.adwords.axis.v201309.ch.CustomerSyncServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201309.ch.CustomerSyncServiceSoapBindingStub(new java.net.URL(CustomerSyncServiceInterfacePort_address), this);
                _stub.setPortName(getCustomerSyncServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/ch/v201309", "CustomerSyncService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/ch/v201309", "CustomerSyncServiceInterfacePort"));
        }
