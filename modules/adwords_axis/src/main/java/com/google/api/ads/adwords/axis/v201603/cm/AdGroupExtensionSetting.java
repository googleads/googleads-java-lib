...
public class AdGroupExtensionSetting  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201603.cm.FeedType extensionType;
     ...
     * : ADD, SET.</span> */
    private com.google.api.ads.adwords.axis.v201603.cm.ExtensionSetting extensionSetting;
    ...
    public AdGroupExtensionSetting(
           ...
           com.google.api.ads.adwords.axis.v201603.cm.FeedType extensionType,
           com.google.api.ads.adwords.axis.v201603.cm.ExtensionSetting extensionSetting) {
     ...
     * and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201603.cm.FeedType getExtensionType() {
     ...
     * and should not be {@code null}.</span>
     */
    public void setExtensionType(com.google.api.ads.adwords.axis.v201603.cm.FeedType extensionType) {
        this.extensionType = extensionType;
    }
     ...
     * : ADD, SET.</span>
     */
    public com.google.api.ads.adwords.axis.v201603.cm.ExtensionSetting getExtensionSetting() {
     ...
     * : ADD, SET.</span>
     */
    public void setExtensionSetting(com.google.api.ads.adwords.axis.v201603.cm.ExtensionSetting extensionSetting) {
        this.extensionSetting = extensionSetting;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201603", "AdGroupExtensionSetting"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201603", "extensionType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201603", "extensionSetting"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201603", "ExtensionSetting"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
