...
public class ExtensionSettingErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CUSTOMER_CONSENT_FOR_CALL_RECORDING_REQUIRED = "CUSTOMER_CONSENT_FOR_CALL_RECORDING_REQUIRED";
    ...
    public static final ExtensionSettingErrorReason CUSTOMER_CONSENT_FOR_CALL_RECORDING_REQUIRED = new ExtensionSettingErrorReason(_CUSTOMER_CONSENT_FOR_CALL_RECORDING_REQUIRED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "ExtensionSettingError.Reason"));
    }
    /**
