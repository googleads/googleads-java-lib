 ...
 */
public class PromotionPage  extends com.google.api.ads.adwords.axis.v201409.express.NoStatsPage  implements java.io.Serializable {
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201409.express.Promotion[] entries;
    ...
    public PromotionPage(
           ...
           com.google.api.ads.adwords.axis.v201409.express.Promotion[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201409.express.Promotion[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201409.express.Promotion[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201409.express.Promotion getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201409.express.Promotion _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201409", "PromotionPage"));
