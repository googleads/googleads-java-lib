 ...
 * </p>
 */
public class ManagedCustomerOperation  extends com.google.api.ads.adwords.axis.v201603.cm.Operation  implements java.io.Serializable {
    /* <span class="constraint Required">This field is required and
     * should not be {@code null}.</span> */
    private com.google.api.ads.adwords.axis.v201603.mcm.ManagedCustomer operand;
    ...
    public ManagedCustomerOperation(
           ...
           com.google.api.ads.adwords.axis.v201603.mcm.ManagedCustomer operand) {
        super(
            operator,
            operationType);
     ...
     * should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201603.mcm.ManagedCustomer getOperand() {
        return operand;
    }
     ...
     * should not be {@code null}.</span>
     */
    public void setOperand(com.google.api.ads.adwords.axis.v201603.mcm.ManagedCustomer operand) {
        this.operand = operand;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/mcm/v201603", "ManagedCustomerOperation"));
