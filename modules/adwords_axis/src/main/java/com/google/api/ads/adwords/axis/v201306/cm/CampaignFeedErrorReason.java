...
public class CampaignFeedErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_OPERATE_ON_DELETED_CAMPAIGN_FEED = "CANNOT_OPERATE_ON_DELETED_CAMPAIGN_FEED";
    ...
    public static final java.lang.String _FEEDS_ONLY_ON_ENHANCED_CAMPAIGNS = "FEEDS_ONLY_ON_ENHANCED_CAMPAIGNS";
    ...
    public static final CampaignFeedErrorReason CANNOT_OPERATE_ON_DELETED_CAMPAIGN_FEED = new CampaignFeedErrorReason(_CANNOT_OPERATE_ON_DELETED_CAMPAIGN_FEED);
    ...
    public static final CampaignFeedErrorReason FEEDS_ONLY_ON_ENHANCED_CAMPAIGNS = new CampaignFeedErrorReason(_FEEDS_ONLY_ON_ENHANCED_CAMPAIGNS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "CampaignFeedError.Reason"));
    }
    /**
