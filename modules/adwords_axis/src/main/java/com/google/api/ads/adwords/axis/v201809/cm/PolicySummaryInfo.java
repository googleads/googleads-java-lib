...
public abstract class PolicySummaryInfo  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201809.cm.PolicySummaryReviewState reviewState;

    /* Overall review status based on the policy topic entries. */
    private com.google.api.ads.adwords.axis.v201809.cm.PolicySummaryDenormalizedStatus denormalizedStatus;

    /* Approval status that combines review state and status. */
    private com.google.api.ads.adwords.axis.v201809.cm.PolicyApprovalStatus combinedApprovalStatus;
     ...
     */
    public com.google.api.ads.adwords.axis.v201809.cm.PolicySummaryReviewState getReviewState() {
        return reviewState;
    }
     ...
     */
    public void setReviewState(com.google.api.ads.adwords.axis.v201809.cm.PolicySummaryReviewState reviewState) {
        this.reviewState = reviewState;
    }
     ...
     */
    public com.google.api.ads.adwords.axis.v201809.cm.PolicySummaryDenormalizedStatus getDenormalizedStatus() {
     ...
     */
    public void setDenormalizedStatus(com.google.api.ads.adwords.axis.v201809.cm.PolicySummaryDenormalizedStatus denormalizedStatus) {
        this.denormalizedStatus = denormalizedStatus;
    }
     ...
     */
    public com.google.api.ads.adwords.axis.v201809.cm.PolicyApprovalStatus getCombinedApprovalStatus() {
     ...
     */
    public void setCombinedApprovalStatus(com.google.api.ads.adwords.axis.v201809.cm.PolicyApprovalStatus combinedApprovalStatus) {
        this.combinedApprovalStatus = combinedApprovalStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "PolicySummaryInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "reviewState"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "PolicySummaryReviewState"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("denormalizedStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "denormalizedStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "PolicySummaryDenormalizedStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("combinedApprovalStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "combinedApprovalStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "PolicyApprovalStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("policySummaryInfoType");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "PolicySummaryInfo.Type"));
