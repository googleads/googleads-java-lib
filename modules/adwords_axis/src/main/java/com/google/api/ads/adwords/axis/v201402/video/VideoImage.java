...
public class VideoImage  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201402.video.VideoImageType type;

    /* An image Type for ad formats that don't support custom media
     * thumbnails.
     *                 This must be one of the YouTube image types (i.e.
     * cannot be MEDIA). */
    private com.google.api.ads.adwords.axis.v201402.video.VideoImageType secondaryType;
     ...
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201402.video.VideoImageMimeType mimeType;

    public VideoImage() {
    }

    public VideoImage(
           com.google.api.ads.adwords.axis.v201402.video.VideoImageType type,
           com.google.api.ads.adwords.axis.v201402.video.VideoImageType secondaryType,
           java.lang.Long mediaId,
           java.lang.String url,
           com.google.api.ads.adwords.axis.v201402.video.VideoImageMimeType mimeType) {
           this.type = type;
     ...
     * and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201402.video.VideoImageType getType() {
        return type;
    }
     ...
     * and should not be {@code null}.</span>
     */
    public void setType(com.google.api.ads.adwords.axis.v201402.video.VideoImageType type) {
        this.type = type;
    }
     ...
     * cannot be MEDIA).
     */
    public com.google.api.ads.adwords.axis.v201402.video.VideoImageType getSecondaryType() {
     ...
     * cannot be MEDIA).
     */
    public void setSecondaryType(com.google.api.ads.adwords.axis.v201402.video.VideoImageType secondaryType) {
        this.secondaryType = secondaryType;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201402.video.VideoImageMimeType getMimeType() {
        return mimeType;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setMimeType(com.google.api.ads.adwords.axis.v201402.video.VideoImageMimeType mimeType) {
        this.mimeType = mimeType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "VideoImage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "VideoImage.Type"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("secondaryType");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "secondaryType"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "VideoImage.Type"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "mediaId"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "url"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "mimeType"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "VideoImage.MimeType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
