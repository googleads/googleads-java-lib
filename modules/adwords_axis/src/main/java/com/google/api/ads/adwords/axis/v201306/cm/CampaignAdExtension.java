...
public class CampaignAdExtension  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201306.cm.CampaignAdExtensionStatus status;

    /* Approval status.
     *                 <span class="constraint Selectable">This field can
     * be selected using the value "ApprovalStatus".</span><span class="constraint
     * Filterable">This field can be filtered on.</span> */
    private com.google.api.ads.adwords.axis.v201306.cm.CampaignAdExtensionApprovalStatus approvalStatus;
    ...
    public CampaignAdExtension(
           ...
           com.google.api.ads.adwords.axis.v201306.cm.CampaignAdExtensionStatus status,
           com.google.api.ads.adwords.axis.v201306.cm.CampaignAdExtensionApprovalStatus approvalStatus,
           com.google.api.ads.adwords.axis.v201306.cm.CampaignAdExtensionStats stats) {
     ...
     * Filterable">This field can be filtered on.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.CampaignAdExtensionStatus getStatus() {
        return status;
    }
     ...
     * Filterable">This field can be filtered on.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201306.cm.CampaignAdExtensionStatus status) {
        this.status = status;
    }
     ...
     * Filterable">This field can be filtered on.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.CampaignAdExtensionApprovalStatus getApprovalStatus() {
     ...
     * Filterable">This field can be filtered on.</span>
     */
    public void setApprovalStatus(com.google.api.ads.adwords.axis.v201306.cm.CampaignAdExtensionApprovalStatus approvalStatus) {
        this.approvalStatus = approvalStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "CampaignAdExtension"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "CampaignAdExtension.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "CampaignAdExtension.ApprovalStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "CampaignAdExtensionStats"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
