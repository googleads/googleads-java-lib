...
public class Promotion  implements java.io.Serializable {
     ...
     * and should not be {@code null} when it is contained within {@link
     * Operator}s : ADD.</span> */
    private com.google.api.ads.adwords.axis.v201509.express.PromotionStatus status;

    /* Creatives of this promotion.
     *                 <span class="constraint Selectable">This field can
     * be selected using the value "Creatives".</span> */
    private com.google.api.ads.adwords.axis.v201509.express.Creative[] creatives;
    ...
    private com.google.api.ads.adwords.axis.v201509.express.PhoneNumber phoneNumber;
    ...
    private com.google.api.ads.adwords.axis.v201509.cm.Money budget;
     ...
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201509.cm.Money remainingBudget;
    ...
    public Promotion(
           ...
           com.google.api.ads.adwords.axis.v201509.express.PromotionStatus status,
           com.google.api.ads.adwords.axis.v201509.express.Creative[] creatives,
           java.lang.String destinationUrl,
           com.google.api.ads.adwords.axis.v201509.express.PhoneNumber phoneNumber,
           java.lang.Boolean streetAddressVisible,
           java.lang.Boolean callTrackingEnabled,
           com.google.api.ads.adwords.axis.v201509.cm.Money budget,
           com.google.api.ads.adwords.axis.v201509.cm.Criterion[] criteria,
           long[] campaignIds,
           com.google.api.ads.adwords.axis.v201509.cm.Money remainingBudget) {
           this.id = id;
           this.name = name;
           this.status = status;
     ...
     * Operator}s : ADD.</span>
     */
    public com.google.api.ads.adwords.axis.v201509.express.PromotionStatus getStatus() {
        return status;
    }
     ...
     * Operator}s : ADD.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201509.express.PromotionStatus status) {
        this.status = status;
    }
     ...
     * be selected using the value "Creatives".</span>
     */
    public com.google.api.ads.adwords.axis.v201509.express.Creative[] getCreatives() {
        return creatives;
    }
     ...
     * be selected using the value "Creatives".</span>
     */
    public void setCreatives(com.google.api.ads.adwords.axis.v201509.express.Creative[] creatives) {
        this.creatives = creatives;
    }

    public com.google.api.ads.adwords.axis.v201509.express.Creative getCreatives(int i) {
        return this.creatives[i];
    }

    public void setCreatives(int i, com.google.api.ads.adwords.axis.v201509.express.Creative _value) {
     ...
     * be selected using the value "PhoneNumber".</span>
     */
    public com.google.api.ads.adwords.axis.v201509.express.PhoneNumber getPhoneNumber() {
        return phoneNumber;
    }
     ...
     * be selected using the value "PhoneNumber".</span>
     */
    public void setPhoneNumber(com.google.api.ads.adwords.axis.v201509.express.PhoneNumber phoneNumber) {
        this.phoneNumber = phoneNumber;
    }
     ...
     * greater than or equal to 1.</span>
     */
    public com.google.api.ads.adwords.axis.v201509.cm.Money getBudget() {
        return budget;
    }
     ...
     * greater than or equal to 1.</span>
     */
    public void setBudget(com.google.api.ads.adwords.axis.v201509.cm.Money budget) {
        this.budget = budget;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201509.cm.Money getRemainingBudget() {
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setRemainingBudget(com.google.api.ads.adwords.axis.v201509.cm.Money remainingBudget) {
        this.remainingBudget = remainingBudget;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "Promotion"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("id");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "id"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "status"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "Promotion.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("creatives");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "creatives"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "Creative"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "destinationUrl"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "phoneNumber"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "PhoneNumber"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("streetAddressVisible");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "streetAddressVisible"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "callTrackingEnabled"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "budget"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "campaignIds"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/express/v201509", "remainingBudget"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "Money"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
