 ...
 */
public class FeedItemReturnValue  extends com.google.api.ads.adwords.axis.v201702.cm.ListReturnValue  implements java.io.Serializable {
    /* List of feed items returned from mutate. */
    private com.google.api.ads.adwords.axis.v201702.cm.FeedItem[] value;
    ...
    public FeedItemReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201702.cm.FeedItem[] value,
     ...
     */
    public com.google.api.ads.adwords.axis.v201702.cm.FeedItem[] getValue() {
        return value;
    }
     ...
     */
    public void setValue(com.google.api.ads.adwords.axis.v201702.cm.FeedItem[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201702.cm.FeedItem getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201702.cm.FeedItem _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "FeedItemReturnValue"));
