...
public class BudgetErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _BUDGET_DELETED = "BUDGET_DELETED";
    ...
    public static final BudgetErrorReason BUDGET_DELETED = new BudgetErrorReason(_BUDGET_DELETED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "BudgetError.Reason"));
    }
    /**
