...
public class CriterionErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _INVALID_YOUTUBE_CHANNEL_ID = "INVALID_YOUTUBE_CHANNEL_ID";
    public static final java.lang.String _INVALID_YOUTUBE_VIDEO_ID = "INVALID_YOUTUBE_VIDEO_ID";
    ...
    public static final java.lang.String _CANNOT_ADD_POSITIVE_PLACEMENTS_TO_SEARCH_CAMPAIGNS = "CANNOT_ADD_POSITIVE_PLACEMENTS_TO_SEARCH_CAMPAIGNS";
    ...
    public static final java.lang.String _INVALID_WEBPAGE_CONDITION = "INVALID_WEBPAGE_CONDITION";
    public static final java.lang.String _INVALID_WEBPAGE_CONDITION_URL = "INVALID_WEBPAGE_CONDITION_URL";
    public static final java.lang.String _WEBPAGE_CONDITION_URL_CANNOT_BE_EMPTY = "WEBPAGE_CONDITION_URL_CANNOT_BE_EMPTY";
    public static final java.lang.String _WEBPAGE_CONDITION_URL_UNSUPPORTED_PROTOCOL = "WEBPAGE_CONDITION_URL_UNSUPPORTED_PROTOCOL";
    public static final java.lang.String _WEBPAGE_CONDITION_URL_CANNOT_BE_IP_ADDRESS = "WEBPAGE_CONDITION_URL_CANNOT_BE_IP_ADDRESS";
    public static final java.lang.String _WEBPAGE_CONDITION_URL_DOMAIN_NOT_CONSISTENT_WITH_CAMPAIGN_SETTING = "WEBPAGE_CONDITION_URL_DOMAIN_NOT_CONSISTENT_WITH_CAMPAIGN_SETTING";
    public static final java.lang.String _WEBPAGE_CONDITION_URL_CANNOT_BE_PUBLIC_SUFFIX = "WEBPAGE_CONDITION_URL_CANNOT_BE_PUBLIC_SUFFIX";
    public static final java.lang.String _WEBPAGE_CONDITION_URL_INVALID_PUBLIC_SUFFIX = "WEBPAGE_CONDITION_URL_INVALID_PUBLIC_SUFFIX";
    public static final java.lang.String _WEBPAGE_CONDITION_URL_VALUE_TRACK_VALUE_NOT_SUPPORTED = "WEBPAGE_CONDITION_URL_VALUE_TRACK_VALUE_NOT_SUPPORTED";
    public static final java.lang.String _WEBPAGE_CRITERION_URL_EQUALS_CAN_HAVE_ONLY_ONE_CONDITION = "WEBPAGE_CRITERION_URL_EQUALS_CAN_HAVE_ONLY_ONE_CONDITION";
    public static final java.lang.String _WEBPAGE_CRITERION_CANNOT_ADD_NON_SMART_TARGETING_TO_NON_DSA_AD_GROUP = "WEBPAGE_CRITERION_CANNOT_ADD_NON_SMART_TARGETING_TO_NON_DSA_AD_GROUP";
    ...
    public static final java.lang.String _ADSENSE_FOR_MOBILE_APPS_PLACEMENT_DEPRECATED = "ADSENSE_FOR_MOBILE_APPS_PLACEMENT_DEPRECATED";
    ...
    public static final CriterionErrorReason INVALID_YOUTUBE_CHANNEL_ID = new CriterionErrorReason(_INVALID_YOUTUBE_CHANNEL_ID);
    public static final CriterionErrorReason INVALID_YOUTUBE_VIDEO_ID = new CriterionErrorReason(_INVALID_YOUTUBE_VIDEO_ID);
    ...
    public static final CriterionErrorReason CANNOT_ADD_POSITIVE_PLACEMENTS_TO_SEARCH_CAMPAIGNS = new CriterionErrorReason(_CANNOT_ADD_POSITIVE_PLACEMENTS_TO_SEARCH_CAMPAIGNS);
    ...
    public static final CriterionErrorReason INVALID_WEBPAGE_CONDITION = new CriterionErrorReason(_INVALID_WEBPAGE_CONDITION);
    public static final CriterionErrorReason INVALID_WEBPAGE_CONDITION_URL = new CriterionErrorReason(_INVALID_WEBPAGE_CONDITION_URL);
    public static final CriterionErrorReason WEBPAGE_CONDITION_URL_CANNOT_BE_EMPTY = new CriterionErrorReason(_WEBPAGE_CONDITION_URL_CANNOT_BE_EMPTY);
    public static final CriterionErrorReason WEBPAGE_CONDITION_URL_UNSUPPORTED_PROTOCOL = new CriterionErrorReason(_WEBPAGE_CONDITION_URL_UNSUPPORTED_PROTOCOL);
    public static final CriterionErrorReason WEBPAGE_CONDITION_URL_CANNOT_BE_IP_ADDRESS = new CriterionErrorReason(_WEBPAGE_CONDITION_URL_CANNOT_BE_IP_ADDRESS);
    public static final CriterionErrorReason WEBPAGE_CONDITION_URL_DOMAIN_NOT_CONSISTENT_WITH_CAMPAIGN_SETTING = new CriterionErrorReason(_WEBPAGE_CONDITION_URL_DOMAIN_NOT_CONSISTENT_WITH_CAMPAIGN_SETTING);
    public static final CriterionErrorReason WEBPAGE_CONDITION_URL_CANNOT_BE_PUBLIC_SUFFIX = new CriterionErrorReason(_WEBPAGE_CONDITION_URL_CANNOT_BE_PUBLIC_SUFFIX);
    public static final CriterionErrorReason WEBPAGE_CONDITION_URL_INVALID_PUBLIC_SUFFIX = new CriterionErrorReason(_WEBPAGE_CONDITION_URL_INVALID_PUBLIC_SUFFIX);
    public static final CriterionErrorReason WEBPAGE_CONDITION_URL_VALUE_TRACK_VALUE_NOT_SUPPORTED = new CriterionErrorReason(_WEBPAGE_CONDITION_URL_VALUE_TRACK_VALUE_NOT_SUPPORTED);
    public static final CriterionErrorReason WEBPAGE_CRITERION_URL_EQUALS_CAN_HAVE_ONLY_ONE_CONDITION = new CriterionErrorReason(_WEBPAGE_CRITERION_URL_EQUALS_CAN_HAVE_ONLY_ONE_CONDITION);
    public static final CriterionErrorReason WEBPAGE_CRITERION_CANNOT_ADD_NON_SMART_TARGETING_TO_NON_DSA_AD_GROUP = new CriterionErrorReason(_WEBPAGE_CRITERION_CANNOT_ADD_NON_SMART_TARGETING_TO_NON_DSA_AD_GROUP);
    ...
    public static final CriterionErrorReason ADSENSE_FOR_MOBILE_APPS_PLACEMENT_DEPRECATED = new CriterionErrorReason(_ADSENSE_FOR_MOBILE_APPS_PLACEMENT_DEPRECATED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201809", "CriterionError.Reason"));
    }
    /**
