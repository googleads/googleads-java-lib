 ...
 */
public class AdSpecListAttribute  extends com.google.api.ads.adwords.axis.v201406.o.Attribute  implements java.io.Serializable {
    /* <span class="constraint Required">This field is required and
     * should not be {@code null}.</span> */
    private com.google.api.ads.adwords.axis.v201406.o.AdSpec[] value;
    ...
    public AdSpecListAttribute(
           ...
           com.google.api.ads.adwords.axis.v201406.o.AdSpec[] value) {
        super(
            attributeType);
        this.value = value;
    }
     ...
     * should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201406.o.AdSpec[] getValue() {
        return value;
    }
     ...
     * should not be {@code null}.</span>
     */
    public void setValue(com.google.api.ads.adwords.axis.v201406.o.AdSpec[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201406.o.AdSpec getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201406.o.AdSpec _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201406", "AdSpecListAttribute"));
