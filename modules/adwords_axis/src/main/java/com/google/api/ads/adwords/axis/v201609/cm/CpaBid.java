 ...
 * CPA Bids.
 */
public class CpaBid  extends com.google.api.ads.adwords.axis.v201609.cm.Bids  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201609.cm.BidSource bidSource;
    ...
    public CpaBid(
           ...
           com.google.api.ads.adwords.axis.v201609.cm.BidSource bidSource) {
        super(
            bidsType);
        this.bid = bid;
     ...
     * be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201609.cm.BidSource getBidSource() {
        return bidSource;
    }
     ...
     * be ignored when sent to the API.</span>
     */
    public void setBidSource(com.google.api.ads.adwords.axis.v201609.cm.BidSource bidSource) {
        this.bidSource = bidSource;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "CpaBid"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "bidSource"));
