...
public class AdGroupAdPolicySummary  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201705.cm.PolicyTopicEntry[] policyTopicEntries;

    /* Progress through the review process. */
    private com.google.api.ads.adwords.axis.v201705.cm.PolicySummaryReviewState reviewState;
    ...
    public AdGroupAdPolicySummary(
           com.google.api.ads.adwords.axis.v201705.cm.PolicyTopicEntry[] policyTopicEntries,
           com.google.api.ads.adwords.axis.v201705.cm.PolicySummaryReviewState reviewState,
           com.google.api.ads.adwords.axis.v201705.cm.PolicySummaryDenormalizedStatus denormalizedStatus,
           com.google.api.ads.adwords.axis.v201705.cm.PolicyApprovalStatus combinedApprovalStatus) {
     ...
     */
    public com.google.api.ads.adwords.axis.v201705.cm.PolicyTopicEntry[] getPolicyTopicEntries() {
     ...
     */
    public void setPolicyTopicEntries(com.google.api.ads.adwords.axis.v201705.cm.PolicyTopicEntry[] policyTopicEntries) {
        this.policyTopicEntries = policyTopicEntries;
    }

    public com.google.api.ads.adwords.axis.v201705.cm.PolicyTopicEntry getPolicyTopicEntries(int i) {
        return this.policyTopicEntries[i];
    }

    public void setPolicyTopicEntries(int i, com.google.api.ads.adwords.axis.v201705.cm.PolicyTopicEntry _value) {
     ...
     */
    public com.google.api.ads.adwords.axis.v201705.cm.PolicySummaryReviewState getReviewState() {
        return reviewState;
    }
     ...
     */
    public void setReviewState(com.google.api.ads.adwords.axis.v201705.cm.PolicySummaryReviewState reviewState) {
        this.reviewState = reviewState;
    }
     ...
     */
    public com.google.api.ads.adwords.axis.v201705.cm.PolicySummaryDenormalizedStatus getDenormalizedStatus() {
     ...
     */
    public void setDenormalizedStatus(com.google.api.ads.adwords.axis.v201705.cm.PolicySummaryDenormalizedStatus denormalizedStatus) {
        this.denormalizedStatus = denormalizedStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201705", "AdGroupAdPolicySummary"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("policyTopicEntries");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201705", "policyTopicEntries"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201705", "PolicyTopicEntry"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201705", "reviewState"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201705", "PolicySummaryReviewState"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("denormalizedStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201705", "denormalizedStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201705", "PolicySummaryDenormalizedStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("combinedApprovalStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201705", "combinedApprovalStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201705", "PolicyApprovalStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
