 ...
 */
public class OperationAccessDenied  extends com.google.api.ads.adwords.axis.v201809.cm.ApiError  implements java.io.Serializable {
    private com.google.api.ads.adwords.axis.v201809.cm.OperationAccessDeniedReason reason;
    ...
    public OperationAccessDenied(
           ...
           com.google.api.ads.adwords.axis.v201809.cm.OperationAccessDeniedReason reason) {
        super(
            fieldPath,
            fieldPathElements,
            trigger,
     ...
     * @return reason
     */
    public com.google.api.ads.adwords.axis.v201809.cm.OperationAccessDeniedReason getReason() {
        return reason;
    }
     ...
     * @param reason
     */
    public void setReason(com.google.api.ads.adwords.axis.v201809.cm.OperationAccessDeniedReason reason) {
        this.reason = reason;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "OperationAccessDenied"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "OperationAccessDenied.Reason"));
