...
public class AdGroupServiceErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _INVALID_ADGROUP_ID = "INVALID_ADGROUP_ID";
    public static final java.lang.String _INVALID_ADGROUP_NAME = "INVALID_ADGROUP_NAME";
    public static final java.lang.String _USE_SET_OPERATOR_AND_MARK_STATUS_TO_DELETED = "USE_SET_OPERATOR_AND_MARK_STATUS_TO_DELETED";
    ...
    public static final AdGroupServiceErrorReason INVALID_ADGROUP_ID = new AdGroupServiceErrorReason(_INVALID_ADGROUP_ID);
    public static final AdGroupServiceErrorReason INVALID_ADGROUP_NAME = new AdGroupServiceErrorReason(_INVALID_ADGROUP_NAME);
    public static final AdGroupServiceErrorReason USE_SET_OPERATOR_AND_MARK_STATUS_TO_DELETED = new AdGroupServiceErrorReason(_USE_SET_OPERATOR_AND_MARK_STATUS_TO_DELETED);
    ...
    public static final AdGroupServiceErrorReason BID_TOO_SMALL = new AdGroupServiceErrorReason(_BID_TOO_SMALL);
    ...
    public static final AdGroupServiceErrorReason INVALID_BID = new AdGroupServiceErrorReason(_INVALID_BID);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "AdGroupServiceError.Reason"));
    }
    /**
