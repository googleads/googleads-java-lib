 ...
 */
public class AdGroupCriterionOperation  extends com.google.api.ads.adwords.axis.v201306.cm.Operation  implements java.io.Serializable {
    /* The adgroup criterion being operated on.
     *                     <span class="constraint Required">This field is
     * required and should not be {@code null}.</span> */
    private com.google.api.ads.adwords.axis.v201306.cm.AdGroupCriterion operand;
    ...
    private com.google.api.ads.adwords.axis.v201306.cm.ExemptionRequest[] exemptionRequests;
    ...
    public AdGroupCriterionOperation(
           ...
           com.google.api.ads.adwords.axis.v201306.cm.AdGroupCriterion operand,
           com.google.api.ads.adwords.axis.v201306.cm.ExemptionRequest[] exemptionRequests) {
        super(
            operator,
            operationType);
     ...
     * required and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.AdGroupCriterion getOperand() {
        return operand;
    }
     ...
     * required and should not be {@code null}.</span>
     */
    public void setOperand(com.google.api.ads.adwords.axis.v201306.cm.AdGroupCriterion operand) {
        this.operand = operand;
    }
     ...
     *                     for which you wish to get exemptions for.
     */
    public com.google.api.ads.adwords.axis.v201306.cm.ExemptionRequest[] getExemptionRequests() {
     ...
     *                     for which you wish to get exemptions for.
     */
    public void setExemptionRequests(com.google.api.ads.adwords.axis.v201306.cm.ExemptionRequest[] exemptionRequests) {
        this.exemptionRequests = exemptionRequests;
    }

    public com.google.api.ads.adwords.axis.v201306.cm.ExemptionRequest getExemptionRequests(int i) {
        return this.exemptionRequests[i];
    }

    public void setExemptionRequests(int i, com.google.api.ads.adwords.axis.v201306.cm.ExemptionRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "AdGroupCriterionOperation"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "exemptionRequests"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "ExemptionRequest"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
