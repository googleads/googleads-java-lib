 ...
 */
public class SimpleMutateJob  extends com.google.api.ads.adwords.axis.v201402.cm.Job  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201402.cm.BasicJobStatus status;

    /* History of this job. */
    private com.google.api.ads.adwords.axis.v201402.cm.JobEvent[] history;
    ...
    public SimpleMutateJob(
           ...
           java.lang.Long id,
           com.google.api.ads.adwords.axis.v201402.cm.BasicJobStatus status,
           com.google.api.ads.adwords.axis.v201402.cm.JobEvent[] history) {
        super(
            failureReason,
            stats,
            billingSummary,
     ...
     *                     {@link MutateJobService#getResult}.
     */
    public com.google.api.ads.adwords.axis.v201402.cm.BasicJobStatus getStatus() {
        return status;
    }
     ...
     *                     {@link MutateJobService#getResult}.
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201402.cm.BasicJobStatus status) {
        this.status = status;
    }
     ...
     */
    public com.google.api.ads.adwords.axis.v201402.cm.JobEvent[] getHistory() {
        return history;
    }
     ...
     */
    public void setHistory(com.google.api.ads.adwords.axis.v201402.cm.JobEvent[] history) {
        this.history = history;
    }

    public com.google.api.ads.adwords.axis.v201402.cm.JobEvent getHistory(int i) {
        return this.history[i];
    }

    public void setHistory(int i, com.google.api.ads.adwords.axis.v201402.cm.JobEvent _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "SimpleMutateJob"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "BasicJobStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("history");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "history"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "JobEvent"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
