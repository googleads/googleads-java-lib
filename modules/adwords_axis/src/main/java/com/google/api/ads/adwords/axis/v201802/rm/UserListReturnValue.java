 ...
 */
public class UserListReturnValue  extends com.google.api.ads.adwords.axis.v201802.cm.ListReturnValue  implements java.io.Serializable {
    private com.google.api.ads.adwords.axis.v201802.rm.UserList[] value;
    ...
    public UserListReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201802.rm.UserList[] value) {
        super(
            listReturnValueType);
        this.value = value;
    }
     ...
     * @return value
     */
    public com.google.api.ads.adwords.axis.v201802.rm.UserList[] getValue() {
        return value;
    }
     ...
     * @param value
     */
    public void setValue(com.google.api.ads.adwords.axis.v201802.rm.UserList[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201802.rm.UserList getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201802.rm.UserList _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201802", "UserListReturnValue"));
