 ...
 * call.
 */
public class SharedSetReturnValue  extends com.google.api.ads.adwords.axis.v201802.cm.ListReturnValue  implements java.io.Serializable {
    private com.google.api.ads.adwords.axis.v201802.cm.SharedSet[] value;
    ...
    public SharedSetReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201802.cm.SharedSet[] value,
     ...
     * @return value
     */
    public com.google.api.ads.adwords.axis.v201802.cm.SharedSet[] getValue() {
        return value;
    }
     ...
     * @param value
     */
    public void setValue(com.google.api.ads.adwords.axis.v201802.cm.SharedSet[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201802.cm.SharedSet getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201802.cm.SharedSet _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "SharedSetReturnValue"));
