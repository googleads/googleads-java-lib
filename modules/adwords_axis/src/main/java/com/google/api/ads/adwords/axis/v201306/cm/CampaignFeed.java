...
public class CampaignFeed  implements java.io.Serializable {
    ...
    public CampaignFeed(
           ...
           com.google.api.ads.adwords.axis.v201306.cm.CampaignFeedStatus status) {
           this.feedId = feedId;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "CampaignFeed"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "CampaignFeed.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
