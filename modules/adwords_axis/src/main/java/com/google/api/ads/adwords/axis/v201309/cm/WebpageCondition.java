...
public class WebpageCondition  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201309.cm.WebpageConditionOperand operand;
    ...
    public WebpageCondition(
           com.google.api.ads.adwords.axis.v201309.cm.WebpageConditionOperand operand,
     ...
     * and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201309.cm.WebpageConditionOperand getOperand() {
        return operand;
    }
     ...
     * and should not be {@code null}.</span>
     */
    public void setOperand(com.google.api.ads.adwords.axis.v201309.cm.WebpageConditionOperand operand) {
        this.operand = operand;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "WebpageCondition"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "WebpageConditionOperand"));
