...
/**
 * Contains the set of TargetingGroups matching filtering and paging
 * options
 *             of the VideoTargetingGroupService.get() call.
 */
public class TargetingGroupPage  extends com.google.api.ads.adwords.axis.v201406.cm.Page  implements java.io.Serializable {
    /* Result entries in this page. */
    private com.google.api.ads.adwords.axis.v201406.video.TargetingGroup[] entries;

    /* Summary stats for the result set. May contain segmented stats
     * as well as total stats. */
    private com.google.api.ads.adwords.axis.v201406.video.VideoEntityStats[] summaryStats;

    public TargetingGroupPage() {
    }

    public TargetingGroupPage(
           java.lang.Integer totalNumEntries,
           java.lang.String pageType,
           com.google.api.ads.adwords.axis.v201406.video.TargetingGroup[] entries,
    ...
    /**
     * Gets the entries value for this TargetingGroupPage.
     * 
     * @return entries   * Result entries in this page.
     */
    public com.google.api.ads.adwords.axis.v201406.video.TargetingGroup[] getEntries() {
        return entries;
    }


    /**
     * Sets the entries value for this TargetingGroupPage.
     * 
     * @param entries   * Result entries in this page.
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201406.video.TargetingGroup[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201406.video.TargetingGroup getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201406.video.TargetingGroup _value) {
        this.entries[i] = _value;
    }


    /**
     * Gets the summaryStats value for this TargetingGroupPage.
     * 
     * @return summaryStats   * Summary stats for the result set. May contain segmented stats
     * as well as total stats.
     */
    ...
    /**
     * Sets the summaryStats value for this TargetingGroupPage.
     * 
     * @param summaryStats   * Summary stats for the result set. May contain segmented stats
     * as well as total stats.
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TargetingGroupPage)) return false;
        TargetingGroupPage other = (TargetingGroupPage) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TargetingGroupPage.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201406", "TargetingGroupPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201406", "TargetingGroup"));
