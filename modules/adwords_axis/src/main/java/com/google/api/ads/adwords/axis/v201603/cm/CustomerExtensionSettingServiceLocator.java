...
public class CustomerExtensionSettingServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.adwords.axis.v201603.cm.CustomerExtensionSettingService {
    ...
    private java.lang.String CustomerExtensionSettingServiceInterfacePort_address = "https://adwords.google.com/api/adwords/cm/v201603/CustomerExtensionSettingService";
    ...
    public com.google.api.ads.adwords.axis.v201603.cm.CustomerExtensionSettingServiceInterface getCustomerExtensionSettingServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.adwords.axis.v201603.cm.CustomerExtensionSettingServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201603.cm.CustomerExtensionSettingServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.adwords.axis.v201603.cm.CustomerExtensionSettingServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.adwords.axis.v201603.cm.CustomerExtensionSettingServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201603.cm.CustomerExtensionSettingServiceSoapBindingStub(new java.net.URL(CustomerExtensionSettingServiceInterfacePort_address), this);
                _stub.setPortName(getCustomerExtensionSettingServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201603", "CustomerExtensionSettingService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201603", "CustomerExtensionSettingServiceInterfacePort"));
        }
