...
public class AdGroupBidModifier  implements java.io.Serializable {
    ...
    public AdGroupBidModifier(
           ...
           com.google.api.ads.adwords.axis.v201309.cm.BidModifierSource bidModifierSource) {
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201309.cm.BidModifierSource getBidModifierSource() {
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setBidModifierSource(com.google.api.ads.adwords.axis.v201309.cm.BidModifierSource bidModifierSource) {
        this.bidModifierSource = bidModifierSource;
    }
