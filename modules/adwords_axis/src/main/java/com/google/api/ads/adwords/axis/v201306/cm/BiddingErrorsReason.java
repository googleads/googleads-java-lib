...
public class BiddingErrorsReason implements java.io.Serializable {
    ...
    public static final java.lang.String _BIDDING_STRATEGY_AVAILABLE_FOR_ENHANCED_CAMPAIGN_ONLY = "BIDDING_STRATEGY_AVAILABLE_FOR_ENHANCED_CAMPAIGN_ONLY";
    public static final java.lang.String _BIDDING_STRATEGY_OVERRIDE_NOT_ALLOWED = "BIDDING_STRATEGY_OVERRIDE_NOT_ALLOWED";
    ...
    public static final java.lang.String _PERCENT_CPA_NOT_AVAILABLE_FOR_CUSTOMER = "PERCENT_CPA_NOT_AVAILABLE_FOR_CUSTOMER";
    ...
    public static final java.lang.String _CANNOT_ATTACH_POP_BIDDING_STRATEGY_FOR_CONTENT_NETWORK_ONLY_CAMPAIGN = "CANNOT_ATTACH_POP_BIDDING_STRATEGY_FOR_CONTENT_NETWORK_ONLY_CAMPAIGN";
    ...
    public static final java.lang.String _BIDDING_STRATEGY_NOT_SUPPORTED_FOR_CAMPAIGNS_WITH_EXPERIMENTS = "BIDDING_STRATEGY_NOT_SUPPORTED_FOR_CAMPAIGNS_WITH_EXPERIMENTS";
    public static final java.lang.String _UNKNOWN = "UNKNOWN";
    public static final BiddingErrorsReason BIDDING_STRATEGY_AVAILABLE_FOR_ENHANCED_CAMPAIGN_ONLY = new BiddingErrorsReason(_BIDDING_STRATEGY_AVAILABLE_FOR_ENHANCED_CAMPAIGN_ONLY);
    public static final BiddingErrorsReason BIDDING_STRATEGY_OVERRIDE_NOT_ALLOWED = new BiddingErrorsReason(_BIDDING_STRATEGY_OVERRIDE_NOT_ALLOWED);
    ...
    public static final BiddingErrorsReason PERCENT_CPA_NOT_AVAILABLE_FOR_CUSTOMER = new BiddingErrorsReason(_PERCENT_CPA_NOT_AVAILABLE_FOR_CUSTOMER);
    ...
    public static final BiddingErrorsReason NOT_ENOUGH_CONVERSION_DATA = new BiddingErrorsReason(_NOT_ENOUGH_CONVERSION_DATA);
    public static final BiddingErrorsReason CANNOT_CREATE_CAMPAIGN_WITH_CONVERSION_OPTIMIZER = new BiddingErrorsReason(_CANNOT_CREATE_CAMPAIGN_WITH_CONVERSION_OPTIMIZER);
    public static final BiddingErrorsReason CANNOT_ATTACH_POP_BIDDING_STRATEGY_FOR_CONTENT_NETWORK_ONLY_CAMPAIGN = new BiddingErrorsReason(_CANNOT_ATTACH_POP_BIDDING_STRATEGY_FOR_CONTENT_NETWORK_ONLY_CAMPAIGN);
    ...
    public static final BiddingErrorsReason BIDDING_STRATEGY_NOT_SUPPORTED_FOR_CAMPAIGNS_WITH_EXPERIMENTS = new BiddingErrorsReason(_BIDDING_STRATEGY_NOT_SUPPORTED_FOR_CAMPAIGNS_WITH_EXPERIMENTS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "BiddingErrors.Reason"));
    }
    /**
