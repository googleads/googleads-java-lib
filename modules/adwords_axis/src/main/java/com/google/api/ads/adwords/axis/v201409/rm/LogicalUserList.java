 ...
 *             interests.
 */
public class LogicalUserList  extends com.google.api.ads.adwords.axis.v201409.rm.UserList  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201409.rm.UserListLogicalRule[] rules;
    ...
    public LogicalUserList(
           ...
           com.google.api.ads.adwords.axis.v201409.rm.UserListLogicalRule[] rules) {
        super(
            id,
            isReadOnly,
            name,
     ...
     * {@link Operator}s : ADD.</span>
     */
    public com.google.api.ads.adwords.axis.v201409.rm.UserListLogicalRule[] getRules() {
        return rules;
    }
     ...
     * {@link Operator}s : ADD.</span>
     */
    public void setRules(com.google.api.ads.adwords.axis.v201409.rm.UserListLogicalRule[] rules) {
        this.rules = rules;
    }

    public com.google.api.ads.adwords.axis.v201409.rm.UserListLogicalRule getRules(int i) {
        return this.rules[i];
    }

    public void setRules(int i, com.google.api.ads.adwords.axis.v201409.rm.UserListLogicalRule _value) {
        this.rules[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201409", "LogicalUserList"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("rules");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201409", "rules"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201409", "UserListLogicalRule"));
