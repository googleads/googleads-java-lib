...
public class Selector  implements java.io.Serializable {
     ...
     *                 <span class="constraint ContentsNotNull">This field
     * must not contain {@code null} elements.</span> */
    private com.google.api.ads.adwords.axis.v201506.cm.Predicate[] predicates;
    ...
    private com.google.api.ads.adwords.axis.v201506.cm.DateRange dateRange;
    ...
    private com.google.api.ads.adwords.axis.v201506.cm.OrderBy[] ordering;
    ...
    public Selector(
           ...
           com.google.api.ads.adwords.axis.v201506.cm.Predicate[] predicates,
           com.google.api.ads.adwords.axis.v201506.cm.DateRange dateRange,
           com.google.api.ads.adwords.axis.v201506.cm.OrderBy[] ordering,
     ...
     * must not contain {@code null} elements.</span>
     */
    public com.google.api.ads.adwords.axis.v201506.cm.Predicate[] getPredicates() {
        return predicates;
    }
     ...
     * must not contain {@code null} elements.</span>
     */
    public void setPredicates(com.google.api.ads.adwords.axis.v201506.cm.Predicate[] predicates) {
        this.predicates = predicates;
    }

    public com.google.api.ads.adwords.axis.v201506.cm.Predicate getPredicates(int i) {
        return this.predicates[i];
    }

    public void setPredicates(int i, com.google.api.ads.adwords.axis.v201506.cm.Predicate _value) {
     ...
     * range must be contained within the range [19700101, 20380101].</span>
     */
    public com.google.api.ads.adwords.axis.v201506.cm.DateRange getDateRange() {
        return dateRange;
    }
     ...
     * range must be contained within the range [19700101, 20380101].</span>
     */
    public void setDateRange(com.google.api.ads.adwords.axis.v201506.cm.DateRange dateRange) {
        this.dateRange = dateRange;
    }
     ...
     *                 specifies the secondary sort order and so on.
     */
    public com.google.api.ads.adwords.axis.v201506.cm.OrderBy[] getOrdering() {
        return ordering;
    }
     ...
     *                 specifies the secondary sort order and so on.
     */
    public void setOrdering(com.google.api.ads.adwords.axis.v201506.cm.OrderBy[] ordering) {
        this.ordering = ordering;
    }

    public com.google.api.ads.adwords.axis.v201506.cm.OrderBy getOrdering(int i) {
        return this.ordering[i];
    }

    public void setOrdering(int i, com.google.api.ads.adwords.axis.v201506.cm.OrderBy _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "Selector"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fields");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "fields"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "predicates"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "Predicate"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "dateRange"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "DateRange"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("ordering");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "ordering"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "OrderBy"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "paging"));
