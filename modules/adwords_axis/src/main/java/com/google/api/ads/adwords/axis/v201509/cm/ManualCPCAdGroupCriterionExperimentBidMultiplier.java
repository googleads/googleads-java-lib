 ...
 * AdX.</span>
 */
public class ManualCPCAdGroupCriterionExperimentBidMultiplier  extends com.google.api.ads.adwords.axis.v201509.cm.AdGroupCriterionExperimentBidMultiplier  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201509.cm.MultiplierSource multiplierSource;
    ...
    public ManualCPCAdGroupCriterionExperimentBidMultiplier(
           ...
           com.google.api.ads.adwords.axis.v201509.cm.MultiplierSource multiplierSource) {
        super(
     ...
     * will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201509.cm.MultiplierSource getMultiplierSource() {
     ...
     * will be ignored when sent to the API.</span>
     */
    public void setMultiplierSource(com.google.api.ads.adwords.axis.v201509.cm.MultiplierSource multiplierSource) {
        this.multiplierSource = multiplierSource;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "ManualCPCAdGroupCriterionExperimentBidMultiplier"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "multiplierSource"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "MultiplierSource"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
