...
public class AdGroupFeedStatus implements java.io.Serializable {
    ...
    public static final AdGroupFeedStatus ACTIVE = new AdGroupFeedStatus(_ACTIVE);
    public static final AdGroupFeedStatus DELETED = new AdGroupFeedStatus(_DELETED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "AdGroupFeed.Status"));
    }
    /**
