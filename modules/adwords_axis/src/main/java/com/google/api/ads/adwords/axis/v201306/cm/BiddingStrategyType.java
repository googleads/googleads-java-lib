...
public class BiddingStrategyType implements java.io.Serializable {
    ...
    public static final java.lang.String _BUDGET_OPTIMIZER = "BUDGET_OPTIMIZER";
    public static final java.lang.String _CONVERSION_OPTIMIZER = "CONVERSION_OPTIMIZER";
    ...
    public static final java.lang.String _PERCENT_CPA = "PERCENT_CPA";
    ...
    public static final BiddingStrategyType BUDGET_OPTIMIZER = new BiddingStrategyType(_BUDGET_OPTIMIZER);
    public static final BiddingStrategyType CONVERSION_OPTIMIZER = new BiddingStrategyType(_CONVERSION_OPTIMIZER);
    ...
    public static final BiddingStrategyType PERCENT_CPA = new BiddingStrategyType(_PERCENT_CPA);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "BiddingStrategyType"));
    }
    /**
