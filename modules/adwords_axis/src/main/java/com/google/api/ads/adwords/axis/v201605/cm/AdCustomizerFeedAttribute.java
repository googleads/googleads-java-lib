...
public class AdCustomizerFeedAttribute  implements java.io.Serializable {
     ...
     * and should not be {@code null} when it is contained within {@link
     * Operator}s : ADD, SET.</span> */
    private com.google.api.ads.adwords.axis.v201605.cm.AdCustomizerFeedAttributeType type;
    ...
    public AdCustomizerFeedAttribute(
           ...
           com.google.api.ads.adwords.axis.v201605.cm.AdCustomizerFeedAttributeType type) {
           this.id = id;
           this.name = name;
           this.type = type;
    }
     ...
     * Operator}s : ADD, SET.</span>
     */
    public com.google.api.ads.adwords.axis.v201605.cm.AdCustomizerFeedAttributeType getType() {
        return type;
    }
     ...
     * Operator}s : ADD, SET.</span>
     */
    public void setType(com.google.api.ads.adwords.axis.v201605.cm.AdCustomizerFeedAttributeType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201605", "AdCustomizerFeedAttribute"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201605", "AdCustomizerFeedAttribute.Type"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
