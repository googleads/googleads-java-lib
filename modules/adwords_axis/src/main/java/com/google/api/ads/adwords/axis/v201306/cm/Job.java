...
public abstract class Job  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201306.cm.ApiErrorReason failureReason;

    /* The statistics concerning the processing of this job.
     *                 <span class="constraint ReadOnly">This field is read
     * only and should not be set.  If this field is sent to the API, it
     * will be ignored.</span> */
    private com.google.api.ads.adwords.axis.v201306.cm.JobStats stats;

    /* The billing summary specifying the cost of this job.
     *                 <span class="constraint ReadOnly">This field is read
     * only and should not be set.  If this field is sent to the API, it
     * will be ignored.</span> */
    private com.google.api.ads.adwords.axis.v201306.cm.BillingSummary billingSummary;
     ...
     * will be ignored.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.ApiErrorReason getFailureReason() {
     ...
     * will be ignored.</span>
     */
    public void setFailureReason(com.google.api.ads.adwords.axis.v201306.cm.ApiErrorReason failureReason) {
        this.failureReason = failureReason;
    }
     ...
     * will be ignored.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.JobStats getStats() {
        return stats;
    }
     ...
     * will be ignored.</span>
     */
    public void setStats(com.google.api.ads.adwords.axis.v201306.cm.JobStats stats) {
        this.stats = stats;
    }
     ...
     * will be ignored.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.BillingSummary getBillingSummary() {
     ...
     * will be ignored.</span>
     */
    public void setBillingSummary(com.google.api.ads.adwords.axis.v201306.cm.BillingSummary billingSummary) {
        this.billingSummary = billingSummary;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "Job"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("failureReason");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "failureReason"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "ApiErrorReason"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "JobStats"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("billingSummary");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "billingSummary"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "BillingSummary"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("jobType");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "Job.Type"));
