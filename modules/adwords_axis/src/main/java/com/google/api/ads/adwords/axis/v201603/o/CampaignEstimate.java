 ...
 */
public class CampaignEstimate  extends com.google.api.ads.adwords.axis.v201603.o.Estimate  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201603.o.AdGroupEstimate[] adGroupEstimates;
    ...
    public CampaignEstimate(
           ...
           com.google.api.ads.adwords.axis.v201603.o.AdGroupEstimate[] adGroupEstimates) {
        super(
            estimateType);
     ...
     * were sent in the request.
     */
    public com.google.api.ads.adwords.axis.v201603.o.AdGroupEstimate[] getAdGroupEstimates() {
     ...
     * were sent in the request.
     */
    public void setAdGroupEstimates(com.google.api.ads.adwords.axis.v201603.o.AdGroupEstimate[] adGroupEstimates) {
        this.adGroupEstimates = adGroupEstimates;
    }

    public com.google.api.ads.adwords.axis.v201603.o.AdGroupEstimate getAdGroupEstimates(int i) {
        return this.adGroupEstimates[i];
    }

    public void setAdGroupEstimates(int i, com.google.api.ads.adwords.axis.v201603.o.AdGroupEstimate _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201603", "CampaignEstimate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201603", "adGroupEstimates"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201603", "AdGroupEstimate"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
