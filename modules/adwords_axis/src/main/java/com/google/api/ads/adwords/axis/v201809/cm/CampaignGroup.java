...
public class CampaignGroup  implements java.io.Serializable {
     ...
     * Filterable">This field can be filtered on.</span> */
    private com.google.api.ads.adwords.axis.v201809.cm.CampaignGroupStatus status;
    ...
    public CampaignGroup(
           ...
           com.google.api.ads.adwords.axis.v201809.cm.CampaignGroupStatus status) {
           this.id = id;
           this.name = name;
           this.status = status;
    }
     ...
     * Filterable">This field can be filtered on.</span>
     */
    public com.google.api.ads.adwords.axis.v201809.cm.CampaignGroupStatus getStatus() {
        return status;
    }
     ...
     * Filterable">This field can be filtered on.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201809.cm.CampaignGroupStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "CampaignGroup"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "CampaignGroupStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
