 ...
 */
public class SharedSetPage  extends com.google.api.ads.adwords.axis.v201702.cm.NullStatsPage  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201702.cm.SharedSet>{
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201702.cm.SharedSet[] entries;
    ...
    public SharedSetPage(
           ...
           com.google.api.ads.adwords.axis.v201702.cm.SharedSet[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201702.cm.SharedSet[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201702.cm.SharedSet[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201702.cm.SharedSet getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201702.cm.SharedSet _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201702.cm.SharedSet> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201702.cm.SharedSet>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201702.cm.SharedSet>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "SharedSetPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "SharedSet"));
