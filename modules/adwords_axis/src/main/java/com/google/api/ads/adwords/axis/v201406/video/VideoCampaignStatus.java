...
public class VideoCampaignStatus implements java.io.Serializable {
    ...
    public static final VideoCampaignStatus ENABLED = new VideoCampaignStatus(_ENABLED);
    public static final VideoCampaignStatus REMOVED = new VideoCampaignStatus(_REMOVED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201406", "VideoCampaignStatus"));
    }
    /**
