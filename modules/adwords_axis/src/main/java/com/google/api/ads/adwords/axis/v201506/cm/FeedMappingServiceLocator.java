...
public class FeedMappingServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.adwords.axis.v201506.cm.FeedMappingService {
    ...
    private java.lang.String FeedMappingServiceInterfacePort_address = "https://adwords.google.com/api/adwords/cm/v201506/FeedMappingService";
    ...
    public com.google.api.ads.adwords.axis.v201506.cm.FeedMappingServiceInterface getFeedMappingServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.adwords.axis.v201506.cm.FeedMappingServiceInterface getFeedMappingServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.adwords.axis.v201506.cm.FeedMappingServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201506.cm.FeedMappingServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.adwords.axis.v201506.cm.FeedMappingServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.adwords.axis.v201506.cm.FeedMappingServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201506.cm.FeedMappingServiceSoapBindingStub(new java.net.URL(FeedMappingServiceInterfacePort_address), this);
                _stub.setPortName(getFeedMappingServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "FeedMappingService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "FeedMappingServiceInterfacePort"));
        }
