 ...
 */
public class BasicUserList  extends com.google.api.ads.adwords.axis.v201710.rm.UserList  implements java.io.Serializable {
    /* Conversion types associated with this user list.
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "ConversionTypes".</span> */
    private com.google.api.ads.adwords.axis.v201710.rm.UserListConversionType[] conversionTypes;
    ...
    public BasicUserList(
           ...
           com.google.api.ads.adwords.axis.v201710.rm.UserListConversionType[] conversionTypes) {
        super(
            id,
            isReadOnly,
            name,
     ...
     * can be selected using the value "ConversionTypes".</span>
     */
    public com.google.api.ads.adwords.axis.v201710.rm.UserListConversionType[] getConversionTypes() {
     ...
     * can be selected using the value "ConversionTypes".</span>
     */
    public void setConversionTypes(com.google.api.ads.adwords.axis.v201710.rm.UserListConversionType[] conversionTypes) {
        this.conversionTypes = conversionTypes;
    }

    public com.google.api.ads.adwords.axis.v201710.rm.UserListConversionType getConversionTypes(int i) {
        return this.conversionTypes[i];
    }

    public void setConversionTypes(int i, com.google.api.ads.adwords.axis.v201710.rm.UserListConversionType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201710", "BasicUserList"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("conversionTypes");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201710", "conversionTypes"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201710", "UserListConversionType"));
