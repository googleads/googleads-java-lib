 ...
 */
public class PercentCpaBid  extends com.google.api.ads.adwords.axis.v201402.cm.Bids  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201402.cm.BidSource percentCpaBidSource;
    ...
    public PercentCpaBid(
           ...
           com.google.api.ads.adwords.axis.v201402.cm.BidSource percentCpaBidSource) {
        super(
            bidsType);
        this.bid = bid;
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201402.cm.BidSource getPercentCpaBidSource() {
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public void setPercentCpaBidSource(com.google.api.ads.adwords.axis.v201402.cm.BidSource percentCpaBidSource) {
        this.percentCpaBidSource = percentCpaBidSource;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "PercentCpaBid"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "percentCpaBidSource"));
