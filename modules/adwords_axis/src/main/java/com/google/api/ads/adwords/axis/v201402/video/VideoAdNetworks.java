...
public class VideoAdNetworks  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201402.video.VideoAdNetwork[] networks;

    public VideoAdNetworks() {
    }

    public VideoAdNetworks(
           com.google.api.ads.adwords.axis.v201402.video.VideoAdNetwork[] networks) {
     ...
     * must not contain {@code null} elements.</span>
     */
    public com.google.api.ads.adwords.axis.v201402.video.VideoAdNetwork[] getNetworks() {
        return networks;
    }
     ...
     * must not contain {@code null} elements.</span>
     */
    public void setNetworks(com.google.api.ads.adwords.axis.v201402.video.VideoAdNetwork[] networks) {
        this.networks = networks;
    }

    public com.google.api.ads.adwords.axis.v201402.video.VideoAdNetwork getNetworks(int i) {
        return this.networks[i];
    }

    public void setNetworks(int i, com.google.api.ads.adwords.axis.v201402.video.VideoAdNetwork _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "VideoAdNetworks"));
