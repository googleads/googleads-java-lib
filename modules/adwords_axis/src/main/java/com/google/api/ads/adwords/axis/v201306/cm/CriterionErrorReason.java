...
public class CriterionErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_ADD_BID_MODIFIER_FOR_BIDDING_STRATEGY = "CANNOT_ADD_BID_MODIFIER_FOR_BIDDING_STRATEGY";
    public static final java.lang.String _CANNOT_BID_MODIFY_NON_ENHANCED_CAMPAIGN = "CANNOT_BID_MODIFY_NON_ENHANCED_CAMPAIGN";
    public static final java.lang.String _CANNOT_BID_MODIFY_DESKTOP = "CANNOT_BID_MODIFY_DESKTOP";
    ...
    public static final java.lang.String _CANNOT_ATTACH_CRITERIA_BIDDING_STRATEGY_ON_CONTENT_NETWORK_ONLY_CAMPAIGN = "CANNOT_ATTACH_CRITERIA_BIDDING_STRATEGY_ON_CONTENT_NETWORK_ONLY_CAMPAIGN";
    ...
    public static final CriterionErrorReason CANNOT_ADD_BID_MODIFIER_FOR_BIDDING_STRATEGY = new CriterionErrorReason(_CANNOT_ADD_BID_MODIFIER_FOR_BIDDING_STRATEGY);
    public static final CriterionErrorReason CANNOT_BID_MODIFY_NON_ENHANCED_CAMPAIGN = new CriterionErrorReason(_CANNOT_BID_MODIFY_NON_ENHANCED_CAMPAIGN);
    public static final CriterionErrorReason CANNOT_BID_MODIFY_DESKTOP = new CriterionErrorReason(_CANNOT_BID_MODIFY_DESKTOP);
    ...
    public static final CriterionErrorReason CANNOT_ATTACH_CRITERIA_BIDDING_STRATEGY_ON_CONTENT_NETWORK_ONLY_CAMPAIGN = new CriterionErrorReason(_CANNOT_ATTACH_CRITERIA_BIDDING_STRATEGY_ON_CONTENT_NETWORK_ONLY_CAMPAIGN);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "CriterionError.Reason"));
    }
    /**
