 ...
 */
public class AdCustomizerFeedPage  extends com.google.api.ads.adwords.axis.v201509.cm.Page  implements java.io.Serializable {
    private com.google.api.ads.adwords.axis.v201509.cm.AdCustomizerFeed[] entries;
    ...
    public AdCustomizerFeedPage(
           ...
           com.google.api.ads.adwords.axis.v201509.cm.AdCustomizerFeed[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     * @return entries
     */
    public com.google.api.ads.adwords.axis.v201509.cm.AdCustomizerFeed[] getEntries() {
        return entries;
    }
     ...
     * @param entries
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201509.cm.AdCustomizerFeed[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201509.cm.AdCustomizerFeed getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201509.cm.AdCustomizerFeed _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "AdCustomizerFeedPage"));
