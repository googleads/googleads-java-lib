...
public class BulkMutateRequest  implements java.io.Serializable {
     ...
     *                 <span class="constraint Required">This field is required
     * and should not be {@code null}.</span> */
    private com.google.api.ads.adwords.axis.v201306.cm.OperationStream[] operationStreams;
    ...
    public BulkMutateRequest(
           ...
           com.google.api.ads.adwords.axis.v201306.cm.OperationStream[] operationStreams) {
     ...
     * and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201306.cm.OperationStream[] getOperationStreams() {
     ...
     * and should not be {@code null}.</span>
     */
    public void setOperationStreams(com.google.api.ads.adwords.axis.v201306.cm.OperationStream[] operationStreams) {
        this.operationStreams = operationStreams;
    }

    public com.google.api.ads.adwords.axis.v201306.cm.OperationStream getOperationStreams(int i) {
        return this.operationStreams[i];
    }

    public void setOperationStreams(int i, com.google.api.ads.adwords.axis.v201306.cm.OperationStream _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "BulkMutateRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "operationStreams"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201306", "OperationStream"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
