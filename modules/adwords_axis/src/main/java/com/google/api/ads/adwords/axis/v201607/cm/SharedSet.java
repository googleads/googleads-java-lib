...
public class SharedSet  implements java.io.Serializable {
     ...
     * and should not be {@code null} when it is contained within {@link
     * Operator}s : ADD.</span> */
    private com.google.api.ads.adwords.axis.v201607.cm.SharedSetType type;
     ...
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201607.cm.SharedSetStatus status;
    ...
    public SharedSet(
           ...
           com.google.api.ads.adwords.axis.v201607.cm.SharedSetType type,
           java.lang.Integer memberCount,
           java.lang.Integer referenceCount,
           com.google.api.ads.adwords.axis.v201607.cm.SharedSetStatus status) {
     ...
     * Operator}s : ADD.</span>
     */
    public com.google.api.ads.adwords.axis.v201607.cm.SharedSetType getType() {
        return type;
    }
     ...
     * Operator}s : ADD.</span>
     */
    public void setType(com.google.api.ads.adwords.axis.v201607.cm.SharedSetType type) {
        this.type = type;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201607.cm.SharedSetStatus getStatus() {
        return status;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201607.cm.SharedSetStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201607", "SharedSet"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201607", "memberCount"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201607", "SharedSet.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
