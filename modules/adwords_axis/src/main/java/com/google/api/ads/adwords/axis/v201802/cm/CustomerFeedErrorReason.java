...
public class CustomerFeedErrorReason implements java.io.Serializable {
    ...
    public static final CustomerFeedErrorReason CANNOT_ADD_FOR_DELETED_FEED = new CustomerFeedErrorReason(_CANNOT_ADD_FOR_DELETED_FEED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "CustomerFeedError.Reason"));
    }
    /**
