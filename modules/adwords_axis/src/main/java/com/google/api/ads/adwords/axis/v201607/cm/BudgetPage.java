 ...
 */
public class BudgetPage  extends com.google.api.ads.adwords.axis.v201607.cm.Page  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201607.cm.Budget>{
    private com.google.api.ads.adwords.axis.v201607.cm.Budget[] entries;
    ...
    public BudgetPage(
           ...
           com.google.api.ads.adwords.axis.v201607.cm.Budget[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     * @return entries
     */
    public com.google.api.ads.adwords.axis.v201607.cm.Budget[] getEntries() {
        return entries;
    }
     ...
     * @param entries
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201607.cm.Budget[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201607.cm.Budget getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201607.cm.Budget _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201607.cm.Budget> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201607.cm.Budget>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201607.cm.Budget>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201607", "BudgetPage"));
