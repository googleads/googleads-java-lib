 ...
 */
public class CampaignPage  extends com.google.api.ads.adwords.axis.v201609.cm.Page  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201609.cm.Campaign>{
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201609.cm.Campaign[] entries;
    ...
    public CampaignPage(
           ...
           com.google.api.ads.adwords.axis.v201609.cm.Campaign[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201609.cm.Campaign[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201609.cm.Campaign[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201609.cm.Campaign getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201609.cm.Campaign _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201609.cm.Campaign> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201609.cm.Campaign>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201609.cm.Campaign>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "CampaignPage"));
