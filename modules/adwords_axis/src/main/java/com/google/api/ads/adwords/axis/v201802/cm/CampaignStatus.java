...
public class CampaignStatus implements java.io.Serializable {
    ...
    public static final CampaignStatus UNKNOWN = new CampaignStatus(_UNKNOWN);
    public static final CampaignStatus ENABLED = new CampaignStatus(_ENABLED);
    public static final CampaignStatus PAUSED = new CampaignStatus(_PAUSED);
    public static final CampaignStatus REMOVED = new CampaignStatus(_REMOVED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "CampaignStatus"));
    }
    /**
