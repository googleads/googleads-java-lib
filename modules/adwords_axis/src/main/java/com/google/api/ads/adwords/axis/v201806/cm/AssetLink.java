...
public class AssetLink  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201806.cm.ServedAssetFieldType pinnedField;

    /* Approval information contained in this AssetLink.
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201806.cm.AssetPolicySummaryInfo assetPolicySummaryInfo;

    /* Performance label for the asset.
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201806.cm.AssetPerformanceLabel assetPerformanceLabel;
    ...
    public AssetLink(
           ...
           com.google.api.ads.adwords.axis.v201806.cm.ServedAssetFieldType pinnedField,
           com.google.api.ads.adwords.axis.v201806.cm.AssetPolicySummaryInfo assetPolicySummaryInfo,
           com.google.api.ads.adwords.axis.v201806.cm.AssetPerformanceLabel assetPerformanceLabel) {
           this.asset = asset;
     ...
     *                 This field is optional.
     */
    public com.google.api.ads.adwords.axis.v201806.cm.ServedAssetFieldType getPinnedField() {
        return pinnedField;
    }
     ...
     *                 This field is optional.
     */
    public void setPinnedField(com.google.api.ads.adwords.axis.v201806.cm.ServedAssetFieldType pinnedField) {
        this.pinnedField = pinnedField;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201806.cm.AssetPolicySummaryInfo getAssetPolicySummaryInfo() {
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setAssetPolicySummaryInfo(com.google.api.ads.adwords.axis.v201806.cm.AssetPolicySummaryInfo assetPolicySummaryInfo) {
        this.assetPolicySummaryInfo = assetPolicySummaryInfo;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201806.cm.AssetPerformanceLabel getAssetPerformanceLabel() {
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setAssetPerformanceLabel(com.google.api.ads.adwords.axis.v201806.cm.AssetPerformanceLabel assetPerformanceLabel) {
        this.assetPerformanceLabel = assetPerformanceLabel;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "AssetLink"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "pinnedField"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "ServedAssetFieldType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("assetPolicySummaryInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "assetPolicySummaryInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "AssetPolicySummaryInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("assetPerformanceLabel");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "assetPerformanceLabel"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "AssetPerformanceLabel"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
