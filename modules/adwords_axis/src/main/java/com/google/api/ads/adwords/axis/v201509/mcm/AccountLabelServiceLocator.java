...
public class AccountLabelServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.adwords.axis.v201509.mcm.AccountLabelService {
    ...
    private java.lang.String AccountLabelServiceInterfacePort_address = "https://adwords.google.com/api/adwords/mcm/v201509/AccountLabelService";
    ...
    public com.google.api.ads.adwords.axis.v201509.mcm.AccountLabelServiceInterface getAccountLabelServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.adwords.axis.v201509.mcm.AccountLabelServiceInterface getAccountLabelServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.adwords.axis.v201509.mcm.AccountLabelServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201509.mcm.AccountLabelServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.adwords.axis.v201509.mcm.AccountLabelServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.adwords.axis.v201509.mcm.AccountLabelServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201509.mcm.AccountLabelServiceSoapBindingStub(new java.net.URL(AccountLabelServiceInterfacePort_address), this);
                _stub.setPortName(getAccountLabelServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/mcm/v201509", "AccountLabelService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/mcm/v201509", "AccountLabelServiceInterfacePort"));
        }
