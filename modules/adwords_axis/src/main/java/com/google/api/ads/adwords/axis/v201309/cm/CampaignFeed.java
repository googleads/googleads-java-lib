...
public class CampaignFeed  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201309.cm.CampaignFeedStatus status;
    ...
    public CampaignFeed(
           ...
           com.google.api.ads.adwords.axis.v201309.cm.CampaignFeedStatus status) {
           this.feedId = feedId;
     ...
     * will be ignored.</span>
     */
    public com.google.api.ads.adwords.axis.v201309.cm.CampaignFeedStatus getStatus() {
        return status;
    }
     ...
     * will be ignored.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201309.cm.CampaignFeedStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "CampaignFeed"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201309", "CampaignFeed.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
