...
public class MutateMembersErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _INVALID_REMOVEALL_OPERATION = "INVALID_REMOVEALL_OPERATION";
    public static final java.lang.String _INVALID_OPERATION_ORDER = "INVALID_OPERATION_ORDER";
    public static final java.lang.String _MISSING_MEMBER_IDENTIFIER = "MISSING_MEMBER_IDENTIFIER";
    public static final java.lang.String _INCOMPATIBLE_UPLOAD_KEY_TYPE = "INCOMPATIBLE_UPLOAD_KEY_TYPE";
    ...
    public static final MutateMembersErrorReason MISSING_MEMBER_IDENTIFIER = new MutateMembersErrorReason(_MISSING_MEMBER_IDENTIFIER);
    public static final MutateMembersErrorReason INCOMPATIBLE_UPLOAD_KEY_TYPE = new MutateMembersErrorReason(_INCOMPATIBLE_UPLOAD_KEY_TYPE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201802", "MutateMembersError.Reason"));
    }
    /**
