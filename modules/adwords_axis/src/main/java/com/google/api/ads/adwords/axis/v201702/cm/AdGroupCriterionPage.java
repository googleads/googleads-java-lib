 ...
 */
public class AdGroupCriterionPage  extends com.google.api.ads.adwords.axis.v201702.cm.Page  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201702.cm.AdGroupCriterion>{
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201702.cm.AdGroupCriterion[] entries;
    ...
    public AdGroupCriterionPage(
           ...
           com.google.api.ads.adwords.axis.v201702.cm.AdGroupCriterion[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201702.cm.AdGroupCriterion[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201702.cm.AdGroupCriterion[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201702.cm.AdGroupCriterion getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201702.cm.AdGroupCriterion _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201702.cm.AdGroupCriterion> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201702.cm.AdGroupCriterion>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201702.cm.AdGroupCriterion>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "AdGroupCriterionPage"));
