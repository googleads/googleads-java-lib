 ...
 * targeting.
 */
public class PlacesOfInterestOperand  extends com.google.api.ads.adwords.axis.v201506.cm.FunctionArgumentOperand  implements java.io.Serializable {
    /* <span class="constraint Required">This field is required and
     * should not be {@code null}.</span> */
    private com.google.api.ads.adwords.axis.v201506.cm.PlacesOfInterestOperandCategory category;
    ...
    public PlacesOfInterestOperand(
           ...
           com.google.api.ads.adwords.axis.v201506.cm.PlacesOfInterestOperandCategory category) {
        super(
     ...
     * should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201506.cm.PlacesOfInterestOperandCategory getCategory() {
        return category;
    }
     ...
     * should not be {@code null}.</span>
     */
    public void setCategory(com.google.api.ads.adwords.axis.v201506.cm.PlacesOfInterestOperandCategory category) {
        this.category = category;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "PlacesOfInterestOperand"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "PlacesOfInterestOperand.Category"));
