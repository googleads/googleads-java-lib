...
public class ReportDefinitionReportType implements java.io.Serializable {
    ...
    public static final java.lang.String _USER_AD_DISTANCE_REPORT = "USER_AD_DISTANCE_REPORT";
    ...
    public static final java.lang.String _PARENTAL_STATUS_PERFORMANCE_REPORT = "PARENTAL_STATUS_PERFORMANCE_REPORT";
    ...
    public static final java.lang.String _FINAL_URL_REPORT = "FINAL_URL_REPORT";
    public static final java.lang.String _VIDEO_PERFORMANCE_REPORT = "VIDEO_PERFORMANCE_REPORT";
    public static final java.lang.String _TOP_CONTENT_PERFORMANCE_REPORT = "TOP_CONTENT_PERFORMANCE_REPORT";
    public static final java.lang.String _CAMPAIGN_CRITERIA_REPORT = "CAMPAIGN_CRITERIA_REPORT";
    public static final java.lang.String _CAMPAIGN_GROUP_PERFORMANCE_REPORT = "CAMPAIGN_GROUP_PERFORMANCE_REPORT";
    public static final java.lang.String _LANDING_PAGE_REPORT = "LANDING_PAGE_REPORT";
    public static final java.lang.String _MARKETPLACE_PERFORMANCE_REPORT = "MARKETPLACE_PERFORMANCE_REPORT";
    ...
    public static final ReportDefinitionReportType USER_AD_DISTANCE_REPORT = new ReportDefinitionReportType(_USER_AD_DISTANCE_REPORT);
    ...
    public static final ReportDefinitionReportType LABEL_REPORT = new ReportDefinitionReportType(_LABEL_REPORT);
    public static final ReportDefinitionReportType FINAL_URL_REPORT = new ReportDefinitionReportType(_FINAL_URL_REPORT);
    public static final ReportDefinitionReportType VIDEO_PERFORMANCE_REPORT = new ReportDefinitionReportType(_VIDEO_PERFORMANCE_REPORT);
    public static final ReportDefinitionReportType TOP_CONTENT_PERFORMANCE_REPORT = new ReportDefinitionReportType(_TOP_CONTENT_PERFORMANCE_REPORT);
    public static final ReportDefinitionReportType CAMPAIGN_CRITERIA_REPORT = new ReportDefinitionReportType(_CAMPAIGN_CRITERIA_REPORT);
    public static final ReportDefinitionReportType CAMPAIGN_GROUP_PERFORMANCE_REPORT = new ReportDefinitionReportType(_CAMPAIGN_GROUP_PERFORMANCE_REPORT);
    public static final ReportDefinitionReportType LANDING_PAGE_REPORT = new ReportDefinitionReportType(_LANDING_PAGE_REPORT);
    public static final ReportDefinitionReportType MARKETPLACE_PERFORMANCE_REPORT = new ReportDefinitionReportType(_MARKETPLACE_PERFORMANCE_REPORT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "ReportDefinition.ReportType"));
    }
    /**
