 ...
 */
public abstract class BidLandscape  extends com.google.api.ads.adwords.axis.v201605.cm.DataEntry  implements java.io.Serializable {
     ...
     * bid amount. */
    private com.google.api.ads.adwords.axis.v201605.cm.BidLandscapeLandscapePoint[] landscapePoints;
    ...
    public BidLandscape(
           ...
           com.google.api.ads.adwords.axis.v201605.cm.BidLandscapeLandscapePoint[] landscapePoints) {
        super(
            dataEntryType);
     ...
     * bid amount.
     */
    public com.google.api.ads.adwords.axis.v201605.cm.BidLandscapeLandscapePoint[] getLandscapePoints() {
     ...
     * bid amount.
     */
    public void setLandscapePoints(com.google.api.ads.adwords.axis.v201605.cm.BidLandscapeLandscapePoint[] landscapePoints) {
        this.landscapePoints = landscapePoints;
    }

    public com.google.api.ads.adwords.axis.v201605.cm.BidLandscapeLandscapePoint getLandscapePoints(int i) {
        return this.landscapePoints[i];
    }

    public void setLandscapePoints(int i, com.google.api.ads.adwords.axis.v201605.cm.BidLandscapeLandscapePoint _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201605", "BidLandscape"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201605", "landscapePoints"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201605", "BidLandscape.LandscapePoint"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
