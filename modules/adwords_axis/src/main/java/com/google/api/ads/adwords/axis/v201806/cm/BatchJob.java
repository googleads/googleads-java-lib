...
public class BatchJob  implements java.io.Serializable {
     ...
     * only and will be ignored when sent to the API for the following {@link
     * Operator}s: ADD.</span> */
    private com.google.api.ads.adwords.axis.v201806.cm.BatchJobStatus status;
    ...
    private com.google.api.ads.adwords.axis.v201806.cm.ProgressStats progressStats;
    ...
    private com.google.api.ads.adwords.axis.v201806.cm.TemporaryUrl uploadUrl;
     ...
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201806.cm.TemporaryUrl downloadUrl;
     ...
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201806.cm.BatchJobProcessingError[] processingErrors;
    ...
    public BatchJob(
           java.lang.Long id,
           com.google.api.ads.adwords.axis.v201806.cm.BatchJobStatus status,
           com.google.api.ads.adwords.axis.v201806.cm.ProgressStats progressStats,
           com.google.api.ads.adwords.axis.v201806.cm.TemporaryUrl uploadUrl,
           com.google.api.ads.adwords.axis.v201806.cm.TemporaryUrl downloadUrl,
           com.google.api.ads.adwords.axis.v201806.cm.BatchJobProcessingError[] processingErrors,
     ...
     * Operator}s: ADD.</span>
     */
    public com.google.api.ads.adwords.axis.v201806.cm.BatchJobStatus getStatus() {
        return status;
    }
     ...
     * Operator}s: ADD.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201806.cm.BatchJobStatus status) {
        this.status = status;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201806.cm.ProgressStats getProgressStats() {
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setProgressStats(com.google.api.ads.adwords.axis.v201806.cm.ProgressStats progressStats) {
        this.progressStats = progressStats;
    }
     ...
     * be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201806.cm.TemporaryUrl getUploadUrl() {
        return uploadUrl;
    }
     ...
     * be ignored when sent to the API.</span>
     */
    public void setUploadUrl(com.google.api.ads.adwords.axis.v201806.cm.TemporaryUrl uploadUrl) {
        this.uploadUrl = uploadUrl;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201806.cm.TemporaryUrl getDownloadUrl() {
        return downloadUrl;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setDownloadUrl(com.google.api.ads.adwords.axis.v201806.cm.TemporaryUrl downloadUrl) {
        this.downloadUrl = downloadUrl;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201806.cm.BatchJobProcessingError[] getProcessingErrors() {
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setProcessingErrors(com.google.api.ads.adwords.axis.v201806.cm.BatchJobProcessingError[] processingErrors) {
        this.processingErrors = processingErrors;
    }

    public com.google.api.ads.adwords.axis.v201806.cm.BatchJobProcessingError getProcessingErrors(int i) {
        return this.processingErrors[i];
    }

    public void setProcessingErrors(int i, com.google.api.ads.adwords.axis.v201806.cm.BatchJobProcessingError _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "BatchJob"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "BatchJobStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("progressStats");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "progressStats"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "ProgressStats"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("uploadUrl");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "uploadUrl"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "TemporaryUrl"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("downloadUrl");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "downloadUrl"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "TemporaryUrl"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "processingErrors"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "BatchJobProcessingError"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "diskUsageQuotaBalance"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
