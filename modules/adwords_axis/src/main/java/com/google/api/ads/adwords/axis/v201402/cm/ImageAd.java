 ...
 * AdX.</span>
 */
public class ImageAd  extends com.google.api.ads.adwords.axis.v201402.cm.Ad  implements java.io.Serializable {
     ...
     * can be selected using the value "ImageCreativeName".</span><span class="constraint
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "ImageAd"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "adToCopyImageFrom"));
