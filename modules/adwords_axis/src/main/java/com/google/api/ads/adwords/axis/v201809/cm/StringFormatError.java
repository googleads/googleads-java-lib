 ...
 */
public class StringFormatError  extends com.google.api.ads.adwords.axis.v201809.cm.ApiError  implements java.io.Serializable {
    private com.google.api.ads.adwords.axis.v201809.cm.StringFormatErrorReason reason;
    ...
    public StringFormatError(
           ...
           com.google.api.ads.adwords.axis.v201809.cm.StringFormatErrorReason reason) {
        super(
            fieldPath,
            fieldPathElements,
            trigger,
     ...
     * @return reason
     */
    public com.google.api.ads.adwords.axis.v201809.cm.StringFormatErrorReason getReason() {
        return reason;
    }
     ...
     * @param reason
     */
    public void setReason(com.google.api.ads.adwords.axis.v201809.cm.StringFormatErrorReason reason) {
        this.reason = reason;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "StringFormatError"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "StringFormatError.Reason"));
