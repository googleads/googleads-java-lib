...
public class MultiplierErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _MULTIPLIER_NOT_ALLOWED_FOR_EXPERIMENT_DELTA_STATUS = "MULTIPLIER_NOT_ALLOWED_FOR_EXPERIMENT_DELTA_STATUS";
    ...
    public static final MultiplierErrorReason MULTIPLIER_NOT_ALLOWED_FOR_EXPERIMENT_DELTA_STATUS = new MultiplierErrorReason(_MULTIPLIER_NOT_ALLOWED_FOR_EXPERIMENT_DELTA_STATUS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "MultiplierError.Reason"));
    }
    /**
