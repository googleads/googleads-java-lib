...
public class Label  implements java.io.Serializable {
    ...
    /* Name of label.
     *                 <span class="constraint Selectable">This field can
     * be selected using the value "LabelName".</span><span class="constraint
     * Filterable">This field can be filtered on.</span>
    ...
    /* Status of the label.
     *                 <span class="constraint Selectable">This field can
     * be selected using the value "LabelStatus".</span><span class="constraint
     * Filterable">This field can be filtered on.</span>
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201509.cm.LabelStatus status;

    /* Attributes of the label.
     *                 <span class="constraint Selectable">This field can
     * be selected using the value "LabelAttribute".</span>
     *                 <span class="constraint ReadOnly">This field is read
     * only and will be ignored when sent to the API for the following {@link
     * Operator}s: REMOVE.</span> */
    private com.google.api.ads.adwords.axis.v201509.cm.LabelAttribute attribute;
    ...
    public Label(
           ...
           com.google.api.ads.adwords.axis.v201509.cm.LabelStatus status,
           com.google.api.ads.adwords.axis.v201509.cm.LabelAttribute attribute,
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201509.cm.LabelStatus getStatus() {
        return status;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201509.cm.LabelStatus status) {
        this.status = status;
    }
     ...
     * Operator}s: REMOVE.</span>
     */
    public com.google.api.ads.adwords.axis.v201509.cm.LabelAttribute getAttribute() {
        return attribute;
    }
     ...
     * Operator}s: REMOVE.</span>
     */
    public void setAttribute(com.google.api.ads.adwords.axis.v201509.cm.LabelAttribute attribute) {
        this.attribute = attribute;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "Label"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "Label.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("attribute");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "attribute"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "LabelAttribute"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("labelType");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "Label.Type"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
