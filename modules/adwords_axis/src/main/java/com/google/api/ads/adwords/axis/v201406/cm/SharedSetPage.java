...
public class SharedSetPage  extends com.google.api.ads.adwords.axis.v201406.cm.NullStatsPage  implements java.io.Serializable {
    ...
    public SharedSetPage(
           ...
           com.google.api.ads.adwords.axis.v201406.cm.SharedSet[] entries) {
        super(
            totalNumEntries,
            pageType);
    ...
    public com.google.api.ads.adwords.axis.v201406.cm.SharedSet getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201406.cm.SharedSet _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "SharedSetPage"));
