...
public class CampaignAdExtension  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201506.cm.AdExtension adExtension;

    /* Status of ad extension in the campaign - defaults to {@code
     * ACTIVE} on add
     *                 if unspecified. */
    private com.google.api.ads.adwords.axis.v201506.cm.CampaignAdExtensionStatus status;

    /* Approval status. */
    private com.google.api.ads.adwords.axis.v201506.cm.CampaignAdExtensionApprovalStatus approvalStatus;
    ...
    public CampaignAdExtension(
           ...
           com.google.api.ads.adwords.axis.v201506.cm.AdExtension adExtension,
           com.google.api.ads.adwords.axis.v201506.cm.CampaignAdExtensionStatus status,
           com.google.api.ads.adwords.axis.v201506.cm.CampaignAdExtensionApprovalStatus approvalStatus) {
     ...
     * and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201506.cm.AdExtension getAdExtension() {
        return adExtension;
    }
     ...
     * and should not be {@code null}.</span>
     */
    public void setAdExtension(com.google.api.ads.adwords.axis.v201506.cm.AdExtension adExtension) {
        this.adExtension = adExtension;
    }
     ...
     *                 if unspecified.
     */
    public com.google.api.ads.adwords.axis.v201506.cm.CampaignAdExtensionStatus getStatus() {
        return status;
    }
     ...
     *                 if unspecified.
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201506.cm.CampaignAdExtensionStatus status) {
        this.status = status;
    }
     ...
     */
    public com.google.api.ads.adwords.axis.v201506.cm.CampaignAdExtensionApprovalStatus getApprovalStatus() {
     ...
     */
    public void setApprovalStatus(com.google.api.ads.adwords.axis.v201506.cm.CampaignAdExtensionApprovalStatus approvalStatus) {
        this.approvalStatus = approvalStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "CampaignAdExtension"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "adExtension"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "AdExtension"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "CampaignAdExtension.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "CampaignAdExtension.ApprovalStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
