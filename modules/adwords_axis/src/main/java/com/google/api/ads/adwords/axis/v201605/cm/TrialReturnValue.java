 ...
 */
public class TrialReturnValue  extends com.google.api.ads.adwords.axis.v201605.cm.ListReturnValue  implements java.io.Serializable {
    private com.google.api.ads.adwords.axis.v201605.cm.Trial[] value;
    ...
    public TrialReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201605.cm.Trial[] value,
     ...
     * @return value
     */
    public com.google.api.ads.adwords.axis.v201605.cm.Trial[] getValue() {
        return value;
    }
     ...
     * @param value
     */
    public void setValue(com.google.api.ads.adwords.axis.v201605.cm.Trial[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201605.cm.Trial getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201605.cm.Trial _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201605", "TrialReturnValue"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201605", "Trial"));
