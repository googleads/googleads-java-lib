...
public class PolicyData  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201609.cm.DisapprovalReason[] disapprovalReasons;
     ...
     */
    public com.google.api.ads.adwords.axis.v201609.cm.DisapprovalReason[] getDisapprovalReasons() {
     ...
     */
    public void setDisapprovalReasons(com.google.api.ads.adwords.axis.v201609.cm.DisapprovalReason[] disapprovalReasons) {
        this.disapprovalReasons = disapprovalReasons;
    }

    public com.google.api.ads.adwords.axis.v201609.cm.DisapprovalReason getDisapprovalReasons(int i) {
        return this.disapprovalReasons[i];
    }

    public void setDisapprovalReasons(int i, com.google.api.ads.adwords.axis.v201609.cm.DisapprovalReason _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "PolicyData"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "DisapprovalReason"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "PolicyData.Type"));
