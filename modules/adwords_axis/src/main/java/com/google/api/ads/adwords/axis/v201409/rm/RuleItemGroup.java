...
public class RuleItemGroup  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201409.rm.RuleItem[] items;

    public RuleItemGroup() {
    }

    public RuleItemGroup(
           com.google.api.ads.adwords.axis.v201409.rm.RuleItem[] items) {
           this.items = items;
    }
     ...
     * and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201409.rm.RuleItem[] getItems() {
        return items;
    }
     ...
     * and should not be {@code null}.</span>
     */
    public void setItems(com.google.api.ads.adwords.axis.v201409.rm.RuleItem[] items) {
        this.items = items;
    }

    public com.google.api.ads.adwords.axis.v201409.rm.RuleItem getItems(int i) {
        return this.items[i];
    }

    public void setItems(int i, com.google.api.ads.adwords.axis.v201409.rm.RuleItem _value) {
        this.items[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201409", "RuleItemGroup"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("items");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201409", "items"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201409", "RuleItem"));
