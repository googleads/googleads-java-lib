 ...
 */
public class BudgetPage  extends com.google.api.ads.adwords.axis.v201605.cm.Page  implements java.io.Serializable {
    private com.google.api.ads.adwords.axis.v201605.cm.Budget[] entries;
    ...
    public BudgetPage(
           ...
           com.google.api.ads.adwords.axis.v201605.cm.Budget[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     * @return entries
     */
    public com.google.api.ads.adwords.axis.v201605.cm.Budget[] getEntries() {
        return entries;
    }
     ...
     * @param entries
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201605.cm.Budget[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201605.cm.Budget getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201605.cm.Budget _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201605", "BudgetPage"));
