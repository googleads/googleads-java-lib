...
public class FeedAttribute  implements java.io.Serializable {
     ...
     * and should not be {@code null} when it is contained within {@link
     * Operator}s : ADD, SET.</span> */
    private com.google.api.ads.adwords.axis.v201607.cm.FeedAttributeType type;
    ...
    public FeedAttribute(
           ...
           com.google.api.ads.adwords.axis.v201607.cm.FeedAttributeType type,
     ...
     * Operator}s : ADD, SET.</span>
     */
    public com.google.api.ads.adwords.axis.v201607.cm.FeedAttributeType getType() {
        return type;
    }
     ...
     * Operator}s : ADD, SET.</span>
     */
    public void setType(com.google.api.ads.adwords.axis.v201607.cm.FeedAttributeType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201607", "FeedAttribute"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201607", "FeedAttribute.Type"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("isPartOfKey");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201607", "isPartOfKey"));
