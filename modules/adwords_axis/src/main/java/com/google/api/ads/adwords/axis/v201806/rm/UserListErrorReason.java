...
public class UserListErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _USERLIST_NAME_IS_RESERVED_FOR_SYSTEM_LIST = "USERLIST_NAME_IS_RESERVED_FOR_SYSTEM_LIST";
    ...
    public static final UserListErrorReason USERLIST_NAME_IS_RESERVED_FOR_SYSTEM_LIST = new UserListErrorReason(_USERLIST_NAME_IS_RESERVED_FOR_SYSTEM_LIST);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201806", "UserListError.Reason"));
    }
    /**
