 ...
 * AdX.</span>
 */
public class ExpandedTextAd  extends com.google.api.ads.adwords.axis.v201809.cm.Ad  implements java.io.Serializable {
    /* First part of the headline.
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "HeadlinePart1".</span><span class="constraint
     ...
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "HeadlinePart2".</span><span class="constraint
     * Filterable">This field can be filtered on.</span>
     *                     <span class="constraint Required">This field is
     * required and should not be {@code null} when it is contained within
     * {@link Operator}s : ADD.</span> */
     ...
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "ExpandedTextAdHeadlinePart3".</span><span
     ...
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "ExpandedTextAdDescription2".</span><span
     * class="constraint Filterable">This field can be filtered on.</span> */
    private java.lang.String description2;

    /* Text that appears in the ad with the displayed URL.
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "Path1".</span><span class="constraint
     * Filterable">This field can be filtered on.</span> */
     ...
     * the displayed URL.
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "Path2".</span><span class="constraint
     * Filterable">This field can be filtered on.</span> */
    ...
    public ExpandedTextAd(
           ...
           java.lang.String headlinePart3,
    ...
    public String toString() {
        return com.google.common.base.MoreObjects.toStringHelper(this.getClass())
            ...
            .add("headlinePart3", getHeadlinePart3())
            .add("id", getId())
            .add("path1", getPath1())
            .add("path2", getPath2())
    ...
    /**
     * Gets the headlinePart3 value for this ExpandedTextAd.
     * 
     * @return headlinePart3   * Third part of the headline.
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "ExpandedTextAdHeadlinePart3".</span><span
     * class="constraint Filterable">This field can be filtered on.</span>
     */
    ...
    /**
     * Sets the headlinePart3 value for this ExpandedTextAd.
     * 
     * @param headlinePart3   * Third part of the headline.
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "ExpandedTextAdHeadlinePart3".</span><span
     * class="constraint Filterable">This field can be filtered on.</span>
     */
    public void setHeadlinePart3(java.lang.String headlinePart3) {
        this.headlinePart3 = headlinePart3;
    }
    ...
    /**
     * Gets the description2 value for this ExpandedTextAd.
     * 
     * @return description2   * The second description line of the ad.
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "ExpandedTextAdDescription2".</span><span
     * class="constraint Filterable">This field can be filtered on.</span>
     */
    ...
    /**
     * Sets the description2 value for this ExpandedTextAd.
     * 
     * @param description2   * The second description line of the ad.
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "ExpandedTextAdDescription2".</span><span
     * class="constraint Filterable">This field can be filtered on.</span>
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.headlinePart3==null && other.getHeadlinePart3()==null) || 
             (this.headlinePart3!=null &&
              this.headlinePart3.equals(other.getHeadlinePart3()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getHeadlinePart3() != null) {
            _hashCode += getHeadlinePart3().hashCode();
        }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "ExpandedTextAd"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("headlinePart1");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "headlinePart1"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "headlinePart2"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("headlinePart3");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "headlinePart3"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
