...
public class ServingStatus implements java.io.Serializable {
    ...
    public static final java.lang.String _CAMPAIGN_DELETED = "CAMPAIGN_DELETED";
    ...
    public static final ServingStatus DELETED = new ServingStatus(_DELETED);
    public static final ServingStatus CAMPAIGN_DELETED = new ServingStatus(_CAMPAIGN_DELETED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/video/v201402", "ServingStatus"));
    }
    /**
