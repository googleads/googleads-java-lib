 ...
 */
public class AdGroupAdReturnValue  extends com.google.api.ads.adwords.axis.v201605.cm.ListReturnValue  implements java.io.Serializable {
    /* List of ads in an ad group. */
    private com.google.api.ads.adwords.axis.v201605.cm.AdGroupAd[] value;
    ...
    public AdGroupAdReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201605.cm.AdGroupAd[] value,
     ...
     */
    public com.google.api.ads.adwords.axis.v201605.cm.AdGroupAd[] getValue() {
        return value;
    }
     ...
     */
    public void setValue(com.google.api.ads.adwords.axis.v201605.cm.AdGroupAd[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201605.cm.AdGroupAd getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201605.cm.AdGroupAd _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201605", "AdGroupAdReturnValue"));
