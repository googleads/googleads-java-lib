...
public class MediaMimeType implements java.io.Serializable {
    ...
    public static final MediaMimeType UNKNOWN = new MediaMimeType(_UNKNOWN);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "MediaMimeType"));
    }
    /**
