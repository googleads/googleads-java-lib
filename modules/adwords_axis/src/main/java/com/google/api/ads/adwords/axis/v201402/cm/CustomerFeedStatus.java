...
public class CustomerFeedStatus implements java.io.Serializable {
    ...
    public static final CustomerFeedStatus ACTIVE = new CustomerFeedStatus(_ACTIVE);
    public static final CustomerFeedStatus DELETED = new CustomerFeedStatus(_DELETED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "CustomerFeed.Status"));
    }
    /**
