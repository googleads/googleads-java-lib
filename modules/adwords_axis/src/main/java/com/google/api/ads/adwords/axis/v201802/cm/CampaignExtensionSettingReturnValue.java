 ...
 * call.
 */
public class CampaignExtensionSettingReturnValue  extends com.google.api.ads.adwords.axis.v201802.cm.ListReturnValue  implements java.io.Serializable {
    /* The resulting CampaignExtensionSettings. */
    private com.google.api.ads.adwords.axis.v201802.cm.CampaignExtensionSetting[] value;
    ...
    public CampaignExtensionSettingReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201802.cm.CampaignExtensionSetting[] value,
     ...
     */
    public com.google.api.ads.adwords.axis.v201802.cm.CampaignExtensionSetting[] getValue() {
        return value;
    }
     ...
     */
    public void setValue(com.google.api.ads.adwords.axis.v201802.cm.CampaignExtensionSetting[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201802.cm.CampaignExtensionSetting getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201802.cm.CampaignExtensionSetting _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "CampaignExtensionSettingReturnValue"));
