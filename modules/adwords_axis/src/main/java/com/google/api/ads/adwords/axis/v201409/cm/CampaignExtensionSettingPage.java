 ...
 */
public class CampaignExtensionSettingPage  extends com.google.api.ads.adwords.axis.v201409.cm.Page  implements java.io.Serializable {
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201409.cm.CampaignExtensionSetting[] entries;
    ...
    public CampaignExtensionSettingPage(
           ...
           com.google.api.ads.adwords.axis.v201409.cm.CampaignExtensionSetting[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201409.cm.CampaignExtensionSetting[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201409.cm.CampaignExtensionSetting[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201409.cm.CampaignExtensionSetting getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201409.cm.CampaignExtensionSetting _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201409", "CampaignExtensionSettingPage"));
