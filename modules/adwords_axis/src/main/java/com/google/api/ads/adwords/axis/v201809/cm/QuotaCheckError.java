 ...
 */
public class QuotaCheckError  extends com.google.api.ads.adwords.axis.v201809.cm.ApiError  implements java.io.Serializable {
    private com.google.api.ads.adwords.axis.v201809.cm.QuotaCheckErrorReason reason;
    ...
    public QuotaCheckError(
           ...
           com.google.api.ads.adwords.axis.v201809.cm.QuotaCheckErrorReason reason) {
        super(
            fieldPath,
            fieldPathElements,
            trigger,
     ...
     * @return reason
     */
    public com.google.api.ads.adwords.axis.v201809.cm.QuotaCheckErrorReason getReason() {
        return reason;
    }
     ...
     * @param reason
     */
    public void setReason(com.google.api.ads.adwords.axis.v201809.cm.QuotaCheckErrorReason reason) {
        this.reason = reason;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "QuotaCheckError"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "QuotaCheckError.Reason"));
