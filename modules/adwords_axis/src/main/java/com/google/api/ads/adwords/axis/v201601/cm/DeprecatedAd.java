 ...
 */
public class DeprecatedAd  extends com.google.api.ads.adwords.axis.v201601.cm.Ad  implements java.io.Serializable {
    /* Name of the ad.
     ...
     *                     <span class="constraint ReadOnly">This field is
     * read only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201601.cm.DeprecatedAdType deprecatedAdType;
    ...
    public DeprecatedAd(
           ...
           com.google.api.ads.adwords.axis.v201601.cm.DeprecatedAdType deprecatedAdType) {
        super(
            id,
            url,
            displayUrl,
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201601.cm.DeprecatedAdType getDeprecatedAdType() {
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public void setDeprecatedAdType(com.google.api.ads.adwords.axis.v201601.cm.DeprecatedAdType deprecatedAdType) {
        this.deprecatedAdType = deprecatedAdType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201601", "DeprecatedAd"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201601", "deprecatedAdType"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201601", "DeprecatedAd.Type"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
