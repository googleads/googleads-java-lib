 ...
 */
public class LabelPage  extends com.google.api.ads.adwords.axis.v201809.cm.NoStatsPage  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201809.cm.Label>{
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201809.cm.Label[] entries;
    ...
    public LabelPage(
           ...
           com.google.api.ads.adwords.axis.v201809.cm.Label[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201809.cm.Label[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201809.cm.Label[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201809.cm.Label getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201809.cm.Label _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201809.cm.Label> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201809.cm.Label>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201809.cm.Label>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "LabelPage"));
