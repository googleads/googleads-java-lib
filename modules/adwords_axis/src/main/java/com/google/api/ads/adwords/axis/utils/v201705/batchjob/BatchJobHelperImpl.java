...
import com.google.api.ads.adwords.axis.v201705.cm.BatchJobOpsServiceSoapBindingStub;
import com.google.api.ads.adwords.axis.v201705.cm.Operand;
...
class BatchJobHelperImpl
  ...
  BatchJobHelperImpl(BatchJobUploader uploader, BatchJobLogger batchJobLogger) {
    ...
    resultQName = new QName("https://adwords.google.com/api/adwords/cm/v201705", "MutateResult");
  }
  ...
  public BatchJobMutateResponse downloadBatchJobMutateResponse(String downloadUrl)
     ...
     */
    List<com.google.api.ads.adwords.axis.v201705.cm.MutateResult> cmMutateResults;
    try {
      cmMutateResults =
    ...
    for (com.google.api.ads.adwords.axis.v201705.cm.MutateResult cmMutateResult : cmMutateResults) {
