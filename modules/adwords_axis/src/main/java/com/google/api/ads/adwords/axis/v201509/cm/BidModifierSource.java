...
public class BidModifierSource implements java.io.Serializable {
    ...
    public static final BidModifierSource NONE = new BidModifierSource(_NONE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201509", "BidModifierSource"));
    }
    /**
