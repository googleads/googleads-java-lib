...
public class Criterion  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201809.cm.CriterionType type;
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201809.cm.CriterionType getType() {
        return type;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setType(com.google.api.ads.adwords.axis.v201809.cm.CriterionType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "Criterion"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "Criterion.Type"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("criterionType");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "Criterion.Type"));
