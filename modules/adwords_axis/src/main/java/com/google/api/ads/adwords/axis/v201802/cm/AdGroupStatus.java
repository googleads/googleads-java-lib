...
public class AdGroupStatus implements java.io.Serializable {
    ...
    public static final AdGroupStatus UNKNOWN = new AdGroupStatus(_UNKNOWN);
    public static final AdGroupStatus ENABLED = new AdGroupStatus(_ENABLED);
    public static final AdGroupStatus PAUSED = new AdGroupStatus(_PAUSED);
    public static final AdGroupStatus REMOVED = new AdGroupStatus(_REMOVED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "AdGroup.Status"));
    }
    /**
