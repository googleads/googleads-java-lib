 ...
 */
public class AdWordsConversionTracker  extends com.google.api.ads.adwords.axis.v201502.cm.ConversionTracker  implements java.io.Serializable {
     ...
     * can be selected using the value "MarkupLanguage".</span><span class="constraint
     * Filterable">This field can be filtered on.</span> */
    private com.google.api.ads.adwords.axis.v201502.cm.AdWordsConversionTrackerMarkupLanguage markupLanguage;

    /* Text format for the site stats logo.
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "TextFormat".</span><span class="constraint
     * Filterable">This field can be filtered on.</span> */
    private com.google.api.ads.adwords.axis.v201502.cm.AdWordsConversionTrackerTextFormat textFormat;
     ...
     * Filterable">This field can be filtered on.</span> */
    private com.google.api.ads.adwords.axis.v201502.cm.AdWordsConversionTrackerTrackingCodeType trackingCodeType;
    ...
    public AdWordsConversionTracker(
           ...
           com.google.api.ads.adwords.axis.v201502.cm.AdWordsConversionTrackerMarkupLanguage markupLanguage,
           com.google.api.ads.adwords.axis.v201502.cm.AdWordsConversionTrackerTextFormat textFormat,
           java.lang.String conversionPageLanguage,
           java.lang.String backgroundColor,
           com.google.api.ads.adwords.axis.v201502.cm.AdWordsConversionTrackerTrackingCodeType trackingCodeType) {
        super(
            id,
     ...
     * 
     * @return markupLanguage   * Markup language for the snippet.
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "MarkupLanguage".</span><span class="constraint
     * Filterable">This field can be filtered on.</span>
     */
    public com.google.api.ads.adwords.axis.v201502.cm.AdWordsConversionTrackerMarkupLanguage getMarkupLanguage() {
     ...
     * 
     * @param markupLanguage   * Markup language for the snippet.
     *                     <span class="constraint Selectable">This field
     * can be selected using the value "MarkupLanguage".</span><span class="constraint
     * Filterable">This field can be filtered on.</span>
     */
    public void setMarkupLanguage(com.google.api.ads.adwords.axis.v201502.cm.AdWordsConversionTrackerMarkupLanguage markupLanguage) {
        this.markupLanguage = markupLanguage;
    }
     ...
     * Filterable">This field can be filtered on.</span>
     */
    public com.google.api.ads.adwords.axis.v201502.cm.AdWordsConversionTrackerTextFormat getTextFormat() {
        return textFormat;
    }
     ...
     * Filterable">This field can be filtered on.</span>
     */
    public void setTextFormat(com.google.api.ads.adwords.axis.v201502.cm.AdWordsConversionTrackerTextFormat textFormat) {
        this.textFormat = textFormat;
    }
     ...
     * Filterable">This field can be filtered on.</span>
     */
    public com.google.api.ads.adwords.axis.v201502.cm.AdWordsConversionTrackerTrackingCodeType getTrackingCodeType() {
     ...
     * Filterable">This field can be filtered on.</span>
     */
    public void setTrackingCodeType(com.google.api.ads.adwords.axis.v201502.cm.AdWordsConversionTrackerTrackingCodeType trackingCodeType) {
        this.trackingCodeType = trackingCodeType;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.markupLanguage==null && other.getMarkupLanguage()==null) || 
             (this.markupLanguage!=null &&
              this.markupLanguage.equals(other.getMarkupLanguage()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getMarkupLanguage() != null) {
            _hashCode += getMarkupLanguage().hashCode();
        }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "AdWordsConversionTracker"));
        ...
        elemField.setFieldName("markupLanguage");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "markupLanguage"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "AdWordsConversionTracker.MarkupLanguage"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("textFormat");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "textFormat"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "AdWordsConversionTracker.TextFormat"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("conversionPageLanguage");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "conversionPageLanguage"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "backgroundColor"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "trackingCodeType"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "AdWordsConversionTracker.TrackingCodeType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
