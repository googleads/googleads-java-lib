 ...
 * calls.
 */
public class CampaignGroupReturnValue  extends com.google.api.ads.adwords.axis.v201802.cm.ListReturnValue  implements java.io.Serializable {
    /* List of returned {@link CampaignGroup} values */
    private com.google.api.ads.adwords.axis.v201802.cm.CampaignGroup[] value;
    ...
    public CampaignGroupReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201802.cm.CampaignGroup[] value,
     ...
     */
    public com.google.api.ads.adwords.axis.v201802.cm.CampaignGroup[] getValue() {
        return value;
    }
     ...
     */
    public void setValue(com.google.api.ads.adwords.axis.v201802.cm.CampaignGroup[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201802.cm.CampaignGroup getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201802.cm.CampaignGroup _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "CampaignGroupReturnValue"));
