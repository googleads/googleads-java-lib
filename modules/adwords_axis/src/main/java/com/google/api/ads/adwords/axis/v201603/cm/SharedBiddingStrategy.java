...
public class SharedBiddingStrategy  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201603.cm.SharedBiddingStrategyBiddingStrategyStatus status;

    /* <span class="constraint Selectable">This field can be selected
     * using the value "Type".</span><span class="constraint Filterable">This
     * field can be filtered on.</span> */
    private com.google.api.ads.adwords.axis.v201603.cm.BiddingStrategyType type;
    ...
    public SharedBiddingStrategy(
           ...
           com.google.api.ads.adwords.axis.v201603.cm.SharedBiddingStrategyBiddingStrategyStatus status,
           com.google.api.ads.adwords.axis.v201603.cm.BiddingStrategyType type) {
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201603.cm.SharedBiddingStrategyBiddingStrategyStatus getStatus() {
        return status;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201603.cm.SharedBiddingStrategyBiddingStrategyStatus status) {
        this.status = status;
    }
     ...
     * field can be filtered on.</span>
     */
    public com.google.api.ads.adwords.axis.v201603.cm.BiddingStrategyType getType() {
        return type;
    }
     ...
     * field can be filtered on.</span>
     */
    public void setType(com.google.api.ads.adwords.axis.v201603.cm.BiddingStrategyType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201603", "SharedBiddingStrategy"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201603", "SharedBiddingStrategy.BiddingStrategyStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
