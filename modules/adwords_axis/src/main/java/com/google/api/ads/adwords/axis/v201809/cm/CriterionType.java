...
public class CriterionType implements java.io.Serializable {
    ...
    public static final CriterionType CUSTOM_AFFINITY = new CriterionType(_CUSTOM_AFFINITY);
    public static final CriterionType CUSTOM_INTENT = new CriterionType(_CUSTOM_INTENT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "Criterion.Type"));
    }
    /**
