 ...
 */
public class CampaignFeedReturnValue  extends com.google.api.ads.adwords.axis.v201806.cm.ListReturnValue  implements java.io.Serializable {
    /* The resulting CampaignFeeds. */
    private com.google.api.ads.adwords.axis.v201806.cm.CampaignFeed[] value;
    ...
    public CampaignFeedReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201806.cm.CampaignFeed[] value,
     ...
     */
    public com.google.api.ads.adwords.axis.v201806.cm.CampaignFeed[] getValue() {
        return value;
    }
     ...
     */
    public void setValue(com.google.api.ads.adwords.axis.v201806.cm.CampaignFeed[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201806.cm.CampaignFeed getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201806.cm.CampaignFeed _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "CampaignFeedReturnValue"));
