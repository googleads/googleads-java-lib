 ...
 */
public class CampaignSharedSetPage  extends com.google.api.ads.adwords.axis.v201607.cm.NullStatsPage  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201607.cm.CampaignSharedSet>{
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201607.cm.CampaignSharedSet> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201607.cm.CampaignSharedSet>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201607.cm.CampaignSharedSet>asList(entries).iterator();
    }
