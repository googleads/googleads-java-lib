...
public class PolicyFindingError  extends com.google.api.ads.adwords.axis.v201806.cm.ApiError  implements java.io.Serializable {
    /* Error reason enum. */
    private com.google.api.ads.adwords.axis.v201806.cm.PolicyFindingErrorReason reason;

    /* Policy summary containing the policy topic that caused the
     * error. */
    private com.google.api.ads.adwords.axis.v201806.cm.PolicySummary policySummary;
    ...
    public PolicyFindingError(
           ...
           com.google.api.ads.adwords.axis.v201806.cm.PolicyFindingErrorReason reason,
           com.google.api.ads.adwords.axis.v201806.cm.PolicySummary policySummary) {
        super(
            fieldPath,
            fieldPathElements,
            trigger,
     ...
     */
    public com.google.api.ads.adwords.axis.v201806.cm.PolicyFindingErrorReason getReason() {
        return reason;
    }
     ...
     */
    public void setReason(com.google.api.ads.adwords.axis.v201806.cm.PolicyFindingErrorReason reason) {
        this.reason = reason;
    }
     ...
     * error.
     */
    public com.google.api.ads.adwords.axis.v201806.cm.PolicySummary getPolicySummary() {
     ...
     * error.
     */
    public void setPolicySummary(com.google.api.ads.adwords.axis.v201806.cm.PolicySummary policySummary) {
        this.policySummary = policySummary;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "PolicyFindingError"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "PolicyFindingError.Reason"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "PolicySummary"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
