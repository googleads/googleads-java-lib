...
public class BatchJobOpsServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.adwords.axis.v201702.cm.BatchJobOpsService {
    ...
    public com.google.api.ads.adwords.axis.v201702.cm.BatchJobOpsServiceInterface getBatchJobOpsServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.adwords.axis.v201702.cm.BatchJobOpsServiceInterface getBatchJobOpsServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.adwords.axis.v201702.cm.BatchJobOpsServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201702.cm.BatchJobOpsServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.adwords.axis.v201702.cm.BatchJobOpsServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.adwords.axis.v201702.cm.BatchJobOpsServiceSoapBindingStub _stub = new com.google.api.ads.adwords.axis.v201702.cm.BatchJobOpsServiceSoapBindingStub(new java.net.URL(BatchJobOpsServiceInterfacePort_address), this);
                _stub.setPortName(getBatchJobOpsServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "BatchJobOpsService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "BatchJobOpsServiceInterfacePort"));
        }
