...
public class FeedItemValidationDetail  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201406.cm.FeedItemValidationDetailValidationStatus validationStatus;

    /* List of error codes specifying what errors were found during
     * validation. */
    private com.google.api.ads.adwords.axis.v201406.cm.FeedItemAttributeError[] validationErrors;

    /* Approval status of feed item for a particular feed mapping. */
    private com.google.api.ads.adwords.axis.v201406.cm.FeedItemValidationDetailApprovalStatus approvalStatus;
    ...
    public FeedItemValidationDetail(
           ...
           com.google.api.ads.adwords.axis.v201406.cm.FeedItemValidationDetailValidationStatus validationStatus,
           com.google.api.ads.adwords.axis.v201406.cm.FeedItemAttributeError[] validationErrors,
           com.google.api.ads.adwords.axis.v201406.cm.FeedItemValidationDetailApprovalStatus approvalStatus) {
     ...
     */
    public com.google.api.ads.adwords.axis.v201406.cm.FeedItemValidationDetailValidationStatus getValidationStatus() {
     ...
     */
    public void setValidationStatus(com.google.api.ads.adwords.axis.v201406.cm.FeedItemValidationDetailValidationStatus validationStatus) {
        this.validationStatus = validationStatus;
    }
     ...
     * validation.
     */
    public com.google.api.ads.adwords.axis.v201406.cm.FeedItemAttributeError[] getValidationErrors() {
     ...
     * validation.
     */
    public void setValidationErrors(com.google.api.ads.adwords.axis.v201406.cm.FeedItemAttributeError[] validationErrors) {
        this.validationErrors = validationErrors;
    }

    public com.google.api.ads.adwords.axis.v201406.cm.FeedItemAttributeError getValidationErrors(int i) {
        return this.validationErrors[i];
    }

    public void setValidationErrors(int i, com.google.api.ads.adwords.axis.v201406.cm.FeedItemAttributeError _value) {
     ...
     */
    public com.google.api.ads.adwords.axis.v201406.cm.FeedItemValidationDetailApprovalStatus getApprovalStatus() {
     ...
     */
    public void setApprovalStatus(com.google.api.ads.adwords.axis.v201406.cm.FeedItemValidationDetailApprovalStatus approvalStatus) {
        this.approvalStatus = approvalStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "FeedItemValidationDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("feedMappingId");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "feedMappingId"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "validationStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "FeedItemValidationDetail.ValidationStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("validationErrors");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "validationErrors"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "FeedItemAttributeError"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "FeedItemValidationDetail.ApprovalStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
