 ...
 */
public class CpcBid  extends com.google.api.ads.adwords.axis.v201406.cm.Bids  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201406.cm.BidSource cpcBidSource;
    ...
    public CpcBid(
           ...
           com.google.api.ads.adwords.axis.v201406.cm.BidSource cpcBidSource) {
        super(
            bidsType);
        this.bid = bid;
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201406.cm.BidSource getCpcBidSource() {
        return cpcBidSource;
    }
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public void setCpcBidSource(com.google.api.ads.adwords.axis.v201406.cm.BidSource cpcBidSource) {
        this.cpcBidSource = cpcBidSource;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "CpcBid"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "cpcBidSource"));
