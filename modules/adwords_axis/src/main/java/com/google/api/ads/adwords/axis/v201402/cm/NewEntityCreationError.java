...
public class NewEntityCreationError  extends com.google.api.ads.adwords.axis.v201402.cm.ApiError  implements java.io.Serializable {
    ...
    public NewEntityCreationError(
           ...
           com.google.api.ads.adwords.axis.v201402.cm.NewEntityCreationErrorReason reason) {
        super(
            fieldPath,
            trigger,
            errorString,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "NewEntityCreationError"));
