...
public class FeedMapping  implements java.io.Serializable {
    ...
    public FeedMapping(
           ...
           com.google.api.ads.adwords.axis.v201502.cm.FeedMappingStatus status,
           com.google.api.ads.adwords.axis.v201502.cm.AttributeFieldMapping[] attributeFieldMappings,
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201502.cm.FeedMappingStatus getStatus() {
        return status;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201502.cm.FeedMappingStatus status) {
        this.status = status;
    }
     ...
     * be selected using the value "AttributeFieldMappings".</span>
     */
    public com.google.api.ads.adwords.axis.v201502.cm.AttributeFieldMapping[] getAttributeFieldMappings() {
     ...
     * be selected using the value "AttributeFieldMappings".</span>
     */
    public void setAttributeFieldMappings(com.google.api.ads.adwords.axis.v201502.cm.AttributeFieldMapping[] attributeFieldMappings) {
        this.attributeFieldMappings = attributeFieldMappings;
    }

    public com.google.api.ads.adwords.axis.v201502.cm.AttributeFieldMapping getAttributeFieldMappings(int i) {
        return this.attributeFieldMappings[i];
    }

    public void setAttributeFieldMappings(int i, com.google.api.ads.adwords.axis.v201502.cm.AttributeFieldMapping _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "FeedMapping"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "FeedMapping.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("attributeFieldMappings");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "attributeFieldMappings"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "AttributeFieldMapping"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201502", "criterionType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
