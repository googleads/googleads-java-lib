 ...
 * type. All cases of the the same
 *             subdivision must have the same dimension type (product
 * type level).
 */
public class ProductType  extends com.google.api.ads.adwords.axis.v201406.cm.ProductDimension  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201406.cm.ProductDimensionType type;
    ...
    public ProductType(
           ...
           com.google.api.ads.adwords.axis.v201406.cm.ProductDimensionType type,
     ...
     * {@link Operator}s : ADD.</span>
     */
    public com.google.api.ads.adwords.axis.v201406.cm.ProductDimensionType getType() {
        return type;
    }
     ...
     * {@link Operator}s : ADD.</span>
     */
    public void setType(com.google.api.ads.adwords.axis.v201406.cm.ProductDimensionType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "ProductType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201406", "ProductDimensionType"));
