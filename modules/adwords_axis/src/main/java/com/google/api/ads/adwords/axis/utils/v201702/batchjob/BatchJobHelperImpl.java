...
package com.google.api.ads.adwords.axis.utils.v201702.batchjob;

import com.google.api.ads.adwords.axis.utils.AxisDeserializer;
import com.google.api.ads.adwords.axis.v201702.cm.ApiError;
import com.google.api.ads.adwords.axis.v201702.cm.BatchJob;
import com.google.api.ads.adwords.axis.v201702.cm.BatchJobOpsServiceSoapBindingStub;
import com.google.api.ads.adwords.axis.v201702.cm.Operand;
...
class BatchJobHelperImpl
  ...
  BatchJobHelperImpl(BatchJobUploader uploader, BatchJobLogger batchJobLogger) {
    ...
    resultQName = new QName("https://adwords.google.com/api/adwords/cm/v201702", "MutateResult");
  }
  ...
  public BatchJobMutateResponse downloadBatchJobMutateResponse(String downloadUrl)
     ...
     */
    List<com.google.api.ads.adwords.axis.v201702.cm.MutateResult> cmMutateResults;
    try {
      cmMutateResults =
          deserializer.deserializeBatchJobMutateResults(
              new URL(downloadUrl),
              getServiceTypeMappings(),
              com.google.api.ads.adwords.axis.v201702.cm.MutateResult.class,
              resultQName);
    } catch (Exception e) {
    ...
    for (com.google.api.ads.adwords.axis.v201702.cm.MutateResult cmMutateResult : cmMutateResults) {
