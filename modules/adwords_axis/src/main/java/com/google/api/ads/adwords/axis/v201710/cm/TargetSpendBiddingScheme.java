 ...
 * AdX.</span>
 */
public class TargetSpendBiddingScheme  extends com.google.api.ads.adwords.axis.v201710.cm.BiddingScheme  implements java.io.Serializable {
     ...
     *                     <span class="constraint InRange">This field must
     * be greater than or equal to 0.</span> */
    private com.google.api.ads.adwords.axis.v201710.cm.Money spendTarget;

    /* The enhanced CPC bidding option for the campaign, which enables
     * CPC bids to be enhanced based
     *                     on conversion optimizer data. For more information
     * about enhanced CPC, see the
     *                     <a href="//support.google.com/adwords/answer/2464964">AdWords
     * Help Center</a>.
     *                     
     *                     <p class="special">This attribute can only be
     * set on a <em>standard</em> bidding strategy.
     *                     Attempting to set this attribute on a portfolio
     * bidding strategy will result in an error. */
    ...
    public TargetSpendBiddingScheme(
           ...
           com.google.api.ads.adwords.axis.v201710.cm.Money spendTarget,
     ...
     * be greater than or equal to 0.</span>
     */
    public com.google.api.ads.adwords.axis.v201710.cm.Money getSpendTarget() {
        return spendTarget;
    }
     ...
     * be greater than or equal to 0.</span>
     */
    public void setSpendTarget(com.google.api.ads.adwords.axis.v201710.cm.Money spendTarget) {
        this.spendTarget = spendTarget;
    }


    /**
     * Gets the enhancedCpcEnabled value for this TargetSpendBiddingScheme.
     * 
    ...
    /**
     * Sets the enhancedCpcEnabled value for this TargetSpendBiddingScheme.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "TargetSpendBiddingScheme"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "spendTarget"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "Money"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "enhancedCpcEnabled"));
