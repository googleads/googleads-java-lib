...
public class CustomerFeed  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201603.cm.CustomerFeedStatus status;
    ...
    public CustomerFeed(
           ...
           com.google.api.ads.adwords.axis.v201603.cm.CustomerFeedStatus status) {
           this.feedId = feedId;
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201603.cm.CustomerFeedStatus getStatus() {
        return status;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201603.cm.CustomerFeedStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201603", "CustomerFeed"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201603", "CustomerFeed.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
