...
public class AppUrl  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201506.cm.AppUrlOsType osType;
    ...
    public AppUrl(
           ...
           com.google.api.ads.adwords.axis.v201506.cm.AppUrlOsType osType) {
           this.url = url;
           this.osType = osType;
    }
     ...
     * and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201506.cm.AppUrlOsType getOsType() {
        return osType;
    }
     ...
     * and should not be {@code null}.</span>
     */
    public void setOsType(com.google.api.ads.adwords.axis.v201506.cm.AppUrlOsType osType) {
        this.osType = osType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "AppUrl"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "osType"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201506", "AppUrl.OsType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
