...
public class AdCustomizerFeed  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201809.cm.FeedStatus feedStatus;
    ...
    private com.google.api.ads.adwords.axis.v201809.cm.AdCustomizerFeedAttribute[] feedAttributes;
    ...
    public AdCustomizerFeed(
           ...
           com.google.api.ads.adwords.axis.v201809.cm.FeedStatus feedStatus,
           com.google.api.ads.adwords.axis.v201809.cm.AdCustomizerFeedAttribute[] feedAttributes) {
           this.feedId = feedId;
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setFeedStatus(com.google.api.ads.adwords.axis.v201809.cm.FeedStatus feedStatus) {
        this.feedStatus = feedStatus;
    }
     ...
     * Operator}s : ADD, SET.</span>
     */
    public void setFeedAttributes(com.google.api.ads.adwords.axis.v201809.cm.AdCustomizerFeedAttribute[] feedAttributes) {
        this.feedAttributes = feedAttributes;
    }

    public com.google.api.ads.adwords.axis.v201809.cm.AdCustomizerFeedAttribute getFeedAttributes(int i) {
        return this.feedAttributes[i];
    }

    public void setFeedAttributes(int i, com.google.api.ads.adwords.axis.v201809.cm.AdCustomizerFeedAttribute _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "AdCustomizerFeed"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "feedName"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "feedStatus"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "feedAttributes"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "AdCustomizerFeedAttribute"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
