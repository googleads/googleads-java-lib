...
public class FeedMappingPage  extends com.google.api.ads.adwords.axis.v201609.cm.NullStatsPage  implements java.io.Serializable {
    ...
    public FeedMappingPage(
           ...
           com.google.api.ads.adwords.axis.v201609.cm.FeedMapping[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201609.cm.FeedMapping[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201609.cm.FeedMapping[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201609.cm.FeedMapping getEntries(int i) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "FeedMappingPage"));
