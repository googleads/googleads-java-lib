 ...
 */
public class FeedPage  extends com.google.api.ads.adwords.axis.v201409.cm.NullStatsPage  implements java.io.Serializable {
    /* The resulting Feeds. */
    private com.google.api.ads.adwords.axis.v201409.cm.Feed[] entries;
    ...
    public FeedPage(
           ...
           com.google.api.ads.adwords.axis.v201409.cm.Feed[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201409.cm.Feed[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201409.cm.Feed[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201409.cm.Feed getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201409.cm.Feed _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201409", "FeedPage"));
