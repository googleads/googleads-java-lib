...
public class StringRuleItem  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201603.rm.StringKey key;

    /* <span class="constraint Required">This field is required and
     * should not be {@code null}.</span> */
    private com.google.api.ads.adwords.axis.v201603.rm.StringRuleItemStringOperator op;
    ...
    public StringRuleItem(
           com.google.api.ads.adwords.axis.v201603.rm.StringKey key,
           com.google.api.ads.adwords.axis.v201603.rm.StringRuleItemStringOperator op,
     ...
     * should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201603.rm.StringKey getKey() {
        return key;
    }
     ...
     * should not be {@code null}.</span>
     */
    public void setKey(com.google.api.ads.adwords.axis.v201603.rm.StringKey key) {
        this.key = key;
    }
     ...
     * should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201603.rm.StringRuleItemStringOperator getOp() {
        return op;
    }
     ...
     * should not be {@code null}.</span>
     */
    public void setOp(com.google.api.ads.adwords.axis.v201603.rm.StringRuleItemStringOperator op) {
        this.op = op;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201603", "StringRuleItem"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201603", "StringKey"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201603", "StringRuleItem.StringOperator"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
