...
public class BudgetErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _BUDGET_CANNOT_BE_EXPLICITLY_SHARED = "BUDGET_CANNOT_BE_EXPLICITLY_SHARED";
    ...
    public static final BudgetErrorReason BUDGET_CANNOT_BE_EXPLICITLY_SHARED = new BudgetErrorReason(_BUDGET_CANNOT_BE_EXPLICITLY_SHARED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201809", "BudgetError.Reason"));
    }
    /**
