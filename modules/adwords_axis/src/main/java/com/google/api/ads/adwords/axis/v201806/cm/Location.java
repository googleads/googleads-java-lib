 ...
 * AdX.</span>
 */
public class Location  extends com.google.api.ads.adwords.axis.v201806.cm.Criterion  implements java.io.Serializable {
     ...
     *                     <span class="constraint ReadOnly">This field is
     * read only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201806.cm.LocationTargetingStatus targetingStatus;

    /* Ordered list of parents of the location criterion.
     *                     <span class="constraint ReadOnly">This field is
     * read only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.adwords.axis.v201806.cm.Location[] parentLocations;
    ...
    public Location(
           ...
           com.google.api.ads.adwords.axis.v201806.cm.LocationTargetingStatus targetingStatus,
           com.google.api.ads.adwords.axis.v201806.cm.Location[] parentLocations) {
        super(
            id,
            type,
            criterionType);
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201806.cm.LocationTargetingStatus getTargetingStatus() {
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public void setTargetingStatus(com.google.api.ads.adwords.axis.v201806.cm.LocationTargetingStatus targetingStatus) {
        this.targetingStatus = targetingStatus;
    }
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201806.cm.Location[] getParentLocations() {
     ...
     * read only and will be ignored when sent to the API.</span>
     */
    public void setParentLocations(com.google.api.ads.adwords.axis.v201806.cm.Location[] parentLocations) {
        this.parentLocations = parentLocations;
    }

    public com.google.api.ads.adwords.axis.v201806.cm.Location getParentLocations(int i) {
        return this.parentLocations[i];
    }

    public void setParentLocations(int i, com.google.api.ads.adwords.axis.v201806.cm.Location _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "Location"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("locationName");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "locationName"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "displayType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "targetingStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "LocationTargetingStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("parentLocations");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "parentLocations"));
