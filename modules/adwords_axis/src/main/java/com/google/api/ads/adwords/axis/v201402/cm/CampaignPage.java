 ...
 * call.
 */
public class CampaignPage  extends com.google.api.ads.adwords.axis.v201402.cm.Page  implements java.io.Serializable {
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201402.cm.Campaign[] entries;
    ...
    public CampaignPage(
           ...
           com.google.api.ads.adwords.axis.v201402.cm.Campaign[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201402.cm.Campaign[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201402.cm.Campaign[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201402.cm.Campaign getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201402.cm.Campaign _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "CampaignPage"));
