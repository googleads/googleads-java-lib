 ...
 * call.
 */
public class CustomerExtensionSettingReturnValue  extends com.google.api.ads.adwords.axis.v201802.cm.ListReturnValue  implements java.io.Serializable {
    /* The resulting CustomerExtensionSettings. */
    private com.google.api.ads.adwords.axis.v201802.cm.CustomerExtensionSetting[] value;
    ...
    public CustomerExtensionSettingReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201802.cm.CustomerExtensionSetting[] value,
     ...
     */
    public com.google.api.ads.adwords.axis.v201802.cm.CustomerExtensionSetting[] getValue() {
        return value;
    }
     ...
     */
    public void setValue(com.google.api.ads.adwords.axis.v201802.cm.CustomerExtensionSetting[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201802.cm.CustomerExtensionSetting getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201802.cm.CustomerExtensionSetting _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "CustomerExtensionSettingReturnValue"));
