 ...
 */
public class CustomerFeedPage  extends com.google.api.ads.adwords.axis.v201609.cm.NullStatsPage  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201609.cm.CustomerFeed>{
    /* The resulting CustomerFeeds. */
    private com.google.api.ads.adwords.axis.v201609.cm.CustomerFeed[] entries;
    ...
    public CustomerFeedPage(
           ...
           com.google.api.ads.adwords.axis.v201609.cm.CustomerFeed[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201609.cm.CustomerFeed[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201609.cm.CustomerFeed[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201609.cm.CustomerFeed getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201609.cm.CustomerFeed _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201609.cm.CustomerFeed> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201609.cm.CustomerFeed>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201609.cm.CustomerFeed>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201609", "CustomerFeedPage"));
