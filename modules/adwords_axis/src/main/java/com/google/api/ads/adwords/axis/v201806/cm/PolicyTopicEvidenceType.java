...
public class PolicyTopicEvidenceType implements java.io.Serializable {
    ...
    public static final java.lang.String _AD_TEXT_LIST = "AD_TEXT_LIST";
    public static final java.lang.String _DESTINATION_TEXT_LIST = "DESTINATION_TEXT_LIST";
    public static final java.lang.String _DESTINATION_MISMATCH = "DESTINATION_MISMATCH";
    ...
    public static final PolicyTopicEvidenceType AD_TEXT_LIST = new PolicyTopicEvidenceType(_AD_TEXT_LIST);
    public static final PolicyTopicEvidenceType DESTINATION_TEXT_LIST = new PolicyTopicEvidenceType(_DESTINATION_TEXT_LIST);
    public static final PolicyTopicEvidenceType DESTINATION_MISMATCH = new PolicyTopicEvidenceType(_DESTINATION_MISMATCH);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "PolicyTopicEvidenceType"));
    }
    /**
