...
public class CustomerFeedErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_MODIFY_DELETED_CUSTOMER_FEED = "CANNOT_MODIFY_DELETED_CUSTOMER_FEED";
    ...
    public static final CustomerFeedErrorReason CANNOT_MODIFY_DELETED_CUSTOMER_FEED = new CustomerFeedErrorReason(_CANNOT_MODIFY_DELETED_CUSTOMER_FEED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201402", "CustomerFeedError.Reason"));
    }
    /**
