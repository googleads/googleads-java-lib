 ...
 */
public class AdCustomizerFeedReturnValue  extends com.google.api.ads.adwords.axis.v201702.cm.ListReturnValue  implements java.io.Serializable {
    /* The resulting AdCustomizerFeeds. */
    private com.google.api.ads.adwords.axis.v201702.cm.AdCustomizerFeed[] value;
    ...
    public AdCustomizerFeedReturnValue(
           ...
           com.google.api.ads.adwords.axis.v201702.cm.AdCustomizerFeed[] value) {
        super(
            listReturnValueType);
        this.value = value;
    }
     ...
     */
    public com.google.api.ads.adwords.axis.v201702.cm.AdCustomizerFeed[] getValue() {
        return value;
    }
     ...
     */
    public void setValue(com.google.api.ads.adwords.axis.v201702.cm.AdCustomizerFeed[] value) {
        this.value = value;
    }

    public com.google.api.ads.adwords.axis.v201702.cm.AdCustomizerFeed getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.google.api.ads.adwords.axis.v201702.cm.AdCustomizerFeed _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "AdCustomizerFeedReturnValue"));
