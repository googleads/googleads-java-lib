...
public class UserListConversionType  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201603.rm.UserListConversionTypeCategory category;
    ...
    public UserListConversionType(
           ...
           com.google.api.ads.adwords.axis.v201603.rm.UserListConversionTypeCategory category) {
           this.id = id;
           this.name = name;
     ...
     * be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201603.rm.UserListConversionTypeCategory getCategory() {
        return category;
    }
     ...
     * be ignored when sent to the API.</span>
     */
    public void setCategory(com.google.api.ads.adwords.axis.v201603.rm.UserListConversionTypeCategory category) {
        this.category = category;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201603", "UserListConversionType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201603", "category"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201603", "UserListConversionType.Category"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
