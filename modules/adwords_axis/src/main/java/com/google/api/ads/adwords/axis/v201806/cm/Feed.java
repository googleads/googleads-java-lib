...
public class Feed  implements java.io.Serializable {
     ...
     * and should not be {@code null} when it is contained within {@link
     * Operator}s : ADD.</span> */
    private com.google.api.ads.adwords.axis.v201806.cm.FeedAttribute[] attributes;
    ...
    private com.google.api.ads.adwords.axis.v201806.cm.FeedStatus status;
     ...
     * Filterable">This field can be filtered on.</span> */
    private com.google.api.ads.adwords.axis.v201806.cm.FeedOrigin origin;
    ...
    private com.google.api.ads.adwords.axis.v201806.cm.SystemFeedGenerationData systemFeedGenerationData;
    ...
    public Feed(
           ...
           com.google.api.ads.adwords.axis.v201806.cm.FeedAttribute[] attributes,
           com.google.api.ads.adwords.axis.v201806.cm.FeedStatus status,
           com.google.api.ads.adwords.axis.v201806.cm.FeedOrigin origin,
           com.google.api.ads.adwords.axis.v201806.cm.SystemFeedGenerationData systemFeedGenerationData) {
           this.id = id;
           this.name = name;
     ...
     * Operator}s : ADD.</span>
     */
    public com.google.api.ads.adwords.axis.v201806.cm.FeedAttribute[] getAttributes() {
        return attributes;
    }
     ...
     * Operator}s : ADD.</span>
     */
    public void setAttributes(com.google.api.ads.adwords.axis.v201806.cm.FeedAttribute[] attributes) {
        this.attributes = attributes;
    }

    public com.google.api.ads.adwords.axis.v201806.cm.FeedAttribute getAttributes(int i) {
        return this.attributes[i];
    }

    public void setAttributes(int i, com.google.api.ads.adwords.axis.v201806.cm.FeedAttribute _value) {
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.adwords.axis.v201806.cm.FeedStatus getStatus() {
        return status;
    }
     ...
     * only and will be ignored when sent to the API.</span>
     */
    public void setStatus(com.google.api.ads.adwords.axis.v201806.cm.FeedStatus status) {
        this.status = status;
    }
     ...
     * Filterable">This field can be filtered on.</span>
     */
    public com.google.api.ads.adwords.axis.v201806.cm.FeedOrigin getOrigin() {
        return origin;
    }
     ...
     * Filterable">This field can be filtered on.</span>
     */
    public void setOrigin(com.google.api.ads.adwords.axis.v201806.cm.FeedOrigin origin) {
        this.origin = origin;
    }
     ...
     * be selected using the value "SystemFeedGenerationData".</span>
     */
    public com.google.api.ads.adwords.axis.v201806.cm.SystemFeedGenerationData getSystemFeedGenerationData() {
     ...
     * be selected using the value "SystemFeedGenerationData".</span>
     */
    public void setSystemFeedGenerationData(com.google.api.ads.adwords.axis.v201806.cm.SystemFeedGenerationData systemFeedGenerationData) {
        this.systemFeedGenerationData = systemFeedGenerationData;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "Feed"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "attributes"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "FeedAttribute"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "Feed.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("origin");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "origin"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "Feed.Origin"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("systemFeedGenerationData");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "systemFeedGenerationData"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201806", "SystemFeedGenerationData"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
