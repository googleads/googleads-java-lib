 ...
 * method.
 */
public class BudgetOrderPage  extends com.google.api.ads.adwords.axis.v201607.cm.Page  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201607.billing.BudgetOrder>{
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201607.billing.BudgetOrder[] entries;
    ...
    public BudgetOrderPage(
           ...
           com.google.api.ads.adwords.axis.v201607.billing.BudgetOrder[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201607.billing.BudgetOrder[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201607.billing.BudgetOrder[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201607.billing.BudgetOrder getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201607.billing.BudgetOrder _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201607.billing.BudgetOrder> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201607.billing.BudgetOrder>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201607.billing.BudgetOrder>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/billing/v201607", "BudgetOrderPage"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("entries");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/billing/v201607", "entries"));
