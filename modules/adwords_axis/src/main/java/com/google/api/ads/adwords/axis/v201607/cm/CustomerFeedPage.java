 ...
 */
public class CustomerFeedPage  extends com.google.api.ads.adwords.axis.v201607.cm.NullStatsPage  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201607.cm.CustomerFeed>{
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201607.cm.CustomerFeed> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201607.cm.CustomerFeed>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201607.cm.CustomerFeed>asList(entries).iterator();
    }
