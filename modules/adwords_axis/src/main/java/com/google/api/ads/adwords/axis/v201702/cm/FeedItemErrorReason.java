...
public class FeedItemErrorReason implements java.io.Serializable {
    ...
    public static final FeedItemErrorReason CANNOT_HAVE_RESTRICTION_ON_EMPTY_GEO_TARGETING = new FeedItemErrorReason(_CANNOT_HAVE_RESTRICTION_ON_EMPTY_GEO_TARGETING);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201702", "FeedItemError.Reason"));
    }
    /**
