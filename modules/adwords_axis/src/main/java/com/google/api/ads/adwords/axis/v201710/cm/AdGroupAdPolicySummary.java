...
public class AdGroupAdPolicySummary  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201710.cm.PolicyTopicEntry[] policyTopicEntries;

    /* Progress through the review process. */
    private com.google.api.ads.adwords.axis.v201710.cm.PolicySummaryReviewState reviewState;

    /* Overall review status based on the policy topic entries. */
    private com.google.api.ads.adwords.axis.v201710.cm.PolicySummaryDenormalizedStatus denormalizedStatus;
    ...
    private com.google.api.ads.adwords.axis.v201710.cm.PolicyApprovalStatus combinedApprovalStatus;

    public AdGroupAdPolicySummary() {
    }

    public AdGroupAdPolicySummary(
           com.google.api.ads.adwords.axis.v201710.cm.PolicyTopicEntry[] policyTopicEntries,
           com.google.api.ads.adwords.axis.v201710.cm.PolicySummaryReviewState reviewState,
           com.google.api.ads.adwords.axis.v201710.cm.PolicySummaryDenormalizedStatus denormalizedStatus,
           com.google.api.ads.adwords.axis.v201710.cm.PolicyApprovalStatus combinedApprovalStatus) {
     ...
     */
    public com.google.api.ads.adwords.axis.v201710.cm.PolicyTopicEntry[] getPolicyTopicEntries() {
     ...
     */
    public void setPolicyTopicEntries(com.google.api.ads.adwords.axis.v201710.cm.PolicyTopicEntry[] policyTopicEntries) {
        this.policyTopicEntries = policyTopicEntries;
    }

    public com.google.api.ads.adwords.axis.v201710.cm.PolicyTopicEntry getPolicyTopicEntries(int i) {
        return this.policyTopicEntries[i];
    }

    public void setPolicyTopicEntries(int i, com.google.api.ads.adwords.axis.v201710.cm.PolicyTopicEntry _value) {
     ...
     */
    public com.google.api.ads.adwords.axis.v201710.cm.PolicySummaryReviewState getReviewState() {
        return reviewState;
    }
     ...
     */
    public void setReviewState(com.google.api.ads.adwords.axis.v201710.cm.PolicySummaryReviewState reviewState) {
        this.reviewState = reviewState;
    }
     ...
     */
    public com.google.api.ads.adwords.axis.v201710.cm.PolicySummaryDenormalizedStatus getDenormalizedStatus() {
     ...
     */
    public void setDenormalizedStatus(com.google.api.ads.adwords.axis.v201710.cm.PolicySummaryDenormalizedStatus denormalizedStatus) {
        this.denormalizedStatus = denormalizedStatus;
    }
     ...
     * class="constraint Filterable">This field can be filtered on.</span>
     */
    public com.google.api.ads.adwords.axis.v201710.cm.PolicyApprovalStatus getCombinedApprovalStatus() {
     ...
     * class="constraint Filterable">This field can be filtered on.</span>
     */
    public void setCombinedApprovalStatus(com.google.api.ads.adwords.axis.v201710.cm.PolicyApprovalStatus combinedApprovalStatus) {
        this.combinedApprovalStatus = combinedApprovalStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "AdGroupAdPolicySummary"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("policyTopicEntries");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "policyTopicEntries"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "PolicyTopicEntry"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "reviewState"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "PolicySummaryReviewState"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("denormalizedStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "denormalizedStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "PolicySummaryDenormalizedStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("combinedApprovalStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "combinedApprovalStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "PolicyApprovalStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
