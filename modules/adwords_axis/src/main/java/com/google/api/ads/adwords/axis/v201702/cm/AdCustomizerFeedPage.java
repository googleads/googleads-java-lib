 ...
 */
public class AdCustomizerFeedPage  extends com.google.api.ads.adwords.axis.v201702.cm.Page  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201702.cm.AdCustomizerFeed>{
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201702.cm.AdCustomizerFeed> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201702.cm.AdCustomizerFeed>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201702.cm.AdCustomizerFeed>asList(entries).iterator();
    }
