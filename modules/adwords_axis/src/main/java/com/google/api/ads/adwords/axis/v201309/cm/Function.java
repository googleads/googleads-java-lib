...
public class Function  implements java.io.Serializable {
    ...
    private com.google.api.ads.adwords.axis.v201309.cm.FunctionOperator operator;
    ...
    private com.google.api.ads.adwords.axis.v201309.cm.FunctionArgumentOperand[] lhsOperand;

    /* Operand on the RHS of the equation. */
    private com.google.api.ads.adwords.axis.v201309.cm.FunctionArgumentOperand[] rhsOperand;

    public Function() {
    }

    public Function(
           com.google.api.ads.adwords.axis.v201309.cm.FunctionOperator operator,
           com.google.api.ads.adwords.axis.v201309.cm.FunctionArgumentOperand[] lhsOperand,
           com.google.api.ads.adwords.axis.v201309.cm.FunctionArgumentOperand[] rhsOperand) {
     ...
     * and should not be {@code null}.</span>
     */
    public com.google.api.ads.adwords.axis.v201309.cm.FunctionOperator getOperator() {
        return operator;
    }
     ...
     * and should not be {@code null}.</span>
     */
    public void setOperator(com.google.api.ads.adwords.axis.v201309.cm.FunctionOperator operator) {
        this.operator = operator;
    }
     ...
     * size of this collection is 1.</span>
     */
    public com.google.api.ads.adwords.axis.v201309.cm.FunctionArgumentOperand[] getLhsOperand() {
        return lhsOperand;
    }
     ...
     * size of this collection is 1.</span>
     */
    public void setLhsOperand(com.google.api.ads.adwords.axis.v201309.cm.FunctionArgumentOperand[] lhsOperand) {
        this.lhsOperand = lhsOperand;
    }

    public com.google.api.ads.adwords.axis.v201309.cm.FunctionArgumentOperand getLhsOperand(int i) {
        return this.lhsOperand[i];
    }

    public void setLhsOperand(int i, com.google.api.ads.adwords.axis.v201309.cm.FunctionArgumentOperand _value) {
     ...
     */
    public com.google.api.ads.adwords.axis.v201309.cm.FunctionArgumentOperand[] getRhsOperand() {
        return rhsOperand;
    }
     ...
     */
    public void setRhsOperand(com.google.api.ads.adwords.axis.v201309.cm.FunctionArgumentOperand[] rhsOperand) {
        this.rhsOperand = rhsOperand;
    }

    public com.google.api.ads.adwords.axis.v201309.cm.FunctionArgumentOperand getRhsOperand(int i) {
        return this.rhsOperand[i];
    }

    public void setRhsOperand(int i, com.google.api.ads.adwords.axis.v201309.cm.FunctionArgumentOperand _value) {
