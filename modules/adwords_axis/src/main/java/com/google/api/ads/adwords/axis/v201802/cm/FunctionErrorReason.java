...
public class FunctionErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _INVALID_FUNCTION_FOR_FEED_WITH_FIXED_SCHEMA = "INVALID_FUNCTION_FOR_FEED_WITH_FIXED_SCHEMA";
    ...
    public static final FunctionErrorReason INVALID_FUNCTION_FOR_FEED_WITH_FIXED_SCHEMA = new FunctionErrorReason(_INVALID_FUNCTION_FOR_FEED_WITH_FIXED_SCHEMA);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "FunctionError.Reason"));
    }
    /**
