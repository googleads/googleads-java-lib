 ...
 */
public class ActivityGroupPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.ActivityGroup>{
    ...
    private com.google.api.ads.admanager.axis.v201802.ActivityGroup[] results;
    ...
    public ActivityGroupPage(
           ...
           com.google.api.ads.admanager.axis.v201802.ActivityGroup[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.ActivityGroup[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.ActivityGroup[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.ActivityGroup getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.ActivityGroup _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.ActivityGroup> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.ActivityGroup>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.ActivityGroup>asList(results).iterator();
    }
