...
public class OperatingSystemVersionTargeting  implements java.io.Serializable {
     ...
     *                 {@link LineItem}. */
    private com.google.api.ads.dfp.axis.v201211.Technology[] targetedOperatingSystemVersions;

    /* Operating system versions that are being excluded by the
     *                 {@link LineItem}. */
    private com.google.api.ads.dfp.axis.v201211.Technology[] excludedOperatingSystemVersions;

    public OperatingSystemVersionTargeting() {
    }

    public OperatingSystemVersionTargeting(
           com.google.api.ads.dfp.axis.v201211.Technology[] targetedOperatingSystemVersions,
           com.google.api.ads.dfp.axis.v201211.Technology[] excludedOperatingSystemVersions) {
     ...
     *                 {@link LineItem}.
     */
    public com.google.api.ads.dfp.axis.v201211.Technology[] getTargetedOperatingSystemVersions() {
     ...
     *                 {@link LineItem}.
     */
    public void setTargetedOperatingSystemVersions(com.google.api.ads.dfp.axis.v201211.Technology[] targetedOperatingSystemVersions) {
        this.targetedOperatingSystemVersions = targetedOperatingSystemVersions;
    }

    public com.google.api.ads.dfp.axis.v201211.Technology getTargetedOperatingSystemVersions(int i) {
        return this.targetedOperatingSystemVersions[i];
    }

    public void setTargetedOperatingSystemVersions(int i, com.google.api.ads.dfp.axis.v201211.Technology _value) {
     ...
     *                 {@link LineItem}.
     */
    public com.google.api.ads.dfp.axis.v201211.Technology[] getExcludedOperatingSystemVersions() {
     ...
     *                 {@link LineItem}.
     */
    public void setExcludedOperatingSystemVersions(com.google.api.ads.dfp.axis.v201211.Technology[] excludedOperatingSystemVersions) {
        this.excludedOperatingSystemVersions = excludedOperatingSystemVersions;
    }

    public com.google.api.ads.dfp.axis.v201211.Technology getExcludedOperatingSystemVersions(int i) {
        return this.excludedOperatingSystemVersions[i];
    }

    public void setExcludedOperatingSystemVersions(int i, com.google.api.ads.dfp.axis.v201211.Technology _value) {
