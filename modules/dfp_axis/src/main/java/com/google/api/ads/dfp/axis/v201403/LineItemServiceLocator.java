...
public class LineItemServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201403.LineItemService {
    ...
    private java.lang.String LineItemServiceInterfacePort_address = "https://www.google.com/apis/ads/publisher/v201403/LineItemService";
    ...
    public com.google.api.ads.dfp.axis.v201403.LineItemServiceInterface getLineItemServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201403.LineItemServiceInterface getLineItemServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201403.LineItemServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201403.LineItemServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201403.LineItemServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201403.LineItemServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201403.LineItemServiceSoapBindingStub(new java.net.URL(LineItemServiceInterfacePort_address), this);
                _stub.setPortName(getLineItemServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201403", "LineItemService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201403", "LineItemServiceInterfacePort"));
        }
