...
public class WorkflowRequestErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _TYPE_REQUIRED = "TYPE_REQUIRED";
    ...
    public static final WorkflowRequestErrorReason TYPE_REQUIRED = new WorkflowRequestErrorReason(_TYPE_REQUIRED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201411", "WorkflowRequestError.Reason"));
    }
    /**
