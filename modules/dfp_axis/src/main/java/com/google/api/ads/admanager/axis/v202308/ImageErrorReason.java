...
public class ImageErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _SYSTEM_ERROR_IRS = "SYSTEM_ERROR_IRS";
    public static final java.lang.String _SYSTEM_ERROR_SCS = "SYSTEM_ERROR_SCS";
    ...
    public static final java.lang.String _PREVERIFIED_MIMETYPE_NOT_ALLOWED = "PREVERIFIED_MIMETYPE_NOT_ALLOWED";
    ...
    public static final ImageErrorReason SYSTEM_ERROR_IRS = new ImageErrorReason(_SYSTEM_ERROR_IRS);
    public static final ImageErrorReason SYSTEM_ERROR_SCS = new ImageErrorReason(_SYSTEM_ERROR_SCS);
    ...
    public static final ImageErrorReason PREVERIFIED_MIMETYPE_NOT_ALLOWED = new ImageErrorReason(_PREVERIFIED_MIMETYPE_NOT_ALLOWED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202308", "ImageError.Reason"));
    }
    /**
