...
public class CustomTargetingKey  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v202308.CustomTargetingKeyType type;
    ...
    private com.google.api.ads.admanager.axis.v202308.CustomTargetingKeyStatus status;

    /* Reportable state of a {@CustomTargetingKey} as defined in {@link
     * ReportableType}. */
    private com.google.api.ads.admanager.axis.v202308.ReportableType reportableType;
    ...
    public CustomTargetingKey(
           ...
           com.google.api.ads.admanager.axis.v202308.CustomTargetingKeyType type,
           com.google.api.ads.admanager.axis.v202308.CustomTargetingKeyStatus status,
           com.google.api.ads.admanager.axis.v202308.ReportableType reportableType) {
           this.id = id;
           this.name = name;
     ...
     *                 while specifying targeting criteria for a line item.
     */
    public com.google.api.ads.admanager.axis.v202308.CustomTargetingKeyType getType() {
        return type;
    }
     ...
     *                 while specifying targeting criteria for a line item.
     */
    public void setType(com.google.api.ads.admanager.axis.v202308.CustomTargetingKeyType type) {
        this.type = type;
    }
     ...
     *                 deactivated by calling {@link CustomTargetingService#performCustomTargetingKeyAction}.
     */
    public com.google.api.ads.admanager.axis.v202308.CustomTargetingKeyStatus getStatus() {
        return status;
    }
     ...
     *                 deactivated by calling {@link CustomTargetingService#performCustomTargetingKeyAction}.
     */
    public void setStatus(com.google.api.ads.admanager.axis.v202308.CustomTargetingKeyStatus status) {
        this.status = status;
    }
     ...
     * ReportableType}.
     */
    public com.google.api.ads.admanager.axis.v202308.ReportableType getReportableType() {
     ...
     * ReportableType}.
     */
    public void setReportableType(com.google.api.ads.admanager.axis.v202308.ReportableType reportableType) {
        this.reportableType = reportableType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202308", "CustomTargetingKey"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202308", "CustomTargetingKey.Type"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202308", "CustomTargetingKey.Status"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("reportableType");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202308", "reportableType"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202308", "ReportableType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
