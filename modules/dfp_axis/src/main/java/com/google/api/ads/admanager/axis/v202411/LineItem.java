 ...
 *             clicks, or time.
 */
public class LineItem  extends com.google.api.ads.admanager.axis.v202411.LineItemSummary  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v202411.CreativeTargeting[] creativeTargetings;
    ...
    public LineItem(
           ...
           com.google.api.ads.admanager.axis.v202411.CreativeTargeting[] creativeTargetings) {
        super(
            orderId,
            id,
            name,
     ...
     *                     that fits into that placeholder.
     */
    public com.google.api.ads.admanager.axis.v202411.CreativeTargeting[] getCreativeTargetings() {
     ...
     *                     that fits into that placeholder.
     */
    public void setCreativeTargetings(com.google.api.ads.admanager.axis.v202411.CreativeTargeting[] creativeTargetings) {
        this.creativeTargetings = creativeTargetings;
    }

    public com.google.api.ads.admanager.axis.v202411.CreativeTargeting getCreativeTargetings(int i) {
        return this.creativeTargetings[i];
    }

    public void setCreativeTargetings(int i, com.google.api.ads.admanager.axis.v202411.CreativeTargeting _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "LineItem"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "creativeTargetings"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "CreativeTargeting"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
