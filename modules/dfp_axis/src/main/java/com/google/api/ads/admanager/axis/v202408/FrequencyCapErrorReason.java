...
public class FrequencyCapErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _DUPLICATE_TIME_UNIT = "DUPLICATE_TIME_UNIT";
    ...
    public static final FrequencyCapErrorReason DUPLICATE_TIME_UNIT = new FrequencyCapErrorReason(_DUPLICATE_TIME_UNIT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202408", "FrequencyCapError.Reason"));
    }
    /**
