...
public class HtmlBundleProcessorErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_DECODE_BUNDLE = "CANNOT_DECODE_BUNDLE";
    ...
    public static final HtmlBundleProcessorErrorReason CANNOT_DECODE_BUNDLE = new HtmlBundleProcessorErrorReason(_CANNOT_DECODE_BUNDLE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202008", "HtmlBundleProcessorError.Reason"));
    }
    /**
