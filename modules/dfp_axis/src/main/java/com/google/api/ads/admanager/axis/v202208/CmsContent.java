...
public class CmsContent  implements java.io.Serializable {
    /* The ID of the Content Source associated with the CMS in Ad
     * Manager.
     ...
     * 
     * @return id   * The ID of the Content Source associated with the CMS in Ad
     * Manager.
     *                 This attribute is read-only.
     */
     ...
     * 
     * @param id   * The ID of the Content Source associated with the CMS in Ad
     * Manager.
     *                 This attribute is read-only.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202208", "CmsContent"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202208", "cmsContentId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
