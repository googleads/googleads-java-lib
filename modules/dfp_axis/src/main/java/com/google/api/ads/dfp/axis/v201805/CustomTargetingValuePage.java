 ...
 */
public class CustomTargetingValuePage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201805.CustomTargetingValue>{
     ...
     * page. */
    private com.google.api.ads.dfp.axis.v201805.CustomTargetingValue[] results;
    ...
    public CustomTargetingValuePage(
           ...
           com.google.api.ads.dfp.axis.v201805.CustomTargetingValue[] results) {
     ...
     * page.
     */
    public com.google.api.ads.dfp.axis.v201805.CustomTargetingValue[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.dfp.axis.v201805.CustomTargetingValue[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201805.CustomTargetingValue getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201805.CustomTargetingValue _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201805.CustomTargetingValue> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201805.CustomTargetingValue>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201805.CustomTargetingValue>asList(results).iterator();
    }
