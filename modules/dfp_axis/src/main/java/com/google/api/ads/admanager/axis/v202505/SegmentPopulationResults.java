...
public class SegmentPopulationResults  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v202505.SegmentPopulationStatus status;

    private java.lang.Long numSuccessfulIdsProcessed;

    private com.google.api.ads.admanager.axis.v202505.IdError[] errors;
    ...
    public SegmentPopulationResults(
           ...
           com.google.api.ads.admanager.axis.v202505.SegmentPopulationStatus status,
           java.lang.Long numSuccessfulIdsProcessed,
           com.google.api.ads.admanager.axis.v202505.IdError[] errors) {
     ...
     * @return status
     */
    public com.google.api.ads.admanager.axis.v202505.SegmentPopulationStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.google.api.ads.admanager.axis.v202505.SegmentPopulationStatus status) {
        this.status = status;
    }
     ...
     * @return errors
     */
    public com.google.api.ads.admanager.axis.v202505.IdError[] getErrors() {
        return errors;
    }
     ...
     * @param errors
     */
    public void setErrors(com.google.api.ads.admanager.axis.v202505.IdError[] errors) {
        this.errors = errors;
    }

    public com.google.api.ads.admanager.axis.v202505.IdError getErrors(int i) {
        return this.errors[i];
    }

    public void setErrors(int i, com.google.api.ads.admanager.axis.v202505.IdError _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202505", "SegmentPopulationResults"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202505", "SegmentPopulationStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("numSuccessfulIdsProcessed");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202505", "numSuccessfulIdsProcessed"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202505", "errors"));
