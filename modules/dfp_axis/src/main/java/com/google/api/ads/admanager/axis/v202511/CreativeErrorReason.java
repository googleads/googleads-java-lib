...
public class CreativeErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_REMOVE_PLACEMENT_IDS = "CANNOT_REMOVE_PLACEMENT_IDS";
    ...
    public static final CreativeErrorReason CANNOT_REMOVE_PLACEMENT_IDS = new CreativeErrorReason(_CANNOT_REMOVE_PLACEMENT_IDS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202511", "CreativeError.Reason"));
    }
    /**
