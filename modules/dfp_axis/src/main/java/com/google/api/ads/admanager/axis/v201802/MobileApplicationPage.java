 ...
 */
public class MobileApplicationPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.MobileApplication>{
     ...
     * page. */
    private com.google.api.ads.admanager.axis.v201802.MobileApplication[] results;
    ...
    public MobileApplicationPage(
           ...
           com.google.api.ads.admanager.axis.v201802.MobileApplication[] results) {
     ...
     * page.
     */
    public com.google.api.ads.admanager.axis.v201802.MobileApplication[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.MobileApplication[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.MobileApplication getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.MobileApplication _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.MobileApplication> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.MobileApplication>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.MobileApplication>asList(results).iterator();
    }
