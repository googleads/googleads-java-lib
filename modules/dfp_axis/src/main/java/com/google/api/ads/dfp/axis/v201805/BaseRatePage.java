 ...
 */
public class BaseRatePage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201805.BaseRate>{
    /* The collection of base rates contained within this page. */
    private com.google.api.ads.dfp.axis.v201805.BaseRate[] results;
    ...
    public BaseRatePage(
           com.google.api.ads.dfp.axis.v201805.BaseRate[] results,
     ...
     */
    public com.google.api.ads.dfp.axis.v201805.BaseRate[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201805.BaseRate[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201805.BaseRate getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201805.BaseRate _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201805.BaseRate> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201805.BaseRate>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201805.BaseRate>asList(results).iterator();
    }
