...
public class AdRuleSlotErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _TOO_MANY_MIDROLL_SLOTS_WITHOUT_ADS = "TOO_MANY_MIDROLL_SLOTS_WITHOUT_ADS";
    ...
    public static final AdRuleSlotErrorReason TOO_MANY_MIDROLL_SLOTS_WITHOUT_ADS = new AdRuleSlotErrorReason(_TOO_MANY_MIDROLL_SLOTS_WITHOUT_ADS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202202", "AdRuleSlotError.Reason"));
    }
    /**
