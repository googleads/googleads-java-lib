...
public class TrafficForecastAdjustment  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v201908.TrafficTimeSeriesFilterCriteria filterCriteria;

    /* Each adjustment segment is a forecast adjustment targeting
     * a continuous date range. */
    private com.google.api.ads.admanager.axis.v201908.TrafficForecastAdjustmentSegment[] forecastAdjustmentSegments;
    ...
    public TrafficForecastAdjustment(
           java.lang.Long id,
           com.google.api.ads.admanager.axis.v201908.TrafficTimeSeriesFilterCriteria filterCriteria,
           com.google.api.ads.admanager.axis.v201908.TrafficForecastAdjustmentSegment[] forecastAdjustmentSegments,
     ...
     * adjustment is assigned.
     */
    public com.google.api.ads.admanager.axis.v201908.TrafficTimeSeriesFilterCriteria getFilterCriteria() {
     ...
     * adjustment is assigned.
     */
    public void setFilterCriteria(com.google.api.ads.admanager.axis.v201908.TrafficTimeSeriesFilterCriteria filterCriteria) {
        this.filterCriteria = filterCriteria;
    }
     ...
     * a continuous date range.
     */
    public com.google.api.ads.admanager.axis.v201908.TrafficForecastAdjustmentSegment[] getForecastAdjustmentSegments() {
     ...
     * a continuous date range.
     */
    public void setForecastAdjustmentSegments(com.google.api.ads.admanager.axis.v201908.TrafficForecastAdjustmentSegment[] forecastAdjustmentSegments) {
        this.forecastAdjustmentSegments = forecastAdjustmentSegments;
    }

    public com.google.api.ads.admanager.axis.v201908.TrafficForecastAdjustmentSegment getForecastAdjustmentSegments(int i) {
        return this.forecastAdjustmentSegments[i];
    }

    public void setForecastAdjustmentSegments(int i, com.google.api.ads.admanager.axis.v201908.TrafficForecastAdjustmentSegment _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201908", "TrafficForecastAdjustment"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201908", "filterCriteria"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201908", "TrafficTimeSeriesFilterCriteria"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("forecastAdjustmentSegments");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201908", "forecastAdjustmentSegments"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201908", "TrafficForecastAdjustmentSegment"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
