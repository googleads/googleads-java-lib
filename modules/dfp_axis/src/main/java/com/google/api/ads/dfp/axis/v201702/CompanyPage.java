 ...
 */
public class CompanyPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201702.Company>{
    ...
    private com.google.api.ads.dfp.axis.v201702.Company[] results;
    ...
    public CompanyPage(
           ...
           com.google.api.ads.dfp.axis.v201702.Company[] results) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201702.Company[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201702.Company[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201702.Company getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201702.Company _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201702.Company> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201702.Company>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201702.Company>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201702", "CompanyPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201702", "Company"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
