...
public class LineItemErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _LINKED_WEB_PROPERTY_NOT_ALLOWED_FOR_ADX_BACKFILL = "LINKED_WEB_PROPERTY_NOT_ALLOWED_FOR_ADX_BACKFILL";
    ...
    public static final java.lang.String _PLACEHOLDER_COUNT_NOT_SUPPORTED = "PLACEHOLDER_COUNT_NOT_SUPPORTED";
    ...
    public static final java.lang.String _INVALID_COST_PER_UNIT_FOR_BACKFILL = "INVALID_COST_PER_UNIT_FOR_BACKFILL";
    public static final java.lang.String _INVALID_SIZE_FOR_ENVIRONMENT = "INVALID_SIZE_FOR_ENVIRONMENT";
    public static final java.lang.String _TARGET_PLATFORM_NOT_ALLOWED = "TARGET_PLATFORM_NOT_ALLOWED";
    ...
    public static final java.lang.String _INVALID_VIEWABILITY_PROVIDER_COMPANY = "INVALID_VIEWABILITY_PROVIDER_COMPANY";
    public static final java.lang.String _CANNOT_ACCESS_CUSTOM_PACING_CURVE_CLOUD_STORAGE_BUCKET = "CANNOT_ACCESS_CUSTOM_PACING_CURVE_CLOUD_STORAGE_BUCKET";
    public static final java.lang.String _CMS_METADATA_LINE_ITEM_ENVIRONMENT_TYPE_NOT_SUPPORTED = "CMS_METADATA_LINE_ITEM_ENVIRONMENT_TYPE_NOT_SUPPORTED";
    public static final java.lang.String _SKIPPABLE_AD_TYPE_NOT_ALLOWED = "SKIPPABLE_AD_TYPE_NOT_ALLOWED";
    public static final java.lang.String _CUSTOM_PACING_CURVE_START_TIME_MUST_MATCH_LINE_ITEM_START_TIME = "CUSTOM_PACING_CURVE_START_TIME_MUST_MATCH_LINE_ITEM_START_TIME";
    public static final java.lang.String _CUSTOM_PACING_CURVE_START_TIME_PAST_LINE_ITEM_END_TIME = "CUSTOM_PACING_CURVE_START_TIME_PAST_LINE_ITEM_END_TIME";
    public static final java.lang.String _INVALID_LINE_ITEM_TYPE_FOR_DELIVERY_FORECAST_SOURCE = "INVALID_LINE_ITEM_TYPE_FOR_DELIVERY_FORECAST_SOURCE";
    public static final java.lang.String _INVALID_LINE_ITEM_TYPE_FOR_ALLOCATION_DELIVERY_PROFILE = "INVALID_LINE_ITEM_TYPE_FOR_ALLOCATION_DELIVERY_PROFILE";
    public static final java.lang.String _INVALID_TOTAL_CUSTOM_PACING_GOAL_AMOUNTS = "INVALID_TOTAL_CUSTOM_PACING_GOAL_AMOUNTS";
    public static final java.lang.String _COPY_LINE_ITEM_WITH_CUSTOM_PACING_CURVE_FULLY_IN_PAST_NOT_ALLOWED = "COPY_LINE_ITEM_WITH_CUSTOM_PACING_CURVE_FULLY_IN_PAST_NOT_ALLOWED";
    public static final java.lang.String _LAST_CUSTOM_PACING_GOAL_AMOUNT_CANNOT_BE_ZERO = "LAST_CUSTOM_PACING_GOAL_AMOUNT_CANNOT_BE_ZERO";
    public static final java.lang.String _GRP_PACED_LINE_ITEM_CANNOT_HAVE_ABSOLUTE_CUSTOM_PACING_CURVE_GOALS = "GRP_PACED_LINE_ITEM_CANNOT_HAVE_ABSOLUTE_CUSTOM_PACING_CURVE_GOALS";
    public static final java.lang.String _INVALID_MAX_VIDEO_CREATIVE_DURATION = "INVALID_MAX_VIDEO_CREATIVE_DURATION";
    public static final java.lang.String _INVALID_NATIVE_SIZE = "INVALID_NATIVE_SIZE";
    public static final java.lang.String _INVALID_TARGETED_REQUEST_PLATFORM_FOR_WEB_PROPERTY_CODE = "INVALID_TARGETED_REQUEST_PLATFORM_FOR_WEB_PROPERTY_CODE";
    public static final java.lang.String _REPEATED_CREATIVE_SERVING_NOT_ALLOWED = "REPEATED_CREATIVE_SERVING_NOT_ALLOWED";
    ...
    public static final LineItemErrorReason LINKED_WEB_PROPERTY_NOT_ALLOWED_FOR_ADX_BACKFILL = new LineItemErrorReason(_LINKED_WEB_PROPERTY_NOT_ALLOWED_FOR_ADX_BACKFILL);
    ...
    public static final LineItemErrorReason PLACEHOLDER_COUNT_NOT_SUPPORTED = new LineItemErrorReason(_PLACEHOLDER_COUNT_NOT_SUPPORTED);
    ...
    public static final LineItemErrorReason INVALID_COST_PER_UNIT_FOR_BACKFILL = new LineItemErrorReason(_INVALID_COST_PER_UNIT_FOR_BACKFILL);
    ...
    public static final LineItemErrorReason TARGET_PLATFORM_NOT_ALLOWED = new LineItemErrorReason(_TARGET_PLATFORM_NOT_ALLOWED);
    ...
    public static final LineItemErrorReason INVALID_VIEWABILITY_PROVIDER_COMPANY = new LineItemErrorReason(_INVALID_VIEWABILITY_PROVIDER_COMPANY);
    public static final LineItemErrorReason CANNOT_ACCESS_CUSTOM_PACING_CURVE_CLOUD_STORAGE_BUCKET = new LineItemErrorReason(_CANNOT_ACCESS_CUSTOM_PACING_CURVE_CLOUD_STORAGE_BUCKET);
    public static final LineItemErrorReason CMS_METADATA_LINE_ITEM_ENVIRONMENT_TYPE_NOT_SUPPORTED = new LineItemErrorReason(_CMS_METADATA_LINE_ITEM_ENVIRONMENT_TYPE_NOT_SUPPORTED);
    public static final LineItemErrorReason SKIPPABLE_AD_TYPE_NOT_ALLOWED = new LineItemErrorReason(_SKIPPABLE_AD_TYPE_NOT_ALLOWED);
    public static final LineItemErrorReason CUSTOM_PACING_CURVE_START_TIME_MUST_MATCH_LINE_ITEM_START_TIME = new LineItemErrorReason(_CUSTOM_PACING_CURVE_START_TIME_MUST_MATCH_LINE_ITEM_START_TIME);
    public static final LineItemErrorReason CUSTOM_PACING_CURVE_START_TIME_PAST_LINE_ITEM_END_TIME = new LineItemErrorReason(_CUSTOM_PACING_CURVE_START_TIME_PAST_LINE_ITEM_END_TIME);
    public static final LineItemErrorReason INVALID_LINE_ITEM_TYPE_FOR_DELIVERY_FORECAST_SOURCE = new LineItemErrorReason(_INVALID_LINE_ITEM_TYPE_FOR_DELIVERY_FORECAST_SOURCE);
    public static final LineItemErrorReason INVALID_LINE_ITEM_TYPE_FOR_ALLOCATION_DELIVERY_PROFILE = new LineItemErrorReason(_INVALID_LINE_ITEM_TYPE_FOR_ALLOCATION_DELIVERY_PROFILE);
    public static final LineItemErrorReason INVALID_TOTAL_CUSTOM_PACING_GOAL_AMOUNTS = new LineItemErrorReason(_INVALID_TOTAL_CUSTOM_PACING_GOAL_AMOUNTS);
    public static final LineItemErrorReason COPY_LINE_ITEM_WITH_CUSTOM_PACING_CURVE_FULLY_IN_PAST_NOT_ALLOWED = new LineItemErrorReason(_COPY_LINE_ITEM_WITH_CUSTOM_PACING_CURVE_FULLY_IN_PAST_NOT_ALLOWED);
    public static final LineItemErrorReason LAST_CUSTOM_PACING_GOAL_AMOUNT_CANNOT_BE_ZERO = new LineItemErrorReason(_LAST_CUSTOM_PACING_GOAL_AMOUNT_CANNOT_BE_ZERO);
    public static final LineItemErrorReason GRP_PACED_LINE_ITEM_CANNOT_HAVE_ABSOLUTE_CUSTOM_PACING_CURVE_GOALS = new LineItemErrorReason(_GRP_PACED_LINE_ITEM_CANNOT_HAVE_ABSOLUTE_CUSTOM_PACING_CURVE_GOALS);
    public static final LineItemErrorReason INVALID_MAX_VIDEO_CREATIVE_DURATION = new LineItemErrorReason(_INVALID_MAX_VIDEO_CREATIVE_DURATION);
    public static final LineItemErrorReason INVALID_NATIVE_SIZE = new LineItemErrorReason(_INVALID_NATIVE_SIZE);
    public static final LineItemErrorReason INVALID_TARGETED_REQUEST_PLATFORM_FOR_WEB_PROPERTY_CODE = new LineItemErrorReason(_INVALID_TARGETED_REQUEST_PLATFORM_FOR_WEB_PROPERTY_CODE);
    public static final LineItemErrorReason REPEATED_CREATIVE_SERVING_NOT_ALLOWED = new LineItemErrorReason(_REPEATED_CREATIVE_SERVING_NOT_ALLOWED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202605", "LineItemError.Reason"));
    }
    /**
