...
public class EntityChildrenLimitReachedErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CUSTOM_TARGETING_VALUES_FOR_FREEFORM_KEY_LIMIT_REACHED = "CUSTOM_TARGETING_VALUES_FOR_FREEFORM_KEY_LIMIT_REACHED";
    ...
    public static final EntityChildrenLimitReachedErrorReason CUSTOM_TARGETING_VALUES_FOR_FREEFORM_KEY_LIMIT_REACHED = new EntityChildrenLimitReachedErrorReason(_CUSTOM_TARGETING_VALUES_FOR_FREEFORM_KEY_LIMIT_REACHED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "EntityChildrenLimitReachedError.Reason"));
    }
    /**
