 ...
 */
public class CmsMetadataValuePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v202208.CmsMetadataValue>{
    private java.lang.Integer totalResultSetSize;

    private java.lang.Integer startIndex;

    private com.google.api.ads.admanager.axis.v202208.CmsMetadataValue[] results;
    ...
    public CmsMetadataValuePage(
           ...
           com.google.api.ads.admanager.axis.v202208.CmsMetadataValue[] results) {
     ...
     * @return results
     */
    public com.google.api.ads.admanager.axis.v202208.CmsMetadataValue[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(com.google.api.ads.admanager.axis.v202208.CmsMetadataValue[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v202208.CmsMetadataValue getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v202208.CmsMetadataValue _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v202208.CmsMetadataValue> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v202208.CmsMetadataValue>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v202208.CmsMetadataValue>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202208", "CmsMetadataValuePage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202208", "CmsMetadataValue"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
