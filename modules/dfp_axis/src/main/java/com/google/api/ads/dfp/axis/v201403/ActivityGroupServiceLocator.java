...
public class ActivityGroupServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201403.ActivityGroupService {
    ...
    private java.lang.String ActivityGroupServiceInterfacePort_address = "https://www.google.com/apis/ads/publisher/v201403/ActivityGroupService";
    ...
    public com.google.api.ads.dfp.axis.v201403.ActivityGroupServiceInterface getActivityGroupServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201403.ActivityGroupServiceInterface getActivityGroupServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201403.ActivityGroupServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201403.ActivityGroupServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201403.ActivityGroupServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201403.ActivityGroupServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201403.ActivityGroupServiceSoapBindingStub(new java.net.URL(ActivityGroupServiceInterfacePort_address), this);
                _stub.setPortName(getActivityGroupServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201403", "ActivityGroupService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201403", "ActivityGroupServiceInterfacePort"));
        }
