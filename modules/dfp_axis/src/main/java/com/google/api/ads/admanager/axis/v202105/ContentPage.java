 ...
 */
public class ContentPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v202105.Content>{
    ...
    private com.google.api.ads.admanager.axis.v202105.Content[] results;
    ...
    public ContentPage(
           ...
           com.google.api.ads.admanager.axis.v202105.Content[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v202105.Content[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v202105.Content[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v202105.Content getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v202105.Content _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v202105.Content> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v202105.Content>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v202105.Content>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202105", "ContentPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202105", "Content"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
