...
public class Content  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.axis.v201408.ContentStatus status;

    /* Whether the content status was defined by the user, or by the
     * source CMS
     *                 from which the content was ingested. This attribute
     * is read-only. */
    private com.google.api.ads.dfp.axis.v201408.ContentStatusDefinedBy statusDefinedBy;

    /* The date and time at which this content was published. This
     * attribute is read-only. */
    private com.google.api.ads.dfp.axis.v201408.DateTime publishDateTime;
     ...
     * from.
     *                 This attribute is read-only. */
    private com.google.api.ads.dfp.axis.v201408.CmsContent[] cmsSources;
    ...
    public Content(
           ...
           com.google.api.ads.dfp.axis.v201408.ContentStatus status,
           com.google.api.ads.dfp.axis.v201408.ContentStatusDefinedBy statusDefinedBy,
           com.google.api.ads.dfp.axis.v201408.DateTime publishDateTime,
           ...
           com.google.api.ads.dfp.axis.v201408.CmsContent[] cmsSources) {
           this.id = id;
           this.name = name;
           this.status = status;
     ...
     */
    public com.google.api.ads.dfp.axis.v201408.ContentStatus getStatus() {
        return status;
    }
     ...
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201408.ContentStatus status) {
        this.status = status;
    }
     ...
     * is read-only.
     */
    public com.google.api.ads.dfp.axis.v201408.ContentStatusDefinedBy getStatusDefinedBy() {
     ...
     * is read-only.
     */
    public void setStatusDefinedBy(com.google.api.ads.dfp.axis.v201408.ContentStatusDefinedBy statusDefinedBy) {
        this.statusDefinedBy = statusDefinedBy;
    }


    /**
     * Gets the publishDateTime value for this Content.
     * 
     * @return publishDateTime   * The date and time at which this content was published. This
     * attribute is read-only.
     */
    public com.google.api.ads.dfp.axis.v201408.DateTime getPublishDateTime() {
        return publishDateTime;
    }


    /**
     * Sets the publishDateTime value for this Content.
     * 
     * @param publishDateTime   * The date and time at which this content was published. This
     * attribute is read-only.
     */
    public void setPublishDateTime(com.google.api.ads.dfp.axis.v201408.DateTime publishDateTime) {
        this.publishDateTime = publishDateTime;
    }
     ...
     *                 This attribute is read-only.
     */
    public com.google.api.ads.dfp.axis.v201408.CmsContent[] getCmsSources() {
        return cmsSources;
    }
     ...
     *                 This attribute is read-only.
     */
    public void setCmsSources(com.google.api.ads.dfp.axis.v201408.CmsContent[] cmsSources) {
        this.cmsSources = cmsSources;
    }

    public com.google.api.ads.dfp.axis.v201408.CmsContent getCmsSources(int i) {
        return this.cmsSources[i];
    }

    public void setCmsSources(int i, com.google.api.ads.dfp.axis.v201408.CmsContent _value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.publishDateTime==null && other.getPublishDateTime()==null) || 
             (this.publishDateTime!=null &&
              this.publishDateTime.equals(other.getPublishDateTime()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getPublishDateTime() != null) {
            _hashCode += getPublishDateTime().hashCode();
        }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201408", "Content"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201408", "ContentStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("statusDefinedBy");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201408", "statusDefinedBy"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201408", "ContentStatusDefinedBy"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("publishDateTime");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201408", "publishDateTime"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201408", "userDefinedCustomTargetingValueIds"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201408", "mappingRuleDefinedCustomTargetingValueIds"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201408", "cmsSources"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201408", "CmsContent"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
