 ...
 */
public class OrderPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v202111.Order>{
    ...
    private com.google.api.ads.admanager.axis.v202111.Order[] results;
    ...
    public OrderPage(
           ...
           com.google.api.ads.admanager.axis.v202111.Order[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v202111.Order[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v202111.Order[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v202111.Order getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v202111.Order _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v202111.Order> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v202111.Order>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v202111.Order>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202111", "OrderPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202111", "Order"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
