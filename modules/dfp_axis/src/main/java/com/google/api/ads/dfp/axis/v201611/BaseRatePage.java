 ...
 */
public class BaseRatePage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201611.BaseRate>{
    /* The collection of base rates contained within this page. */
    private com.google.api.ads.dfp.axis.v201611.BaseRate[] results;
    ...
    public BaseRatePage(
           com.google.api.ads.dfp.axis.v201611.BaseRate[] results,
     ...
     */
    public com.google.api.ads.dfp.axis.v201611.BaseRate[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201611.BaseRate[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201611.BaseRate getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201611.BaseRate _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201611.BaseRate> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201611.BaseRate>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201611.BaseRate>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201611", "BaseRatePage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201611", "BaseRate"));
