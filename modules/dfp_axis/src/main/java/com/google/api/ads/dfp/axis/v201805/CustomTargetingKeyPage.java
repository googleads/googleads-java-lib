 ...
 */
public class CustomTargetingKeyPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201805.CustomTargetingKey>{
     ...
     * page. */
    private com.google.api.ads.dfp.axis.v201805.CustomTargetingKey[] results;
    ...
    public CustomTargetingKeyPage(
           ...
           com.google.api.ads.dfp.axis.v201805.CustomTargetingKey[] results) {
     ...
     * page.
     */
    public com.google.api.ads.dfp.axis.v201805.CustomTargetingKey[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.dfp.axis.v201805.CustomTargetingKey[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201805.CustomTargetingKey getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201805.CustomTargetingKey _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201805.CustomTargetingKey> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201805.CustomTargetingKey>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201805.CustomTargetingKey>asList(results).iterator();
    }
