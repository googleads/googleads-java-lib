 ...
 */
public class DateValue  extends com.google.api.ads.admanager.axis.v201802.Value  implements java.io.Serializable {
    /* The {@code Date} value. */
    private com.google.api.ads.admanager.axis.v201802.Date value;

    public DateValue() {
    }

    public DateValue(
           com.google.api.ads.admanager.axis.v201802.Date value) {
        this.value = value;
    }
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.Date getValue() {
        return value;
    }
     ...
     */
    public void setValue(com.google.api.ads.admanager.axis.v201802.Date value) {
        this.value = value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "DateValue"));
