...
public class ContentServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201405.ContentService {
    ...
    private java.lang.String ContentServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v201405/ContentService";
    ...
    public com.google.api.ads.dfp.axis.v201405.ContentServiceInterface getContentServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201405.ContentServiceInterface getContentServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201405.ContentServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201405.ContentServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201405.ContentServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201405.ContentServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201405.ContentServiceSoapBindingStub(new java.net.URL(ContentServiceInterfacePort_address), this);
                _stub.setPortName(getContentServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201405", "ContentService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201405", "ContentServiceInterfacePort"));
        }
