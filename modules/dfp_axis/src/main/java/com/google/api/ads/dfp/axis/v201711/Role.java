...
public class Role  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.axis.v201711.RoleStatus status;
    ...
    public Role(
           ...
           com.google.api.ads.dfp.axis.v201711.RoleStatus status) {
           this.id = id;
           this.name = name;
     ...
     *                 visibility of the role in the UI.
     */
    public com.google.api.ads.dfp.axis.v201711.RoleStatus getStatus() {
        return status;
    }
     ...
     *                 visibility of the role in the UI.
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201711.RoleStatus status) {
        this.status = status;
    }
