...
public class ActivityGroup  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.axis.v201308.ActivityGroupStatus status;
    ...
    public ActivityGroup(
           ...
           com.google.api.ads.dfp.axis.v201308.ActivityGroupStatus status) {
           this.id = id;
           this.name = name;
     ...
     */
    public com.google.api.ads.dfp.axis.v201308.ActivityGroupStatus getStatus() {
        return status;
    }
     ...
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201308.ActivityGroupStatus status) {
        this.status = status;
    }
