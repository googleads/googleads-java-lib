...
public class ProgrammaticErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _INVALID_BUYER = "INVALID_BUYER";
    ...
    public static final ProgrammaticErrorReason INVALID_BUYER = new ProgrammaticErrorReason(_INVALID_BUYER);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202508", "ProgrammaticError.Reason"));
    }
    /**
