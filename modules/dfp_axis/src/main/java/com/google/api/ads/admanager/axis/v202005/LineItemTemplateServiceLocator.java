...
public class LineItemTemplateServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.admanager.axis.v202005.LineItemTemplateService {
    ...
    private java.lang.String LineItemTemplateServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v202005/LineItemTemplateService";
    ...
    public com.google.api.ads.admanager.axis.v202005.LineItemTemplateServiceInterface getLineItemTemplateServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.admanager.axis.v202005.LineItemTemplateServiceInterface getLineItemTemplateServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.admanager.axis.v202005.LineItemTemplateServiceSoapBindingStub _stub = new com.google.api.ads.admanager.axis.v202005.LineItemTemplateServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.admanager.axis.v202005.LineItemTemplateServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.admanager.axis.v202005.LineItemTemplateServiceSoapBindingStub _stub = new com.google.api.ads.admanager.axis.v202005.LineItemTemplateServiceSoapBindingStub(new java.net.URL(LineItemTemplateServiceInterfacePort_address), this);
                _stub.setPortName(getLineItemTemplateServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202005", "LineItemTemplateService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202005", "LineItemTemplateServiceInterfacePort"));
        }
