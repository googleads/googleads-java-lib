 ...
 */
public class WorkflowApprovalRequest  extends com.google.api.ads.dfp.axis.v201608.WorkflowRequest  implements java.io.Serializable {
    /* The status of the {@code WorkflowApprovalRequest}. This attribute
     * is readonly. */
    private com.google.api.ads.dfp.axis.v201608.WorkflowApprovalRequestStatus status;
    ...
    public WorkflowApprovalRequest(
           ...
           com.google.api.ads.dfp.axis.v201608.WorkflowApprovalRequestStatus status) {
        super(
            id,
            workflowRuleName,
            entityId,
     ...
     * is readonly.
     */
    public com.google.api.ads.dfp.axis.v201608.WorkflowApprovalRequestStatus getStatus() {
        return status;
    }
     ...
     * is readonly.
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201608.WorkflowApprovalRequestStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201608", "WorkflowApprovalRequest"));
