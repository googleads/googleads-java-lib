...
public class AudienceSegmentErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _SHARED_SELLING_PARTNER_ROOT_CANNOT_BE_INCLUDED = "SHARED_SELLING_PARTNER_ROOT_CANNOT_BE_INCLUDED";
    ...
    public static final java.lang.String _SEGMENT_VIOLATED_POLICY = "SEGMENT_VIOLATED_POLICY";
    ...
    public static final AudienceSegmentErrorReason SHARED_SELLING_PARTNER_ROOT_CANNOT_BE_INCLUDED = new AudienceSegmentErrorReason(_SHARED_SELLING_PARTNER_ROOT_CANNOT_BE_INCLUDED);
    ...
    public static final AudienceSegmentErrorReason SEGMENT_VIOLATED_POLICY = new AudienceSegmentErrorReason(_SEGMENT_VIOLATED_POLICY);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202311", "AudienceSegmentError.Reason"));
    }
    /**
