 ...
 */
public class PremiumRatePage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201702.PremiumRate>{
    /* The collection of premium rates contained within this page. */
    private com.google.api.ads.dfp.axis.v201702.PremiumRate[] results;
    ...
    public PremiumRatePage(
           com.google.api.ads.dfp.axis.v201702.PremiumRate[] results,
     ...
     */
    public com.google.api.ads.dfp.axis.v201702.PremiumRate[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201702.PremiumRate[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201702.PremiumRate getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201702.PremiumRate _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201702.PremiumRate> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201702.PremiumRate>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201702.PremiumRate>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201702", "PremiumRatePage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201702", "PremiumRate"));
