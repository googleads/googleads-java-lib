...
public class ComputedStatus implements java.io.Serializable {
    ...
    public static final ComputedStatus INACTIVE = new ComputedStatus(_INACTIVE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "ComputedStatus"));
    }
    /**
