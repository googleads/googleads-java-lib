...
public class CreativeWrapperServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201403.CreativeWrapperService {
    ...
    public com.google.api.ads.dfp.axis.v201403.CreativeWrapperServiceInterface getCreativeWrapperServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201403.CreativeWrapperServiceInterface getCreativeWrapperServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201403.CreativeWrapperServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201403.CreativeWrapperServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201403.CreativeWrapperServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201403.CreativeWrapperServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201403.CreativeWrapperServiceSoapBindingStub(new java.net.URL(CreativeWrapperServiceInterfacePort_address), this);
                _stub.setPortName(getCreativeWrapperServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201403", "CreativeWrapperService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201403", "CreativeWrapperServiceInterfacePort"));
        }
