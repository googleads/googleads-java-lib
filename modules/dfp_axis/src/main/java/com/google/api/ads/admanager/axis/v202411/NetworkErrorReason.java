...
public class NetworkErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _DEPRECATED_DATA_TRANSFER_CONFIG_EVENT_TYPE = "DEPRECATED_DATA_TRANSFER_CONFIG_EVENT_TYPE";
    ...
    public static final java.lang.String _ERROR_REENABLING_AD_EXCHANGE_ON_MCM_CHILD = "ERROR_REENABLING_AD_EXCHANGE_ON_MCM_CHILD";
    public static final java.lang.String _ERROR_SETTING_SITE_SERVING_MODE_ON_MCM_CHILD = "ERROR_SETTING_SITE_SERVING_MODE_ON_MCM_CHILD";
    ...
    public static final NetworkErrorReason DEPRECATED_DATA_TRANSFER_CONFIG_EVENT_TYPE = new NetworkErrorReason(_DEPRECATED_DATA_TRANSFER_CONFIG_EVENT_TYPE);
    ...
    public static final NetworkErrorReason ERROR_REENABLING_AD_EXCHANGE_ON_MCM_CHILD = new NetworkErrorReason(_ERROR_REENABLING_AD_EXCHANGE_ON_MCM_CHILD);
    public static final NetworkErrorReason ERROR_SETTING_SITE_SERVING_MODE_ON_MCM_CHILD = new NetworkErrorReason(_ERROR_SETTING_SITE_SERVING_MODE_ON_MCM_CHILD);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "NetworkError.Reason"));
    }
    /**
