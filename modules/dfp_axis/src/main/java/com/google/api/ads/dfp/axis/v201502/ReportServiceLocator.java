...
public class ReportServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201502.ReportService {
    ...
    private java.lang.String ReportServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v201502/ReportService";
    ...
    public com.google.api.ads.dfp.axis.v201502.ReportServiceInterface getReportServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201502.ReportServiceInterface getReportServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201502.ReportServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201502.ReportServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201502.ReportServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201502.ReportServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201502.ReportServiceSoapBindingStub(new java.net.URL(ReportServiceInterfacePort_address), this);
                _stub.setPortName(getReportServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201502", "ReportService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201502", "ReportServiceInterfacePort"));
        }
