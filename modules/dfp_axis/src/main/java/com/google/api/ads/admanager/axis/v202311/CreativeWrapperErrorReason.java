...
public class CreativeWrapperErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _NEITHER_HEADER_NOR_FOOTER_NOR_VIDEO_TRACKING_URLS_SPECIFIED = "NEITHER_HEADER_NOR_FOOTER_NOR_VIDEO_TRACKING_URLS_SPECIFIED";
    ...
    public static final java.lang.String _CANNOT_APPLY_TO_AD_UNIT_WITHOUT_VIDEO_SIZES = "CANNOT_APPLY_TO_AD_UNIT_WITHOUT_VIDEO_SIZES";
    public static final java.lang.String _CANNOT_APPLY_TO_AD_UNIT_WITHOUT_LABEL_ASSOCIATION = "CANNOT_APPLY_TO_AD_UNIT_WITHOUT_LABEL_ASSOCIATION";
    ...
    public static final CreativeWrapperErrorReason NEITHER_HEADER_NOR_FOOTER_NOR_VIDEO_TRACKING_URLS_SPECIFIED = new CreativeWrapperErrorReason(_NEITHER_HEADER_NOR_FOOTER_NOR_VIDEO_TRACKING_URLS_SPECIFIED);
    ...
    public static final CreativeWrapperErrorReason CANNOT_APPLY_TO_AD_UNIT_WITHOUT_VIDEO_SIZES = new CreativeWrapperErrorReason(_CANNOT_APPLY_TO_AD_UNIT_WITHOUT_VIDEO_SIZES);
    public static final CreativeWrapperErrorReason CANNOT_APPLY_TO_AD_UNIT_WITHOUT_LABEL_ASSOCIATION = new CreativeWrapperErrorReason(_CANNOT_APPLY_TO_AD_UNIT_WITHOUT_LABEL_ASSOCIATION);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202311", "CreativeWrapperError.Reason"));
    }
    /**
