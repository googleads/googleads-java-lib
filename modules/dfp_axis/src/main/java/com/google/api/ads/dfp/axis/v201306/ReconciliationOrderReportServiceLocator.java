...
public class ReconciliationOrderReportServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201306.ReconciliationOrderReportService {
    ...
    private java.lang.String ReconciliationOrderReportServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v201306/ReconciliationOrderReportService";
    ...
    public com.google.api.ads.dfp.axis.v201306.ReconciliationOrderReportServiceInterface getReconciliationOrderReportServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201306.ReconciliationOrderReportServiceInterface getReconciliationOrderReportServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201306.ReconciliationOrderReportServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201306.ReconciliationOrderReportServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201306.ReconciliationOrderReportServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201306.ReconciliationOrderReportServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201306.ReconciliationOrderReportServiceSoapBindingStub(new java.net.URL(ReconciliationOrderReportServiceInterfacePort_address), this);
                _stub.setPortName(getReconciliationOrderReportServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
