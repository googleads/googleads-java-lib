...
public class RateCard  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.axis.v201311.RateCardStatus status;
    ...
    public RateCard(
           ...
           com.google.api.ads.dfp.axis.v201311.RateCardStatus status,
           long[] appliedTeamIds,
     ...
     *                 created in the {@link RateCardStatus#INACTIVE} state.
     */
    public com.google.api.ads.dfp.axis.v201311.RateCardStatus getStatus() {
        return status;
    }
     ...
     *                 created in the {@link RateCardStatus#INACTIVE} state.
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201311.RateCardStatus status) {
        this.status = status;
    }
