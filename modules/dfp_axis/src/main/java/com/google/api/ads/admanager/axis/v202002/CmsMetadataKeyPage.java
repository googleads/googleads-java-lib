 ...
 */
public class CmsMetadataKeyPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v202002.CmsMetadataKey>{
    private java.lang.Integer totalResultSetSize;

    private java.lang.Integer startIndex;

    private com.google.api.ads.admanager.axis.v202002.CmsMetadataKey[] results;
    ...
    public CmsMetadataKeyPage(
           ...
           com.google.api.ads.admanager.axis.v202002.CmsMetadataKey[] results) {
     ...
     * @return results
     */
    public com.google.api.ads.admanager.axis.v202002.CmsMetadataKey[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(com.google.api.ads.admanager.axis.v202002.CmsMetadataKey[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v202002.CmsMetadataKey getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v202002.CmsMetadataKey _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v202002.CmsMetadataKey> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v202002.CmsMetadataKey>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v202002.CmsMetadataKey>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202002", "CmsMetadataKeyPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202002", "CmsMetadataKey"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
