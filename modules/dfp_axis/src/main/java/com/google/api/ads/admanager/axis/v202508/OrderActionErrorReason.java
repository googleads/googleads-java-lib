...
public class OrderActionErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_UPDATE_ORDER_OVER_LINE_ITEM_LIMIT = "CANNOT_UPDATE_ORDER_OVER_LINE_ITEM_LIMIT";
    ...
    public static final OrderActionErrorReason CANNOT_UPDATE_ORDER_OVER_LINE_ITEM_LIMIT = new OrderActionErrorReason(_CANNOT_UPDATE_ORDER_OVER_LINE_ITEM_LIMIT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202508", "OrderActionError.Reason"));
    }
    /**
