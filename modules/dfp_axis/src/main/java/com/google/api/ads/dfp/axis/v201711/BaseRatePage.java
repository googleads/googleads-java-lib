 ...
 */
public class BaseRatePage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201711.BaseRate>{
    /* The collection of base rates contained within this page. */
    private com.google.api.ads.dfp.axis.v201711.BaseRate[] results;
    ...
    public BaseRatePage(
           com.google.api.ads.dfp.axis.v201711.BaseRate[] results,
     ...
     */
    public com.google.api.ads.dfp.axis.v201711.BaseRate[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201711.BaseRate[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201711.BaseRate getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201711.BaseRate _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201711.BaseRate> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201711.BaseRate>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201711.BaseRate>asList(results).iterator();
    }
