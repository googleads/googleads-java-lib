...
public class LineItemCreativeAssociationErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _UNSUPPORTED_CREATIVE_VAST_REDIRECT_TYPE = "UNSUPPORTED_CREATIVE_VAST_REDIRECT_TYPE";
    public static final java.lang.String _UNSUPPORTED_YOUTUBE_HOSTED_CREATIVE = "UNSUPPORTED_YOUTUBE_HOSTED_CREATIVE";
    ...
    public static final java.lang.String _CANNOT_ACTIVATE_ASSOCIATION_WITH_INACTIVE_CREATIVE = "CANNOT_ACTIVATE_ASSOCIATION_WITH_INACTIVE_CREATIVE";
    ...
    public static final java.lang.String _CLICK_MACROS_REQUIRED = "CLICK_MACROS_REQUIRED";
    public static final java.lang.String _VIEW_MACROS_NOT_ALLOWED = "VIEW_MACROS_NOT_ALLOWED";
    public static final java.lang.String _CREATIVE_SKIPPABILITY_MISMATCH_WITH_LINE_ITEM = "CREATIVE_SKIPPABILITY_MISMATCH_WITH_LINE_ITEM";
    public static final java.lang.String _CREATIVE_BUYER_PLACEMENT_ID_REQUIRED = "CREATIVE_BUYER_PLACEMENT_ID_REQUIRED";
    ...
    public static final LineItemCreativeAssociationErrorReason UNSUPPORTED_CREATIVE_VAST_REDIRECT_TYPE = new LineItemCreativeAssociationErrorReason(_UNSUPPORTED_CREATIVE_VAST_REDIRECT_TYPE);
    public static final LineItemCreativeAssociationErrorReason UNSUPPORTED_YOUTUBE_HOSTED_CREATIVE = new LineItemCreativeAssociationErrorReason(_UNSUPPORTED_YOUTUBE_HOSTED_CREATIVE);
    ...
    public static final LineItemCreativeAssociationErrorReason CANNOT_ACTIVATE_ASSOCIATION_WITH_INACTIVE_CREATIVE = new LineItemCreativeAssociationErrorReason(_CANNOT_ACTIVATE_ASSOCIATION_WITH_INACTIVE_CREATIVE);
    ...
    public static final LineItemCreativeAssociationErrorReason CLICK_MACROS_REQUIRED = new LineItemCreativeAssociationErrorReason(_CLICK_MACROS_REQUIRED);
    public static final LineItemCreativeAssociationErrorReason VIEW_MACROS_NOT_ALLOWED = new LineItemCreativeAssociationErrorReason(_VIEW_MACROS_NOT_ALLOWED);
    public static final LineItemCreativeAssociationErrorReason CREATIVE_SKIPPABILITY_MISMATCH_WITH_LINE_ITEM = new LineItemCreativeAssociationErrorReason(_CREATIVE_SKIPPABILITY_MISMATCH_WITH_LINE_ITEM);
    public static final LineItemCreativeAssociationErrorReason CREATIVE_BUYER_PLACEMENT_ID_REQUIRED = new LineItemCreativeAssociationErrorReason(_CREATIVE_BUYER_PLACEMENT_ID_REQUIRED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202511", "LineItemCreativeAssociationError.Reason"));
    }
    /**
