 ...
 */
public class UserPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201905.User>{
    ...
    private com.google.api.ads.admanager.axis.v201905.User[] results;
    ...
    public UserPage(
           ...
           com.google.api.ads.admanager.axis.v201905.User[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201905.User[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201905.User[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201905.User getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201905.User _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201905.User> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201905.User>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201905.User>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201905", "UserPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201905", "User"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
