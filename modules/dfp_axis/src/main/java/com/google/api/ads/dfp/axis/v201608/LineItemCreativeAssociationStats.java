...
public class LineItemCreativeAssociationStats  implements java.io.Serializable {
     ...
     * associations. */
    private com.google.api.ads.dfp.axis.v201608.Long_StatsMapEntry[] creativeSetStats;

    /* The revenue generated thus far by the creative from its association
     * with
     *                 the particular line item in the publisher's currency. */
    private com.google.api.ads.dfp.axis.v201608.Money costInOrderCurrency;
    ...
    public LineItemCreativeAssociationStats(
           ...
           com.google.api.ads.dfp.axis.v201608.Long_StatsMapEntry[] creativeSetStats,
           com.google.api.ads.dfp.axis.v201608.Money costInOrderCurrency) {
           this.stats = stats;
     ...
     * associations.
     */
    public com.google.api.ads.dfp.axis.v201608.Long_StatsMapEntry[] getCreativeSetStats() {
     ...
     * associations.
     */
    public void setCreativeSetStats(com.google.api.ads.dfp.axis.v201608.Long_StatsMapEntry[] creativeSetStats) {
        this.creativeSetStats = creativeSetStats;
    }

    public com.google.api.ads.dfp.axis.v201608.Long_StatsMapEntry getCreativeSetStats(int i) {
        return this.creativeSetStats[i];
    }

    public void setCreativeSetStats(int i, com.google.api.ads.dfp.axis.v201608.Long_StatsMapEntry _value) {
     ...
     *                 the particular line item in the publisher's currency.
     */
    public com.google.api.ads.dfp.axis.v201608.Money getCostInOrderCurrency() {
     ...
     *                 the particular line item in the publisher's currency.
     */
    public void setCostInOrderCurrency(com.google.api.ads.dfp.axis.v201608.Money costInOrderCurrency) {
        this.costInOrderCurrency = costInOrderCurrency;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201608", "LineItemCreativeAssociationStats"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201608", "creativeSetStats"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201608", "Long_StatsMapEntry"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201608", "costInOrderCurrency"));
