...
public class ContactServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201508.ContactService {
    ...
    private java.lang.String ContactServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v201508/ContactService";
    ...
    public com.google.api.ads.dfp.axis.v201508.ContactServiceInterface getContactServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201508.ContactServiceInterface getContactServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201508.ContactServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201508.ContactServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201508.ContactServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201508.ContactServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201508.ContactServiceSoapBindingStub(new java.net.URL(ContactServiceInterfacePort_address), this);
                _stub.setPortName(getContactServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201508", "ContactService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201508", "ContactServiceInterfacePort"));
        }
