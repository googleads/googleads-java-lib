...
public class DeviceCategoryTargeting  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.axis.v201208.Technology[] targetedDeviceCategories;

    /* Device categories that are being excluded by the {@link LineItem}. */
    private com.google.api.ads.dfp.axis.v201208.Technology[] excludedDeviceCategories;

    public DeviceCategoryTargeting() {
    }

    public DeviceCategoryTargeting(
           com.google.api.ads.dfp.axis.v201208.Technology[] targetedDeviceCategories,
           com.google.api.ads.dfp.axis.v201208.Technology[] excludedDeviceCategories) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201208.Technology[] getTargetedDeviceCategories() {
     ...
     */
    public void setTargetedDeviceCategories(com.google.api.ads.dfp.axis.v201208.Technology[] targetedDeviceCategories) {
        this.targetedDeviceCategories = targetedDeviceCategories;
    }

    public com.google.api.ads.dfp.axis.v201208.Technology getTargetedDeviceCategories(int i) {
        return this.targetedDeviceCategories[i];
    }

    public void setTargetedDeviceCategories(int i, com.google.api.ads.dfp.axis.v201208.Technology _value) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201208.Technology[] getExcludedDeviceCategories() {
     ...
     */
    public void setExcludedDeviceCategories(com.google.api.ads.dfp.axis.v201208.Technology[] excludedDeviceCategories) {
        this.excludedDeviceCategories = excludedDeviceCategories;
    }

    public com.google.api.ads.dfp.axis.v201208.Technology getExcludedDeviceCategories(int i) {
        return this.excludedDeviceCategories[i];
    }

    public void setExcludedDeviceCategories(int i, com.google.api.ads.dfp.axis.v201208.Technology _value) {
