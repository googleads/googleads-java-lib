 ...
 */
public class CompanyPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.Company>{
    ...
    private com.google.api.ads.admanager.axis.v201802.Company[] results;
    ...
    public CompanyPage(
           ...
           com.google.api.ads.admanager.axis.v201802.Company[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.Company[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.Company[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.Company getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.Company _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.Company> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.Company>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.Company>asList(results).iterator();
    }
