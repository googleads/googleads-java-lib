...
public class VideoAdTagErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _DUPLICATE_AD_TAG_PARAMETER = "DUPLICATE_AD_TAG_PARAMETER";
    ...
    public static final VideoAdTagErrorReason DUPLICATE_AD_TAG_PARAMETER = new VideoAdTagErrorReason(_DUPLICATE_AD_TAG_PARAMETER);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202511", "VideoAdTagError.Reason"));
    }
    /**
