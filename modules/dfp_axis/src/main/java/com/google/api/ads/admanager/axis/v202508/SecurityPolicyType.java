...
public class SecurityPolicyType implements java.io.Serializable {
    ...
    public static final java.lang.String _CLOUD_MEDIA = "CLOUD_MEDIA";
    ...
    public static final SecurityPolicyType CLOUD_MEDIA = new SecurityPolicyType(_CLOUD_MEDIA);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202508", "SecurityPolicyType"));
    }
    /**
