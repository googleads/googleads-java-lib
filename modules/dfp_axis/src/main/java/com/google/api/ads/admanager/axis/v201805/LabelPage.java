 ...
 */
public class LabelPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201805.Label>{
    ...
    private com.google.api.ads.admanager.axis.v201805.Label[] results;
    ...
    public LabelPage(
           ...
           com.google.api.ads.admanager.axis.v201805.Label[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201805.Label[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201805.Label[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201805.Label getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201805.Label _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201805.Label> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201805.Label>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201805.Label>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201805", "LabelPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201805", "Label"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
