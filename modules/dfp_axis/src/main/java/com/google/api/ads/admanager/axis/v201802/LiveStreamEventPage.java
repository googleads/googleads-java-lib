 ...
 */
public class LiveStreamEventPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.LiveStreamEvent>{
     ...
     * page. */
    private com.google.api.ads.admanager.axis.v201802.LiveStreamEvent[] results;
    ...
    public LiveStreamEventPage(
           ...
           com.google.api.ads.admanager.axis.v201802.LiveStreamEvent[] results) {
     ...
     * page.
     */
    public com.google.api.ads.admanager.axis.v201802.LiveStreamEvent[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.LiveStreamEvent[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.LiveStreamEvent getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.LiveStreamEvent _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.LiveStreamEvent> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.LiveStreamEvent>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.LiveStreamEvent>asList(results).iterator();
    }
