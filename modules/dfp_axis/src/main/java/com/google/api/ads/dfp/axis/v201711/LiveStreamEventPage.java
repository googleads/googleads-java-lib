 ...
 */
public class LiveStreamEventPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201711.LiveStreamEvent>{
     ...
     * page. */
    private com.google.api.ads.dfp.axis.v201711.LiveStreamEvent[] results;
    ...
    public LiveStreamEventPage(
           ...
           com.google.api.ads.dfp.axis.v201711.LiveStreamEvent[] results) {
     ...
     * page.
     */
    public com.google.api.ads.dfp.axis.v201711.LiveStreamEvent[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.dfp.axis.v201711.LiveStreamEvent[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201711.LiveStreamEvent getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201711.LiveStreamEvent _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201711.LiveStreamEvent> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201711.LiveStreamEvent>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201711.LiveStreamEvent>asList(results).iterator();
    }
