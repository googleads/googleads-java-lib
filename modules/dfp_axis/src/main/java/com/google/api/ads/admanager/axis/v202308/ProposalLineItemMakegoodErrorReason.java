...
public class ProposalLineItemMakegoodErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _MAKEGOODS_NOT_SUPPORTED_FOR_COST_TYPE = "MAKEGOODS_NOT_SUPPORTED_FOR_COST_TYPE";
    ...
    public static final ProposalLineItemMakegoodErrorReason MAKEGOODS_NOT_SUPPORTED_FOR_COST_TYPE = new ProposalLineItemMakegoodErrorReason(_MAKEGOODS_NOT_SUPPORTED_FOR_COST_TYPE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202308", "ProposalLineItemMakegoodError.Reason"));
    }
    /**
