...
public class DeliveryForecast  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.axis.v201805.LineItemDeliveryForecast[] lineItemDeliveryForecasts;

    public DeliveryForecast() {
    }

    public DeliveryForecast(
           com.google.api.ads.dfp.axis.v201805.LineItemDeliveryForecast[] lineItemDeliveryForecasts) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201805.LineItemDeliveryForecast[] getLineItemDeliveryForecasts() {
     ...
     */
    public void setLineItemDeliveryForecasts(com.google.api.ads.dfp.axis.v201805.LineItemDeliveryForecast[] lineItemDeliveryForecasts) {
        this.lineItemDeliveryForecasts = lineItemDeliveryForecasts;
    }

    public com.google.api.ads.dfp.axis.v201805.LineItemDeliveryForecast getLineItemDeliveryForecasts(int i) {
        return this.lineItemDeliveryForecasts[i];
    }

    public void setLineItemDeliveryForecasts(int i, com.google.api.ads.dfp.axis.v201805.LineItemDeliveryForecast _value) {
