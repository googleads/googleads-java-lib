...
public class ForecastAdjustmentErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _AD_REQUEST_ADJUSTMENT_MUST_USE_PARENT_SEGMENT_TARGETING = "AD_REQUEST_ADJUSTMENT_MUST_USE_PARENT_SEGMENT_TARGETING";
    ...
    public static final ForecastAdjustmentErrorReason AD_REQUEST_ADJUSTMENT_MUST_USE_PARENT_SEGMENT_TARGETING = new ForecastAdjustmentErrorReason(_AD_REQUEST_ADJUSTMENT_MUST_USE_PARENT_SEGMENT_TARGETING);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202505", "ForecastAdjustmentError.Reason"));
    }
    /**
