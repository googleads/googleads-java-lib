...
public class CrossSellErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _UNSUPPORTED_RESERVATION_TYPE = "UNSUPPORTED_RESERVATION_TYPE";
    public static final java.lang.String _NO_VALID_ELIGIBLE_RESERVATION_TYPES = "NO_VALID_ELIGIBLE_RESERVATION_TYPES";
    ...
    public static final CrossSellErrorReason UNSUPPORTED_RESERVATION_TYPE = new CrossSellErrorReason(_UNSUPPORTED_RESERVATION_TYPE);
    public static final CrossSellErrorReason NO_VALID_ELIGIBLE_RESERVATION_TYPES = new CrossSellErrorReason(_NO_VALID_ELIGIBLE_RESERVATION_TYPES);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201602", "CrossSellError.Reason"));
    }
    /**
