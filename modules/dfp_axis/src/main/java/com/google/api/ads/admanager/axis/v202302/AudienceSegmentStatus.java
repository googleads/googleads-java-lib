...
public class AudienceSegmentStatus implements java.io.Serializable {
    ...
    public static final AudienceSegmentStatus UNKNOWN = new AudienceSegmentStatus(_UNKNOWN);
    ...
    public static final AudienceSegmentStatus UNUSED = new AudienceSegmentStatus(_UNUSED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202302", "AudienceSegment.Status"));
    }
    /**
