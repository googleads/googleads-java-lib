...
public class ProposalLineItemErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _START_DATE_TIME_TOO_LATE_IN_MONTH = "START_DATE_TIME_TOO_LATE_IN_MONTH";
    ...
    public static final java.lang.String _NO_WEB_PROPERTY_FOR_TARGETED_REQUEST_PLATFORM = "NO_WEB_PROPERTY_FOR_TARGETED_REQUEST_PLATFORM";
    ...
    public static final java.lang.String _CROSS_SELL_TARGETING_UNSUPPORTED = "CROSS_SELL_TARGETING_UNSUPPORTED";
    public static final java.lang.String _CANNOT_SET_VIDEO_DURATION_ON_NON_VIDEO_DEAL = "CANNOT_SET_VIDEO_DURATION_ON_NON_VIDEO_DEAL";
    public static final java.lang.String _UPDATE_VIDEO_CREATIVE_SKIPPABILITY_NOT_ALLOWED = "UPDATE_VIDEO_CREATIVE_SKIPPABILITY_NOT_ALLOWED";
    public static final java.lang.String _UPDATE_VIDEO_CREATIVE_FIELDS_NOT_ALLOWED = "UPDATE_VIDEO_CREATIVE_FIELDS_NOT_ALLOWED";
    ...
    public static final ProposalLineItemErrorReason START_DATE_TIME_TOO_LATE_IN_MONTH = new ProposalLineItemErrorReason(_START_DATE_TIME_TOO_LATE_IN_MONTH);
    ...
    public static final ProposalLineItemErrorReason ALL_COMPANION_DELIVERY_NOT_ALLOWED = new ProposalLineItemErrorReason(_ALL_COMPANION_DELIVERY_NOT_ALLOWED);
    ...
    public static final ProposalLineItemErrorReason NO_WEB_PROPERTY_FOR_TARGETED_REQUEST_PLATFORM = new ProposalLineItemErrorReason(_NO_WEB_PROPERTY_FOR_TARGETED_REQUEST_PLATFORM);
    ...
    public static final ProposalLineItemErrorReason SKIPPABLE_AD_TYPE_NOT_ALLOWED = new ProposalLineItemErrorReason(_SKIPPABLE_AD_TYPE_NOT_ALLOWED);
    public static final ProposalLineItemErrorReason CROSS_SELL_TARGETING_UNSUPPORTED = new ProposalLineItemErrorReason(_CROSS_SELL_TARGETING_UNSUPPORTED);
    public static final ProposalLineItemErrorReason CANNOT_SET_VIDEO_DURATION_ON_NON_VIDEO_DEAL = new ProposalLineItemErrorReason(_CANNOT_SET_VIDEO_DURATION_ON_NON_VIDEO_DEAL);
    public static final ProposalLineItemErrorReason UPDATE_VIDEO_CREATIVE_SKIPPABILITY_NOT_ALLOWED = new ProposalLineItemErrorReason(_UPDATE_VIDEO_CREATIVE_SKIPPABILITY_NOT_ALLOWED);
    public static final ProposalLineItemErrorReason UPDATE_VIDEO_CREATIVE_FIELDS_NOT_ALLOWED = new ProposalLineItemErrorReason(_UPDATE_VIDEO_CREATIVE_FIELDS_NOT_ALLOWED);
    public static final ProposalLineItemErrorReason INVALID_LINE_ITEM_TYPE_FOR_ALLOCATION_DELIVERY_PROFILE = new ProposalLineItemErrorReason(_INVALID_LINE_ITEM_TYPE_FOR_ALLOCATION_DELIVERY_PROFILE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202602", "ProposalLineItemError.Reason"));
    }
    /**
