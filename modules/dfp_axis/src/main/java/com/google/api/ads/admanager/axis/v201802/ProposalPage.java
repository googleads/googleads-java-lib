 ...
 */
public class ProposalPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.Proposal>{
    ...
    private com.google.api.ads.admanager.axis.v201802.Proposal[] results;
    ...
    public ProposalPage(
           ...
           com.google.api.ads.admanager.axis.v201802.Proposal[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.Proposal[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.Proposal[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.Proposal getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.Proposal _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.Proposal> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.Proposal>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.Proposal>asList(results).iterator();
    }
