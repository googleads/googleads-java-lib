 ...
 */
public class SavedQueryPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.SavedQuery>{
    ...
    private com.google.api.ads.admanager.axis.v201802.SavedQuery[] results;
    ...
    public SavedQueryPage(
           ...
           com.google.api.ads.admanager.axis.v201802.SavedQuery[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.SavedQuery[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.SavedQuery[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.SavedQuery getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.SavedQuery _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.SavedQuery> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.SavedQuery>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.SavedQuery>asList(results).iterator();
    }
