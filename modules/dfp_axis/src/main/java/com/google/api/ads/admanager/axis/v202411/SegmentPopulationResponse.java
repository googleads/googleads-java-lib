...
public class SegmentPopulationResponse  implements java.io.Serializable {
    ...
    public SegmentPopulationResponse(
           ...
           com.google.api.ads.admanager.axis.v202411.IdError[] idErrors) {
    ...
    public com.google.api.ads.admanager.axis.v202411.IdError getIdErrors(int i) {
        return this.idErrors[i];
    }

    public void setIdErrors(int i, com.google.api.ads.admanager.axis.v202411.IdError _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "SegmentPopulationResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "idErrors"));
