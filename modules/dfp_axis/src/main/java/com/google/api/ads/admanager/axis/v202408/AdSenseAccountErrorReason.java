...
public class AdSenseAccountErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_ACCESS_INVALID_ACCOUNT = "CANNOT_ACCESS_INVALID_ACCOUNT";
    public static final java.lang.String _ACCOUNT_ACCESS_DENIED = "ACCOUNT_ACCESS_DENIED";
    ...
    public static final AdSenseAccountErrorReason CANNOT_ACCESS_INVALID_ACCOUNT = new AdSenseAccountErrorReason(_CANNOT_ACCESS_INVALID_ACCOUNT);
    public static final AdSenseAccountErrorReason ACCOUNT_ACCESS_DENIED = new AdSenseAccountErrorReason(_ACCOUNT_ACCESS_DENIED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202408", "AdSenseAccountError.Reason"));
    }
    /**
