...
public class ConversionEvent_TrackingUrlsMapEntry  implements java.io.Serializable {
    private com.google.api.ads.dfp.axis.v201411.ConversionEvent key;

    private com.google.api.ads.dfp.axis.v201411.TrackingUrls value;

    public ConversionEvent_TrackingUrlsMapEntry() {
    }

    public ConversionEvent_TrackingUrlsMapEntry(
           com.google.api.ads.dfp.axis.v201411.ConversionEvent key,
           com.google.api.ads.dfp.axis.v201411.TrackingUrls value) {
           this.key = key;
           this.value = value;
    }
     ...
     * @return key
     */
    public com.google.api.ads.dfp.axis.v201411.ConversionEvent getKey() {
        return key;
    }
     ...
     * @param key
     */
    public void setKey(com.google.api.ads.dfp.axis.v201411.ConversionEvent key) {
        this.key = key;
    }
     ...
     * @return value
     */
    public com.google.api.ads.dfp.axis.v201411.TrackingUrls getValue() {
        return value;
    }
     ...
     * @param value
     */
    public void setValue(com.google.api.ads.dfp.axis.v201411.TrackingUrls value) {
        this.value = value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201411", "ConversionEvent_TrackingUrlsMapEntry"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201411", "ConversionEvent"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201411", "TrackingUrls"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
