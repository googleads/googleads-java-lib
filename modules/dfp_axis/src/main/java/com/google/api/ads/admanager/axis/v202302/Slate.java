...
public class Slate  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v202302.SlateStatus status;

    /* Server side transcoding status of the current slate. */
    private com.google.api.ads.admanager.axis.v202302.TranscodeStatus transcodeStatus;
    ...
    public Slate(
           ...
           com.google.api.ads.admanager.axis.v202302.SlateStatus status,
           com.google.api.ads.admanager.axis.v202302.TranscodeStatus transcodeStatus,
     ...
     *                 are created in the {@link SlateStatus#ACTIVE} state.
     */
    public com.google.api.ads.admanager.axis.v202302.SlateStatus getStatus() {
        return status;
    }
     ...
     *                 are created in the {@link SlateStatus#ACTIVE} state.
     */
    public void setStatus(com.google.api.ads.admanager.axis.v202302.SlateStatus status) {
        this.status = status;
    }
     ...
     */
    public com.google.api.ads.admanager.axis.v202302.TranscodeStatus getTranscodeStatus() {
     ...
     */
    public void setTranscodeStatus(com.google.api.ads.admanager.axis.v202302.TranscodeStatus transcodeStatus) {
        this.transcodeStatus = transcodeStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202302", "Slate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202302", "SlateStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("transcodeStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202302", "transcodeStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202302", "TranscodeStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("videoSourceUrl");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202302", "videoSourceUrl"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
