...
public class LineItemOperationErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_ACTIVATE_UNCONFIGURED_LINE_ITEM = "CANNOT_ACTIVATE_UNCONFIGURED_LINE_ITEM";
    ...
    public static final LineItemOperationErrorReason CANNOT_ACTIVATE_UNCONFIGURED_LINE_ITEM = new LineItemOperationErrorReason(_CANNOT_ACTIVATE_UNCONFIGURED_LINE_ITEM);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201808", "LineItemOperationError.Reason"));
    }
    /**
