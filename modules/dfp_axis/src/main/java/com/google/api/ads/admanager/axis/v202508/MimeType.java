...
public class MimeType implements java.io.Serializable {
    ...
    public static final java.lang.String _VIDEO_MP2T = "VIDEO_MP2T";
    ...
    public static final MimeType VIDEO_MP2T = new MimeType(_VIDEO_MP2T);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202508", "MimeType"));
    }
    /**
