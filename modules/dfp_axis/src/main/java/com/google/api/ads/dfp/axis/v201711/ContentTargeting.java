...
public class ContentTargeting  implements java.io.Serializable {
     ...
     * targeted by the {@code LineItem}. */
    private com.google.api.ads.dfp.axis.v201711.ContentMetadataKeyHierarchyTargeting[] targetedContentMetadata;

    /* A list of content metadata within hierarchies that are being
     * excluded by the {@code LineItem}. */
    private com.google.api.ads.dfp.axis.v201711.ContentMetadataKeyHierarchyTargeting[] excludedContentMetadata;
    ...
    public ContentTargeting(
           ...
           com.google.api.ads.dfp.axis.v201711.ContentMetadataKeyHierarchyTargeting[] targetedContentMetadata,
           com.google.api.ads.dfp.axis.v201711.ContentMetadataKeyHierarchyTargeting[] excludedContentMetadata) {
     ...
     * targeted by the {@code LineItem}.
     */
    public com.google.api.ads.dfp.axis.v201711.ContentMetadataKeyHierarchyTargeting[] getTargetedContentMetadata() {
     ...
     * targeted by the {@code LineItem}.
     */
    public void setTargetedContentMetadata(com.google.api.ads.dfp.axis.v201711.ContentMetadataKeyHierarchyTargeting[] targetedContentMetadata) {
        this.targetedContentMetadata = targetedContentMetadata;
    }

    public com.google.api.ads.dfp.axis.v201711.ContentMetadataKeyHierarchyTargeting getTargetedContentMetadata(int i) {
        return this.targetedContentMetadata[i];
    }

    public void setTargetedContentMetadata(int i, com.google.api.ads.dfp.axis.v201711.ContentMetadataKeyHierarchyTargeting _value) {
     ...
     * excluded by the {@code LineItem}.
     */
    public com.google.api.ads.dfp.axis.v201711.ContentMetadataKeyHierarchyTargeting[] getExcludedContentMetadata() {
     ...
     * excluded by the {@code LineItem}.
     */
    public void setExcludedContentMetadata(com.google.api.ads.dfp.axis.v201711.ContentMetadataKeyHierarchyTargeting[] excludedContentMetadata) {
        this.excludedContentMetadata = excludedContentMetadata;
    }

    public com.google.api.ads.dfp.axis.v201711.ContentMetadataKeyHierarchyTargeting getExcludedContentMetadata(int i) {
        return this.excludedContentMetadata[i];
    }

    public void setExcludedContentMetadata(int i, com.google.api.ads.dfp.axis.v201711.ContentMetadataKeyHierarchyTargeting _value) {
