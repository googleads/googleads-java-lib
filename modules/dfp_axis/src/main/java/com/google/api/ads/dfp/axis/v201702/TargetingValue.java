 ...
 */
public class TargetingValue  extends com.google.api.ads.dfp.axis.v201702.ObjectValue  implements java.io.Serializable {
    /* The {@code Targeting} value. */
    private com.google.api.ads.dfp.axis.v201702.Targeting value;

    public TargetingValue() {
    }

    public TargetingValue(
           com.google.api.ads.dfp.axis.v201702.Targeting value) {
        this.value = value;
    }
     ...
     */
    public com.google.api.ads.dfp.axis.v201702.Targeting getValue() {
        return value;
    }
     ...
     */
    public void setValue(com.google.api.ads.dfp.axis.v201702.Targeting value) {
        this.value = value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201702", "TargetingValue"));
