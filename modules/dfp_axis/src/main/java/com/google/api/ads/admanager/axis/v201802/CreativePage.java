 ...
 */
public class CreativePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.Creative>{
    ...
    private com.google.api.ads.admanager.axis.v201802.Creative[] results;
    ...
    public CreativePage(
           ...
           com.google.api.ads.admanager.axis.v201802.Creative[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.Creative[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.Creative[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.Creative getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.Creative _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.Creative> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.Creative>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.Creative>asList(results).iterator();
    }
