...
public class AdUnitSize  implements java.io.Serializable {
     ...
     *                 results in an error. */
    private com.google.api.ads.dfp.axis.v201605.AdUnitSize[] companions;
    ...
    public AdUnitSize(
           ...
           com.google.api.ads.dfp.axis.v201605.AdUnitSize[] companions,
     ...
     *                 results in an error.
     */
    public com.google.api.ads.dfp.axis.v201605.AdUnitSize[] getCompanions() {
        return companions;
    }
     ...
     *                 results in an error.
     */
    public void setCompanions(com.google.api.ads.dfp.axis.v201605.AdUnitSize[] companions) {
        this.companions = companions;
    }

    public com.google.api.ads.dfp.axis.v201605.AdUnitSize getCompanions(int i) {
        return this.companions[i];
    }

    public void setCompanions(int i, com.google.api.ads.dfp.axis.v201605.AdUnitSize _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201605", "AdUnitSize"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201605", "fullDisplayString"));
