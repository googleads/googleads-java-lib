...
public class YieldGroupPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v202211.YieldGroup>{
    private java.lang.Integer totalResultSetSize;

    private java.lang.Integer startIndex;

    private com.google.api.ads.admanager.axis.v202211.YieldGroup[] results;
    ...
    public YieldGroupPage(
           ...
           com.google.api.ads.admanager.axis.v202211.YieldGroup[] results) {
     ...
     * @return results
     */
    public com.google.api.ads.admanager.axis.v202211.YieldGroup[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(com.google.api.ads.admanager.axis.v202211.YieldGroup[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v202211.YieldGroup getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v202211.YieldGroup _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v202211.YieldGroup> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v202211.YieldGroup>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v202211.YieldGroup>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202211", "YieldGroupPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202211", "YieldGroup"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
