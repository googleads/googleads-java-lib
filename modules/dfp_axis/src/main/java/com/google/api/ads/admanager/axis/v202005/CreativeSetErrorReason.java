...
public class CreativeSetErrorReason implements java.io.Serializable {
    ...
    public static final CreativeSetErrorReason SKIPPABLE_AD_TYPE_NOT_ALLOWED = new CreativeSetErrorReason(_SKIPPABLE_AD_TYPE_NOT_ALLOWED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202005", "CreativeSetError.Reason"));
    }
    /**
