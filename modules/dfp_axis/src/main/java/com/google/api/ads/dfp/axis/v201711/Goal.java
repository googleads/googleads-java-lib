...
public class Goal  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.axis.v201711.GoalType goalType;
    ...
    public Goal(
           com.google.api.ads.dfp.axis.v201711.GoalType goalType,
     ...
     *                 for {@code LineItem} should be reached.
     */
    public com.google.api.ads.dfp.axis.v201711.GoalType getGoalType() {
        return goalType;
    }
     ...
     *                 for {@code LineItem} should be reached.
     */
    public void setGoalType(com.google.api.ads.dfp.axis.v201711.GoalType goalType) {
        this.goalType = goalType;
    }
