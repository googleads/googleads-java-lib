...
public class ForecastErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _OUTSIDE_AVAILABLE_DATE_RANGE = "OUTSIDE_AVAILABLE_DATE_RANGE";
    ...
    public static final ForecastErrorReason OUTSIDE_AVAILABLE_DATE_RANGE = new ForecastErrorReason(_OUTSIDE_AVAILABLE_DATE_RANGE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202305", "ForecastError.Reason"));
    }
    /**
