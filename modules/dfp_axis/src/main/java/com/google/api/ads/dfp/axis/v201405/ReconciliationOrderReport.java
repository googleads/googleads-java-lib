...
public class ReconciliationOrderReport  implements java.io.Serializable {
     ...
     *                 This value is read-only. */
    private com.google.api.ads.dfp.axis.v201405.ReconciliationOrderReportStatus status;

    /* The time when this order report is submitted.
     *                 This value is read-only. */
    private com.google.api.ads.dfp.axis.v201405.DateTime submissionDateTime;
    ...
    public ReconciliationOrderReport(
           ...
           com.google.api.ads.dfp.axis.v201405.ReconciliationOrderReportStatus status,
           com.google.api.ads.dfp.axis.v201405.DateTime submissionDateTime,
     ...
     *                 This value is read-only.
     */
    public com.google.api.ads.dfp.axis.v201405.ReconciliationOrderReportStatus getStatus() {
        return status;
    }
     ...
     *                 This value is read-only.
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201405.ReconciliationOrderReportStatus status) {
        this.status = status;
    }
     ...
     *                 This value is read-only.
     */
    public com.google.api.ads.dfp.axis.v201405.DateTime getSubmissionDateTime() {
     ...
     *                 This value is read-only.
     */
    public void setSubmissionDateTime(com.google.api.ads.dfp.axis.v201405.DateTime submissionDateTime) {
        this.submissionDateTime = submissionDateTime;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201405", "ReconciliationOrderReport"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201405", "ReconciliationOrderReportStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("submissionDateTime");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201405", "submissionDateTime"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201405", "submitterId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
