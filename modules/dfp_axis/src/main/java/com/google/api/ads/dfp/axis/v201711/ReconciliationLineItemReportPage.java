 ...
 */
public class ReconciliationLineItemReportPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201711.ReconciliationLineItemReport>{
    /* The collection of {@link ReconciliationLineItemReport} objects
     * contained in this page. */
    private com.google.api.ads.dfp.axis.v201711.ReconciliationLineItemReport[] results;
    ...
    public ReconciliationLineItemReportPage(
           com.google.api.ads.dfp.axis.v201711.ReconciliationLineItemReport[] results,
     ...
     * contained in this page.
     */
    public com.google.api.ads.dfp.axis.v201711.ReconciliationLineItemReport[] getResults() {
        return results;
    }
     ...
     * contained in this page.
     */
    public void setResults(com.google.api.ads.dfp.axis.v201711.ReconciliationLineItemReport[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201711.ReconciliationLineItemReport getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201711.ReconciliationLineItemReport _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201711.ReconciliationLineItemReport> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201711.ReconciliationLineItemReport>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201711.ReconciliationLineItemReport>asList(results).iterator();
    }
