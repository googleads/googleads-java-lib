 ...
 */
public class SuggestedAdUnitPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201711.SuggestedAdUnit>{
     ...
     * page. */
    private com.google.api.ads.dfp.axis.v201711.SuggestedAdUnit[] results;
    ...
    public SuggestedAdUnitPage(
           ...
           com.google.api.ads.dfp.axis.v201711.SuggestedAdUnit[] results) {
     ...
     * page.
     */
    public com.google.api.ads.dfp.axis.v201711.SuggestedAdUnit[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.dfp.axis.v201711.SuggestedAdUnit[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201711.SuggestedAdUnit getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201711.SuggestedAdUnit _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201711.SuggestedAdUnit> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201711.SuggestedAdUnit>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201711.SuggestedAdUnit>asList(results).iterator();
    }
