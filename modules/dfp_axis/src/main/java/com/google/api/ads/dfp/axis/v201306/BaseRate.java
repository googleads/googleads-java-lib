...
public abstract class BaseRate  implements java.io.Serializable {
     ...
     * and is
     *                 assigned by Google. */
    private com.google.api.ads.dfp.axis.v201306.BaseRateStatus status;
     ...
     *                 assigned by Google.
     */
    public com.google.api.ads.dfp.axis.v201306.BaseRateStatus getStatus() {
        return status;
    }
     ...
     *                 assigned by Google.
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201306.BaseRateStatus status) {
        this.status = status;
    }
