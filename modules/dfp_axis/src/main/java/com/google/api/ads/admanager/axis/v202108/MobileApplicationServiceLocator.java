...
public class MobileApplicationServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.admanager.axis.v202108.MobileApplicationService {
    ...
    private java.lang.String MobileApplicationServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v202108/MobileApplicationService";
    ...
    public com.google.api.ads.admanager.axis.v202108.MobileApplicationServiceInterface getMobileApplicationServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.admanager.axis.v202108.MobileApplicationServiceInterface getMobileApplicationServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.admanager.axis.v202108.MobileApplicationServiceSoapBindingStub _stub = new com.google.api.ads.admanager.axis.v202108.MobileApplicationServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.admanager.axis.v202108.MobileApplicationServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.admanager.axis.v202108.MobileApplicationServiceSoapBindingStub _stub = new com.google.api.ads.admanager.axis.v202108.MobileApplicationServiceSoapBindingStub(new java.net.URL(MobileApplicationServiceInterfacePort_address), this);
                _stub.setPortName(getMobileApplicationServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202108", "MobileApplicationService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202108", "MobileApplicationServiceInterfacePort"));
        }
