...
public class TargetingDimension implements java.io.Serializable {
    ...
    public static final java.lang.String _FORECASTED_CREATIVE_RESTRICTION = "FORECASTED_CREATIVE_RESTRICTION";
    public static final java.lang.String _VERTICAL = "VERTICAL";
    public static final java.lang.String _CONTENT_LABEL = "CONTENT_LABEL";
    public static final java.lang.String _PUBLISHER_PROVIDED_SIGNALS = "PUBLISHER_PROVIDED_SIGNALS";
    ...
    public static final TargetingDimension FORECASTED_CREATIVE_RESTRICTION = new TargetingDimension(_FORECASTED_CREATIVE_RESTRICTION);
    public static final TargetingDimension VERTICAL = new TargetingDimension(_VERTICAL);
    public static final TargetingDimension CONTENT_LABEL = new TargetingDimension(_CONTENT_LABEL);
    public static final TargetingDimension PUBLISHER_PROVIDED_SIGNALS = new TargetingDimension(_PUBLISHER_PROVIDED_SIGNALS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202511", "TargetingDimension"));
    }
    /**
