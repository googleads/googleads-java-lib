...
public class ContentBundle  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.axis.v201306.ContentBundleStatus status;
    ...
    public ContentBundle(
           ...
           com.google.api.ads.dfp.axis.v201306.ContentBundleStatus status) {
           this.id = id;
           this.name = name;
     ...
     *                 defaults to {@link ContentBundleStatus#INACTIVE}.
     */
    public com.google.api.ads.dfp.axis.v201306.ContentBundleStatus getStatus() {
        return status;
    }
     ...
     *                 defaults to {@link ContentBundleStatus#INACTIVE}.
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201306.ContentBundleStatus status) {
        this.status = status;
    }
