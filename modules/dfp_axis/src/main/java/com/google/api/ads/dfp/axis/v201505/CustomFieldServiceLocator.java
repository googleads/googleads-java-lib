...
public class CustomFieldServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201505.CustomFieldService {
    ...
    private java.lang.String CustomFieldServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v201505/CustomFieldService";
    ...
    public com.google.api.ads.dfp.axis.v201505.CustomFieldServiceInterface getCustomFieldServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201505.CustomFieldServiceInterface getCustomFieldServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201505.CustomFieldServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201505.CustomFieldServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201505.CustomFieldServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201505.CustomFieldServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201505.CustomFieldServiceSoapBindingStub(new java.net.URL(CustomFieldServiceInterfacePort_address), this);
                _stub.setPortName(getCustomFieldServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "CustomFieldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "CustomFieldServiceInterfacePort"));
        }
