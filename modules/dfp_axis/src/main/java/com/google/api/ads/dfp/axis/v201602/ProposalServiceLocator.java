...
public class ProposalServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201602.ProposalService {
    ...
    private java.lang.String ProposalServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v201602/ProposalService";
    ...
    public com.google.api.ads.dfp.axis.v201602.ProposalServiceInterface getProposalServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201602.ProposalServiceInterface getProposalServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201602.ProposalServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201602.ProposalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201602.ProposalServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201602.ProposalServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201602.ProposalServiceSoapBindingStub(new java.net.URL(ProposalServiceInterfacePort_address), this);
                _stub.setPortName(getProposalServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201602", "ProposalService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201602", "ProposalServiceInterfacePort"));
        }
