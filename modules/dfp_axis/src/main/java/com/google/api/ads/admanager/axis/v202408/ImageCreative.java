 ...
 */
public class ImageCreative  extends com.google.api.ads.admanager.axis.v202408.BaseImageCreative  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v202408.CreativeAsset[] secondaryImageAssets;
    ...
    public ImageCreative(
           ...
           com.google.api.ads.admanager.axis.v202408.CreativeAsset[] secondaryImageAssets) {
        super(
            advertiserId,
            id,
            name,
     ...
     *                     asset for use on non-standard density screens.
     */
    public com.google.api.ads.admanager.axis.v202408.CreativeAsset[] getSecondaryImageAssets() {
     ...
     *                     asset for use on non-standard density screens.
     */
    public void setSecondaryImageAssets(com.google.api.ads.admanager.axis.v202408.CreativeAsset[] secondaryImageAssets) {
        this.secondaryImageAssets = secondaryImageAssets;
    }

    public com.google.api.ads.admanager.axis.v202408.CreativeAsset getSecondaryImageAssets(int i) {
        return this.secondaryImageAssets[i];
    }

    public void setSecondaryImageAssets(int i, com.google.api.ads.admanager.axis.v202408.CreativeAsset _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202408", "ImageCreative"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202408", "secondaryImageAssets"));
