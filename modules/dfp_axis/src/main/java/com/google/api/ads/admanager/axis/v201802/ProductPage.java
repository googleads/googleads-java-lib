 ...
 */
public class ProductPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.Product>{
    ...
    private com.google.api.ads.admanager.axis.v201802.Product[] results;
    ...
    public ProductPage(
           ...
           com.google.api.ads.admanager.axis.v201802.Product[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.Product[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.Product[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.Product getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.Product _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.Product> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.Product>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.Product>asList(results).iterator();
    }
