 ...
 */
public class ContentMetadataKeyHierarchyPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.ContentMetadataKeyHierarchy>{
     ...
     * within this page. */
    private com.google.api.ads.admanager.axis.v201802.ContentMetadataKeyHierarchy[] results;
    ...
    public ContentMetadataKeyHierarchyPage(
           ...
           com.google.api.ads.admanager.axis.v201802.ContentMetadataKeyHierarchy[] results) {
     ...
     * within this page.
     */
    public com.google.api.ads.admanager.axis.v201802.ContentMetadataKeyHierarchy[] getResults() {
        return results;
    }
     ...
     * within this page.
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.ContentMetadataKeyHierarchy[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.ContentMetadataKeyHierarchy getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.ContentMetadataKeyHierarchy _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.ContentMetadataKeyHierarchy> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.ContentMetadataKeyHierarchy>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.ContentMetadataKeyHierarchy>asList(results).iterator();
    }
