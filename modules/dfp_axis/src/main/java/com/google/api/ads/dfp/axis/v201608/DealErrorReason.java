...
public class DealErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _CAN_ONLY_EXECUTE_ON_DRAFT = "CAN_ONLY_EXECUTE_ON_DRAFT";
    ...
    public static final DealErrorReason CAN_ONLY_EXECUTE_ON_DRAFT = new DealErrorReason(_CAN_ONLY_EXECUTE_ON_DRAFT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201608", "DealError.Reason"));
    }
    /**
