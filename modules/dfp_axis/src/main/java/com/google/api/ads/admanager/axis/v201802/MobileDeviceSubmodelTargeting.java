...
public class MobileDeviceSubmodelTargeting  implements java.io.Serializable {
     ...
     * LineItem}. */
    private com.google.api.ads.admanager.axis.v201802.Technology[] targetedMobileDeviceSubmodels;

    /* Mobile device submodels that are being excluded by the {@link
     * LineItem}. */
    private com.google.api.ads.admanager.axis.v201802.Technology[] excludedMobileDeviceSubmodels;

    public MobileDeviceSubmodelTargeting() {
    }

    public MobileDeviceSubmodelTargeting(
           com.google.api.ads.admanager.axis.v201802.Technology[] targetedMobileDeviceSubmodels,
           com.google.api.ads.admanager.axis.v201802.Technology[] excludedMobileDeviceSubmodels) {
     ...
     * LineItem}.
     */
    public com.google.api.ads.admanager.axis.v201802.Technology[] getTargetedMobileDeviceSubmodels() {
     ...
     * LineItem}.
     */
    public void setTargetedMobileDeviceSubmodels(com.google.api.ads.admanager.axis.v201802.Technology[] targetedMobileDeviceSubmodels) {
        this.targetedMobileDeviceSubmodels = targetedMobileDeviceSubmodels;
    }

    public com.google.api.ads.admanager.axis.v201802.Technology getTargetedMobileDeviceSubmodels(int i) {
        return this.targetedMobileDeviceSubmodels[i];
    }

    public void setTargetedMobileDeviceSubmodels(int i, com.google.api.ads.admanager.axis.v201802.Technology _value) {
     ...
     * LineItem}.
     */
    public com.google.api.ads.admanager.axis.v201802.Technology[] getExcludedMobileDeviceSubmodels() {
     ...
     * LineItem}.
     */
    public void setExcludedMobileDeviceSubmodels(com.google.api.ads.admanager.axis.v201802.Technology[] excludedMobileDeviceSubmodels) {
        this.excludedMobileDeviceSubmodels = excludedMobileDeviceSubmodels;
    }

    public com.google.api.ads.admanager.axis.v201802.Technology getExcludedMobileDeviceSubmodels(int i) {
        return this.excludedMobileDeviceSubmodels[i];
    }

    public void setExcludedMobileDeviceSubmodels(int i, com.google.api.ads.admanager.axis.v201802.Technology _value) {
