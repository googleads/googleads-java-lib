 ...
 */
public class AdRulePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.AdRule>{
    ...
    private com.google.api.ads.admanager.axis.v201802.AdRule[] results;
    ...
    public AdRulePage(
           ...
           com.google.api.ads.admanager.axis.v201802.AdRule[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.AdRule[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.AdRule[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.AdRule getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.AdRule _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.AdRule> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.AdRule>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.AdRule>asList(results).iterator();
    }
