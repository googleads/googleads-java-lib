...
public class YieldIntegrationType implements java.io.Serializable {
    ...
    public static final java.lang.String _NETWORK_BIDDING = "NETWORK_BIDDING";
    ...
    public static final YieldIntegrationType NETWORK_BIDDING = new YieldIntegrationType(_NETWORK_BIDDING);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202302", "YieldIntegrationType"));
    }
    /**
