...
public class MobileApplicationPlatform implements java.io.Serializable {
    ...
    public static final MobileApplicationPlatform UNSUPPORTED = new MobileApplicationPlatform(_UNSUPPORTED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202605", "MobileApplicationPlatform"));
    }
    /**
