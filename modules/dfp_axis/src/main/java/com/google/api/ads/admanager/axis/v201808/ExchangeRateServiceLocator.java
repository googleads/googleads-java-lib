...
public class ExchangeRateServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.admanager.axis.v201808.ExchangeRateService {
    ...
    private java.lang.String ExchangeRateServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v201808/ExchangeRateService";
    ...
    public com.google.api.ads.admanager.axis.v201808.ExchangeRateServiceInterface getExchangeRateServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.admanager.axis.v201808.ExchangeRateServiceInterface getExchangeRateServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.admanager.axis.v201808.ExchangeRateServiceSoapBindingStub _stub = new com.google.api.ads.admanager.axis.v201808.ExchangeRateServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.admanager.axis.v201808.ExchangeRateServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.admanager.axis.v201808.ExchangeRateServiceSoapBindingStub _stub = new com.google.api.ads.admanager.axis.v201808.ExchangeRateServiceSoapBindingStub(new java.net.URL(ExchangeRateServiceInterfacePort_address), this);
                _stub.setPortName(getExchangeRateServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201808", "ExchangeRateService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201808", "ExchangeRateServiceInterfacePort"));
        }
