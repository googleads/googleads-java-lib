...
public class DateTime  implements java.io.Serializable {
    private com.google.api.ads.dfp.axis.v201302.Date date;
    ...
    public DateTime(
           com.google.api.ads.dfp.axis.v201302.Date date,
     ...
     * @return date
     */
    public com.google.api.ads.dfp.axis.v201302.Date getDate() {
        return date;
    }
     ...
     * @param date
     */
    public void setDate(com.google.api.ads.dfp.axis.v201302.Date date) {
        this.date = date;
    }
