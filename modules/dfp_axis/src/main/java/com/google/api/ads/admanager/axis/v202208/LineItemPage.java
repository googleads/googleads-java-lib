 ...
 */
public class LineItemPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v202208.LineItem>{
    ...
    private com.google.api.ads.admanager.axis.v202208.LineItem[] results;
    ...
    public LineItemPage(
           ...
           com.google.api.ads.admanager.axis.v202208.LineItem[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v202208.LineItem[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v202208.LineItem[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v202208.LineItem getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v202208.LineItem _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v202208.LineItem> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v202208.LineItem>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v202208.LineItem>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202208", "LineItemPage"));
