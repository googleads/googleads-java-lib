...
public abstract class WorkflowRequest  implements java.io.Serializable {
     ...
     * request. */
    private com.google.api.ads.dfp.axis.v201505.WorkflowEntityType entityType;

    /* The {@link WorkflowRequestType} of this workflow request. This
     * attribute is readonly and is
     *                 assigned by Google. */
    private com.google.api.ads.dfp.axis.v201505.WorkflowRequestType type;
    ...
    public WorkflowRequest(
           ...
           com.google.api.ads.dfp.axis.v201505.WorkflowEntityType entityType,
           com.google.api.ads.dfp.axis.v201505.WorkflowRequestType type) {
           this.id = id;
     ...
     * request.
     */
    public com.google.api.ads.dfp.axis.v201505.WorkflowEntityType getEntityType() {
        return entityType;
    }
     ...
     * request.
     */
    public void setEntityType(com.google.api.ads.dfp.axis.v201505.WorkflowEntityType entityType) {
        this.entityType = entityType;
    }
     ...
     *                 assigned by Google.
     */
    public com.google.api.ads.dfp.axis.v201505.WorkflowRequestType getType() {
        return type;
    }
     ...
     *                 assigned by Google.
     */
    public void setType(com.google.api.ads.dfp.axis.v201505.WorkflowRequestType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "WorkflowRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "workflowRuleName"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "entityId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "WorkflowEntityType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "WorkflowRequestType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
