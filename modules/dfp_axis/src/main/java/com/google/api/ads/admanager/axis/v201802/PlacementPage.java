 ...
 */
public class PlacementPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.Placement>{
    ...
    private com.google.api.ads.admanager.axis.v201802.Placement[] results;
    ...
    public PlacementPage(
           ...
           com.google.api.ads.admanager.axis.v201802.Placement[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.Placement[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.Placement[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.Placement getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.Placement _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.Placement> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.Placement>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.Placement>asList(results).iterator();
    }
