...
public class QuotaErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _REPORT_JOB_LIMIT = "REPORT_JOB_LIMIT";
    public static final java.lang.String _SEGMENT_POPULATION_LIMIT = "SEGMENT_POPULATION_LIMIT";
    ...
    public static final QuotaErrorReason REPORT_JOB_LIMIT = new QuotaErrorReason(_REPORT_JOB_LIMIT);
    public static final QuotaErrorReason SEGMENT_POPULATION_LIMIT = new QuotaErrorReason(_SEGMENT_POPULATION_LIMIT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202408", "QuotaError.Reason"));
    }
    /**
