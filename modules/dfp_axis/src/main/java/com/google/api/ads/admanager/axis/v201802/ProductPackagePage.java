 ...
 */
public class ProductPackagePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.ProductPackage>{
    ...
    private com.google.api.ads.admanager.axis.v201802.ProductPackage[] results;
    ...
    public ProductPackagePage(
           ...
           com.google.api.ads.admanager.axis.v201802.ProductPackage[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.ProductPackage[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.ProductPackage[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.ProductPackage getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.ProductPackage _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.ProductPackage> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.ProductPackage>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.ProductPackage>asList(results).iterator();
    }
