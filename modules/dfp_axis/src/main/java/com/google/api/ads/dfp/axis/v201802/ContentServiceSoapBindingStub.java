...
public class ContentServiceSoapBindingStub extends org.apache.axis.client.Stub implements com.google.api.ads.dfp.axis.v201802.ContentServiceInterface {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(com.google.api.ads.dfp.axis.v201802.ContentPage.class);
    ...
    public ContentServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201802.CmsContent.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201802.Content.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201802.ContentPage.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201802.ContentStatus.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201802.ContentStatusDefinedBy.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201802.DaiIngestError.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201802.DaiIngestErrorReason.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201802.DaiIngestStatus.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {statement});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.google.api.ads.dfp.axis.v201802.ContentPage) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.google.api.ads.dfp.axis.v201802.ContentPage) org.apache.axis.utils.JavaUtils.convert(_resp, com.google.api.ads.dfp.axis.v201802.ContentPage.class);
            }
        }
