 ...
 */
public class ContactPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.Contact>{
    ...
    private com.google.api.ads.admanager.axis.v201802.Contact[] results;
    ...
    public ContactPage(
           ...
           com.google.api.ads.admanager.axis.v201802.Contact[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.Contact[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.Contact[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.Contact getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.Contact _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.Contact> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.Contact>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.Contact>asList(results).iterator();
    }
