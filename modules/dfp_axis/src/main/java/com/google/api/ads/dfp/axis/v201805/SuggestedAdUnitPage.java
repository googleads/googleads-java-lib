 ...
 */
public class SuggestedAdUnitPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201805.SuggestedAdUnit>{
     ...
     * page. */
    private com.google.api.ads.dfp.axis.v201805.SuggestedAdUnit[] results;
    ...
    public SuggestedAdUnitPage(
           ...
           com.google.api.ads.dfp.axis.v201805.SuggestedAdUnit[] results) {
     ...
     * page.
     */
    public com.google.api.ads.dfp.axis.v201805.SuggestedAdUnit[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.dfp.axis.v201805.SuggestedAdUnit[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201805.SuggestedAdUnit getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201805.SuggestedAdUnit _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201805.SuggestedAdUnit> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201805.SuggestedAdUnit>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201805.SuggestedAdUnit>asList(results).iterator();
    }
