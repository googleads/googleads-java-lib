...
public class LabelType implements java.io.Serializable {
    ...
    public static final java.lang.String _CANONICAL_CATEGORY = "CANONICAL_CATEGORY";
    ...
    public static final LabelType CANONICAL_CATEGORY = new LabelType(_CANONICAL_CATEGORY);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202202", "LabelType"));
    }
    /**
