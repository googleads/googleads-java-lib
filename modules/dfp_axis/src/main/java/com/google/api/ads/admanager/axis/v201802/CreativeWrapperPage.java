 ...
 */
public class CreativeWrapperPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.CreativeWrapper>{
    ...
    private com.google.api.ads.admanager.axis.v201802.CreativeWrapper[] results;
    ...
    public CreativeWrapperPage(
           ...
           com.google.api.ads.admanager.axis.v201802.CreativeWrapper[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.CreativeWrapper[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.CreativeWrapper[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.CreativeWrapper getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.CreativeWrapper _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.CreativeWrapper> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.CreativeWrapper>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.CreativeWrapper>asList(results).iterator();
    }
