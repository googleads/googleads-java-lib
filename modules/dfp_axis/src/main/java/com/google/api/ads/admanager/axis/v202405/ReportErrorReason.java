...
public class ReportErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _INVALID_CMS_METADATA_DIMENSIONS = "INVALID_CMS_METADATA_DIMENSIONS";
    ...
    public static final java.lang.String _DATE_RANGE_NOT_SUPPORTED_FOR_REQUESTED_REPORT = "DATE_RANGE_NOT_SUPPORTED_FOR_REQUESTED_REPORT";
    public static final java.lang.String _TIME_ZONE_TYPE_NOT_SUPPORTED_FOR_REQUESTED_REPORT = "TIME_ZONE_TYPE_NOT_SUPPORTED_FOR_REQUESTED_REPORT";
    public static final java.lang.String _CURRENCY_CODE_NOT_SUPPORTED_FOR_REQUESTED_REPORT = "CURRENCY_CODE_NOT_SUPPORTED_FOR_REQUESTED_REPORT";
    ...
    public static final java.lang.String _AD_UNIT_VIEW_NOT_SUPPORTED_FOR_REQUESTED_REPORT = "AD_UNIT_VIEW_NOT_SUPPORTED_FOR_REQUESTED_REPORT";
    public static final java.lang.String _REPORT_FIELD_TEMPORARILY_DISABLED = "REPORT_FIELD_TEMPORARILY_DISABLED";
    ...
    public static final ReportErrorReason INVALID_CMS_METADATA_DIMENSIONS = new ReportErrorReason(_INVALID_CMS_METADATA_DIMENSIONS);
    ...
    public static final ReportErrorReason DATE_RANGE_NOT_SUPPORTED_FOR_REQUESTED_REPORT = new ReportErrorReason(_DATE_RANGE_NOT_SUPPORTED_FOR_REQUESTED_REPORT);
    public static final ReportErrorReason TIME_ZONE_TYPE_NOT_SUPPORTED_FOR_REQUESTED_REPORT = new ReportErrorReason(_TIME_ZONE_TYPE_NOT_SUPPORTED_FOR_REQUESTED_REPORT);
    public static final ReportErrorReason CURRENCY_CODE_NOT_SUPPORTED_FOR_REQUESTED_REPORT = new ReportErrorReason(_CURRENCY_CODE_NOT_SUPPORTED_FOR_REQUESTED_REPORT);
    ...
    public static final ReportErrorReason AD_UNIT_VIEW_NOT_SUPPORTED_FOR_REQUESTED_REPORT = new ReportErrorReason(_AD_UNIT_VIEW_NOT_SUPPORTED_FOR_REQUESTED_REPORT);
    public static final ReportErrorReason REPORT_FIELD_TEMPORARILY_DISABLED = new ReportErrorReason(_REPORT_FIELD_TEMPORARILY_DISABLED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202405", "ReportError.Reason"));
    }
    /**
