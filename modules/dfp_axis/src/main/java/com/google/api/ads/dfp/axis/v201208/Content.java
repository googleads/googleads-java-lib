...
public class Content  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.axis.v201208.ContentStatus status;
    ...
    public Content(
           ...
           com.google.api.ads.dfp.axis.v201208.ContentStatus status) {
           this.id = id;
           this.name = name;
           this.status = status;
    }
     ...
     */
    public com.google.api.ads.dfp.axis.v201208.ContentStatus getStatus() {
        return status;
    }
     ...
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201208.ContentStatus status) {
        this.status = status;
    }
