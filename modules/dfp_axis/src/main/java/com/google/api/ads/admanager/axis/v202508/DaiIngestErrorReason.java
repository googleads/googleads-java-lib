...
public class DaiIngestErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _MIXED_AD_BREAK_TAGS = "MIXED_AD_BREAK_TAGS";
    public static final java.lang.String _AD_BREAK_TAGS_INCONSISTENT_ACROSS_VARIANTS = "AD_BREAK_TAGS_INCONSISTENT_ACROSS_VARIANTS";
    public static final java.lang.String _MALFORMED_SUBTITLES = "MALFORMED_SUBTITLES";
    public static final java.lang.String _SUBTITLES_TOO_LARGE = "SUBTITLES_TOO_LARGE";
    ...
    public static final java.lang.String _MULTIPLE_ELEMENTARY_STREAMS_OF_SAME_MEDIA_TYPE_IN_TS = "MULTIPLE_ELEMENTARY_STREAMS_OF_SAME_MEDIA_TYPE_IN_TS";
    ...
    public static final java.lang.String _CUE_POINT_COUNT_DOES_NOT_MATCH_PTS_COUNT = "CUE_POINT_COUNT_DOES_NOT_MATCH_PTS_COUNT";
    public static final java.lang.String _DISCONTINUITY_COUNT_DOES_NOT_MATCH_PTS_COUNT = "DISCONTINUITY_COUNT_DOES_NOT_MATCH_PTS_COUNT";
    public static final java.lang.String _DASH_CUE_POINT_EVENT_MISMATCH = "DASH_CUE_POINT_EVENT_MISMATCH";
    public static final java.lang.String _DASH_MANIFEST_CONDITIONING_FAILED = "DASH_MANIFEST_CONDITIONING_FAILED";
    public static final java.lang.String _DASH_MANIFEST_CONDITIONING_SEGMENT_BOUNDARY_ERROR = "DASH_MANIFEST_CONDITIONING_SEGMENT_BOUNDARY_ERROR";
    public static final java.lang.String _CLOSED_CAPTION_LANGUAGE_VALUE_INVALID = "CLOSED_CAPTION_LANGUAGE_VALUE_INVALID";
    public static final java.lang.String _CLOSED_CAPTION_NAME_VALUE_INVALID = "CLOSED_CAPTION_NAME_VALUE_INVALID";
    public static final java.lang.String _CLOSED_CAPTION_CHARACTERISTICS_VALUE_UNEXPECTED = "CLOSED_CAPTION_CHARACTERISTICS_VALUE_UNEXPECTED";
    public static final java.lang.String _CLOSED_CAPTIONS_WITH_DUPLICATE_KEYS = "CLOSED_CAPTIONS_WITH_DUPLICATE_KEYS";
    public static final java.lang.String _SUBTITLES_PRESENT_IN_FEED_AND_MANIFEST = "SUBTITLES_PRESENT_IN_FEED_AND_MANIFEST";
    public static final java.lang.String _INVALID_MEDIA_PROFILE = "INVALID_MEDIA_PROFILE";
    public static final java.lang.String _CHAPTER_PTS_MISMATCH = "CHAPTER_PTS_MISMATCH";
    public static final java.lang.String _CHAPTER_RENDITION_ERROR = "CHAPTER_RENDITION_ERROR";
    ...
    public static final DaiIngestErrorReason SUBTITLES_TOO_LARGE = new DaiIngestErrorReason(_SUBTITLES_TOO_LARGE);
    ...
    public static final DaiIngestErrorReason MULTIPLE_ELEMENTARY_STREAMS_OF_SAME_MEDIA_TYPE_IN_TS = new DaiIngestErrorReason(_MULTIPLE_ELEMENTARY_STREAMS_OF_SAME_MEDIA_TYPE_IN_TS);
    ...
    public static final DaiIngestErrorReason CUE_POINT_COUNT_DOES_NOT_MATCH_PTS_COUNT = new DaiIngestErrorReason(_CUE_POINT_COUNT_DOES_NOT_MATCH_PTS_COUNT);
    public static final DaiIngestErrorReason DISCONTINUITY_COUNT_DOES_NOT_MATCH_PTS_COUNT = new DaiIngestErrorReason(_DISCONTINUITY_COUNT_DOES_NOT_MATCH_PTS_COUNT);
    public static final DaiIngestErrorReason DASH_CUE_POINT_EVENT_MISMATCH = new DaiIngestErrorReason(_DASH_CUE_POINT_EVENT_MISMATCH);
    public static final DaiIngestErrorReason DASH_MANIFEST_CONDITIONING_FAILED = new DaiIngestErrorReason(_DASH_MANIFEST_CONDITIONING_FAILED);
    public static final DaiIngestErrorReason DASH_MANIFEST_CONDITIONING_SEGMENT_BOUNDARY_ERROR = new DaiIngestErrorReason(_DASH_MANIFEST_CONDITIONING_SEGMENT_BOUNDARY_ERROR);
    public static final DaiIngestErrorReason CLOSED_CAPTION_LANGUAGE_VALUE_INVALID = new DaiIngestErrorReason(_CLOSED_CAPTION_LANGUAGE_VALUE_INVALID);
    public static final DaiIngestErrorReason CLOSED_CAPTION_NAME_VALUE_INVALID = new DaiIngestErrorReason(_CLOSED_CAPTION_NAME_VALUE_INVALID);
    public static final DaiIngestErrorReason CLOSED_CAPTION_CHARACTERISTICS_VALUE_UNEXPECTED = new DaiIngestErrorReason(_CLOSED_CAPTION_CHARACTERISTICS_VALUE_UNEXPECTED);
    public static final DaiIngestErrorReason CLOSED_CAPTIONS_WITH_DUPLICATE_KEYS = new DaiIngestErrorReason(_CLOSED_CAPTIONS_WITH_DUPLICATE_KEYS);
    public static final DaiIngestErrorReason SUBTITLES_PRESENT_IN_FEED_AND_MANIFEST = new DaiIngestErrorReason(_SUBTITLES_PRESENT_IN_FEED_AND_MANIFEST);
    public static final DaiIngestErrorReason INVALID_MEDIA_PROFILE = new DaiIngestErrorReason(_INVALID_MEDIA_PROFILE);
    public static final DaiIngestErrorReason CHAPTER_PTS_MISMATCH = new DaiIngestErrorReason(_CHAPTER_PTS_MISMATCH);
    public static final DaiIngestErrorReason CHAPTER_RENDITION_ERROR = new DaiIngestErrorReason(_CHAPTER_RENDITION_ERROR);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202508", "DaiIngestErrorReason"));
    }
    /**
