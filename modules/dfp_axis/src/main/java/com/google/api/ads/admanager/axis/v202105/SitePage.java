...
public class SitePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v202105.Site>{
    private java.lang.Integer totalResultSetSize;

    private java.lang.Integer startIndex;

    private com.google.api.ads.admanager.axis.v202105.Site[] results;
    ...
    public SitePage(
           ...
           com.google.api.ads.admanager.axis.v202105.Site[] results) {
     ...
     * @return results
     */
    public com.google.api.ads.admanager.axis.v202105.Site[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(com.google.api.ads.admanager.axis.v202105.Site[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v202105.Site getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v202105.Site _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v202105.Site> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v202105.Site>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v202105.Site>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202105", "SitePage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202105", "Site"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
