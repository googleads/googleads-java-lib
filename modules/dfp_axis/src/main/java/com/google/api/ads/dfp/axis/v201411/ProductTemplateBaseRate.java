 ...
 */
public class ProductTemplateBaseRate  extends com.google.api.ads.dfp.axis.v201411.BaseRate  implements java.io.Serializable {
     ...
     * is read-only. */
    private com.google.api.ads.dfp.axis.v201411.Money rate;
    ...
    public ProductTemplateBaseRate(
           ...
           com.google.api.ads.dfp.axis.v201411.Money rate) {
        super(
            rateCardId,
            id,
            baseRateType);
     ...
     * is read-only.
     */
    public com.google.api.ads.dfp.axis.v201411.Money getRate() {
        return rate;
    }
     ...
     * is read-only.
     */
    public void setRate(com.google.api.ads.dfp.axis.v201411.Money rate) {
        this.rate = rate;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201411", "ProductTemplateBaseRate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201411", "rate"));
