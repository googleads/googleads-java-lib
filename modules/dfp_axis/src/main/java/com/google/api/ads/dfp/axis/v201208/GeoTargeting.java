...
public class GeoTargeting  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.axis.v201208.Location[] targetedLocations;

    /* The geographical locations being excluded by the {@link LineItem}. */
    private com.google.api.ads.dfp.axis.v201208.Location[] excludedLocations;

    public GeoTargeting() {
    }

    public GeoTargeting(
           com.google.api.ads.dfp.axis.v201208.Location[] targetedLocations,
           com.google.api.ads.dfp.axis.v201208.Location[] excludedLocations) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201208.Location[] getTargetedLocations() {
     ...
     */
    public void setTargetedLocations(com.google.api.ads.dfp.axis.v201208.Location[] targetedLocations) {
        this.targetedLocations = targetedLocations;
    }

    public com.google.api.ads.dfp.axis.v201208.Location getTargetedLocations(int i) {
        return this.targetedLocations[i];
    }

    public void setTargetedLocations(int i, com.google.api.ads.dfp.axis.v201208.Location _value) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201208.Location[] getExcludedLocations() {
     ...
     */
    public void setExcludedLocations(com.google.api.ads.dfp.axis.v201208.Location[] excludedLocations) {
        this.excludedLocations = excludedLocations;
    }

    public com.google.api.ads.dfp.axis.v201208.Location getExcludedLocations(int i) {
        return this.excludedLocations[i];
    }

    public void setExcludedLocations(int i, com.google.api.ads.dfp.axis.v201208.Location _value) {
