...
public class AdUnitCodeErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _INVALID_CHARACTERS_FOR_LEGACY_AD_EXCHANGE_TAG = "INVALID_CHARACTERS_FOR_LEGACY_AD_EXCHANGE_TAG";
    ...
    public static final AdUnitCodeErrorReason INVALID_CHARACTERS_FOR_LEGACY_AD_EXCHANGE_TAG = new AdUnitCodeErrorReason(_INVALID_CHARACTERS_FOR_LEGACY_AD_EXCHANGE_TAG);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201908", "AdUnitCodeError.Reason"));
    }
    /**
