...
public class YieldGroupPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v202405.YieldGroup>{
    private java.lang.Integer totalResultSetSize;

    private java.lang.Integer startIndex;

    private com.google.api.ads.admanager.axis.v202405.YieldGroup[] results;
    ...
    public YieldGroupPage(
           ...
           com.google.api.ads.admanager.axis.v202405.YieldGroup[] results) {
     ...
     * @return results
     */
    public com.google.api.ads.admanager.axis.v202405.YieldGroup[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(com.google.api.ads.admanager.axis.v202405.YieldGroup[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v202405.YieldGroup getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v202405.YieldGroup _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v202405.YieldGroup> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v202405.YieldGroup>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v202405.YieldGroup>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202405", "YieldGroupPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202405", "YieldGroup"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
