...
public class LabelEntityAssociationErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _NEGATION_NOT_ALLOWED = "NEGATION_NOT_ALLOWED";
    ...
    public static final LabelEntityAssociationErrorReason NEGATION_NOT_ALLOWED = new LabelEntityAssociationErrorReason(_NEGATION_NOT_ALLOWED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202111", "LabelEntityAssociationError.Reason"));
    }
    /**
