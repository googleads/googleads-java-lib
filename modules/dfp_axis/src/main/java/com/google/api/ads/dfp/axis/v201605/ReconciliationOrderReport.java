...
public class ReconciliationOrderReport  implements java.io.Serializable {
     ...
     *                 This value is read-only. */
    private com.google.api.ads.dfp.axis.v201605.ReconciliationOrderReportStatus status;

    /* The time when this order report is submitted.
     *                 This value is read-only. */
    private com.google.api.ads.dfp.axis.v201605.DateTime submissionDateTime;
     ...
     * is {@code null}.
     *                 This value is read-only. */
    private com.google.api.ads.dfp.axis.v201605.Money proposalNetBillableRevenueManualAdjustment;
    ...
    private com.google.api.ads.dfp.axis.v201605.Money proposalGrossBillableRevenueManualAdjustment;
    ...
    public ReconciliationOrderReport(
           ...
           com.google.api.ads.dfp.axis.v201605.ReconciliationOrderReportStatus status,
           com.google.api.ads.dfp.axis.v201605.DateTime submissionDateTime,
           java.lang.Long submitterId,
           com.google.api.ads.dfp.axis.v201605.Money proposalNetBillableRevenueManualAdjustment,
           com.google.api.ads.dfp.axis.v201605.Money proposalGrossBillableRevenueManualAdjustment) {
           this.id = id;
     ...
     *                 This value is read-only.
     */
    public com.google.api.ads.dfp.axis.v201605.ReconciliationOrderReportStatus getStatus() {
        return status;
    }
     ...
     *                 This value is read-only.
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201605.ReconciliationOrderReportStatus status) {
        this.status = status;
    }
     ...
     *                 This value is read-only.
     */
    public com.google.api.ads.dfp.axis.v201605.DateTime getSubmissionDateTime() {
     ...
     *                 This value is read-only.
     */
    public void setSubmissionDateTime(com.google.api.ads.dfp.axis.v201605.DateTime submissionDateTime) {
        this.submissionDateTime = submissionDateTime;
    }
     ...
     *                 This value is read-only.
     */
    public com.google.api.ads.dfp.axis.v201605.Money getProposalNetBillableRevenueManualAdjustment() {
     ...
     *                 This value is read-only.
     */
    public void setProposalNetBillableRevenueManualAdjustment(com.google.api.ads.dfp.axis.v201605.Money proposalNetBillableRevenueManualAdjustment) {
        this.proposalNetBillableRevenueManualAdjustment = proposalNetBillableRevenueManualAdjustment;
    }
     ...
     *                 This value is editable.
     */
    public com.google.api.ads.dfp.axis.v201605.Money getProposalGrossBillableRevenueManualAdjustment() {
     ...
     *                 This value is editable.
     */
    public void setProposalGrossBillableRevenueManualAdjustment(com.google.api.ads.dfp.axis.v201605.Money proposalGrossBillableRevenueManualAdjustment) {
        this.proposalGrossBillableRevenueManualAdjustment = proposalGrossBillableRevenueManualAdjustment;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201605", "ReconciliationOrderReport"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201605", "ReconciliationOrderReportStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("submissionDateTime");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201605", "submissionDateTime"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201605", "submitterId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201605", "proposalNetBillableRevenueManualAdjustment"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201605", "proposalGrossBillableRevenueManualAdjustment"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201605", "Money"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
