...
public class ContentMetadataKeyHierarchy  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.axis.v201411.ContentMetadataKeyHierarchyLevel[] hierarchyLevels;
    ...
    private com.google.api.ads.dfp.axis.v201411.ContentMetadataKeyHierarchyStatus status;
    ...
    public ContentMetadataKeyHierarchy(
           ...
           com.google.api.ads.dfp.axis.v201411.ContentMetadataKeyHierarchyLevel[] hierarchyLevels,
           com.google.api.ads.dfp.axis.v201411.ContentMetadataKeyHierarchyStatus status) {
           this.id = id;
           this.name = name;
     ...
     *                 of levels in the hierarchy.
     */
    public com.google.api.ads.dfp.axis.v201411.ContentMetadataKeyHierarchyLevel[] getHierarchyLevels() {
     ...
     *                 of levels in the hierarchy.
     */
    public void setHierarchyLevels(com.google.api.ads.dfp.axis.v201411.ContentMetadataKeyHierarchyLevel[] hierarchyLevels) {
        this.hierarchyLevels = hierarchyLevels;
    }

    public com.google.api.ads.dfp.axis.v201411.ContentMetadataKeyHierarchyLevel getHierarchyLevels(int i) {
        return this.hierarchyLevels[i];
    }

    public void setHierarchyLevels(int i, com.google.api.ads.dfp.axis.v201411.ContentMetadataKeyHierarchyLevel _value) {
     ...
     *                 and defaults to {@link ContentMetadataKeyHierarchyStatus#ACTIVE}.
     */
    public com.google.api.ads.dfp.axis.v201411.ContentMetadataKeyHierarchyStatus getStatus() {
        return status;
    }
     ...
     *                 and defaults to {@link ContentMetadataKeyHierarchyStatus#ACTIVE}.
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201411.ContentMetadataKeyHierarchyStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201411", "ContentMetadataKeyHierarchy"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201411", "hierarchyLevels"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201411", "ContentMetadataKeyHierarchyLevel"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201411", "ContentMetadataKeyHierarchyStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
