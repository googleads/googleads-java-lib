 ...
 */
public class NativeStylePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.NativeStyle>{
    ...
    private com.google.api.ads.admanager.axis.v201802.NativeStyle[] results;
    ...
    public NativeStylePage(
           ...
           com.google.api.ads.admanager.axis.v201802.NativeStyle[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.NativeStyle[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.NativeStyle[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.NativeStyle getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.NativeStyle _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.NativeStyle> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.NativeStyle>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.NativeStyle>asList(results).iterator();
    }
