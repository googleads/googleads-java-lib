...
public class ProductServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201405.ProductService {
    ...
    public com.google.api.ads.dfp.axis.v201405.ProductServiceInterface getProductServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201405.ProductServiceInterface getProductServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201405.ProductServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201405.ProductServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201405.ProductServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201405.ProductServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201405.ProductServiceSoapBindingStub(new java.net.URL(ProductServiceInterfacePort_address), this);
                _stub.setPortName(getProductServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201405", "ProductService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201405", "ProductServiceInterfacePort"));
        }
