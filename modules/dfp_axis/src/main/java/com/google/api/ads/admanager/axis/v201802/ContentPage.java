 ...
 */
public class ContentPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.Content>{
    ...
    private com.google.api.ads.admanager.axis.v201802.Content[] results;
    ...
    public ContentPage(
           ...
           com.google.api.ads.admanager.axis.v201802.Content[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.Content[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.Content[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.Content getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.Content _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.Content> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.Content>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.Content>asList(results).iterator();
    }
