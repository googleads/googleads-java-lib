...
public class CompanyErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _INVALID_LABEL_ASSOCIATION = "INVALID_LABEL_ASSOCIATION";
    public static final java.lang.String _INVALID_COMPANY_TYPE_FOR_DEFAULT_BILLING_SETTING = "INVALID_COMPANY_TYPE_FOR_DEFAULT_BILLING_SETTING";
    public static final java.lang.String _INVALID_DEFAULT_BILLING_SETTING = "INVALID_DEFAULT_BILLING_SETTING";
    public static final java.lang.String _COMPANY_HAS_ACTIVE_SHARE_ASSIGNMENTS = "COMPANY_HAS_ACTIVE_SHARE_ASSIGNMENTS";
    ...
    public static final CompanyErrorReason INVALID_LABEL_ASSOCIATION = new CompanyErrorReason(_INVALID_LABEL_ASSOCIATION);
    public static final CompanyErrorReason INVALID_COMPANY_TYPE_FOR_DEFAULT_BILLING_SETTING = new CompanyErrorReason(_INVALID_COMPANY_TYPE_FOR_DEFAULT_BILLING_SETTING);
    public static final CompanyErrorReason INVALID_DEFAULT_BILLING_SETTING = new CompanyErrorReason(_INVALID_DEFAULT_BILLING_SETTING);
    public static final CompanyErrorReason COMPANY_HAS_ACTIVE_SHARE_ASSIGNMENTS = new CompanyErrorReason(_COMPANY_HAS_ACTIVE_SHARE_ASSIGNMENTS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "CompanyError.Reason"));
    }
    /**
