...
public class ContentBundleServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201411.ContentBundleService {
    ...
    private java.lang.String ContentBundleServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v201411/ContentBundleService";
    ...
    public com.google.api.ads.dfp.axis.v201411.ContentBundleServiceInterface getContentBundleServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201411.ContentBundleServiceInterface getContentBundleServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201411.ContentBundleServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201411.ContentBundleServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201411.ContentBundleServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201411.ContentBundleServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201411.ContentBundleServiceSoapBindingStub(new java.net.URL(ContentBundleServiceInterfacePort_address), this);
                _stub.setPortName(getContentBundleServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201411", "ContentBundleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201411", "ContentBundleServiceInterfacePort"));
        }
