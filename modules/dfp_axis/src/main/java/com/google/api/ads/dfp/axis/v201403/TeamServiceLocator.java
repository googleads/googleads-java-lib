...
public class TeamServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201403.TeamService {
    ...
    private java.lang.String TeamServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v201403/TeamService";
    ...
    public com.google.api.ads.dfp.axis.v201403.TeamServiceInterface getTeamServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201403.TeamServiceInterface getTeamServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201403.TeamServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201403.TeamServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201403.TeamServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201403.TeamServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201403.TeamServiceSoapBindingStub(new java.net.URL(TeamServiceInterfacePort_address), this);
                _stub.setPortName(getTeamServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201403", "TeamService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201403", "TeamServiceInterfacePort"));
        }
