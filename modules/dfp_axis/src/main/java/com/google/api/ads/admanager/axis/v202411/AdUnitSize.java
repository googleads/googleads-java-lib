...
public class AdUnitSize  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v202411.AdUnitSize[] companions;
    ...
    public AdUnitSize(
           ...
           com.google.api.ads.admanager.axis.v202411.AdUnitSize[] companions,
     ...
     *                 companions results in an error.
     */
    public com.google.api.ads.admanager.axis.v202411.AdUnitSize[] getCompanions() {
        return companions;
    }
     ...
     *                 companions results in an error.
     */
    public void setCompanions(com.google.api.ads.admanager.axis.v202411.AdUnitSize[] companions) {
        this.companions = companions;
    }

    public com.google.api.ads.admanager.axis.v202411.AdUnitSize getCompanions(int i) {
        return this.companions[i];
    }

    public void setCompanions(int i, com.google.api.ads.admanager.axis.v202411.AdUnitSize _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "AdUnitSize"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "fullDisplayString"));
