 ...
 */
public class CompanyPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201608.Company>{
    ...
    private com.google.api.ads.dfp.axis.v201608.Company[] results;
    ...
    public CompanyPage(
           ...
           com.google.api.ads.dfp.axis.v201608.Company[] results) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201608.Company[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201608.Company[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201608.Company getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201608.Company _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201608.Company> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201608.Company>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201608.Company>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201608", "CompanyPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201608", "Company"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
