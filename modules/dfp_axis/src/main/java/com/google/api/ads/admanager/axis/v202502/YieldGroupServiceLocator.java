...
public class YieldGroupServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.admanager.axis.v202502.YieldGroupService {
    ...
    private java.lang.String YieldGroupServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v202502/YieldGroupService";
    ...
    public com.google.api.ads.admanager.axis.v202502.YieldGroupServiceInterface getYieldGroupServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.admanager.axis.v202502.YieldGroupServiceInterface getYieldGroupServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.admanager.axis.v202502.YieldGroupServiceSoapBindingStub _stub = new com.google.api.ads.admanager.axis.v202502.YieldGroupServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.admanager.axis.v202502.YieldGroupServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.admanager.axis.v202502.YieldGroupServiceSoapBindingStub _stub = new com.google.api.ads.admanager.axis.v202502.YieldGroupServiceSoapBindingStub(new java.net.URL(YieldGroupServiceInterfacePort_address), this);
                _stub.setPortName(getYieldGroupServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202502", "YieldGroupService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202502", "YieldGroupServiceInterfacePort"));
        }
