...
public class ProposalErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _NEW_TRADITIONAL_ONLY_PROPOSAL_NOT_ALLOWED = "NEW_TRADITIONAL_ONLY_PROPOSAL_NOT_ALLOWED";
    ...
    public static final ProposalErrorReason NEW_TRADITIONAL_ONLY_PROPOSAL_NOT_ALLOWED = new ProposalErrorReason(_NEW_TRADITIONAL_ONLY_PROPOSAL_NOT_ALLOWED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201905", "ProposalError.Reason"));
    }
    /**
