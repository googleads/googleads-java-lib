 ...
 */
public class LineItemTemplatePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.LineItemTemplate>{
     ...
     * page. */
    private com.google.api.ads.admanager.axis.v201802.LineItemTemplate[] results;
    ...
    public LineItemTemplatePage(
           ...
           com.google.api.ads.admanager.axis.v201802.LineItemTemplate[] results) {
     ...
     * page.
     */
    public com.google.api.ads.admanager.axis.v201802.LineItemTemplate[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.LineItemTemplate[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.LineItemTemplate getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.LineItemTemplate _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.LineItemTemplate> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.LineItemTemplate>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.LineItemTemplate>asList(results).iterator();
    }
