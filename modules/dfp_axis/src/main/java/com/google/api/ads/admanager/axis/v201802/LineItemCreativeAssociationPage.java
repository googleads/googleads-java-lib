 ...
 */
public class LineItemCreativeAssociationPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.LineItemCreativeAssociation>{
     ...
     * within this
     *                 page. */
    private com.google.api.ads.admanager.axis.v201802.LineItemCreativeAssociation[] results;
    ...
    public LineItemCreativeAssociationPage(
           ...
           com.google.api.ads.admanager.axis.v201802.LineItemCreativeAssociation[] results) {
     ...
     *                 page.
     */
    public com.google.api.ads.admanager.axis.v201802.LineItemCreativeAssociation[] getResults() {
        return results;
    }
     ...
     *                 page.
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.LineItemCreativeAssociation[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.LineItemCreativeAssociation getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.LineItemCreativeAssociation _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.LineItemCreativeAssociation> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.LineItemCreativeAssociation>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.LineItemCreativeAssociation>asList(results).iterator();
    }
