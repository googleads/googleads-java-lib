...
public class LineItemCreativeAssociationStats  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v202411.Long_StatsMapEntry[] creativeSetStats;
    ...
    private com.google.api.ads.admanager.axis.v202411.Money costInOrderCurrency;
    ...
    public LineItemCreativeAssociationStats(
           ...
           com.google.api.ads.admanager.axis.v202411.Long_StatsMapEntry[] creativeSetStats,
           com.google.api.ads.admanager.axis.v202411.Money costInOrderCurrency) {
           this.stats = stats;
     ...
     *                 null} for non creative set associations.
     */
    public com.google.api.ads.admanager.axis.v202411.Long_StatsMapEntry[] getCreativeSetStats() {
     ...
     *                 null} for non creative set associations.
     */
    public void setCreativeSetStats(com.google.api.ads.admanager.axis.v202411.Long_StatsMapEntry[] creativeSetStats) {
        this.creativeSetStats = creativeSetStats;
    }

    public com.google.api.ads.admanager.axis.v202411.Long_StatsMapEntry getCreativeSetStats(int i) {
        return this.creativeSetStats[i];
    }

    public void setCreativeSetStats(int i, com.google.api.ads.admanager.axis.v202411.Long_StatsMapEntry _value) {
     ...
     *                 item in the publisher's currency.
     */
    public com.google.api.ads.admanager.axis.v202411.Money getCostInOrderCurrency() {
     ...
     *                 item in the publisher's currency.
     */
    public void setCostInOrderCurrency(com.google.api.ads.admanager.axis.v202411.Money costInOrderCurrency) {
        this.costInOrderCurrency = costInOrderCurrency;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "LineItemCreativeAssociationStats"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "creativeSetStats"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "Long_StatsMapEntry"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "costInOrderCurrency"));
