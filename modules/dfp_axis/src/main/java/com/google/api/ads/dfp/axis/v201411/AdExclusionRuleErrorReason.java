...
public class AdExclusionRuleErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _AD_UNITS_OVER_LIMIT = "AD_UNITS_OVER_LIMIT";
    ...
    public static final AdExclusionRuleErrorReason AD_UNITS_OVER_LIMIT = new AdExclusionRuleErrorReason(_AD_UNITS_OVER_LIMIT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201411", "AdExclusionRuleError.Reason"));
    }
    /**
