 ...
 */
public class AdExclusionRulePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.AdExclusionRule>{
    ...
    private com.google.api.ads.admanager.axis.v201802.AdExclusionRule[] results;
    ...
    public AdExclusionRulePage(
           ...
           com.google.api.ads.admanager.axis.v201802.AdExclusionRule[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.AdExclusionRule[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.AdExclusionRule[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.AdExclusionRule getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.AdExclusionRule _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.AdExclusionRule> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.AdExclusionRule>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.AdExclusionRule>asList(results).iterator();
    }
