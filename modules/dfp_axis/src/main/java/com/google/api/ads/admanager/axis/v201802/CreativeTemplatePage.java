 ...
 */
public class CreativeTemplatePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.CreativeTemplate>{
     ...
     * page. */
    private com.google.api.ads.admanager.axis.v201802.CreativeTemplate[] results;
    ...
    public CreativeTemplatePage(
           ...
           com.google.api.ads.admanager.axis.v201802.CreativeTemplate[] results) {
     ...
     * page.
     */
    public com.google.api.ads.admanager.axis.v201802.CreativeTemplate[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.CreativeTemplate[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.CreativeTemplate getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.CreativeTemplate _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.CreativeTemplate> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.CreativeTemplate>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.CreativeTemplate>asList(results).iterator();
    }
