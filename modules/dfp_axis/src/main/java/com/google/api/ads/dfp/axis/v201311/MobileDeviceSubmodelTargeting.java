...
public class MobileDeviceSubmodelTargeting  implements java.io.Serializable {
     ...
     * LineItem}. */
    private com.google.api.ads.dfp.axis.v201311.Technology[] targetedMobileDeviceSubmodels;

    /* Mobile device submodels that are being excluded by the {@link
     * LineItem}. */
    private com.google.api.ads.dfp.axis.v201311.Technology[] excludedMobileDeviceSubmodels;

    public MobileDeviceSubmodelTargeting() {
    }

    public MobileDeviceSubmodelTargeting(
           com.google.api.ads.dfp.axis.v201311.Technology[] targetedMobileDeviceSubmodels,
           com.google.api.ads.dfp.axis.v201311.Technology[] excludedMobileDeviceSubmodels) {
     ...
     * LineItem}.
     */
    public com.google.api.ads.dfp.axis.v201311.Technology[] getTargetedMobileDeviceSubmodels() {
     ...
     * LineItem}.
     */
    public void setTargetedMobileDeviceSubmodels(com.google.api.ads.dfp.axis.v201311.Technology[] targetedMobileDeviceSubmodels) {
        this.targetedMobileDeviceSubmodels = targetedMobileDeviceSubmodels;
    }

    public com.google.api.ads.dfp.axis.v201311.Technology getTargetedMobileDeviceSubmodels(int i) {
        return this.targetedMobileDeviceSubmodels[i];
    }

    public void setTargetedMobileDeviceSubmodels(int i, com.google.api.ads.dfp.axis.v201311.Technology _value) {
     ...
     * LineItem}.
     */
    public com.google.api.ads.dfp.axis.v201311.Technology[] getExcludedMobileDeviceSubmodels() {
     ...
     * LineItem}.
     */
    public void setExcludedMobileDeviceSubmodels(com.google.api.ads.dfp.axis.v201311.Technology[] excludedMobileDeviceSubmodels) {
        this.excludedMobileDeviceSubmodels = excludedMobileDeviceSubmodels;
    }

    public com.google.api.ads.dfp.axis.v201311.Technology getExcludedMobileDeviceSubmodels(int i) {
        return this.excludedMobileDeviceSubmodels[i];
    }

    public void setExcludedMobileDeviceSubmodels(int i, com.google.api.ads.dfp.axis.v201311.Technology _value) {
