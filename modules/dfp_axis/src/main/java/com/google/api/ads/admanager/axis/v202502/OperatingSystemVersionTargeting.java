...
public class OperatingSystemVersionTargeting  implements java.io.Serializable {
    private com.google.api.ads.admanager.axis.v202502.Technology[] targetedOperatingSystemVersions;

    private com.google.api.ads.admanager.axis.v202502.Technology[] excludedOperatingSystemVersions;

    public OperatingSystemVersionTargeting() {
    }

    public OperatingSystemVersionTargeting(
           com.google.api.ads.admanager.axis.v202502.Technology[] targetedOperatingSystemVersions,
           com.google.api.ads.admanager.axis.v202502.Technology[] excludedOperatingSystemVersions) {
     ...
     */
    public com.google.api.ads.admanager.axis.v202502.Technology[] getTargetedOperatingSystemVersions() {
        return targetedOperatingSystemVersions;
    }
     ...
     */
    public void setTargetedOperatingSystemVersions(com.google.api.ads.admanager.axis.v202502.Technology[] targetedOperatingSystemVersions) {
        this.targetedOperatingSystemVersions = targetedOperatingSystemVersions;
    }

    public com.google.api.ads.admanager.axis.v202502.Technology getTargetedOperatingSystemVersions(int i) {
        return this.targetedOperatingSystemVersions[i];
    }

    public void setTargetedOperatingSystemVersions(int i, com.google.api.ads.admanager.axis.v202502.Technology _value) {
     ...
     */
    public com.google.api.ads.admanager.axis.v202502.Technology[] getExcludedOperatingSystemVersions() {
        return excludedOperatingSystemVersions;
    }
     ...
     */
    public void setExcludedOperatingSystemVersions(com.google.api.ads.admanager.axis.v202502.Technology[] excludedOperatingSystemVersions) {
        this.excludedOperatingSystemVersions = excludedOperatingSystemVersions;
    }

    public com.google.api.ads.admanager.axis.v202502.Technology getExcludedOperatingSystemVersions(int i) {
        return this.excludedOperatingSystemVersions[i];
    }

    public void setExcludedOperatingSystemVersions(int i, com.google.api.ads.admanager.axis.v202502.Technology _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202502", "OperatingSystemVersionTargeting"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("targetedOperatingSystemVersions");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202502", "targetedOperatingSystemVersions"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202502", "Technology"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202502", "excludedOperatingSystemVersions"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202502", "Technology"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
