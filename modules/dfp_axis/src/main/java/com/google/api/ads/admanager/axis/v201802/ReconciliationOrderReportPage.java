 ...
 */
public class ReconciliationOrderReportPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.ReconciliationOrderReport>{
     ...
     * this page. */
    private com.google.api.ads.admanager.axis.v201802.ReconciliationOrderReport[] results;
    ...
    public ReconciliationOrderReportPage(
           ...
           com.google.api.ads.admanager.axis.v201802.ReconciliationOrderReport[] results) {
     ...
     * this page.
     */
    public com.google.api.ads.admanager.axis.v201802.ReconciliationOrderReport[] getResults() {
        return results;
    }
     ...
     * this page.
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.ReconciliationOrderReport[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.ReconciliationOrderReport getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.ReconciliationOrderReport _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.ReconciliationOrderReport> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.ReconciliationOrderReport>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.ReconciliationOrderReport>asList(results).iterator();
    }
