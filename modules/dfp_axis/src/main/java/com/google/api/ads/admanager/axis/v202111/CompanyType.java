...
public class CompanyType implements java.io.Serializable {
    ...
    public static final java.lang.String _CHILD_PUBLISHER = "CHILD_PUBLISHER";
    public static final java.lang.String _VIEWABILITY_PROVIDER = "VIEWABILITY_PROVIDER";
    ...
    public static final CompanyType PARTNER = new CompanyType(_PARTNER);
    public static final CompanyType CHILD_PUBLISHER = new CompanyType(_CHILD_PUBLISHER);
    public static final CompanyType VIEWABILITY_PROVIDER = new CompanyType(_VIEWABILITY_PROVIDER);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202111", "Company.Type"));
    }
    /**
