...
public class UnitType implements java.io.Serializable {
    ...
    public static final java.lang.String _IN_TARGET_IMPRESSIONS = "IN_TARGET_IMPRESSIONS";
    public static final java.lang.String _COMPLETED_VIEWS = "COMPLETED_VIEWS";
    ...
    public static final UnitType IN_TARGET_IMPRESSIONS = new UnitType(_IN_TARGET_IMPRESSIONS);
    public static final UnitType COMPLETED_VIEWS = new UnitType(_COMPLETED_VIEWS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202508", "UnitType"));
    }
    /**
