 ...
 */
public class ContentBundlePage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201705.ContentBundle>{
    ...
    private com.google.api.ads.dfp.axis.v201705.ContentBundle[] results;
    ...
    public ContentBundlePage(
           ...
           com.google.api.ads.dfp.axis.v201705.ContentBundle[] results) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201705.ContentBundle[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201705.ContentBundle[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201705.ContentBundle getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201705.ContentBundle _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201705.ContentBundle> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201705.ContentBundle>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201705.ContentBundle>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201705", "ContentBundlePage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201705", "ContentBundle"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
