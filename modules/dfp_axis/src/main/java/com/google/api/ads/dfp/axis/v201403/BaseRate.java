...
public abstract class BaseRate  implements java.io.Serializable {
     ...
     * and is
     *                 assigned by Google. */
    private com.google.api.ads.dfp.axis.v201403.BaseRateStatus status;
     ...
     *                 assigned by Google.
     */
    public com.google.api.ads.dfp.axis.v201403.BaseRateStatus getStatus() {
        return status;
    }
     ...
     *                 assigned by Google.
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201403.BaseRateStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201403", "BaseRate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201403", "BaseRateStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("baseRateType");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201403", "BaseRate.Type"));
