...
public class AccountStatus implements java.io.Serializable {
    ...
    public static final java.lang.String _DISAPPROVED_POLICY_VIOLATION = "DISAPPROVED_POLICY_VIOLATION";
    ...
    public static final AccountStatus DISAPPROVED_POLICY_VIOLATION = new AccountStatus(_DISAPPROVED_POLICY_VIOLATION);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202008", "AccountStatus"));
    }
    /**
