 ...
 */
public class PremiumRatePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.PremiumRate>{
    /* The collection of premium rates contained within this page. */
    private com.google.api.ads.admanager.axis.v201802.PremiumRate[] results;
    ...
    public PremiumRatePage(
           com.google.api.ads.admanager.axis.v201802.PremiumRate[] results,
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.PremiumRate[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.PremiumRate[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.PremiumRate getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.PremiumRate _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.PremiumRate> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.PremiumRate>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.PremiumRate>asList(results).iterator();
    }
