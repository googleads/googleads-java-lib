 ...
 */
public class UserTeamAssociationPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.UserTeamAssociation>{
     ...
     * page. */
    private com.google.api.ads.admanager.axis.v201802.UserTeamAssociation[] results;
    ...
    public UserTeamAssociationPage(
           ...
           com.google.api.ads.admanager.axis.v201802.UserTeamAssociation[] results) {
     ...
     * page.
     */
    public com.google.api.ads.admanager.axis.v201802.UserTeamAssociation[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.UserTeamAssociation[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.UserTeamAssociation getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.UserTeamAssociation _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.UserTeamAssociation> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.UserTeamAssociation>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.UserTeamAssociation>asList(results).iterator();
    }
