...
public class SegmentPopulationResponse  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v202405.IdError[] idErrors;
    ...
    public SegmentPopulationResponse(
           ...
           com.google.api.ads.admanager.axis.v202405.IdError[] idErrors) {
     ...
     * @return idErrors
     */
    public com.google.api.ads.admanager.axis.v202405.IdError[] getIdErrors() {
        return idErrors;
    }
     ...
     * @param idErrors
     */
    public void setIdErrors(com.google.api.ads.admanager.axis.v202405.IdError[] idErrors) {
        this.idErrors = idErrors;
    }

    public com.google.api.ads.admanager.axis.v202405.IdError getIdErrors(int i) {
        return this.idErrors[i];
    }

    public void setIdErrors(int i, com.google.api.ads.admanager.axis.v202405.IdError _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202405", "SegmentPopulationResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202405", "idErrors"));
