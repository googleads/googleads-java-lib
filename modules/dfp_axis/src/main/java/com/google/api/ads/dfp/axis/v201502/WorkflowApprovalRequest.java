 ...
 */
public class WorkflowApprovalRequest  extends com.google.api.ads.dfp.axis.v201502.WorkflowRequest  implements java.io.Serializable {
    /* The status of the {@code WorkflowApprovalRequest}. This attribute
     * is readonly. */
    private com.google.api.ads.dfp.axis.v201502.WorkflowApprovalRequestStatus status;
    ...
    public WorkflowApprovalRequest(
           ...
           com.google.api.ads.dfp.axis.v201502.WorkflowApprovalRequestStatus status) {
        super(
            id,
            workflowRuleName,
            entityId,
     ...
     * is readonly.
     */
    public com.google.api.ads.dfp.axis.v201502.WorkflowApprovalRequestStatus getStatus() {
        return status;
    }
     ...
     * is readonly.
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201502.WorkflowApprovalRequestStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201502", "WorkflowApprovalRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201502", "WorkflowApprovalRequestStatus"));
