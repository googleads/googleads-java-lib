...
public class LiveStreamEventServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201505.LiveStreamEventService {
    ...
    private java.lang.String LiveStreamEventServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v201505/LiveStreamEventService";
    ...
    public com.google.api.ads.dfp.axis.v201505.LiveStreamEventServiceInterface getLiveStreamEventServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201505.LiveStreamEventServiceInterface getLiveStreamEventServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201505.LiveStreamEventServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201505.LiveStreamEventServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201505.LiveStreamEventServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201505.LiveStreamEventServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201505.LiveStreamEventServiceSoapBindingStub(new java.net.URL(LiveStreamEventServiceInterfacePort_address), this);
                _stub.setPortName(getLiveStreamEventServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "LiveStreamEventService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "LiveStreamEventServiceInterfacePort"));
        }
