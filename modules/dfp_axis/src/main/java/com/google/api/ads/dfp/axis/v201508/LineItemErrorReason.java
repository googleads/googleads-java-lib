...
public class LineItemErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _SYSTEM_DEFINED_TEMPLATE_REQUIRED = "SYSTEM_DEFINED_TEMPLATE_REQUIRED";
    ...
    public static final LineItemErrorReason SYSTEM_DEFINED_TEMPLATE_REQUIRED = new LineItemErrorReason(_SYSTEM_DEFINED_TEMPLATE_REQUIRED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201508", "LineItemError.Reason"));
    }
    /**
