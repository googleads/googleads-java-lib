 ...
 */
public class ProposalLineItemPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v202202.ProposalLineItem>{
    /* The collection of proposal line items contained within this
     * page. */
    private com.google.api.ads.admanager.axis.v202202.ProposalLineItem[] results;
    ...
    public ProposalLineItemPage(
           com.google.api.ads.admanager.axis.v202202.ProposalLineItem[] results,
     ...
     * page.
     */
    public com.google.api.ads.admanager.axis.v202202.ProposalLineItem[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.admanager.axis.v202202.ProposalLineItem[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v202202.ProposalLineItem getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v202202.ProposalLineItem _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v202202.ProposalLineItem> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v202202.ProposalLineItem>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v202202.ProposalLineItem>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202202", "ProposalLineItemPage"));
