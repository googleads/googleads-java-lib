 ...
 */
public class PackagePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.Package>{
    /* The collection of packages contained within this page. */
    private com.google.api.ads.admanager.axis.v201802.Package[] results;
    ...
    public PackagePage(
           com.google.api.ads.admanager.axis.v201802.Package[] results,
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.Package[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.Package[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.Package getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.Package _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.Package> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.Package>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.Package>asList(results).iterator();
    }
