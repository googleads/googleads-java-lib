...
public class DaiAuthenticationKeyServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.admanager.axis.v202202.DaiAuthenticationKeyService {
    ...
    private java.lang.String DaiAuthenticationKeyServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v202202/DaiAuthenticationKeyService";
    ...
    public com.google.api.ads.admanager.axis.v202202.DaiAuthenticationKeyServiceInterface getDaiAuthenticationKeyServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.admanager.axis.v202202.DaiAuthenticationKeyServiceInterface getDaiAuthenticationKeyServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.admanager.axis.v202202.DaiAuthenticationKeyServiceSoapBindingStub _stub = new com.google.api.ads.admanager.axis.v202202.DaiAuthenticationKeyServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.admanager.axis.v202202.DaiAuthenticationKeyServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.admanager.axis.v202202.DaiAuthenticationKeyServiceSoapBindingStub _stub = new com.google.api.ads.admanager.axis.v202202.DaiAuthenticationKeyServiceSoapBindingStub(new java.net.URL(DaiAuthenticationKeyServiceInterfacePort_address), this);
                _stub.setPortName(getDaiAuthenticationKeyServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202202", "DaiAuthenticationKeyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202202", "DaiAuthenticationKeyServiceInterfacePort"));
        }
