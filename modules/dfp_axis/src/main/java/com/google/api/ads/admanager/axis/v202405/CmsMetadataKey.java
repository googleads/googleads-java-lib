...
public class CmsMetadataKey  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v202405.CmsMetadataKeyStatus status;
    ...
    public CmsMetadataKey(
           ...
           com.google.api.ads.admanager.axis.v202405.CmsMetadataKeyStatus status) {
           this.id = id;
           this.name = name;
           this.status = status;
    }
     ...
     *                 This attribute is read-only.
     */
    public com.google.api.ads.admanager.axis.v202405.CmsMetadataKeyStatus getStatus() {
        return status;
    }
     ...
     *                 This attribute is read-only.
     */
    public void setStatus(com.google.api.ads.admanager.axis.v202405.CmsMetadataKeyStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202405", "CmsMetadataKey"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202405", "CmsMetadataKeyStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
