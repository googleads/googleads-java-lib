...
public class ProposalErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _UNSUPPORTED_BUYER_CURRENCY_CODE = "UNSUPPORTED_BUYER_CURRENCY_CODE";
    ...
    public static final java.lang.String _UPDATE_SUPPLY_PATH_NOT_ALLOWED = "UPDATE_SUPPLY_PATH_NOT_ALLOWED";
    public static final java.lang.String _BUYER_DISABLED_FOR_AGENCY_DIRECT = "BUYER_DISABLED_FOR_AGENCY_DIRECT";
    ...
    public static final ProposalErrorReason UNSUPPORTED_BUYER_CURRENCY_CODE = new ProposalErrorReason(_UNSUPPORTED_BUYER_CURRENCY_CODE);
    ...
    public static final ProposalErrorReason UPDATE_SUPPLY_PATH_NOT_ALLOWED = new ProposalErrorReason(_UPDATE_SUPPLY_PATH_NOT_ALLOWED);
    public static final ProposalErrorReason BUYER_DISABLED_FOR_AGENCY_DIRECT = new ProposalErrorReason(_BUYER_DISABLED_FOR_AGENCY_DIRECT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202511", "ProposalError.Reason"));
    }
    /**
