 ...
 */
public class CmsMetadataValuePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v202411.CmsMetadataValue>{
    private java.lang.Integer totalResultSetSize;

    private java.lang.Integer startIndex;

    private com.google.api.ads.admanager.axis.v202411.CmsMetadataValue[] results;
    ...
    public CmsMetadataValuePage(
           ...
           com.google.api.ads.admanager.axis.v202411.CmsMetadataValue[] results) {
     ...
     * @return results
     */
    public com.google.api.ads.admanager.axis.v202411.CmsMetadataValue[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(com.google.api.ads.admanager.axis.v202411.CmsMetadataValue[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v202411.CmsMetadataValue getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v202411.CmsMetadataValue _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v202411.CmsMetadataValue> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v202411.CmsMetadataValue>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v202411.CmsMetadataValue>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "CmsMetadataValuePage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "CmsMetadataValue"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
