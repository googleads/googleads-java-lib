 ...
 */
public class UserPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v202302.User>{
    ...
    private com.google.api.ads.admanager.axis.v202302.User[] results;
    ...
    public UserPage(
           ...
           com.google.api.ads.admanager.axis.v202302.User[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v202302.User[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v202302.User[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v202302.User getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v202302.User _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v202302.User> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v202302.User>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v202302.User>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202302", "UserPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202302", "User"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
