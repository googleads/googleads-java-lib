 ...
 */
public class SetValue  extends com.google.api.ads.admanager.axis.v201802.Value  implements java.io.Serializable {
    /* The values. They must all be the same type of {@code Value}
     * and not contain duplicates. */
    private com.google.api.ads.admanager.axis.v201802.Value[] values;

    public SetValue() {
    }

    public SetValue(
           com.google.api.ads.admanager.axis.v201802.Value[] values) {
        this.values = values;
    }
     ...
     * and not contain duplicates.
     */
    public com.google.api.ads.admanager.axis.v201802.Value[] getValues() {
        return values;
    }
     ...
     * and not contain duplicates.
     */
    public void setValues(com.google.api.ads.admanager.axis.v201802.Value[] values) {
        this.values = values;
    }

    public com.google.api.ads.admanager.axis.v201802.Value getValues(int i) {
        return this.values[i];
    }

    public void setValues(int i, com.google.api.ads.admanager.axis.v201802.Value _value) {
