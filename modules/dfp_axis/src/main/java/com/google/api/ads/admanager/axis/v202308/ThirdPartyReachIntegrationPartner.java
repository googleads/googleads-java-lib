...
public class ThirdPartyReachIntegrationPartner implements java.io.Serializable {
    ...
    public static final java.lang.String _VIDEO_RESEARCH = "VIDEO_RESEARCH";
    public static final java.lang.String _GEMIUS = "GEMIUS";
    public static final java.lang.String _VIDEO_AMP = "VIDEO_AMP";
    public static final java.lang.String _ISPOT_TV = "ISPOT_TV";
    public static final java.lang.String _AUDIENCE_PROJECT = "AUDIENCE_PROJECT";
    ...
    public static final ThirdPartyReachIntegrationPartner VIDEO_RESEARCH = new ThirdPartyReachIntegrationPartner(_VIDEO_RESEARCH);
    public static final ThirdPartyReachIntegrationPartner GEMIUS = new ThirdPartyReachIntegrationPartner(_GEMIUS);
    public static final ThirdPartyReachIntegrationPartner VIDEO_AMP = new ThirdPartyReachIntegrationPartner(_VIDEO_AMP);
    public static final ThirdPartyReachIntegrationPartner ISPOT_TV = new ThirdPartyReachIntegrationPartner(_ISPOT_TV);
    public static final ThirdPartyReachIntegrationPartner AUDIENCE_PROJECT = new ThirdPartyReachIntegrationPartner(_AUDIENCE_PROJECT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202308", "ThirdPartyReachIntegrationPartner"));
    }
    /**
