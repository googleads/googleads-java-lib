...
public class MobileApplicationStore implements java.io.Serializable {
    ...
    public static final MobileApplicationStore LG_TV = new MobileApplicationStore(_LG_TV);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202402", "MobileApplicationStore"));
    }
    /**
