...
public class Goal  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v201802.GoalType goalType;
    ...
    public Goal(
           com.google.api.ads.admanager.axis.v201802.GoalType goalType,
     ...
     *                 for {@code LineItem} should be reached.
     */
    public com.google.api.ads.admanager.axis.v201802.GoalType getGoalType() {
        return goalType;
    }
     ...
     *                 for {@code LineItem} should be reached.
     */
    public void setGoalType(com.google.api.ads.admanager.axis.v201802.GoalType goalType) {
        this.goalType = goalType;
    }
