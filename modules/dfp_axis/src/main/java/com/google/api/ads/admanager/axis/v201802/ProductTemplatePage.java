 ...
 */
public class ProductTemplatePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.ProductTemplate>{
     ...
     * this page. */
    private com.google.api.ads.admanager.axis.v201802.ProductTemplate[] results;
    ...
    public ProductTemplatePage(
           ...
           com.google.api.ads.admanager.axis.v201802.ProductTemplate[] results) {
     ...
     * this page.
     */
    public com.google.api.ads.admanager.axis.v201802.ProductTemplate[] getResults() {
        return results;
    }
     ...
     * this page.
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.ProductTemplate[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.ProductTemplate getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.ProductTemplate _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.ProductTemplate> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.ProductTemplate>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.ProductTemplate>asList(results).iterator();
    }
