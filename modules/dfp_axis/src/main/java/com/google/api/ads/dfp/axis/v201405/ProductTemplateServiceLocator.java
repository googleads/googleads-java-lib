...
public class ProductTemplateServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201405.ProductTemplateService {
    ...
    public com.google.api.ads.dfp.axis.v201405.ProductTemplateServiceInterface getProductTemplateServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201405.ProductTemplateServiceInterface getProductTemplateServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201405.ProductTemplateServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201405.ProductTemplateServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201405.ProductTemplateServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201405.ProductTemplateServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201405.ProductTemplateServiceSoapBindingStub(new java.net.URL(ProductTemplateServiceInterfacePort_address), this);
                _stub.setPortName(getProductTemplateServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201405", "ProductTemplateService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201405", "ProductTemplateServiceInterfacePort"));
        }
