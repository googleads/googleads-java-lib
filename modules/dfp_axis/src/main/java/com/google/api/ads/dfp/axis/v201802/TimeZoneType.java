...
public class TimeZoneType implements java.io.Serializable {
    ...
    public static final java.lang.String _PROPOSAL_LOCAL = "PROPOSAL_LOCAL";
    ...
    public static final TimeZoneType PROPOSAL_LOCAL = new TimeZoneType(_PROPOSAL_LOCAL);
    public static final TimeZoneType PUBLISHER = new TimeZoneType(_PUBLISHER);
    public static final TimeZoneType AD_EXCHANGE = new TimeZoneType(_AD_EXCHANGE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "TimeZoneType"));
    }
    /**
