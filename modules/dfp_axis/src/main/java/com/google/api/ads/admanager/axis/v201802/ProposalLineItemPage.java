 ...
 */
public class ProposalLineItemPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.ProposalLineItem>{
    /* The collection of proposal line items contained within this
     * page. */
    private com.google.api.ads.admanager.axis.v201802.ProposalLineItem[] results;
    ...
    public ProposalLineItemPage(
           com.google.api.ads.admanager.axis.v201802.ProposalLineItem[] results,
     ...
     * page.
     */
    public com.google.api.ads.admanager.axis.v201802.ProposalLineItem[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.ProposalLineItem[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.ProposalLineItem getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.ProposalLineItem _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.ProposalLineItem> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.ProposalLineItem>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.ProposalLineItem>asList(results).iterator();
    }
