...
public class ReconciliationOrderReport  implements java.io.Serializable {
     ...
     *                 This value is read-only and is assigned by Google
     * when the order report is created. */
    private com.google.api.ads.dfp.axis.v201306.ReconciliationOrderReportStatus status;

    /* The time when this order report is submitted.
     *                 This value is read-only and is assigned by Google
     * when the order report is created. */
    private com.google.api.ads.dfp.axis.v201306.DateTime submissionDateTime;
    ...
    public ReconciliationOrderReport(
           ...
           com.google.api.ads.dfp.axis.v201306.ReconciliationOrderReportStatus status,
           com.google.api.ads.dfp.axis.v201306.DateTime submissionDateTime,
     ...
     * when the order report is created.
     */
    public com.google.api.ads.dfp.axis.v201306.ReconciliationOrderReportStatus getStatus() {
        return status;
    }
     ...
     * when the order report is created.
     */
    public void setStatus(com.google.api.ads.dfp.axis.v201306.ReconciliationOrderReportStatus status) {
        this.status = status;
    }
     ...
     * when the order report is created.
     */
    public com.google.api.ads.dfp.axis.v201306.DateTime getSubmissionDateTime() {
     ...
     * when the order report is created.
     */
    public void setSubmissionDateTime(com.google.api.ads.dfp.axis.v201306.DateTime submissionDateTime) {
        this.submissionDateTime = submissionDateTime;
    }
