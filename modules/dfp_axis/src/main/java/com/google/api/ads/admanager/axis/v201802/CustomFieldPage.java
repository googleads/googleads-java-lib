 ...
 */
public class CustomFieldPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.CustomField>{
    ...
    private com.google.api.ads.admanager.axis.v201802.CustomField[] results;
    ...
    public CustomFieldPage(
           ...
           com.google.api.ads.admanager.axis.v201802.CustomField[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.CustomField[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.CustomField[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.CustomField getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.CustomField _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.CustomField> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.CustomField>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.CustomField>asList(results).iterator();
    }
