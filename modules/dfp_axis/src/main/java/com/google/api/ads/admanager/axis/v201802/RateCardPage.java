 ...
 */
public class RateCardPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.RateCard>{
    /* The collection of rate cards contained within this page. */
    private com.google.api.ads.admanager.axis.v201802.RateCard[] results;
    ...
    public RateCardPage(
           com.google.api.ads.admanager.axis.v201802.RateCard[] results,
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.RateCard[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.RateCard[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.RateCard getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.RateCard _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.RateCard> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.RateCard>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.RateCard>asList(results).iterator();
    }
