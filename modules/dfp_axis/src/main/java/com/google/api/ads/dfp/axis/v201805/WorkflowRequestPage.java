 ...
 */
public class WorkflowRequestPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201805.WorkflowRequest>{
    /* The collection of workflow requests contained within this page. */
    private com.google.api.ads.dfp.axis.v201805.WorkflowRequest[] results;
    ...
    public WorkflowRequestPage(
           com.google.api.ads.dfp.axis.v201805.WorkflowRequest[] results,
     ...
     */
    public com.google.api.ads.dfp.axis.v201805.WorkflowRequest[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201805.WorkflowRequest[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201805.WorkflowRequest getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201805.WorkflowRequest _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201805.WorkflowRequest> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201805.WorkflowRequest>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201805.WorkflowRequest>asList(results).iterator();
    }
