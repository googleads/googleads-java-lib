...
public class PublisherQueryLanguageServiceSoapBindingStub extends org.apache.axis.client.Stub implements com.google.api.ads.dfp.axis.v201711.PublisherQueryLanguageServiceInterface {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(com.google.api.ads.dfp.axis.v201711.ResultSet.class);
    ...
    private void addBindings0() {
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201711.ChangeHistoryEntityType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201711.ChangeHistoryOperation.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201711.ChangeHistoryValue.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201711.ColumnType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    private void addBindings1() {
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201711.ResultSet.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201711.Row.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201711.TargetingValue.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public com.google.api.ads.dfp.axis.v201711.ResultSet select(com.google.api.ads.dfp.axis.v201711.Statement selectStatement) throws java.rmi.RemoteException, com.google.api.ads.dfp.axis.v201711.ApiException {
        if (super.cachedEndpoint == null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {selectStatement});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.google.api.ads.dfp.axis.v201711.ResultSet) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.google.api.ads.dfp.axis.v201711.ResultSet) org.apache.axis.utils.JavaUtils.convert(_resp, com.google.api.ads.dfp.axis.v201711.ResultSet.class);
            }
        }
