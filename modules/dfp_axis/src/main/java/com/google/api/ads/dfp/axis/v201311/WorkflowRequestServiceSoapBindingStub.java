...
public class WorkflowRequestServiceSoapBindingStub extends org.apache.axis.client.Stub implements com.google.api.ads.dfp.axis.v201311.WorkflowRequestServiceInterface {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(com.google.api.ads.dfp.axis.v201311.WorkflowRequestPage.class);
    ...
    public WorkflowRequestServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201311.ApproveWorkflowApprovalRequests.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201311.RejectWorkflowApprovalRequests.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201311.WorkflowApprovalRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201311.WorkflowApprovalRequestStatus.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201311.WorkflowEntityType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201311.WorkflowRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201311.WorkflowRequestAction.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.axis.v201311.WorkflowRequestPage.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {filterStatement});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.google.api.ads.dfp.axis.v201311.WorkflowRequestPage) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.google.api.ads.dfp.axis.v201311.WorkflowRequestPage) org.apache.axis.utils.JavaUtils.convert(_resp, com.google.api.ads.dfp.axis.v201311.WorkflowRequestPage.class);
            }
        }
