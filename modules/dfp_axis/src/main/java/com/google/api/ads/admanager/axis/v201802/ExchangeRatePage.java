 ...
 */
public class ExchangeRatePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.ExchangeRate>{
    /* The collection of exchange rates contained within this page. */
    private com.google.api.ads.admanager.axis.v201802.ExchangeRate[] results;
    ...
    public ExchangeRatePage(
           com.google.api.ads.admanager.axis.v201802.ExchangeRate[] results,
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.ExchangeRate[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.ExchangeRate[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.ExchangeRate getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.ExchangeRate _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.ExchangeRate> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.ExchangeRate>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.ExchangeRate>asList(results).iterator();
    }
