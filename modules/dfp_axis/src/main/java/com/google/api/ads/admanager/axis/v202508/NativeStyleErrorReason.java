...
public class NativeStyleErrorReason implements java.io.Serializable {
    private java.lang.String _value_;
    private static java.util.HashMap _table_ = new java.util.HashMap();

    // Constructor
    protected NativeStyleErrorReason(java.lang.String value) {
        _value_ = value;
    ...
    public static final java.lang.String _INVALID_FLUID_SIZE_FOR_NEWSLETTER_FORMAT = "INVALID_FLUID_SIZE_FOR_NEWSLETTER_FORMAT";
    ...
    public static final NativeStyleErrorReason INVALID_STATUS = new NativeStyleErrorReason(_INVALID_STATUS);
    public static final NativeStyleErrorReason INVALID_TARGETING_TYPE = new NativeStyleErrorReason(_INVALID_TARGETING_TYPE);
    public static final NativeStyleErrorReason INVALID_FLUID_SIZE_FOR_NEWSLETTER_FORMAT = new NativeStyleErrorReason(_INVALID_FLUID_SIZE_FOR_NEWSLETTER_FORMAT);
    ...
    public static NativeStyleErrorReason fromValue(java.lang.String value)
        ...
        NativeStyleErrorReason enumeration = (NativeStyleErrorReason)
            _table_.get(value);
        if (enumeration==null) throw new java.lang.IllegalArgumentException();
        return enumeration;
    }
    public static NativeStyleErrorReason fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(NativeStyleErrorReason.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202508", "NativeStyleError.Reason"));
    }
    /**
