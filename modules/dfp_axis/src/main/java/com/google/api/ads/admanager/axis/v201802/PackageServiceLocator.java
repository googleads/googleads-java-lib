...
public class PackageServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.admanager.axis.v201802.PackageService {
    ...
    public com.google.api.ads.admanager.axis.v201802.PackageServiceInterface getPackageServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.admanager.axis.v201802.PackageServiceInterface getPackageServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.admanager.axis.v201802.PackageServiceSoapBindingStub _stub = new com.google.api.ads.admanager.axis.v201802.PackageServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.admanager.axis.v201802.PackageServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.admanager.axis.v201802.PackageServiceSoapBindingStub _stub = new com.google.api.ads.admanager.axis.v201802.PackageServiceSoapBindingStub(new java.net.URL(PackageServiceInterfacePort_address), this);
                _stub.setPortName(getPackageServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
