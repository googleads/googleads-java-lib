...
/**
 * The action to reserve inventory for {@link ProposalLineItem} objects.
 * It does not
 *             overbook inventory unless {@link #allowOverbook} is set
 * to {@code true}.
 *             This action is only applicable for programmatic proposals
 * not using sales management.
 */
public class ReserveProposalLineItems  extends com.google.api.ads.admanager.axis.v202205.ProposalLineItemAction  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReserveProposalLineItems)) return false;
        ReserveProposalLineItems other = (ReserveProposalLineItems) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReserveProposalLineItems.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202205", "ReserveProposalLineItems"));
