...
public class Dimension implements java.io.Serializable {
    ...
    public static final java.lang.String _INVENTORY_OWNERSHIP_CODE = "INVENTORY_OWNERSHIP_CODE";
    public static final java.lang.String _INVENTORY_OWNERSHIP_NAME = "INVENTORY_OWNERSHIP_NAME";
    public static final java.lang.String _NETWORK_PARTNER_ID = "NETWORK_PARTNER_ID";
    public static final java.lang.String _NETWORK_PARTNER_NAME = "NETWORK_PARTNER_NAME";
    ...
    public static final Dimension INVENTORY_OWNERSHIP_CODE = new Dimension(_INVENTORY_OWNERSHIP_CODE);
    public static final Dimension INVENTORY_OWNERSHIP_NAME = new Dimension(_INVENTORY_OWNERSHIP_NAME);
    public static final Dimension NETWORK_PARTNER_ID = new Dimension(_NETWORK_PARTNER_ID);
    public static final Dimension NETWORK_PARTNER_NAME = new Dimension(_NETWORK_PARTNER_NAME);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202205", "Dimension"));
    }
    /**
