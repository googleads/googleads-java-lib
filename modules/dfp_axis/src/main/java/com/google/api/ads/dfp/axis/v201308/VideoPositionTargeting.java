...
public class VideoPositionTargeting  implements java.io.Serializable {
     ...
     * the
     *                 video {@link LineItem}. */
    private com.google.api.ads.dfp.axis.v201308.VideoPositionTarget[] targetedPositions;

    public VideoPositionTargeting() {
    }

    public VideoPositionTargeting(
           com.google.api.ads.dfp.axis.v201308.VideoPositionTarget[] targetedPositions) {
     ...
     *                 video {@link LineItem}.
     */
    public com.google.api.ads.dfp.axis.v201308.VideoPositionTarget[] getTargetedPositions() {
     ...
     *                 video {@link LineItem}.
     */
    public void setTargetedPositions(com.google.api.ads.dfp.axis.v201308.VideoPositionTarget[] targetedPositions) {
        this.targetedPositions = targetedPositions;
    }

    public com.google.api.ads.dfp.axis.v201308.VideoPositionTarget getTargetedPositions(int i) {
        return this.targetedPositions[i];
    }

    public void setTargetedPositions(int i, com.google.api.ads.dfp.axis.v201308.VideoPositionTarget _value) {
