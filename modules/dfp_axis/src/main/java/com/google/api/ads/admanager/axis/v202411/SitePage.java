...
public class SitePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v202411.Site>{
    ...
    public SitePage(
           ...
           com.google.api.ads.admanager.axis.v202411.Site[] results) {
    ...
    public com.google.api.ads.admanager.axis.v202411.Site getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v202411.Site _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v202411.Site> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v202411.Site>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v202411.Site>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "SitePage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202411", "Site"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
