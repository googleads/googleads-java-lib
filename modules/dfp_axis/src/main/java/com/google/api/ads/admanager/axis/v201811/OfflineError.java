...
/**
 * An error that occurs for an internal Ad Manager process that happens
 * in the background. For
 *             example, {@link Proposal} workflows can have background
 * tasks that may have offline errors.
 */
public class OfflineError  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v201811.DateTime errorTime;
    ...
    public OfflineError(
           ...
           com.google.api.ads.admanager.axis.v201811.DateTime errorTime,
     ...
     */
    public com.google.api.ads.admanager.axis.v201811.DateTime getErrorTime() {
        return errorTime;
    }
     ...
     */
    public void setErrorTime(com.google.api.ads.admanager.axis.v201811.DateTime errorTime) {
        this.errorTime = errorTime;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201811", "OfflineError"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201811", "errorTime"));
