...
public class InventorySizeTargeting  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v202508.TargetedSize[] targetedSizes;
    ...
    public InventorySizeTargeting(
           ...
           com.google.api.ads.admanager.axis.v202508.TargetedSize[] targetedSizes) {
     ...
     */
    public com.google.api.ads.admanager.axis.v202508.TargetedSize[] getTargetedSizes() {
        return targetedSizes;
    }
     ...
     * @param targetedSizes
     */
    public void setTargetedSizes(com.google.api.ads.admanager.axis.v202508.TargetedSize[] targetedSizes) {
        this.targetedSizes = targetedSizes;
    }

    public com.google.api.ads.admanager.axis.v202508.TargetedSize getTargetedSizes(int i) {
        return this.targetedSizes[i];
    }

    public void setTargetedSizes(int i, com.google.api.ads.admanager.axis.v202508.TargetedSize _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202508", "InventorySizeTargeting"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202508", "targetedSizes"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202508", "TargetedSize"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
