...
public class AdExclusionRule  implements java.io.Serializable {
    ...
    private com.google.api.ads.admanager.axis.v201802.AdExclusionRuleType type;
    ...
    public AdExclusionRule(
           ...
           com.google.api.ads.admanager.axis.v201802.AdExclusionRuleType type) {
           this.id = id;
           this.name = name;
     ...
     *                 field will not be persisted.
     */
    public com.google.api.ads.admanager.axis.v201802.AdExclusionRuleType getType() {
        return type;
    }
     ...
     *                 field will not be persisted.
     */
    public void setType(com.google.api.ads.admanager.axis.v201802.AdExclusionRuleType type) {
        this.type = type;
    }
