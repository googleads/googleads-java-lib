 ...
 */
public class ContentBundlePage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.ContentBundle>{
    ...
    private com.google.api.ads.admanager.axis.v201802.ContentBundle[] results;
    ...
    public ContentBundlePage(
           ...
           com.google.api.ads.admanager.axis.v201802.ContentBundle[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.ContentBundle[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.ContentBundle[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.ContentBundle getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.ContentBundle _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.ContentBundle> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.ContentBundle>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.ContentBundle>asList(results).iterator();
    }
