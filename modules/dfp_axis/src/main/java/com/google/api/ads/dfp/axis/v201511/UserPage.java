...
public class UserPage  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.axis.v201511.User[] results;
    ...
    public UserPage(
           ...
           com.google.api.ads.dfp.axis.v201511.User[] results) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201511.User[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201511.User[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201511.User getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201511.User _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201511", "UserPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201511", "User"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
