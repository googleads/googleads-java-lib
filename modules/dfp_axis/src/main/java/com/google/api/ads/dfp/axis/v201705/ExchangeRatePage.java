 ...
 */
public class ExchangeRatePage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201705.ExchangeRate>{
    /* The collection of exchange rates contained within this page. */
    private com.google.api.ads.dfp.axis.v201705.ExchangeRate[] results;
    ...
    public ExchangeRatePage(
           com.google.api.ads.dfp.axis.v201705.ExchangeRate[] results,
     ...
     */
    public com.google.api.ads.dfp.axis.v201705.ExchangeRate[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201705.ExchangeRate[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201705.ExchangeRate getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201705.ExchangeRate _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201705.ExchangeRate> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201705.ExchangeRate>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201705.ExchangeRate>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201705", "ExchangeRatePage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201705", "ExchangeRate"));
