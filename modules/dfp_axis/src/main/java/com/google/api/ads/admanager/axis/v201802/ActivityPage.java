 ...
 */
public class ActivityPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.Activity>{
    ...
    private com.google.api.ads.admanager.axis.v201802.Activity[] results;
    ...
    public ActivityPage(
           ...
           com.google.api.ads.admanager.axis.v201802.Activity[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.Activity[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.Activity[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.Activity getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.Activity _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.Activity> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.Activity>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.Activity>asList(results).iterator();
    }
