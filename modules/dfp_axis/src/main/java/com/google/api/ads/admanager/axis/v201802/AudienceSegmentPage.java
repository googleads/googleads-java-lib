 ...
 */
public class AudienceSegmentPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.AudienceSegment>{
    ...
    private com.google.api.ads.admanager.axis.v201802.AudienceSegment[] results;
    ...
    public AudienceSegmentPage(
           ...
           com.google.api.ads.admanager.axis.v201802.AudienceSegment[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.AudienceSegment[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.AudienceSegment[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.AudienceSegment getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.AudienceSegment _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.AudienceSegment> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.AudienceSegment>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.AudienceSegment>asList(results).iterator();
    }
