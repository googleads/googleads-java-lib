...
public class SharedAdUnitServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201505.SharedAdUnitService {
    ...
    private java.lang.String SharedAdUnitServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v201505/SharedAdUnitService";
    ...
    public com.google.api.ads.dfp.axis.v201505.SharedAdUnitServiceInterface getSharedAdUnitServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201505.SharedAdUnitServiceInterface getSharedAdUnitServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201505.SharedAdUnitServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201505.SharedAdUnitServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201505.SharedAdUnitServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201505.SharedAdUnitServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201505.SharedAdUnitServiceSoapBindingStub(new java.net.URL(SharedAdUnitServiceInterfacePort_address), this);
                _stub.setPortName(getSharedAdUnitServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "SharedAdUnitService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "SharedAdUnitServiceInterfacePort"));
        }
