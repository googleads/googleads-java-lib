 ...
 */
public class TeamPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.Team>{
    ...
    private com.google.api.ads.admanager.axis.v201802.Team[] results;
    ...
    public TeamPage(
           ...
           com.google.api.ads.admanager.axis.v201802.Team[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.Team[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.Team[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.Team getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.Team _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.Team> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.Team>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.Team>asList(results).iterator();
    }
