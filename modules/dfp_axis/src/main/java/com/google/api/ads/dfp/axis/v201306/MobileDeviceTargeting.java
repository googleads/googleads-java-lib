...
public class MobileDeviceTargeting  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.axis.v201306.Technology[] targetedMobileDevices;

    /* Mobile devices that are being excluded by the {@link LineItem}. */
    private com.google.api.ads.dfp.axis.v201306.Technology[] excludedMobileDevices;

    public MobileDeviceTargeting() {
    }

    public MobileDeviceTargeting(
           com.google.api.ads.dfp.axis.v201306.Technology[] targetedMobileDevices,
           com.google.api.ads.dfp.axis.v201306.Technology[] excludedMobileDevices) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201306.Technology[] getTargetedMobileDevices() {
     ...
     */
    public void setTargetedMobileDevices(com.google.api.ads.dfp.axis.v201306.Technology[] targetedMobileDevices) {
        this.targetedMobileDevices = targetedMobileDevices;
    }

    public com.google.api.ads.dfp.axis.v201306.Technology getTargetedMobileDevices(int i) {
        return this.targetedMobileDevices[i];
    }

    public void setTargetedMobileDevices(int i, com.google.api.ads.dfp.axis.v201306.Technology _value) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201306.Technology[] getExcludedMobileDevices() {
     ...
     */
    public void setExcludedMobileDevices(com.google.api.ads.dfp.axis.v201306.Technology[] excludedMobileDevices) {
        this.excludedMobileDevices = excludedMobileDevices;
    }

    public com.google.api.ads.dfp.axis.v201306.Technology getExcludedMobileDevices(int i) {
        return this.excludedMobileDevices[i];
    }

    public void setExcludedMobileDevices(int i, com.google.api.ads.dfp.axis.v201306.Technology _value) {
