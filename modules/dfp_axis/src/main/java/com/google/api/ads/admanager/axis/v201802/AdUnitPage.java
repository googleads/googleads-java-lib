 ...
 */
public class AdUnitPage  implements java.io.Serializable , Iterable<com.google.api.ads.admanager.axis.v201802.AdUnit>{
    ...
    private com.google.api.ads.admanager.axis.v201802.AdUnit[] results;
    ...
    public AdUnitPage(
           ...
           com.google.api.ads.admanager.axis.v201802.AdUnit[] results) {
     ...
     */
    public com.google.api.ads.admanager.axis.v201802.AdUnit[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.admanager.axis.v201802.AdUnit[] results) {
        this.results = results;
    }

    public com.google.api.ads.admanager.axis.v201802.AdUnit getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.admanager.axis.v201802.AdUnit _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.admanager.axis.v201802.AdUnit> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.admanager.axis.v201802.AdUnit>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.admanager.axis.v201802.AdUnit>asList(results).iterator();
    }
