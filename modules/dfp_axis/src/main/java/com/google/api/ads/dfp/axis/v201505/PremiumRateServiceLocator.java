...
public class PremiumRateServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201505.PremiumRateService {
    ...
    private java.lang.String PremiumRateServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v201505/PremiumRateService";
    ...
    public com.google.api.ads.dfp.axis.v201505.PremiumRateServiceInterface getPremiumRateServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201505.PremiumRateServiceInterface getPremiumRateServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201505.PremiumRateServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201505.PremiumRateServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201505.PremiumRateServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201505.PremiumRateServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201505.PremiumRateServiceSoapBindingStub(new java.net.URL(PremiumRateServiceInterfacePort_address), this);
                _stub.setPortName(getPremiumRateServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "PremiumRateService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "PremiumRateServiceInterfacePort"));
        }
