...
public class GrpSettingsErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _DEMOG_GOAL_NOT_SUPPORTED = "DEMOG_GOAL_NOT_SUPPORTED";
    public static final java.lang.String _IMPRESSION_GOAL_NOT_ENOUGH = "IMPRESSION_GOAL_NOT_ENOUGH";
    public static final java.lang.String _CANNOT_SET_DEMOG_GOAL = "CANNOT_SET_DEMOG_GOAL";
    public static final java.lang.String _CANNOT_REMOVE_DEMOG_GOAL = "CANNOT_REMOVE_DEMOG_GOAL";
    ...
    public static final GrpSettingsErrorReason DEMOG_GOAL_NOT_SUPPORTED = new GrpSettingsErrorReason(_DEMOG_GOAL_NOT_SUPPORTED);
    public static final GrpSettingsErrorReason IMPRESSION_GOAL_NOT_ENOUGH = new GrpSettingsErrorReason(_IMPRESSION_GOAL_NOT_ENOUGH);
    public static final GrpSettingsErrorReason CANNOT_SET_DEMOG_GOAL = new GrpSettingsErrorReason(_CANNOT_SET_DEMOG_GOAL);
    public static final GrpSettingsErrorReason CANNOT_REMOVE_DEMOG_GOAL = new GrpSettingsErrorReason(_CANNOT_REMOVE_DEMOG_GOAL);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201602", "GrpSettingsError.Reason"));
    }
    /**
