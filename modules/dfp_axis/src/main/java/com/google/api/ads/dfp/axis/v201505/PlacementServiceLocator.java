...
public class PlacementServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.axis.v201505.PlacementService {
    ...
    private java.lang.String PlacementServiceInterfacePort_address = "https://ads.google.com/apis/ads/publisher/v201505/PlacementService";
    ...
    public com.google.api.ads.dfp.axis.v201505.PlacementServiceInterface getPlacementServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.axis.v201505.PlacementServiceInterface getPlacementServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.axis.v201505.PlacementServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201505.PlacementServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.axis.v201505.PlacementServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.axis.v201505.PlacementServiceSoapBindingStub _stub = new com.google.api.ads.dfp.axis.v201505.PlacementServiceSoapBindingStub(new java.net.URL(PlacementServiceInterfacePort_address), this);
                _stub.setPortName(getPlacementServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "PlacementService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201505", "PlacementServiceInterfacePort"));
        }
