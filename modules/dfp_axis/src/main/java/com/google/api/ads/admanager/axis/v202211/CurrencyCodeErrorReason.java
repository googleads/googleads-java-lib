...
public class CurrencyCodeErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _DEPRECATED_CURRENCY_USED = "DEPRECATED_CURRENCY_USED";
    public static final CurrencyCodeErrorReason INVALID = new CurrencyCodeErrorReason(_INVALID);
    public static final CurrencyCodeErrorReason UNSUPPORTED = new CurrencyCodeErrorReason(_UNSUPPORTED);
    public static final CurrencyCodeErrorReason DEPRECATED_CURRENCY_USED = new CurrencyCodeErrorReason(_DEPRECATED_CURRENCY_USED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v202211", "CurrencyCodeError.Reason"));
    }
    /**
