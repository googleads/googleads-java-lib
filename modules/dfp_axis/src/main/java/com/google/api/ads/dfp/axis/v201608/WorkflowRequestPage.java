 ...
 */
public class WorkflowRequestPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201608.WorkflowRequest>{
    /* The collection of workflow requests contained within this page. */
    private com.google.api.ads.dfp.axis.v201608.WorkflowRequest[] results;
    ...
    public WorkflowRequestPage(
           com.google.api.ads.dfp.axis.v201608.WorkflowRequest[] results,
     ...
     */
    public com.google.api.ads.dfp.axis.v201608.WorkflowRequest[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201608.WorkflowRequest[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201608.WorkflowRequest getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201608.WorkflowRequest _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201608.WorkflowRequest> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201608.WorkflowRequest>emptyIterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201608.WorkflowRequest>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201608", "WorkflowRequestPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201608", "WorkflowRequest"));
