...
import com.google.api.ads.admanager.axis.v201802.Statement;
import com.google.api.ads.admanager.axis.v201802.String_ValueMapEntry;
...
public class StatementBuilderTest {
  ...
  public void testBindVariables_bool() {
    ...
    Statement statement = statementBuilder
        .where("bool = :bool")
        .withBindVariableValue("bool", true)
        .toStatement();
  ...
  public void testBindVariables_text() {
    ...
    Statement statement = statementBuilder
        .where("text = :text")
        .withBindVariableValue("text", "foo")
        .toStatement();
    String_ValueMapEntry entry = statement.getValues(0);
  ...
  public void testIncreaseOffset() {
    StatementBuilder statementBuilder = new StatementBuilder();
    Statement initialOffset = statementBuilder
        .limit(100)
        .offset(100)
        .toStatement();
    assertEquals("LIMIT 100 OFFSET 100", initialOffset.getQuery());
    Statement increasedOffset = statementBuilder
  ...
  public void testRemoveLimitAndOffset() {
    ...
    Statement removed = statementBuilder
  ...
  public void testBuildQuery() {
    ...
    String expected = "SELECT id, name FROM line_item WHERE name like :prefix ORDER BY id ASC "
        + "LIMIT 100 OFFSET 0";
