 ...
 */
public class BasicUserList  extends com.google.api.ads.ddp.axis.v201603.dmp.UserList  implements java.io.Serializable {
    /* Conversion types associated with this user list.
     *                                         <span class="constraint Selectable">This
     * field can be selected using the value "ConversionTypes".</span> */
    private com.google.api.ads.ddp.axis.v201603.dmp.UserListConversionType[] conversionTypes;
    ...
    public BasicUserList(
           ...
           com.google.api.ads.ddp.axis.v201603.dmp.UserListConversionType[] conversionTypes) {
        super(
            id,
            isReadOnly,
            name,
     ...
     * field can be selected using the value "ConversionTypes".</span>
     */
    public com.google.api.ads.ddp.axis.v201603.dmp.UserListConversionType[] getConversionTypes() {
     ...
     * field can be selected using the value "ConversionTypes".</span>
     */
    public void setConversionTypes(com.google.api.ads.ddp.axis.v201603.dmp.UserListConversionType[] conversionTypes) {
        this.conversionTypes = conversionTypes;
    }

    public com.google.api.ads.ddp.axis.v201603.dmp.UserListConversionType getConversionTypes(int i) {
        return this.conversionTypes[i];
    }

    public void setConversionTypes(int i, com.google.api.ads.ddp.axis.v201603.dmp.UserListConversionType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201603", "BasicUserList"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("conversionTypes");
        elemField.setXmlName(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201603", "conversionTypes"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201603", "UserListConversionType"));
