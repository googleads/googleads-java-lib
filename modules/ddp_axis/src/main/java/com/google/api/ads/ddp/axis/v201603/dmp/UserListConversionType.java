...
public class UserListConversionType  implements java.io.Serializable {
     ...
     * the
     *                                 conversion event was generated (from
     * a user's perspective).
     *                                 <span class="constraint ReadOnly">This
     * field is read only and will be ignored when sent to the API.</span> */
    private com.google.api.ads.ddp.axis.v201603.dmp.UserListConversionTypeCategory category;
    ...
    public UserListConversionType(
           ...
           com.google.api.ads.ddp.axis.v201603.dmp.UserListConversionTypeCategory category) {
           this.id = id;
           this.name = name;
     ...
     * field is read only and will be ignored when sent to the API.</span>
     */
    public com.google.api.ads.ddp.axis.v201603.dmp.UserListConversionTypeCategory getCategory() {
        return category;
    }
     ...
     * field is read only and will be ignored when sent to the API.</span>
     */
    public void setCategory(com.google.api.ads.ddp.axis.v201603.dmp.UserListConversionTypeCategory category) {
        this.category = category;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201603", "UserListConversionType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201603", "category"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201603", "UserListConversionType.Category"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
