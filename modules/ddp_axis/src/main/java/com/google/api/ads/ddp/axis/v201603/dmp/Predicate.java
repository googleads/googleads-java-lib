...
public class Predicate  implements java.io.Serializable {
     ...
     *                                 the entity's reference page. For example,
     * for predicates for the
     *                                 CampaignService {@link Selector selector},
     * refer to the filterable fields from the
     ...
     *                                 <span class="constraint Required">This
     * field is required and should not be {@code null}.</span> */
    private com.google.api.ads.ddp.axis.v201603.dmp.PredicateOperator operator;
    ...
    public Predicate(
           ...
           com.google.api.ads.ddp.axis.v201603.dmp.PredicateOperator operator,
     ...
     * field is required and should not be {@code null}.</span>
     */
    public com.google.api.ads.ddp.axis.v201603.dmp.PredicateOperator getOperator() {
        return operator;
    }
     ...
     * field is required and should not be {@code null}.</span>
     */
    public void setOperator(com.google.api.ads.ddp.axis.v201603.dmp.PredicateOperator operator) {
        this.operator = operator;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201603", "Predicate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201603", "Predicate.Operator"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("values");
        elemField.setXmlName(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201603", "values"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
