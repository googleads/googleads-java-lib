...
public class OrderBy  implements java.io.Serializable {
    ...
    private com.google.api.ads.ddp.axis.v201603.provider.SortOrder sortOrder;
    ...
    public OrderBy(
           ...
           com.google.api.ads.ddp.axis.v201603.provider.SortOrder sortOrder) {
           this.field = field;
     ...
     * {@link SortOrder#ASCENDING}.
     */
    public com.google.api.ads.ddp.axis.v201603.provider.SortOrder getSortOrder() {
        return sortOrder;
    }
     ...
     * {@link SortOrder#ASCENDING}.
     */
    public void setSortOrder(com.google.api.ads.ddp.axis.v201603.provider.SortOrder sortOrder) {
        this.sortOrder = sortOrder;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201603", "OrderBy"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201603", "sortOrder"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201603", "SortOrder"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
