...
public class Selector  implements java.io.Serializable {
     ...
     *                 <span class="constraint ContentsNotNull">This field
     * must not contain {@code null} elements.</span> */
    private com.google.api.ads.ddp.axis.v201603.provider.Predicate[] predicates;
    ...
    private com.google.api.ads.ddp.axis.v201603.provider.DateRange dateRange;
    ...
    private com.google.api.ads.ddp.axis.v201603.provider.OrderBy[] ordering;

    /* Pagination information. */
    private com.google.api.ads.ddp.axis.v201603.provider.Paging paging;
    ...
    public Selector(
           ...
           com.google.api.ads.ddp.axis.v201603.provider.Predicate[] predicates,
           com.google.api.ads.ddp.axis.v201603.provider.DateRange dateRange,
           com.google.api.ads.ddp.axis.v201603.provider.OrderBy[] ordering,
           com.google.api.ads.ddp.axis.v201603.provider.Paging paging) {
           this.fields = fields;
     ...
     * must not contain {@code null} elements.</span>
     */
    public com.google.api.ads.ddp.axis.v201603.provider.Predicate[] getPredicates() {
        return predicates;
    }
     ...
     * must not contain {@code null} elements.</span>
     */
    public void setPredicates(com.google.api.ads.ddp.axis.v201603.provider.Predicate[] predicates) {
        this.predicates = predicates;
    }

    public com.google.api.ads.ddp.axis.v201603.provider.Predicate getPredicates(int i) {
        return this.predicates[i];
    }

    public void setPredicates(int i, com.google.api.ads.ddp.axis.v201603.provider.Predicate _value) {
     ...
     * range must be contained within the range [19700101, 20380101].</span>
     */
    public com.google.api.ads.ddp.axis.v201603.provider.DateRange getDateRange() {
        return dateRange;
    }
     ...
     * range must be contained within the range [19700101, 20380101].</span>
     */
    public void setDateRange(com.google.api.ads.ddp.axis.v201603.provider.DateRange dateRange) {
        this.dateRange = dateRange;
    }
     ...
     *                 specifies the secondary sort order and so on.
     */
    public com.google.api.ads.ddp.axis.v201603.provider.OrderBy[] getOrdering() {
        return ordering;
    }
     ...
     *                 specifies the secondary sort order and so on.
     */
    public void setOrdering(com.google.api.ads.ddp.axis.v201603.provider.OrderBy[] ordering) {
        this.ordering = ordering;
    }

    public com.google.api.ads.ddp.axis.v201603.provider.OrderBy getOrdering(int i) {
        return this.ordering[i];
    }

    public void setOrdering(int i, com.google.api.ads.ddp.axis.v201603.provider.OrderBy _value) {
     ...
     */
    public com.google.api.ads.ddp.axis.v201603.provider.Paging getPaging() {
        return paging;
    }
     ...
     */
    public void setPaging(com.google.api.ads.ddp.axis.v201603.provider.Paging paging) {
        this.paging = paging;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201603", "Selector"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fields");
        elemField.setXmlName(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201603", "fields"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201603", "predicates"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201603", "Predicate"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201603", "dateRange"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201603", "DateRange"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("ordering");
        elemField.setXmlName(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201603", "ordering"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201603", "OrderBy"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201603", "paging"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201603", "Paging"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
